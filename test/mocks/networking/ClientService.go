...
func (_m *ClientService) IPServicePolicyCreate(params *clientnetworking.IPServicePolicyCreateParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientnetworking.ClientOption) (*clientnetworking.IPServicePolicyCreateOK, *clientnetworking.IPServicePolicyCreateCreated, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 *clientnetworking.IPServicePolicyCreateCreated
	var r2 error
	if rf, ok := ret.Get(0).(func(*clientnetworking.IPServicePolicyCreateParams, runtime.ClientAuthInfoWriter, ...clientnetworking.ClientOption) (*clientnetworking.IPServicePolicyCreateOK, *clientnetworking.IPServicePolicyCreateCreated, error)); ok {
		return rf(params, authInfo, opts...)
	}
	...
	if rf, ok := ret.Get(1).(func(*clientnetworking.IPServicePolicyCreateParams, runtime.ClientAuthInfoWriter, ...clientnetworking.ClientOption) *clientnetworking.IPServicePolicyCreateCreated); ok {
		r1 = rf(params, authInfo, opts...)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*clientnetworking.IPServicePolicyCreateCreated)
		}
	}

	if rf, ok := ret.Get(2).(func(*clientnetworking.IPServicePolicyCreateParams, runtime.ClientAuthInfoWriter, ...clientnetworking.ClientOption) error); ok {
...
func (_m *ClientService) NetworkEthernetPortDelete(params *clientnetworking.NetworkEthernetPortDeleteParams, authInfo runtime.ClientAuthInfoWriter, opts ...clientnetworking.ClientOption) (*clientnetworking.NetworkEthernetPortDeleteOK, *clientnetworking.NetworkEthernetPortDeleteAccepted, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 *clientnetworking.NetworkEthernetPortDeleteAccepted
	var r2 error
	if rf, ok := ret.Get(0).(func(*clientnetworking.NetworkEthernetPortDeleteParams, runtime.ClientAuthInfoWriter, ...clientnetworking.ClientOption) (*clientnetworking.NetworkEthernetPortDeleteOK, *clientnetworking.NetworkEthernetPortDeleteAccepted, error)); ok {
		return rf(params, authInfo, opts...)
	}
	...
	if rf, ok := ret.Get(1).(func(*clientnetworking.NetworkEthernetPortDeleteParams, runtime.ClientAuthInfoWriter, ...clientnetworking.ClientOption) *clientnetworking.NetworkEthernetPortDeleteAccepted); ok {
		r1 = rf(params, authInfo, opts...)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*clientnetworking.NetworkEthernetPortDeleteAccepted)
		}
	}

	if rf, ok := ret.Get(2).(func(*clientnetworking.NetworkEthernetPortDeleteParams, runtime.ClientAuthInfoWriter, ...clientnetworking.ClientOption) error); ok {
		r2 = rf(params, authInfo, opts...)
	} else {
		r2 = ret.Error(2)
	}
