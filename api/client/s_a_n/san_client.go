...
// WithAcceptMultipartFormData sets the Accept header to "multipart/form-data".
func WithAcceptMultipartFormData(r *runtime.ClientOperation) {
	r.ProducesMediaTypes = []string{"multipart/form-data"}
}
