...
type AzureKeyVaultResponse struct {
	...
	// links
	Links *AzureKeyVaultResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// azure key vault response inline records
	AzureKeyVaultResponseInlineRecords []*AzureKeyVault `json:"records,omitempty" yaml:"records,omitempty"`
