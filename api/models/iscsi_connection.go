...
type IscsiConnection struct {
	...
	// links
	Links *IscsiConnectionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	// Read Only: true
	Cid *int64 `json:"cid,omitempty" yaml:"cid,omitempty"`

	// initiator address
	InitiatorAddress *IscsiConnectionInlineInitiatorAddress `json:"initiator_address,omitempty" yaml:"initiator_address,omitempty"`

	// interface
	Interface *IscsiConnectionInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`
}
...
type IscsiConnectionInlineInterface struct {
	...
	// links
	Links *IscsiConnectionInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *IscsiConnectionInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
