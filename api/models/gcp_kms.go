...
type GcpKms struct {
	...
	// links
	Links *GcpKmsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Format: password
	ApplicationCredentials *strfmt.Password `json:"application_credentials,omitempty" yaml:"application_credentials,omitempty"`

	// Google Cloud KMS caller account email
	// Example: myaccount@myproject.com
	// Read Only: true
	CallerAccount *string `json:"caller_account,omitempty" yaml:"caller_account,omitempty"`

	// Google Cloud KMS host subdomain.
	// Example: cloudkms.googleapis.com
	CloudkmsHost *string `json:"cloudkms_host,omitempty" yaml:"cloudkms_host,omitempty"`

	// gcp kms inline ekmip reachability
	// Read Only: true
	GcpKmsInlineEkmipReachability []*GcpKmsInlineEkmipReachabilityInlineArrayItem `json:"ekmip_reachability,omitempty" yaml:"ekmip_reachability,omitempty"`

	// google reachability
	GoogleReachability *GcpKmsInlineGoogleReachability `json:"google_reachability,omitempty" yaml:"google_reachability,omitempty"`
	...
	// Example: global
	KeyRingLocation *string `json:"key_ring_location,omitempty" yaml:"key_ring_location,omitempty"`
	...
	OauthURL *string `json:"oauth_url,omitempty" yaml:"oauth_url,omitempty"`
	...
	PrivilegedAccount *string `json:"privileged_account,omitempty" yaml:"privileged_account,omitempty"`
	...
	// state
	State *GcpKmsInlineState `json:"state,omitempty" yaml:"state,omitempty"`

	// svm
	Svm *GcpKmsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	VerifyIP *bool `json:"verify_ip,omitempty" yaml:"verify_ip,omitempty"`
}
...
type GcpKmsInlineEkmipReachabilityInlineArrayItem struct {
	...
	// node
	Node *GcpKmsInlineEkmipReachabilityInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type GcpKmsInlineEkmipReachabilityInlineArrayItemInlineNode struct {
	...
	// links
	Links *GcpKmsInlineEkmipReachabilityInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type GcpKmsInlineSvm struct {
	...
	// links
	Links *GcpKmsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
