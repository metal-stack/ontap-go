...
type StoragePoolResponse struct {
	...
	// links
	Links *StoragePoolResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	StoragePoolResponseInlineRecords []*StoragePool `json:"records,omitempty" yaml:"records,omitempty"`

	// storage pool response inline spares
	StoragePoolResponseInlineSpares []*StoragePoolShowSpares `json:"spares,omitempty" yaml:"spares,omitempty"`
}
