...
type SnmpTraphost struct {
	...
	// links
	Links *SnmpTraphostInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// ip address
	IPAddress *IPAddressReadonly `json:"ip_address,omitempty" yaml:"ip_address,omitempty"`

	// user
	User *SnmpTraphostInlineUser `json:"user,omitempty" yaml:"user,omitempty"`
}
...
type SnmpTraphostInlineUser struct {
	...
	// links
	Links *SnmpTraphostInlineUserInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
