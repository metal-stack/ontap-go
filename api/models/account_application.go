...
type AccountApplication struct {
	...
	AuthenticationMethods []*string `json:"authentication_methods,omitempty" yaml:"authentication_methods,omitempty"`

	// Optional property that specifies the mode of authentication as LDAP Fastbind.
	IsLdapFastbind *bool `json:"is_ldap_fastbind,omitempty" yaml:"is_ldap_fastbind,omitempty"`
