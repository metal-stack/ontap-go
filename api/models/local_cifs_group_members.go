...
type LocalCifsGroupMembers struct {
	...
	// local cifs group
	LocalCifsGroup *LocalCifsGroupMembersInlineLocalCifsGroup `json:"local_cifs_group,omitempty" yaml:"local_cifs_group,omitempty"`
	...
	//
	LocalCifsGroupMembersInlineRecords []*LocalCifsGroupMembersInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
	...
	// svm
	Svm *LocalCifsGroupMembersInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type LocalCifsGroupMembersInlineSvm struct {
	...
	// links
	Links *LocalCifsGroupMembersInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
