...
type S3Policy struct {
	...
	S3PolicyInlineStatements []*S3PolicyStatement `json:"statements,omitempty" yaml:"statements,omitempty"`

	// svm
	Svm *S3PolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type S3PolicyInlineSvm struct {
	...
	// links
	Links *S3PolicyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
