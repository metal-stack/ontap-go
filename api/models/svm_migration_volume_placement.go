...
type SvmMigrationVolumePlacement struct {
	...
	SvmMigrationVolumePlacementInlineAggregates []*SvmMigrationVolumePlacementInlineAggregatesInlineArrayItem `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`

	// Optional property used to specify the list of desired volume-aggregate pairs in the destination.
	SvmMigrationVolumePlacementInlineVolumeAggregatePairs []*SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItem `json:"volume_aggregate_pairs,omitempty" yaml:"volume_aggregate_pairs,omitempty"`
}
...
type SvmMigrationVolumePlacementInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *SvmMigrationVolumePlacementInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItem struct {
	...
	// aggregate
	Aggregate *SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItemInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// volume
	Volume *SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItemInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItemInlineAggregate struct {
	...
	// links
	Links *SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItemInlineAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItemInlineVolume struct {
	...
	// links
	Links *SvmMigrationVolumePlacementInlineVolumeAggregatePairsInlineArrayItemInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
