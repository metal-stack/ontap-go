...
type AnalyticsHistogramByTime struct {
	...
	AnalyticsHistogramByTimeInlinePercentages []*float64 `json:"percentages,omitempty" yaml:"percentages,omitempty"`

	// Values for this histogram
	// Example: [15925248,1735569408,27672576,2430595072,116105216,12889948160,0]
	AnalyticsHistogramByTimeInlineValues []*int64 `json:"values,omitempty" yaml:"values,omitempty"`
