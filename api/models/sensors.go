...
type Sensors struct {
	...
	// Read Only: true
	CriticalHighThreshold *int64 `json:"critical_high_threshold,omitempty" yaml:"critical_high_threshold,omitempty"`

	// Value below which the sensor goes into a critically low state.
	// Read Only: true
	CriticalLowThreshold *int64 `json:"critical_low_threshold,omitempty" yaml:"critical_low_threshold,omitempty"`
	...
	DiscreteState *string `json:"discrete_state,omitempty" yaml:"discrete_state,omitempty"`

	// Applies to discrete sensors which do not have an integer value. It can have values like on, off, good, bad, ok.
	// Example: ok
	// Read Only: true
	DiscreteValue *string `json:"discrete_value,omitempty" yaml:"discrete_value,omitempty"`
	...
	// node
	Node *SensorsInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// Example: mV
	// Read Only: true
	ValueUnits *string `json:"value_units,omitempty" yaml:"value_units,omitempty"`

	// Value above which the sensor goes into a warning high state.
	// Read Only: true
	WarningHighThreshold *int64 `json:"warning_high_threshold,omitempty" yaml:"warning_high_threshold,omitempty"`

	// Value below which the sensor goes into a warning low state.
	// Read Only: true
	WarningLowThreshold *int64 `json:"warning_low_threshold,omitempty" yaml:"warning_low_threshold,omitempty"`
}
...
type SensorsInlineNode struct {
	...
	// links
	Links *SensorsInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
