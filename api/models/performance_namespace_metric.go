...
type PerformanceNamespaceMetric struct {
	...
	// links
	Links *PerformanceNamespaceMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceNamespaceMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceNamespaceMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceNamespaceMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
