...
type AccountPassword struct {
	...
	// owner
	Owner *AccountPasswordInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
...
type AccountPasswordInlineOwner struct {
	...
	// links
	Links *AccountPasswordInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
