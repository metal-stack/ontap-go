...
type IgroupInitiator struct {
	...
	// links
	Links *IgroupInitiatorInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ConnectivityTracking *IgroupInitiatorInlineConnectivityTracking `json:"connectivity_tracking,omitempty" yaml:"connectivity_tracking,omitempty"`

	// igroup
	Igroup *IgroupInitiatorInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`
	...
	//
	IgroupInitiatorInlineRecords []*IgroupInitiatorInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
	...
	// proximity
	Proximity *IgroupInitiatorInlineProximity `json:"proximity,omitempty" yaml:"proximity,omitempty"`
}
...
type IgroupInitiatorInlineConnectivityTracking struct {
	...
	// alerts
	// Read Only: true
	Alerts []*IgroupInitiatorConnectivityTrackingAlertsItems0 `json:"alerts,omitempty" yaml:"alerts,omitempty"`
	...
	// connections
	Connections []*IgroupInitiatorConnectivityTrackingConnectionsItems0 `json:"connections,omitempty" yaml:"connections,omitempty"`
}
...
type IgroupInitiatorConnectivityTrackingAlertsItems0 struct {
	...
	// summary
	Summary *IgroupInitiatorConnectivityTrackingAlertsItems0Summary `json:"summary,omitempty" yaml:"summary,omitempty"`
}
...
type IgroupInitiatorConnectivityTrackingConnectionsItems0 struct {
	...
	// logins
	Logins []*IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0 `json:"logins" yaml:"logins"`

	// node
	Node *IgroupInitiatorConnectivityTrackingConnectionsItems0Node `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0 struct {
	...
	// interface
	Interface *IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0Interface `json:"interface,omitempty" yaml:"interface,omitempty"`
	...
	// Read Only: true
	// Format: date-time
	LastSeenTime *strfmt.DateTime `json:"last_seen_time,omitempty" yaml:"last_seen_time,omitempty"`
}
...
type IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0Interface struct {
	...
	// fc
	Fc *IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceFc `json:"fc,omitempty" yaml:"fc,omitempty"`

	// ip
	IP *IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceIP `json:"ip,omitempty" yaml:"ip,omitempty"`
}
...
type IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceFc struct {
	...
	// links
	Links *IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceFcLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceIP struct {
	...
	// links
	Links *IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceIPLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *IgroupInitiatorConnectivityTrackingConnectionsItems0LoginsItems0InterfaceIPIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type IgroupInitiatorConnectivityTrackingConnectionsItems0Node struct {
	...
	// links
	Links *IgroupInitiatorConnectivityTrackingConnectionsItems0NodeLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInitiatorInlineIgroup struct {
	...
	// links
	Links *IgroupInitiatorInlineIgroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInitiatorInlineProximity struct {
	...
	//
	PeerSvms []*IgroupInitiatorProximityPeerSvmsItems0 `json:"peer_svms,omitempty" yaml:"peer_svms,omitempty"`
}
...
type IgroupInitiatorProximityPeerSvmsItems0 struct {
	...
	// links
	Links *IgroupInitiatorProximityPeerSvmsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInitiatorInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *IgroupInitiatorInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// proximity
	Proximity *IgroupInitiatorInlineRecordsInlineArrayItemInlineProximity `json:"proximity,omitempty" yaml:"proximity,omitempty"`
}
...
type IgroupInitiatorInlineRecordsInlineArrayItemInlineProximity struct {
	...
	// An array of remote peer SVMs to which the initiator is proximal.
	//
	PeerSvms []*IgroupInitiatorRecordsItems0ProximityPeerSvmsItems0 `json:"peer_svms" yaml:"peer_svms"`
}
...
type IgroupInitiatorRecordsItems0ProximityPeerSvmsItems0 struct {
	...
	// links
	Links *IgroupInitiatorRecordsItems0ProximityPeerSvmsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
