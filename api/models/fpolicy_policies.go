...
type FpolicyPolicies struct {
	...
	FpolicyPoliciesInlineEvents []*FpolicyEventReference `json:"events,omitempty" yaml:"events,omitempty"`
	...
	// scope
	Scope *FpolicyPoliciesInlineScope `json:"scope,omitempty" yaml:"scope,omitempty"`
}
