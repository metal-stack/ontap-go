...
type LdapService struct {
	...
	// links
	Links *LdapServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	BaseScope *string `json:"base_scope,omitempty" yaml:"base_scope,omitempty"`

	// Specifies whether or not CIFS server's credentials are used to bind to the LDAP server.
	//
	BindAsCifsServer *bool `json:"bind_as_cifs_server,omitempty" yaml:"bind_as_cifs_server,omitempty"`
	...
	GroupDn *string `json:"group_dn,omitempty" yaml:"group_dn,omitempty"`

	// Specifies the custom filter used for group membership lookups from an LDAP server.
	//
	GroupMembershipFilter *string `json:"group_membership_filter,omitempty" yaml:"group_membership_filter,omitempty"`
	...
	//
	// Enum: ["base","onelevel","subtree"]
	GroupScope *string `json:"group_scope,omitempty" yaml:"group_scope,omitempty"`

	// Specifies whether or not netgroup by host querying is enabled.
	//
	IsNetgroupByhostEnabled *bool `json:"is_netgroup_byhost_enabled,omitempty" yaml:"is_netgroup_byhost_enabled,omitempty"`
	...
	LdapServiceInlinePreferredAdServers []*string `json:"preferred_ad_servers,omitempty" yaml:"preferred_ad_servers,omitempty"`

	// ldap service inline servers
	LdapServiceInlineServers []*string `json:"servers,omitempty" yaml:"servers,omitempty"`

	// Specifies whether or not LDAPS is enabled.
	//
	LdapsEnabled *bool `json:"ldaps_enabled,omitempty" yaml:"ldaps_enabled,omitempty"`
	...
	MinBindLevel *string `json:"min_bind_level,omitempty" yaml:"min_bind_level,omitempty"`
	...
	// Example: cn=abc,users,dc=com
	NetgroupByhostDn *string `json:"netgroup_byhost_dn,omitempty" yaml:"netgroup_byhost_dn,omitempty"`
	...
	//
	// Enum: ["base","onelevel","subtree"]
	NetgroupByhostScope *string `json:"netgroup_byhost_scope,omitempty" yaml:"netgroup_byhost_scope,omitempty"`
	...
	// Example: cn=abc,users,dc=com
	NetgroupDn *string `json:"netgroup_dn,omitempty" yaml:"netgroup_dn,omitempty"`
	...
	//
	// Enum: ["base","onelevel","subtree"]
	NetgroupScope *string `json:"netgroup_scope,omitempty" yaml:"netgroup_scope,omitempty"`
	...
	//
	QueryTimeout *int64 `json:"query_timeout,omitempty" yaml:"query_timeout,omitempty"`

	// Specifies whether or not LDAP referral is enabled.
	//
	ReferralEnabled *bool `json:"referral_enabled,omitempty" yaml:"referral_enabled,omitempty"`
	...
	//
	// Enum: ["none","sign","seal"]
	SessionSecurity *string `json:"session_security,omitempty" yaml:"session_security,omitempty"`

	// Indicates whether or not the validation for the specified LDAP configuration is disabled.
	//
	SkipConfigValidation *bool `json:"skip_config_validation,omitempty" yaml:"skip_config_validation,omitempty"`

	// status
	Status *LdapServiceInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`

	// svm
	Svm *LdapServiceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// Specifies whether or not channel binding is attempted in the case of TLS/LDAPS.
	//
	TryChannelBinding *bool `json:"try_channel_binding,omitempty" yaml:"try_channel_binding,omitempty"`

	// Specifies whether or not to use Start TLS over LDAP connections.
	//
	UseStartTLS *bool `json:"use_start_tls,omitempty" yaml:"use_start_tls,omitempty"`

	// Specifies the user Distinguished Name (DN) that is used as the starting point in the LDAP directory tree for user lookups.
	// Example: cn=abc,users,dc=com
	UserDn *string `json:"user_dn,omitempty" yaml:"user_dn,omitempty"`
	...
	//
	// Enum: ["base","onelevel","subtree"]
	UserScope *string `json:"user_scope,omitempty" yaml:"user_scope,omitempty"`
}
...
type LdapServiceInlineStatus struct {
	...
	// dn message
	DnMessage []*string `json:"dn_message,omitempty" yaml:"dn_message,omitempty"`

	// ipv4
	IPV4 *LdapServiceInlineStatusInlineIPV4 `json:"ipv4,omitempty" yaml:"ipv4,omitempty"`

	// This field is no longer supported. Use ipv4.state instead.
	//
	// Enum: ["up","down"]
	IPV4State *string `json:"ipv4_state,omitempty" yaml:"ipv4_state,omitempty"`

	// ipv6
	IPV6 *LdapServiceInlineStatusInlineIPV6 `json:"ipv6,omitempty" yaml:"ipv6,omitempty"`

	// This field is no longer supported. Use ipv6.state instead.
	//
	// Enum: ["up","down"]
	IPV6State *string `json:"ipv6_state,omitempty" yaml:"ipv6_state,omitempty"`
...
type LdapServiceInlineStatusInlineIPV4 struct {
	...
	// dn messages
	DnMessages []*string `json:"dn_messages,omitempty" yaml:"dn_messages,omitempty"`
...
type LdapServiceInlineSvm struct {
	...
	// links
	Links *LdapServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
