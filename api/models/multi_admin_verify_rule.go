...
type MultiAdminVerifyRule struct {
	...
	ApprovalExpiry *string `json:"approval_expiry,omitempty" yaml:"approval_expiry,omitempty"`

	// When true, ONTAP automatically creates a request for any failed operation where there is no matching pending request.
	AutoRequestCreate *bool `json:"auto_request_create,omitempty" yaml:"auto_request_create,omitempty"`
	...
	ExecutionExpiry *string `json:"execution_expiry,omitempty" yaml:"execution_expiry,omitempty"`

	// List of approval groups that are allowed to approve requests for rules that don't have approval groups.
	MultiAdminVerifyRuleInlineApprovalGroups []*MultiAdminVerifyRuleInlineApprovalGroupsInlineArrayItem `json:"approval_groups,omitempty" yaml:"approval_groups,omitempty"`

	// Command that requires one or more approvals.
	Operation *string `json:"operation,omitempty" yaml:"operation,omitempty"`

	// owner
	Owner *MultiAdminVerifyRuleInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
...
type MultiAdminVerifyRuleInlineOwner struct {
	...
	// links
	Links *MultiAdminVerifyRuleInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
