...
type Snmp struct {
	...
	// Example: true
	AuthTrapsEnabled *bool `json:"auth_traps_enabled,omitempty" yaml:"auth_traps_enabled,omitempty"`
	...
	// Example: true
	TrapsEnabled *bool `json:"traps_enabled,omitempty" yaml:"traps_enabled,omitempty"`

	// Trigger a test SNMP trap.
	// Example: true
	TriggerTestTrap *bool `json:"trigger_test_trap,omitempty" yaml:"trigger_test_trap,omitempty"`
}
