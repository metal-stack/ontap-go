...
type NvmeSubsystemMap struct {
	...
	// links
	Links *NvmeSubsystemMapInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// namespace
	Namespace *NvmeSubsystemMapInlineNamespace `json:"namespace,omitempty" yaml:"namespace,omitempty"`
	...
	// subsystem
	Subsystem *NvmeSubsystemMapInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`

	// svm
	Svm *NvmeSubsystemMapInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type NvmeSubsystemMapInlineNamespace struct {
	...
	// node
	Node *NvmeSubsystemMapInlineNamespaceInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type NvmeSubsystemMapInlineNamespaceInlineNode struct {
	...
	// links
	Links *NvmeSubsystemMapInlineNamespaceInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeSubsystemMapInlineSubsystem struct {
	...
	// links
	Links *NvmeSubsystemMapInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeSubsystemMapInlineSvm struct {
	...
	// links
	Links *NvmeSubsystemMapInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
