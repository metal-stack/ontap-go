...
type KeyServerReadcreate struct {
	...
	// connectivity
	Connectivity *KeyServerReadcreateInlineConnectivity `json:"connectivity,omitempty" yaml:"connectivity,omitempty"`
	...
	// Read Only: true
	SecondaryKeyServers *string `json:"secondary_key_servers,omitempty" yaml:"secondary_key_servers,omitempty"`
