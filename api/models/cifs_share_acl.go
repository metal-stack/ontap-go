...
type CifsShareACL struct {
	...
	// links
	Links *CifsShareACLInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *CifsShareACLInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type CifsShareACLInlineSvm struct {
	...
	// links
	Links *CifsShareACLInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
