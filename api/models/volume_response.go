...
type VolumeResponse struct {
	...
	// links
	Links *VolumeResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	VolumeResponseInlineRecords []*Volume `json:"records,omitempty" yaml:"records,omitempty"`
}
