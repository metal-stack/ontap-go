...
type MetroclusterDrGroup struct {
	...
	MetroclusterDrGroupInlineDrPairs []*DrPair `json:"dr_pairs,omitempty" yaml:"dr_pairs,omitempty"`

	// List of Port specifications.
	MetroclusterDrGroupInlineMccipPorts []*MetroclusterDrGroupInlineMccipPortsInlineArrayItem `json:"mccip_ports,omitempty" yaml:"mccip_ports,omitempty"`

	// partner cluster
	PartnerCluster *MetroclusterDrGroupInlinePartnerCluster `json:"partner_cluster,omitempty" yaml:"partner_cluster,omitempty"`
}
...
type MetroclusterDrGroupInlineMccipPortsInlineArrayItem struct {
	...
	// l3 config
	L3Config *MetroclusterDrGroupInlineMccipPortsInlineArrayItemInlineL3Config `json:"l3_config,omitempty" yaml:"l3_config,omitempty"`
	...
	// node
	Node *MetroclusterDrGroupInlineMccipPortsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type MetroclusterDrGroupInlineMccipPortsInlineArrayItemInlineL3Config struct {
	...
	// ipv4 interface
	IPV4Interface *MetroclusterDrGroupInlineMccipPortsInlineArrayItemInlineL3ConfigInlineIPV4Interface `json:"ipv4_interface,omitempty" yaml:"ipv4_interface,omitempty"`
}
...
type MetroclusterDrGroupInlineMccipPortsInlineArrayItemInlineNode struct {
	...
	// links
	Links *MetroclusterDrGroupInlineMccipPortsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterDrGroupInlinePartnerCluster struct {
	...
	// links
	Links *MetroclusterDrGroupInlinePartnerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
