...
type NvmeSubsystemHost struct {
	...
	// links
	Links *NvmeSubsystemHostInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// dh hmac chap
	DhHmacChap *NvmeSubsystemHostInlineDhHmacChap `json:"dh_hmac_chap,omitempty" yaml:"dh_hmac_chap,omitempty"`

	// io queue
	IoQueue *NvmeSubsystemHostInlineIoQueue `json:"io_queue,omitempty" yaml:"io_queue,omitempty"`
	...
	//
	NvmeSubsystemHostInlineRecords []*NvmeSubsystemHostInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
	...
	// subsystem
	Subsystem *NvmeSubsystemHostInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`

	// tls
	TLS *NvmeSubsystemHostInlineTLS `json:"tls,omitempty" yaml:"tls,omitempty"`
}
...
type NvmeSubsystemHostInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// dh hmac chap
	DhHmacChap *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineDhHmacChap `json:"dh_hmac_chap,omitempty" yaml:"dh_hmac_chap,omitempty"`

	// io queue
	IoQueue *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineIoQueue `json:"io_queue,omitempty" yaml:"io_queue,omitempty"`
	...
	// subsystem
	Subsystem *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`

	// tls
	TLS *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineTLS `json:"tls,omitempty" yaml:"tls,omitempty"`
}
...
type NvmeSubsystemHostInlineRecordsInlineArrayItemInlineSubsystem struct {
	...
	// links
	Links *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeSubsystemHostInlineSubsystem struct {
	...
	// links
	Links *NvmeSubsystemHostInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
