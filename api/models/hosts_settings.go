...
type HostsSettings struct {
	...
	// links
	Links *HostsSettingsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Specifies whether TTL is based on the DNS or host settings. If enabled, TTL from DNS is used.
	//
	// Example: true
	DNSTTLEnabled *bool `json:"dns_ttl_enabled,omitempty" yaml:"dns_ttl_enabled,omitempty"`
	...
	// svm
	Svm *HostsSettingsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type HostsSettingsInlineSvm struct {
	...
	// links
	Links *HostsSettingsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
