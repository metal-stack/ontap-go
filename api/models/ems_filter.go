...
type EmsFilter struct {
	...
	// links
	Links *EmsFilterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access control role
	AccessControlRole *EmsFilterInlineAccessControlRole `json:"access_control_role,omitempty" yaml:"access_control_role,omitempty"`

	// Array of event filter rules on which to match.
	EmsFilterInlineRules []*EmsFilterInlineRulesInlineArrayItem `json:"rules,omitempty" yaml:"rules,omitempty"`
...
type EmsFilterInlineAccessControlRole struct {
	...
	// links
	Links *EmsFilterInlineAccessControlRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsFilterInlineRulesInlineArrayItem struct {
	...
	// links
	Links *EmsFilterInlineRulesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// message criteria
	MessageCriteria *EmsFilterInlineRulesInlineArrayItemInlineMessageCriteria `json:"message_criteria,omitempty" yaml:"message_criteria,omitempty"`
	...
	ParameterCriteria []*EmsFilterRulesItems0ParameterCriteriaItems0 `json:"parameter_criteria" yaml:"parameter_criteria"`
...
type EmsFilterInlineRulesInlineArrayItemInlineMessageCriteria struct {
	...
	// links
	Links *EmsFilterInlineRulesInlineArrayItemInlineMessageCriteriaInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
