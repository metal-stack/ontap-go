...
type EmsMessageResponse struct {
	...
	// links
	Links *EmsMessageResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ems message response inline records
	EmsMessageResponseInlineRecords []*EmsMessageResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type EmsMessageResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *EmsMessageResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnmpTrapType *string `json:"snmp_trap_type,omitempty" yaml:"snmp_trap_type,omitempty"`
}
