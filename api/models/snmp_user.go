...
type SnmpUser struct {
	...
	// links
	Links *SnmpUserInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	EngineID *string `json:"engine_id,omitempty" yaml:"engine_id,omitempty"`
	...
	// owner
	Owner *SnmpUserInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
	...
	// snmpv3
	Snmpv3 *SnmpUserInlineSnmpv3 `json:"snmpv3,omitempty" yaml:"snmpv3,omitempty"`
	...
	// Example: 10.23.34.45
	SwitchAddress *string `json:"switch_address,omitempty" yaml:"switch_address,omitempty"`
}
...
type SnmpUserInlineOwner struct {
	...
	// links
	Links *SnmpUserInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnmpUserInlineSnmpv3 struct {
	...
	// links
	Links *SnmpUserInlineSnmpv3InlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Authentication protocol password.
	// Example: humTdumt*@t0nAwa11
	// Min Length: 8
	AuthenticationPassword *string `json:"authentication_password,omitempty" yaml:"authentication_password,omitempty"`

	// Authentication protocol.
	// Example: sha2_256
	// Enum: ["none","md5","sha","sha2_256"]
	AuthenticationProtocol *string `json:"authentication_protocol,omitempty" yaml:"authentication_protocol,omitempty"`

	// Privacy protocol password.
	// Example: p@**GOandCLCt*200
	// Min Length: 8
	PrivacyPassword *string `json:"privacy_password,omitempty" yaml:"privacy_password,omitempty"`
