...
type HostRecord struct {
	...
	// Example: ["127.0.0.1"]
	// Read Only: true
	HostRecordInlineIPV4Addresses []*string `json:"ipv4_addresses,omitempty" yaml:"ipv4_addresses,omitempty"`

	// List of IPv6 addresses.
	//
	// Example: ["::1"]
	// Read Only: true
	HostRecordInlineIPV6Addresses []*string `json:"ipv6_addresses,omitempty" yaml:"ipv6_addresses,omitempty"`
	...
	// svm
	Svm *HostRecordInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type HostRecordInlineSvm struct {
	...
	// links
	Links *HostRecordInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
