...
type VolumeRebalancing struct {
	...
	// links
	Links *VolumeRebalancingInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	VolumeRebalancingInlineNotices []*Error `json:"notices,omitempty" yaml:"notices,omitempty"`
}
...
type VolumeRebalancingInlineEngine struct {
	...
	// movement
	Movement *VolumeRebalancingInlineEngineInlineMovement `json:"movement,omitempty" yaml:"movement,omitempty"`

	// scanner
	Scanner *VolumeRebalancingInlineEngineInlineScanner `json:"scanner,omitempty" yaml:"scanner,omitempty"`
}
...
type VolumeRebalancingInlineEngineInlineMovement struct {
	...
	// last error
	LastError *VolumeRebalancingInlineEngineInlineMovementInlineLastError `json:"last_error,omitempty" yaml:"last_error,omitempty"`
...
type VolumeRebalancingInlineEngineInlineScanner struct {
	...
	// blocks skipped
	BlocksSkipped *VolumeRebalancingInlineEngineInlineScannerInlineBlocksSkipped `json:"blocks_skipped,omitempty" yaml:"blocks_skipped,omitempty"`
	...
	// files skipped
	FilesSkipped *VolumeRebalancingInlineEngineInlineScannerInlineFilesSkipped `json:"files_skipped,omitempty" yaml:"files_skipped,omitempty"`
}
