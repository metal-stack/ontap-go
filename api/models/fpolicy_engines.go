...
type FpolicyEngines struct {
	...
	// buffer size
	BufferSize *FpolicyEnginesInlineBufferSize `json:"buffer_size,omitempty" yaml:"buffer_size,omitempty"`

	// certificate
	Certificate *FpolicyEnginesInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
	...
	FpolicyEnginesInlinePrimaryServers []*string `json:"primary_servers,omitempty" yaml:"primary_servers,omitempty"`

	// fpolicy engines inline secondary servers
	// Example: ["10.132.145.20","10.132.145.21"]
	FpolicyEnginesInlineSecondaryServers []*string `json:"secondary_servers,omitempty" yaml:"secondary_servers,omitempty"`
	...
	// resiliency
	Resiliency *FpolicyEnginesInlineResiliency `json:"resiliency,omitempty" yaml:"resiliency,omitempty"`
