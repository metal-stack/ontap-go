...
type FirmwareSpBmc struct {
	...
	// Read Only: true
	// Enum: ["SP","BMC"]
	FwType *string `json:"fw_type,omitempty" yaml:"fw_type,omitempty"`
	...
	// in progress
	// Read Only: true
	InProgress *bool `json:"in_progress,omitempty" yaml:"in_progress,omitempty"`
	...
	// Maximum: 100
	// Minimum: 0
	PercentDone *int64 `json:"percent_done,omitempty" yaml:"percent_done,omitempty"`

	// running version
	// Example: 1.2.3.4
	// Read Only: true
	RunningVersion *string `json:"running_version,omitempty" yaml:"running_version,omitempty"`
