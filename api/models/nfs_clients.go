...
type NfsClients struct {
	...
	// links
	Links *NfsClientsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// export policy
	ExportPolicy *NfsClientsInlineExportPolicy `json:"export_policy,omitempty" yaml:"export_policy,omitempty"`
	...
	//
	LocalRequestCount *int64 `json:"local_request_count,omitempty" yaml:"local_request_count,omitempty"`

	// node
	Node *NfsClientsInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	//
	RemoteRequestCount *int64 `json:"remote_request_count,omitempty" yaml:"remote_request_count,omitempty"`
	...
	// svm
	Svm *NfsClientsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume
	Volume *NfsClientsInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type NfsClientsInlineExportPolicy struct {
	...
	// links
	Links *NfsClientsInlineExportPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NfsClientsInlineNode struct {
	...
	// links
	Links *NfsClientsInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NfsClientsInlineSvm struct {
	...
	// links
	Links *NfsClientsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NfsClientsInlineVolume struct {
	...
	// links
	Links *NfsClientsInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
