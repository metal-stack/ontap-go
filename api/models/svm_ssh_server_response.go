...
type SvmSSHServerResponse struct {
	...
	// links
	Links *SvmSSHServerResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SvmSSHServerResponseInlineRecords []*SvmSSHServer `json:"records,omitempty" yaml:"records,omitempty"`
}
