...
type FpolicyPersistentStore struct {
	...
	AutosizeMode *string `json:"autosize_mode,omitempty" yaml:"autosize_mode,omitempty"`
	...
	// svm
	Svm *FpolicyPersistentStoreInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
