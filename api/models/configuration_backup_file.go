...
type ConfigurationBackupFile struct {
	...
	// Read Only: true
	ConfigurationBackupFileInlineBackupNodes []*BackupNode `json:"backup_nodes,omitempty" yaml:"backup_nodes,omitempty"`

	// The link to download the backup file.
	// Example: https://10.224.65.198/backups/backup_file.7z
	// Read Only: true
	DownloadLink *string `json:"download_link,omitempty" yaml:"download_link,omitempty"`
	...
	// node
	Node *ConfigurationBackupFileInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type ConfigurationBackupFileInlineNode struct {
	...
	// links
	Links *ConfigurationBackupFileInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
