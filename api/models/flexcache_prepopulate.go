...
type FlexcachePrepopulate struct {
	...
	FlexcachePrepopulateInlineDirPaths []*string `json:"dir_paths,omitempty" yaml:"dir_paths,omitempty"`

	// flexcache prepopulate inline exclude dir paths
	FlexcachePrepopulateInlineExcludeDirPaths []*string `json:"exclude_dir_paths,omitempty" yaml:"exclude_dir_paths,omitempty"`
