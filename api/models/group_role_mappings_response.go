...
type GroupRoleMappingsResponse struct {
	...
	// links
	Links *GroupRoleMappingsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// group role mappings response inline records
	GroupRoleMappingsResponseInlineRecords []*GroupRoleMappings `json:"records,omitempty" yaml:"records,omitempty"`
