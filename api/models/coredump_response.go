...
type CoredumpResponse struct {
	...
	// links
	Links *CoredumpResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// coredump response inline records
	CoredumpResponseInlineRecords []*Coredump `json:"records,omitempty" yaml:"records,omitempty"`
