...
type TopMetricsSvmFileResponse struct {
	...
	// links
	Links *TopMetricsSvmFileResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// notice
	Notice *TopMetricsSvmFileResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsSvmFileResponseInlineExcludedVolumes []*TopMetricsSvmFileExcludedVolume `json:"excluded_volumes,omitempty" yaml:"excluded_volumes,omitempty"`

	// top metrics svm file response inline records
	TopMetricsSvmFileResponseInlineRecords []*TopMetricsSvmFile `json:"records,omitempty" yaml:"records,omitempty"`
}
