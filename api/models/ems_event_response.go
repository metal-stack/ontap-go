...
type EmsEventResponse struct {
	...
	// links
	Links *EmsEventResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ems event response inline records
	EmsEventResponseInlineRecords []*EmsEventResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type EmsEventResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *EmsEventResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// message
	Message *EmsEventResponseInlineRecordsInlineArrayItemInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`

	// node
	Node *EmsEventResponseInlineRecordsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// A list of parameters provided with the EMS event.
	// Read Only: true
	Parameters []*EmsEventResponseRecordsItems0ParametersItems0 `json:"parameters" yaml:"parameters"`
...
type EmsEventResponseInlineRecordsInlineArrayItemInlineLinks struct {
	...
	// self
	Self *EmsEventResponseInlineRecordsInlineArrayItemInlineLinksInlineSelf `json:"self,omitempty" yaml:"self,omitempty"`
}
...
type EmsEventResponseInlineRecordsInlineArrayItemInlineMessage struct {
	...
	// links
	Links *EmsEventResponseInlineRecordsInlineArrayItemInlineMessageInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsEventResponseInlineRecordsInlineArrayItemInlineNode struct {
	...
	// links
	Links *EmsEventResponseInlineRecordsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
