...
type BgpPeerGroupResponse struct {
	...
	// links
	Links *BgpPeerGroupResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// bgp peer group response inline records
	BgpPeerGroupResponseInlineRecords []*BgpPeerGroup `json:"records,omitempty" yaml:"records,omitempty"`
