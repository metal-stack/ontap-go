...
type FpolicyConnection struct {
	...
	// links
	Links *FpolicyConnectionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// disconnected reason
	DisconnectedReason *FpolicyConnectionInlineDisconnectedReason `json:"disconnected_reason,omitempty" yaml:"disconnected_reason,omitempty"`

	// node
	Node *FpolicyConnectionInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// policy
	// Read Only: true
	Policy *FpolicyPolicyReference `json:"policy,omitempty" yaml:"policy,omitempty"`
	...
	// Read Only: true
	SessionUUID *string `json:"session_uuid,omitempty" yaml:"session_uuid,omitempty"`
	...
	// svm
	Svm *FpolicyConnectionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type FpolicyConnectionInlineNode struct {
	...
	// links
	Links *FpolicyConnectionInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FpolicyConnectionInlineSvm struct {
	...
	// links
	Links *FpolicyConnectionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
