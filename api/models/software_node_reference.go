...
type SoftwareNodeReference struct {
	...
	// firmware
	Firmware *Firmware `json:"firmware,omitempty" yaml:"firmware,omitempty"`
	...
	// software images
	SoftwareImages SoftwareImagesArrayInline `json:"software_images,omitempty" yaml:"software_images,omitempty"`
