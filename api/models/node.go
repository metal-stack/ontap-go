...
type Node struct {
	...
	// links
	Links *NodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// cluster interface
	ClusterInterface *NodeInlineClusterInterface `json:"cluster_interface,omitempty" yaml:"cluster_interface,omitempty"`

	// controller
	Controller *NodeInlineController `json:"controller,omitempty" yaml:"controller,omitempty"`
	...
	// external cache
	ExternalCache *NodeInlineExternalCache `json:"external_cache,omitempty" yaml:"external_cache,omitempty"`

	// ha
	Ha *NodeInlineHa `json:"ha,omitempty" yaml:"ha,omitempty"`

	// hw assist
	HwAssist *NodeInlineHwAssist `json:"hw_assist,omitempty" yaml:"hw_assist,omitempty"`
	...
	ManagementInterface *NodeInlineManagementInterface `json:"management_interface,omitempty" yaml:"management_interface,omitempty"`
	...
	// metric
	Metric *NodeInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// metrocluster
	Metrocluster *NodeInlineMetrocluster `json:"metrocluster,omitempty" yaml:"metrocluster,omitempty"`
	...
	// Read Only: true
	NodeInlineClusterInterfaces []*NodeInlineClusterInterfacesInlineArrayItem `json:"cluster_interfaces,omitempty" yaml:"cluster_interfaces,omitempty"`

	// node inline management interfaces
	// Read Only: true
	NodeInlineManagementInterfaces []*NodeInlineManagementInterfacesInlineArrayItem `json:"management_interfaces,omitempty" yaml:"management_interfaces,omitempty"`

	// nvram
	Nvram *NodeInlineNvram `json:"nvram,omitempty" yaml:"nvram,omitempty"`
	...
	// service processor
	ServiceProcessor *NodeInlineServiceProcessor `json:"service_processor,omitempty" yaml:"service_processor,omitempty"`

	// snaplock
	Snaplock *NodeInlineSnaplock `json:"snaplock,omitempty" yaml:"snaplock,omitempty"`
	...
	// statistics
	Statistics *NodeInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`
	...
	// system aggregate
	SystemAggregate *NodeInlineSystemAggregate `json:"system_aggregate,omitempty" yaml:"system_aggregate,omitempty"`
	...
	// version
	Version *NodeInlineVersion `json:"version,omitempty" yaml:"version,omitempty"`

	// vm
	VM *NodeInlineVM `json:"vm,omitempty" yaml:"vm,omitempty"`
}
...
type NodeInlineClusterInterfacesInlineArrayItem struct {
	...
	// links
	Links *NodeInlineClusterInterfacesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *NodeInlineClusterInterfacesInlineArrayItemInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type NodeInlineController struct {
	...
	// cpu
	CPU *NodeInlineControllerInlineCPU `json:"cpu,omitempty" yaml:"cpu,omitempty"`

	// failed fan
	FailedFan *NodeInlineControllerInlineFailedFan `json:"failed_fan,omitempty" yaml:"failed_fan,omitempty"`

	// failed power supply
	FailedPowerSupply *NodeInlineControllerInlineFailedPowerSupply `json:"failed_power_supply,omitempty" yaml:"failed_power_supply,omitempty"`

	// A list of Flash-Cache devices. Only returned when requested by name.
	// Read Only: true
	FlashCache []*NodeControllerFlashCacheItems0 `json:"flash_cache,omitempty" yaml:"flash_cache,omitempty"`

	// List of FRUs on the node. Only returned when requested by name.
	Frus []*NodeControllerFrusItems0 `json:"frus,omitempty" yaml:"frus,omitempty"`
...
type NodeInlineControllerInlineFailedFan struct {
	...
	// message
	Message *NodeInlineControllerInlineFailedFanInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`
}
...
type NodeInlineControllerInlineFailedPowerSupply struct {
	...
	// message
	Message *NodeInlineControllerInlineFailedPowerSupplyInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`
}
...
type NodeInlineHa struct {
	...
	// giveback
	Giveback *NodeInlineHaInlineGiveback `json:"giveback,omitempty" yaml:"giveback,omitempty"`

	// interconnect
	Interconnect *NodeInlineHaInlineInterconnect `json:"interconnect,omitempty" yaml:"interconnect,omitempty"`

	// Nodes in this node's High Availability (HA) group.
	// Read Only: true
	Partners []*NodeHaPartnersItems0 `json:"partners,omitempty" yaml:"partners,omitempty"`

	// ports
	// Read Only: true
	Ports []*NodeHaPortsItems0 `json:"ports,omitempty" yaml:"ports,omitempty"`

	// takeover
	Takeover *NodeInlineHaInlineTakeover `json:"takeover,omitempty" yaml:"takeover,omitempty"`

	// takeover check
	TakeoverCheck *NodeInlineHaInlineTakeoverCheck `json:"takeover_check,omitempty" yaml:"takeover_check,omitempty"`
}
...
type NodeInlineHaInlineGiveback struct {
	...
	// failure
	Failure *NodeInlineHaInlineGivebackInlineFailure `json:"failure,omitempty" yaml:"failure,omitempty"`
	...
	// Read Only: true
	Status []*NodeHaGivebackStatusItems0 `json:"status,omitempty" yaml:"status,omitempty"`
}
...
type NodeHaGivebackStatusItems0 struct {
	...
	// aggregate
	Aggregate *NodeHaGivebackStatusItems0Aggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// error
	Error *NodeHaGivebackStatusItems0Error `json:"error,omitempty" yaml:"error,omitempty"`
...
type NodeHaGivebackStatusItems0Aggregate struct {
	...
	// links
	Links *NodeHaGivebackStatusItems0AggregateLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NodeHaPartnersItems0 struct {
	...
	// links
	Links *NodeHaPartnersItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NodeInlineHaInlineTakeover struct {
	...
	// failure
	Failure *NodeInlineHaInlineTakeoverInlineFailure `json:"failure,omitempty" yaml:"failure,omitempty"`
...
type NodeInlineHwAssist struct {
	...
	// status
	Status *NodeInlineHwAssistInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
}
...
type NodeInlineHwAssistInlineStatus struct {
	...
	// local
	Local *NodeInlineHwAssistInlineStatusInlineLocal `json:"local,omitempty" yaml:"local,omitempty"`

	// partner
	Partner *NodeInlineHwAssistInlineStatusInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
}
...
type NodeInlineManagementInterfacesInlineArrayItem struct {
	...
	// links
	Links *NodeInlineManagementInterfacesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *NodeInlineManagementInterfacesInlineArrayItemInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type NodeInlineMetric struct {
	...
	// links
	Links *NodeInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NodeInlineMetrocluster struct {
	...
	// Read Only: true
	Ports []*NodeMetroclusterPortsItems0 `json:"ports,omitempty" yaml:"ports,omitempty"`
...
type NodeInlineServiceProcessor struct {
	...
	// api service
	APIService *NodeInlineServiceProcessorInlineAPIService `json:"api_service,omitempty" yaml:"api_service,omitempty"`

	// auto config
	AutoConfig *NodeInlineServiceProcessorInlineAutoConfig `json:"auto_config,omitempty" yaml:"auto_config,omitempty"`
	...
	// backup
	Backup *NodeInlineServiceProcessorInlineBackup `json:"backup,omitempty" yaml:"backup,omitempty"`
	...
	// ipv4 interface
	IPV4Interface *NodeInlineServiceProcessorInlineIPV4Interface `json:"ipv4_interface,omitempty" yaml:"ipv4_interface,omitempty"`

	// ipv6 interface
	IPV6Interface *NodeInlineServiceProcessorInlineIPV6Interface `json:"ipv6_interface,omitempty" yaml:"ipv6_interface,omitempty"`
	...
	// primary
	Primary *NodeInlineServiceProcessorInlinePrimary `json:"primary,omitempty" yaml:"primary,omitempty"`

	// ssh info
	SSHInfo *NodeInlineServiceProcessorInlineSSHInfo `json:"ssh_info,omitempty" yaml:"ssh_info,omitempty"`
	...
	// web service
	WebService *NodeInlineServiceProcessorInlineWebService `json:"web_service,omitempty" yaml:"web_service,omitempty"`
}
...
type NodeInlineServiceProcessorInlineSSHInfo struct {
	...
	AllowedAddresses []*IPAddressAndNetmask `json:"allowed_addresses,omitempty" yaml:"allowed_addresses,omitempty"`
}
...
type NodeInlineSystemAggregate struct {
	...
	// links
	Links *NodeInlineSystemAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
