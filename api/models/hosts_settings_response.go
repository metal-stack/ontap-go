...
type HostsSettingsResponse struct {
	...
	// links
	Links *HostsSettingsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// hosts settings response inline records
	HostsSettingsResponseInlineRecords []*HostsSettings `json:"records,omitempty" yaml:"records,omitempty"`
