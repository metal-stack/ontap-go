...
type SoftwareStatusDetailsReference struct {
	...
	// action
	Action *SoftwareStatusDetailsReferenceInlineAction `json:"action,omitempty" yaml:"action,omitempty"`
	...
	// issue
	Issue *SoftwareStatusDetailsReferenceInlineIssue `json:"issue,omitempty" yaml:"issue,omitempty"`
	...
	// node
	Node *SoftwareStatusDetailsReferenceInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
