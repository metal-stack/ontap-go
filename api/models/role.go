...
type Role struct {
	...
	// links
	Links *RoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// owner
	Owner *RoleInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`

	// The list of privileges that this role has been granted.
	RoleInlinePrivileges []*RolePrivilege `json:"privileges,omitempty" yaml:"privileges,omitempty"`
...
type RoleInlineOwner struct {
	...
	// links
	Links *RoleInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
