...
type SvmPeerPermissionResponse struct {
	...
	// links
	Links *SvmPeerPermissionResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SvmPeerPermissionResponseInlineRecords []*SvmPeerPermission `json:"records,omitempty" yaml:"records,omitempty"`
}
