...
type EmsFilterRule struct {
	...
	// links
	Links *EmsFilterRuleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	EmsFilterRuleInlineParameterCriteria []*EmsFilterRuleInlineParameterCriteriaInlineArrayItem `json:"parameter_criteria,omitempty" yaml:"parameter_criteria,omitempty"`
	...
	// message criteria
	MessageCriteria *EmsFilterRuleInlineMessageCriteria `json:"message_criteria,omitempty" yaml:"message_criteria,omitempty"`
...
type EmsFilterRuleInlineMessageCriteria struct {
	...
	// links
	Links *EmsFilterRuleInlineMessageCriteriaInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
