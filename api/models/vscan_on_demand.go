...
type VscanOnDemand struct {
	...
	// schedule
	Schedule *VscanOnDemandInlineSchedule `json:"schedule,omitempty" yaml:"schedule,omitempty"`

	// scope
	Scope *VscanOnDemandInlineScope `json:"scope,omitempty" yaml:"scope,omitempty"`

	// svm
	Svm *VscanOnDemandInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// List of paths that need to be scanned.
	// Example: ["/vol1/","/vol2/cifs/"]
	VscanOnDemandInlineScanPaths []*string `json:"scan_paths,omitempty" yaml:"scan_paths,omitempty"`
}
...
type VscanOnDemandInlineSchedule struct {
	...
	// links
	Links *VscanOnDemandInlineScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VscanOnDemandInlineSvm struct {
	...
	// links
	Links *VscanOnDemandInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
