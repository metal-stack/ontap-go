...
type WebSvm struct {
	...
	// links
	Links *WebSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// certificate
	Certificate *WebSvmInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
	...
	// svm
	Svm *WebSvmInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type WebSvmInlineCertificate struct {
	...
	// links
	Links *WebSvmInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type WebSvmInlineSvm struct {
	...
	// links
	Links *WebSvmInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
