...
type SvmMigrationVolumeAggregatePair struct {
	...
	// aggregate
	Aggregate *SvmMigrationVolumeAggregatePairInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// volume
	Volume *SvmMigrationVolumeAggregatePairInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SvmMigrationVolumeAggregatePairInlineAggregate struct {
	...
	// links
	Links *SvmMigrationVolumeAggregatePairInlineAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationVolumeAggregatePairInlineVolume struct {
	...
	// links
	Links *SvmMigrationVolumeAggregatePairInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
