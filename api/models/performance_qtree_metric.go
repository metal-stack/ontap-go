...
type PerformanceQtreeMetric struct {
	...
	// links
	Links *PerformanceQtreeMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceQtreeMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceQtreeMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`

	// qtree
	Qtree *PerformanceQtreeMetricInlineQtree `json:"qtree,omitempty" yaml:"qtree,omitempty"`
	...
	// svm
	Svm *PerformanceQtreeMetricInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *PerformanceQtreeMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
	...
	// volume
	Volume *PerformanceQtreeMetricInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type PerformanceQtreeMetricInlineQtree struct {
	...
	// links
	Links *PerformanceQtreeMetricInlineQtreeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PerformanceQtreeMetricInlineSvm struct {
	...
	// links
	Links *PerformanceQtreeMetricInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PerformanceQtreeMetricInlineVolume struct {
	...
	// links
	Links *PerformanceQtreeMetricInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
