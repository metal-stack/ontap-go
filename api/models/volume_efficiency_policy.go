...
type VolumeEfficiencyPolicy struct {
	...
	// links
	Links *VolumeEfficiencyPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	QosPolicy *string `json:"qos_policy,omitempty" yaml:"qos_policy,omitempty"`
	...
	// svm
	Svm *VolumeEfficiencyPolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type VolumeEfficiencyPolicyInlineSvm struct {
	...
	// links
	Links *VolumeEfficiencyPolicyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
