...
type FabricResponse struct {
	...
	// links
	Links *FabricResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fabric response inline records
	FabricResponseInlineRecords []*Fabric `json:"records,omitempty" yaml:"records,omitempty"`
