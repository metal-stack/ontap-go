...
type IPSubnet struct {
	...
	// links
	Links *IPSubnetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// available count
	// Read Only: true
	AvailableCount *int64 `json:"available_count,omitempty" yaml:"available_count,omitempty"`

	// broadcast domain
	BroadcastDomain *IPSubnetInlineBroadcastDomain `json:"broadcast_domain,omitempty" yaml:"broadcast_domain,omitempty"`
	...
	FailIfLifsConflict *bool `json:"fail_if_lifs_conflict,omitempty" yaml:"fail_if_lifs_conflict,omitempty"`
	...
	// Read Only: true
	IPSubnetInlineAvailableIPRanges []*IPAddressRange `json:"available_ip_ranges,omitempty" yaml:"available_ip_ranges,omitempty"`

	// ip subnet inline ip ranges
	IPSubnetInlineIPRanges []*IPAddressRange `json:"ip_ranges,omitempty" yaml:"ip_ranges,omitempty"`

	// ipspace
	Ipspace *IPSubnetInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
	...
	// subnet
	Subnet *IPInfo `json:"subnet,omitempty" yaml:"subnet,omitempty"`
	...
	// used count
	// Read Only: true
	UsedCount *int64 `json:"used_count,omitempty" yaml:"used_count,omitempty"`
...
type IPSubnetInlineBroadcastDomain struct {
	...
	// links
	Links *IPSubnetInlineBroadcastDomainInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPSubnetInlineIpspace struct {
	...
	// links
	Links *IPSubnetInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
