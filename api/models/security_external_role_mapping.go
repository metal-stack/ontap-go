...
type SecurityExternalRoleMapping struct {
	...
	ExternalRole *string `json:"external_role,omitempty" yaml:"external_role,omitempty"`

	// ontap role
	OntapRole *SecurityExternalRoleMappingInlineOntapRole `json:"ontap_role,omitempty" yaml:"ontap_role,omitempty"`
...
type SecurityExternalRoleMappingInlineOntapRole struct {
	...
	// links
	Links *SecurityExternalRoleMappingInlineOntapRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
