...
type Cluster struct {
	...
	AutoEnableAnalytics *bool `json:"auto_enable_analytics,omitempty" yaml:"auto_enable_analytics,omitempty"`

	// certificate
	Certificate *ClusterInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
	...
	// Max Items: 64
	ClusterInlineTags []*string `json:"_tags,omitempty" yaml:"_tags,omitempty"`
	...
	// Max Items: 6
	ClusterInlineDNSDomains []*string `json:"dns_domains,omitempty" yaml:"dns_domains,omitempty"`

	// cluster inline management interfaces
	// Read Only: true
	ClusterInlineManagementInterfaces []*ClusterInlineManagementInterfacesInlineArrayItem `json:"management_interfaces,omitempty" yaml:"management_interfaces,omitempty"`
	...
	// Max Items: 3
	ClusterInlineNameServers []*string `json:"name_servers,omitempty" yaml:"name_servers,omitempty"`

	// cluster inline nodes
	ClusterInlineNodes []*ClusterInlineNodesInlineArrayItem `json:"nodes,omitempty" yaml:"nodes,omitempty"`
	...
	ClusterInlineNtpServers []*string `json:"ntp_servers,omitempty" yaml:"ntp_servers,omitempty"`

	// configuration backup
	ConfigurationBackup *ClusterInlineConfigurationBackup `json:"configuration_backup,omitempty" yaml:"configuration_backup,omitempty"`
	...
	ManagementInterface *ClusterInlineManagementInterface `json:"management_interface,omitempty" yaml:"management_interface,omitempty"`

	// metric
	Metric *ClusterInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// peering policy
	PeeringPolicy *ClusterInlinePeeringPolicy `json:"peering_policy,omitempty" yaml:"peering_policy,omitempty"`

	// Specifies if this cluster is an All SAN Array.
	// Read Only: true
	SanOptimized *bool `json:"san_optimized,omitempty" yaml:"san_optimized,omitempty"`

	// statistics
	Statistics *ClusterInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// timezone
	Timezone *ClusterInlineTimezone `json:"timezone,omitempty" yaml:"timezone,omitempty"`
	...
	// version
	Version *ClusterInlineVersion `json:"version,omitempty" yaml:"version,omitempty"`
}
...
type ClusterInlineCertificate struct {
	...
	// links
	Links *ClusterInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClusterInlineManagementInterface struct {
	...
	// ip
	IP *ClusterInlineManagementInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
}
...
type ClusterInlineManagementInterfacesInlineArrayItem struct {
	...
	// links
	Links *ClusterInlineManagementInterfacesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *ClusterInlineManagementInterfacesInlineArrayItemInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type ClusterInlineManagementInterfacesInlineArrayItemInlineIP struct {
	...
	// address
	Address *IPAddressReadonly `json:"address,omitempty" yaml:"address,omitempty"`
}
...
type ClusterInlineMetric struct {
	...
	// links
	Links *ClusterInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *ClusterInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *ClusterInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *ClusterInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type ClusterInlineNodesInlineArrayItem struct {
	...
	// cluster interfaces
	// Read Only: true
	ClusterInterfaces []*ClusterNodesItems0ClusterInterfacesItems0 `json:"cluster_interfaces" yaml:"cluster_interfaces"`

	// controller
	Controller *ClusterInlineNodesInlineArrayItemInlineController `json:"controller,omitempty" yaml:"controller,omitempty"`
	...
	// external cache
	ExternalCache *ClusterInlineNodesInlineArrayItemInlineExternalCache `json:"external_cache,omitempty" yaml:"external_cache,omitempty"`

	// ha
	Ha *ClusterInlineNodesInlineArrayItemInlineHa `json:"ha,omitempty" yaml:"ha,omitempty"`

	// hw assist
	HwAssist *ClusterInlineNodesInlineArrayItemInlineHwAssist `json:"hw_assist,omitempty" yaml:"hw_assist,omitempty"`

	// Specifies whether or not the node is in spares low condition.
	// Read Only: true
	IsSparesLow *bool `json:"is_spares_low,omitempty" yaml:"is_spares_low,omitempty"`
	...
	// management interface
	ManagementInterface *ClusterInlineNodesInlineArrayItemInlineManagementInterface `json:"management_interface,omitempty" yaml:"management_interface,omitempty"`

	// management interfaces
	// Read Only: true
	ManagementInterfaces []*ClusterNodesItems0ManagementInterfacesItems0 `json:"management_interfaces" yaml:"management_interfaces"`
	...
	// metric
	Metric *ClusterInlineNodesInlineArrayItemInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// metrocluster
	Metrocluster *ClusterInlineNodesInlineArrayItemInlineMetrocluster `json:"metrocluster,omitempty" yaml:"metrocluster,omitempty"`
	...
	// nvram
	Nvram *ClusterInlineNodesInlineArrayItemInlineNvram `json:"nvram,omitempty" yaml:"nvram,omitempty"`
	...
	// service processor
	ServiceProcessor *ClusterInlineNodesInlineArrayItemInlineServiceProcessor `json:"service_processor,omitempty" yaml:"service_processor,omitempty"`

	// snaplock
	Snaplock *ClusterInlineNodesInlineArrayItemInlineSnaplock `json:"snaplock,omitempty" yaml:"snaplock,omitempty"`
	...
	// statistics
	Statistics *ClusterInlineNodesInlineArrayItemInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`
	...
	StorageConfiguration *string `json:"storage_configuration,omitempty" yaml:"storage_configuration,omitempty"`

	// system aggregate
	SystemAggregate *ClusterInlineNodesInlineArrayItemInlineSystemAggregate `json:"system_aggregate,omitempty" yaml:"system_aggregate,omitempty"`
	...
	// Example: 7Y56-CTOWW1
	// Read Only: true
	SystemMachineType *string `json:"system_machine_type,omitempty" yaml:"system_machine_type,omitempty"`

	// The total time, in seconds, that the node has been up.
	// Example: 300536
	// Read Only: true
	Uptime *int64 `json:"uptime,omitempty" yaml:"uptime,omitempty"`
	...
	// Read Only: true
	VendorSerialNumber *string `json:"vendor_serial_number,omitempty" yaml:"vendor_serial_number,omitempty"`

	// version
	Version *ClusterInlineNodesInlineArrayItemInlineVersion `json:"version,omitempty" yaml:"version,omitempty"`

	// vm
	VM *ClusterInlineNodesInlineArrayItemInlineVM `json:"vm,omitempty" yaml:"vm,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineClusterInterface struct {
	...
	// ip
	IP *NodeSetupIP `json:"ip,omitempty" yaml:"ip,omitempty"`
}
...
type ClusterNodesItems0ClusterInterfacesItems0 struct {
	...
	// links
	Links *ClusterNodesItems0ClusterInterfacesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *ClusterNodesItems0ClusterInterfacesItems0IP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineController struct {
	...
	// cpu
	CPU *ClusterInlineNodesInlineArrayItemInlineControllerInlineCPU `json:"cpu,omitempty" yaml:"cpu,omitempty"`

	// failed fan
	FailedFan *ClusterInlineNodesInlineArrayItemInlineControllerInlineFailedFan `json:"failed_fan,omitempty" yaml:"failed_fan,omitempty"`

	// failed power supply
	FailedPowerSupply *ClusterInlineNodesInlineArrayItemInlineControllerInlineFailedPowerSupply `json:"failed_power_supply,omitempty" yaml:"failed_power_supply,omitempty"`

	// A list of Flash-Cache devices. Only returned when requested by name.
	// Read Only: true
	FlashCache []*ClusterNodesItems0ControllerFlashCacheItems0 `json:"flash_cache" yaml:"flash_cache"`

	// List of FRUs on the node. Only returned when requested by name.
	Frus []*ClusterNodesItems0ControllerFrusItems0 `json:"frus" yaml:"frus"`

	// Memory available on the node, in bytes.
	// Example: 1024000000
	// Read Only: true
	MemorySize *int64 `json:"memory_size,omitempty" yaml:"memory_size,omitempty"`
	...
	// Read Only: true
	// Enum: ["over","normal"]
	OverTemperature *string `json:"over_temperature,omitempty" yaml:"over_temperature,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineControllerInlineCPU struct {
	...
	// Read Only: true
	FirmwareRelease *string `json:"firmware_release,omitempty" yaml:"firmware_release,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineControllerInlineFailedFan struct {
	...
	// message
	Message *ClusterInlineNodesInlineArrayItemInlineControllerInlineFailedFanInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineControllerInlineFailedPowerSupply struct {
	...
	// message
	Message *ClusterInlineNodesInlineArrayItemInlineControllerInlineFailedPowerSupplyInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`
}
...
type ClusterNodesItems0ControllerFlashCacheItems0 struct {
	...
	// Example: 0
	// Read Only: true
	DeviceID *int64 `json:"device_id,omitempty" yaml:"device_id,omitempty"`

	// firmware file
	// Example: X9170_O000Z6300NVM
	// Read Only: true
	FirmwareFile *string `json:"firmware_file,omitempty" yaml:"firmware_file,omitempty"`
	...
	// Example: A1
	// Read Only: true
	HardwareRevision *string `json:"hardware_revision,omitempty" yaml:"hardware_revision,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineExternalCache struct {
	...
	// Example: true
	IsHyaEnabled *bool `json:"is_hya_enabled,omitempty" yaml:"is_hya_enabled,omitempty"`

	// Indicates whether rewarm is enabled.
	// Example: true
	IsRewarmEnabled *bool `json:"is_rewarm_enabled,omitempty" yaml:"is_rewarm_enabled,omitempty"`

	// PCS size in gigabytes.
	PcsSize *int64 `json:"pcs_size,omitempty" yaml:"pcs_size,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineHa struct {
	...
	AutoGiveback *bool `json:"auto_giveback,omitempty" yaml:"auto_giveback,omitempty"`

	// Specifies whether or not storage failover is enabled.
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty"`

	// giveback
	Giveback *ClusterInlineNodesInlineArrayItemInlineHaInlineGiveback `json:"giveback,omitempty" yaml:"giveback,omitempty"`

	// interconnect
	Interconnect *ClusterInlineNodesInlineArrayItemInlineHaInlineInterconnect `json:"interconnect,omitempty" yaml:"interconnect,omitempty"`

	// Nodes in this node's High Availability (HA) group.
	// Read Only: true
	Partners []*ClusterNodesItems0HaPartnersItems0 `json:"partners" yaml:"partners"`

	// ports
	// Read Only: true
	Ports []*ClusterNodesItems0HaPortsItems0 `json:"ports" yaml:"ports"`

	// takeover
	Takeover *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeover `json:"takeover,omitempty" yaml:"takeover,omitempty"`

	// takeover check
	TakeoverCheck *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverCheck `json:"takeover_check,omitempty" yaml:"takeover_check,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineHaInlineGiveback struct {
	...
	// failure
	Failure *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackInlineFailure `json:"failure,omitempty" yaml:"failure,omitempty"`
...
type ClusterNodesItems0HaGivebackStatusItems0 struct {
	...
	// aggregate
	Aggregate *ClusterNodesItems0HaGivebackStatusItems0Aggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// error
	Error *ClusterNodesItems0HaGivebackStatusItems0Error `json:"error,omitempty" yaml:"error,omitempty"`
...
type ClusterNodesItems0HaGivebackStatusItems0Aggregate struct {
	...
	// links
	Links *ClusterNodesItems0HaGivebackStatusItems0AggregateLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClusterNodesItems0HaPartnersItems0 struct {
	...
	// links
	Links *ClusterNodesItems0HaPartnersItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineHaInlineTakeover struct {
	...
	// failure
	Failure *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverInlineFailure `json:"failure,omitempty" yaml:"failure,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverCheck struct {
	...
	// Read Only: true
	TakeoverPossible *bool `json:"takeover_possible,omitempty" yaml:"takeover_possible,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineHwAssist struct {
	...
	// status
	Status *ClusterInlineNodesInlineArrayItemInlineHwAssistInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineHwAssistInlineStatus struct {
	...
	// local
	Local *ClusterInlineNodesInlineArrayItemInlineHwAssistInlineStatusInlineLocal `json:"local,omitempty" yaml:"local,omitempty"`

	// partner
	Partner *ClusterInlineNodesInlineArrayItemInlineHwAssistInlineStatusInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
}
...
type ClusterNodesItems0ManagementInterfacesItems0 struct {
	...
	// links
	Links *ClusterNodesItems0ManagementInterfacesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *ClusterNodesItems0ManagementInterfacesItems0IP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineMetric struct {
	...
	// links
	Links *ClusterInlineNodesInlineArrayItemInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: 13
	ProcessorUtilization *int64 `json:"processor_utilization,omitempty" yaml:"processor_utilization,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineMetrocluster struct {
	...
	// Read Only: true
	CustomVlanCapable *bool `json:"custom_vlan_capable,omitempty" yaml:"custom_vlan_capable,omitempty"`

	// MetroCluster over IP ports.
	// Read Only: true
	Ports []*ClusterNodesItems0MetroclusterPortsItems0 `json:"ports" yaml:"ports"`
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessor struct {
	...
	// api service
	APIService *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineAPIService `json:"api_service,omitempty" yaml:"api_service,omitempty"`

	// auto config
	AutoConfig *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineAutoConfig `json:"auto_config,omitempty" yaml:"auto_config,omitempty"`

	// Indicates whether the service processor can be automatically updated from ONTAP.
	AutoupdateEnabled *bool `json:"autoupdate_enabled,omitempty" yaml:"autoupdate_enabled,omitempty"`

	// backup
	Backup *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineBackup `json:"backup,omitempty" yaml:"backup,omitempty"`
	...
	DhcpEnabled *bool `json:"dhcp_enabled,omitempty" yaml:"dhcp_enabled,omitempty"`
	...
	// ipv4 interface
	IPV4Interface *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineIPV4Interface `json:"ipv4_interface,omitempty" yaml:"ipv4_interface,omitempty"`

	// ipv6 interface
	IPV6Interface *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineIPV6Interface `json:"ipv6_interface,omitempty" yaml:"ipv6_interface,omitempty"`

	// Indicates whether the service processor network is configured.
	// Read Only: true
	IsIPConfigured *bool `json:"is_ip_configured,omitempty" yaml:"is_ip_configured,omitempty"`

	// Provides the "update status" of the last service processor update.
	// Read Only: true
	// Enum: ["failed","passed"]
	LastUpdateState *string `json:"last_update_state,omitempty" yaml:"last_update_state,omitempty"`

	// link status
	// Read Only: true
	// Enum: ["up","down","disabled","unknown"]
	LinkStatus *string `json:"link_status,omitempty" yaml:"link_status,omitempty"`
	...
	// primary
	Primary *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlinePrimary `json:"primary,omitempty" yaml:"primary,omitempty"`

	// ssh info
	SSHInfo *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineSSHInfo `json:"ssh_info,omitempty" yaml:"ssh_info,omitempty"`
	...
	// web service
	WebService *ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineWebService `json:"web_service,omitempty" yaml:"web_service,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineAPIService struct {
	...
	LimitAccess *bool `json:"limit_access,omitempty" yaml:"limit_access,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineAutoConfig struct {
	...
	// Example: ipv4_mgmt
	IPV4Subnet *string `json:"ipv4_subnet,omitempty" yaml:"ipv4_subnet,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineBackup struct {
	...
	// Read Only: true
	IsCurrent *bool `json:"is_current,omitempty" yaml:"is_current,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineIPV4Interface struct {
	...
	SetupState *string `json:"setup_state,omitempty" yaml:"setup_state,omitempty"`
}
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineIPV6Interface struct {
	...
	IsIPV6RaEnabled *bool `json:"is_ipv6_ra_enabled,omitempty" yaml:"is_ipv6_ra_enabled,omitempty"`

	// Link local IP address.
	// Example: FE80::/10
	LinkLocalIP *string `json:"link_local_ip,omitempty" yaml:"link_local_ip,omitempty"`

	// The IPv6 netmask/prefix length. The default value is 64 with a valid range of 1 to 127.
	// Example: 64
	Netmask *int64 `json:"netmask,omitempty" yaml:"netmask,omitempty"`

	// Router assigned IP address.
	// Example: 2001:0db8:85a3:0000:0000:8a2e:0370:7334
	RouterIP *string `json:"router_ip,omitempty" yaml:"router_ip,omitempty"`
...
type ClusterInlineNodesInlineArrayItemInlineServiceProcessorInlineSSHInfo struct {
	...
	AllowedAddresses []*IPAddressAndNetmask `json:"allowed_addresses" yaml:"allowed_addresses"`
}
...
type ClusterInlineNodesInlineArrayItemInlineSystemAggregate struct {
	...
	// links
	Links *ClusterInlineNodesInlineArrayItemInlineSystemAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClusterInlinePeeringPolicy struct {
	...
	// Read Only: true
	AuthenticationRequired *bool `json:"authentication_required,omitempty" yaml:"authentication_required,omitempty"`
	...
	// Read Only: true
	EncryptionRequired *bool `json:"encryption_required,omitempty" yaml:"encryption_required,omitempty"`
	...
	// Maximum: 1500
	// Minimum: 0
	MinimumPassphraseLength *int64 `json:"minimum_passphrase_length,omitempty" yaml:"minimum_passphrase_length,omitempty"`
}
...
type ClusterInlineStatistics struct {
	...
	// iops raw
	IopsRaw *ClusterInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *ClusterInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *ClusterInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
