...
type SnaplockFileFingerprintGet struct {
	...
	// links
	Links *SnaplockFileFingerprintGetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *SnaplockFileFingerprintGetInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *SnaplockFileFingerprintGetInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SnaplockFileFingerprintGetInlineSvm struct {
	...
	// links
	Links *SnaplockFileFingerprintGetInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnaplockFileFingerprintGetInlineVolume struct {
	...
	// links
	Links *SnaplockFileFingerprintGetInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
