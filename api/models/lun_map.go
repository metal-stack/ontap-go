...
type LunMap struct {
	...
	// links
	Links *LunMapInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// igroup
	Igroup *LunMapInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`
	...
	// lun
	Lun *LunMapInlineLun `json:"lun,omitempty" yaml:"lun,omitempty"`
	...
	// svm
	Svm *LunMapInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type LunMapInlineIgroup struct {
	...
	// links
	Links *LunMapInlineIgroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// The initiators that are members of the initiator group.
	//
	// Read Only: true
	Initiators []*string `json:"initiators,omitempty" yaml:"initiators,omitempty"`
...
type LunMapInlineLun struct {
	...
	// node
	Node *LunMapInlineLunInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// smbc
	Smbc *LunMapInlineLunInlineSmbc `json:"smbc,omitempty" yaml:"smbc,omitempty"`
...
type LunMapInlineLunInlineNode struct {
	...
	// links
	Links *LunMapInlineLunInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunMapInlineReportingNodesInlineArrayItem struct {
	...
	// links
	Links *LunMapInlineReportingNodesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunMapInlineReportingNodesInlineArrayItemInlineLinks struct {
	...
	// node
	Node *Href `json:"node,omitempty" yaml:"node,omitempty"`
...
type LunMapInlineSvm struct {
	...
	// links
	Links *LunMapInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
