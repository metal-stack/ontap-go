...
type IpsecPolicyResponse struct {
	...
	// links
	Links *IpsecPolicyResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// error
	Error *IpsecPolicyResponseInlineError `json:"error,omitempty" yaml:"error,omitempty"`

	// ipsec policy response inline records
	IpsecPolicyResponseInlineRecords []*IpsecPolicyResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type IpsecPolicyResponseInlineRecordsInlineArrayItem struct {
	...
	// certificate
	Certificate *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`

	// Indicates whether or not the policy is enabled.
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty"`

	// ipspace
	Ipspace *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// local endpoint
	LocalEndpoint *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineLocalEndpoint `json:"local_endpoint,omitempty" yaml:"local_endpoint,omitempty"`

	// Local Identity
	LocalIdentity *string `json:"local_identity,omitempty" yaml:"local_identity,omitempty"`
	...
	// remote endpoint
	RemoteEndpoint *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineRemoteEndpoint `json:"remote_endpoint,omitempty" yaml:"remote_endpoint,omitempty"`

	// Remote Identity
	RemoteIdentity *string `json:"remote_identity,omitempty" yaml:"remote_identity,omitempty"`
	...
	// svm
	Svm *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type IpsecPolicyResponseInlineRecordsInlineArrayItemInlineCertificate struct {
	...
	// links
	Links *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IpsecPolicyResponseInlineRecordsInlineArrayItemInlineIpspace struct {
	...
	// links
	Links *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IpsecPolicyResponseInlineRecordsInlineArrayItemInlineLocalEndpoint struct {
	...
	// address
	Address *IPAddress `json:"address,omitempty" yaml:"address,omitempty"`

	// family
	Family *IPAddressFamily `json:"family,omitempty" yaml:"family,omitempty"`
...
type IpsecPolicyResponseInlineRecordsInlineArrayItemInlineSvm struct {
	...
	// links
	Links *IpsecPolicyResponseInlineRecordsInlineArrayItemInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
