...
type TopMetricsDirectoryResponse struct {
	...
	// links
	Links *TopMetricsDirectoryResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// incomplete response reason
	IncompleteResponseReason *TopMetricsDirectoryResponseInlineIncompleteResponseReason `json:"incomplete_response_reason,omitempty" yaml:"incomplete_response_reason,omitempty"`

	// notice
	Notice *TopMetricsDirectoryResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsDirectoryResponseInlineRecords []*TopMetricsDirectory `json:"records,omitempty" yaml:"records,omitempty"`
}
