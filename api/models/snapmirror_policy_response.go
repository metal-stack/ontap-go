...
type SnapmirrorPolicyResponse struct {
	...
	// links
	Links *SnapmirrorPolicyResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnapmirrorPolicyResponseInlineRecords []*SnapmirrorPolicy `json:"records,omitempty" yaml:"records,omitempty"`
}
