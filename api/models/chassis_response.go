...
type ChassisResponse struct {
	...
	// links
	Links *ChassisResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// chassis response inline records
	ChassisResponseInlineRecords []*Chassis `json:"records,omitempty" yaml:"records,omitempty"`
