...
type ConsistencyGroupChild struct {
	...
	// application
	Application *ConsistencyGroupChildInlineApplication `json:"application,omitempty" yaml:"application,omitempty"`
	...
	// Max Items: 64
	ConsistencyGroupChildInlineTags []*string `json:"_tags,omitempty" yaml:"_tags,omitempty"`
	...
	ParentConsistencyGroup *ConsistencyGroupChildInlineParentConsistencyGroup `json:"parent_consistency_group,omitempty" yaml:"parent_consistency_group,omitempty"`

	// provisioning options
	ProvisioningOptions *ConsistencyGroupChildInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`

	// qos
	Qos *ConsistencyGroupChildInlineQos `json:"qos,omitempty" yaml:"qos,omitempty"`
	...
	// space
	Space *ConsistencyGroupChildInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// svm
	Svm *ConsistencyGroupChildInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// tiering
	Tiering *ConsistencyGroupChildInlineTiering `json:"tiering,omitempty" yaml:"tiering,omitempty"`
...
type ConsistencyGroupChildInlineLunsInlineArrayItem struct {
	...
	// clone
	Clone *ConsistencyGroupChildInlineLunsInlineArrayItemInlineClone `json:"clone,omitempty" yaml:"clone,omitempty"`
	...
	//
	LunMaps []*ConsistencyGroupChildLunsItems0LunMapsItems0 `json:"lun_maps" yaml:"lun_maps"`
	...
	// provisioning options
	ProvisioningOptions *ConsistencyGroupChildInlineLunsInlineArrayItemInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`

	// qos
	Qos *ConsistencyGroupChildInlineLunsInlineArrayItemInlineQos `json:"qos,omitempty" yaml:"qos,omitempty"`
...
type ConsistencyGroupChildInlineLunsInlineArrayItemInlineClone struct {
	...
	// source
	Source *ConsistencyGroupChildInlineLunsInlineArrayItemInlineCloneInlineSource `json:"source,omitempty" yaml:"source,omitempty"`
}
...
type ConsistencyGroupChildLunsItems0LunMapsItems0Igroup struct {
	...
	//
	Initiators []*ConsistencyGroupChildLunsItems0LunMapsItems0IgroupInitiatorsItems0 `json:"initiators" yaml:"initiators"`
...
type ConsistencyGroupChildInlineLunsInlineArrayItemInlineQos struct {
	...
	// policy
	Policy *ConsistencyGroupChildInlineLunsInlineArrayItemInlineQosInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
}
...
type ConsistencyGroupChildInlineNamespacesInlineArrayItem struct {
	...
	// provisioning options
	ProvisioningOptions *ConsistencyGroupChildInlineNamespacesInlineArrayItemInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`

	// space
	Space *ConsistencyGroupChildInlineNamespacesInlineArrayItemInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// status
	Status *ConsistencyGroupChildInlineNamespacesInlineArrayItemInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`

	// subsystem map
	SubsystemMap *ConsistencyGroupChildInlineNamespacesInlineArrayItemInlineSubsystemMap `json:"subsystem_map,omitempty" yaml:"subsystem_map,omitempty"`
...
type ConsistencyGroupChildInlineNamespacesInlineArrayItemInlineSpace struct {
	...
	// guarantee
	Guarantee *ConsistencyGroupChildInlineNamespacesInlineArrayItemInlineSpaceInlineGuarantee `json:"guarantee,omitempty" yaml:"guarantee,omitempty"`
...
type ConsistencyGroupChildInlineProvisioningOptions struct {
	...
	// storage service
	StorageService *ConsistencyGroupChildInlineProvisioningOptionsInlineStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type ConsistencyGroupChildInlineQos struct {
	...
	// policy
	Policy *ConsistencyGroupChildInlineQosInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
}
...
type ConsistencyGroupChildInlineRestoreTo struct {
	...
	// snapshot
	Snapshot *ConsistencyGroupChildInlineRestoreToInlineSnapshot `json:"snapshot,omitempty" yaml:"snapshot,omitempty"`
}
...
type ConsistencyGroupChildInlineSvm struct {
	...
	// links
	Links *ConsistencyGroupChildInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ConsistencyGroupChildInlineVolumesInlineArrayItem struct {
	...
	// nas
	Nas *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineNas `json:"nas,omitempty" yaml:"nas,omitempty"`

	// provisioning options
	ProvisioningOptions *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`
	...
	// space
	Space *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// tiering
	Tiering *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineTiering `json:"tiering,omitempty" yaml:"tiering,omitempty"`
...
type ConsistencyGroupChildInlineVolumesInlineArrayItemInlineNas struct {
	...
	// cifs
	Cifs *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineNasInlineCifs `json:"cifs,omitempty" yaml:"cifs,omitempty"`

	// export policy
	ExportPolicy *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineNasInlineExportPolicy `json:"export_policy,omitempty" yaml:"export_policy,omitempty"`

	// The UNIX group ID of the volume. Valid in POST or PATCH.
	Gid *int64 `json:"gid,omitempty" yaml:"gid,omitempty"`

	// junction parent
	JunctionParent *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineNasInlineJunctionParent `json:"junction_parent,omitempty" yaml:"junction_parent,omitempty"`
...
type ConsistencyGroupChildInlineVolumesInlineArrayItemInlineProvisioningOptions struct {
	...
	// storage service
	StorageService *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineProvisioningOptionsInlineStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type ConsistencyGroupChildInlineVolumesInlineArrayItemInlineQos struct {
	...
	// policy
	Policy *ConsistencyGroupChildInlineVolumesInlineArrayItemInlineQosInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
}
