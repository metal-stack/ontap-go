...
type ConsistencyGroupSnapshotResponse struct {
	...
	ConsistencyGroupSnapshotResponseInlineRecords []*ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
