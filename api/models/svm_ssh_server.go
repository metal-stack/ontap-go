...
type SvmSSHServer struct {
	...
	// svm
	Svm *SvmSSHServerInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	SvmSSHServerInlineKeyExchangeAlgorithms []*KeyExchangeAlgorithm `json:"key_exchange_algorithms,omitempty" yaml:"key_exchange_algorithms,omitempty"`

	// MAC algorithms.
	// Example: ["hmac_sha2_512","hmac_sha2_512_etm"]
	SvmSSHServerInlineMacAlgorithms []*MacAlgorithm `json:"mac_algorithms,omitempty" yaml:"mac_algorithms,omitempty"`
}
...
type SvmSSHServerInlineSvm struct {
	...
	// links
	Links *SvmSSHServerInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
