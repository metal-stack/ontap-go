...
type StoragePortResponse struct {
	...
	// links
	Links *StoragePortResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	StoragePortResponseInlineRecords []*StoragePort `json:"records,omitempty" yaml:"records,omitempty"`
}
