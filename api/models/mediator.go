...
type Mediator struct {
	...
	// dr group
	DrGroup *MediatorInlineDrGroup `json:"dr_group,omitempty" yaml:"dr_group,omitempty"`
	...
	// peer cluster
	PeerCluster *MediatorInlinePeerCluster `json:"peer_cluster,omitempty" yaml:"peer_cluster,omitempty"`
...
type MediatorInlinePeerCluster struct {
	...
	// links
	Links *MediatorInlinePeerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
