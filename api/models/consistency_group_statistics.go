...
type ConsistencyGroupStatistics struct {
	...
	// iops raw
	IopsRaw *ConsistencyGroupStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *ConsistencyGroupStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *ConsistencyGroupStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
