...
type StoragePool struct {
	...
	// links
	Links *StoragePoolInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// capacity
	Capacity *StoragePoolInlineCapacity `json:"capacity,omitempty" yaml:"capacity,omitempty"`

	// health
	Health *StoragePoolInlineHealth `json:"health,omitempty" yaml:"health,omitempty"`

	// Storage pool name.
	Name *string `json:"name,omitempty" yaml:"name,omitempty"`

	// Nodes that can use this storage pool for their aggregates.
	StoragePoolInlineNodes []*NodeReference `json:"nodes,omitempty" yaml:"nodes,omitempty"`
...
type StoragePoolInlineCapacity struct {
	...
	Disks []*StoragePoolDisk `json:"disks,omitempty" yaml:"disks,omitempty"`

	// Remaining usable capacity in the flash pool, in bytes.
	// Read Only: true
	Remaining *int64 `json:"remaining,omitempty" yaml:"remaining,omitempty"`

	// Properties of spare allocation units.
	SpareAllocationUnits []*StoragePoolSpareAllocationUnit `json:"spare_allocation_units,omitempty" yaml:"spare_allocation_units,omitempty"`
	...
	UsedAllocationUnits []*StoragePoolUsedAllocationUnit `json:"used_allocation_units,omitempty" yaml:"used_allocation_units,omitempty"`
}
