...
type Fpolicy struct {
	...
	// links
	Links *FpolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fpolicy inline engines
	FpolicyInlineEngines []*FpolicyEngines `json:"engines,omitempty" yaml:"engines,omitempty"`

	// fpolicy inline events
	FpolicyInlineEvents []*FpolicyEvents `json:"events,omitempty" yaml:"events,omitempty"`

	// fpolicy inline persistent stores
	FpolicyInlinePersistentStores []*FpolicyPersistentStores `json:"persistent_stores,omitempty" yaml:"persistent_stores,omitempty"`

	// fpolicy inline policies
	FpolicyInlinePolicies []*FpolicyPolicies `json:"policies,omitempty" yaml:"policies,omitempty"`

	// svm
	Svm *FpolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type FpolicyInlineSvm struct {
	...
	// links
	Links *FpolicyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
