...
type IgroupResponse struct {
	...
	// links
	Links *IgroupResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// igroup response inline records
	IgroupResponseInlineRecords []*Igroup `json:"records,omitempty" yaml:"records,omitempty"`
