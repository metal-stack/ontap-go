...
type SnaplockComplianceClockResponse struct {
	...
	// links
	Links *SnaplockComplianceClockResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnaplockComplianceClockResponseInlineRecords []*SnaplockComplianceClock `json:"records,omitempty" yaml:"records,omitempty"`
}
