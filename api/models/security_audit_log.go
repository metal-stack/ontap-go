...
type SecurityAuditLog struct {
	...
	// links
	Links *SecurityAuditLogInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *SecurityAuditLogInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *SecurityAuditLogInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type SecurityAuditLogInlineNode struct {
	...
	// links
	Links *SecurityAuditLogInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
