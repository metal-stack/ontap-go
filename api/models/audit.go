...
type Audit struct {
	...
	// events
	Events *AuditInlineEvents `json:"events,omitempty" yaml:"events,omitempty"`

	// Indicates whether there is a strict Guarantee of Auditing
	// Example: false
	Guarantee *bool `json:"guarantee,omitempty" yaml:"guarantee,omitempty"`
	...
	// svm
	Svm *AuditInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type AuditInlineEvents struct {
	...
	CapStaging *bool `json:"cap_staging,omitempty" yaml:"cap_staging,omitempty"`

	// CIFS logon and logoff events
	CifsLogonLogoff *bool `json:"cifs_logon_logoff,omitempty" yaml:"cifs_logon_logoff,omitempty"`

	// File operation events
	FileOperations *bool `json:"file_operations,omitempty" yaml:"file_operations,omitempty"`

	// File share category events
	FileShare *bool `json:"file_share,omitempty" yaml:"file_share,omitempty"`

	// Local security group management events
	SecurityGroup *bool `json:"security_group,omitempty" yaml:"security_group,omitempty"`

	// Local user account management events
	UserAccount *bool `json:"user_account,omitempty" yaml:"user_account,omitempty"`
}
...
type AuditInlineSvm struct {
	...
	// links
	Links *AuditInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
