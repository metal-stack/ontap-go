...
type ChassisNode struct {
	...
	// links
	Links *ChassisNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// pcis
	Pcis *ChassisNodeInlinePcis `json:"pcis,omitempty" yaml:"pcis,omitempty"`
	...
	// usbs
	Usbs *ChassisNodeInlineUsbs `json:"usbs,omitempty" yaml:"usbs,omitempty"`
...
type ChassisNodeInlinePcis struct {
	...
	// cards
	Cards []*ChassisNodePcisCardsItems0 `json:"cards,omitempty" yaml:"cards,omitempty"`
}
...
type ChassisNodeInlineUsbs struct {
	...
	// ports
	Ports []*ChassisNodeUsbsPortsItems0 `json:"ports,omitempty" yaml:"ports,omitempty"`
