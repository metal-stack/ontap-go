...
type MetroclusterDiagConnection struct {
	...
	// destination address
	// Read Only: true
	DestinationAddress *string `json:"destination_address,omitempty" yaml:"destination_address,omitempty"`

	// partner
	Partner *MetroclusterDiagConnectionInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
...
type MetroclusterDiagConnectionInlinePartner struct {
	...
	// node
	Node *MetroclusterDiagConnectionInlinePartnerInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type MetroclusterDiagConnectionInlinePartnerInlineNode struct {
	...
	// links
	Links *MetroclusterDiagConnectionInlinePartnerInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
