...
type EmsConfig struct {
	...
	// links
	Links *EmsConfigInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Mail from
	// Example: administrator@mycompany.com
	MailFrom *string `json:"mail_from,omitempty" yaml:"mail_from,omitempty"`

	// Mail server (SMTP)
	// Example: mail.mycompany.com
	MailServer *string `json:"mail_server,omitempty" yaml:"mail_server,omitempty"`

	// Password for Mail server (SMTP)
	// Example: password
	MailServerPassword *string `json:"mail_server_password,omitempty" yaml:"mail_server_password,omitempty"`

	// Username for Mail server (SMTP)
	// Example: user
	MailServerUser *string `json:"mail_server_user,omitempty" yaml:"mail_server_user,omitempty"`
	...
	// Example: true
	PubsubEnabled *bool `json:"pubsub_enabled,omitempty" yaml:"pubsub_enabled,omitempty"`
}
