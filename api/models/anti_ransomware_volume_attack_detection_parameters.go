...
type AntiRansomwareVolumeAttackDetectionParameters struct {
	...
	BasedOnFileCreateOpRate *bool `json:"based_on_file_create_op_rate,omitempty" yaml:"based_on_file_create_op_rate,omitempty"`
	...
	BasedOnFileDeleteOpRate *bool `json:"based_on_file_delete_op_rate,omitempty" yaml:"based_on_file_delete_op_rate,omitempty"`
	...
	BasedOnFileRenameOpRate *bool `json:"based_on_file_rename_op_rate,omitempty" yaml:"based_on_file_rename_op_rate,omitempty"`

	// Specifies whether a high entropy data rate should be considered for attack detection.
	BasedOnHighEntropyDataRate *bool `json:"based_on_high_entropy_data_rate,omitempty" yaml:"based_on_high_entropy_data_rate,omitempty"`

	// Specifies whether file extensions never seen before should be considered for attack detection.
	BasedOnNeverSeenBeforeFileExtension *bool `json:"based_on_never_seen_before_file_extension,omitempty" yaml:"based_on_never_seen_before_file_extension,omitempty"`

	// Specifies the percentage of surge in the file create rate up to which it is considered normal behavior.
	// Example: 100
	FileCreateOpRateSurgeNotifyPercent *int64 `json:"file_create_op_rate_surge_notify_percent,omitempty" yaml:"file_create_op_rate_surge_notify_percent,omitempty"`

	// Specifies the percentage of surge in the file delete rate up to which it is considered normal behavior.
	FileDeleteOpRateSurgeNotifyPercent *int64 `json:"file_delete_op_rate_surge_notify_percent,omitempty" yaml:"file_delete_op_rate_surge_notify_percent,omitempty"`

	// Specifies the percent of surge in the file rename rate up to which it is considered normal behavior.
	FileRenameOpRateSurgeNotifyPercent *int64 `json:"file_rename_op_rate_surge_notify_percent,omitempty" yaml:"file_rename_op_rate_surge_notify_percent,omitempty"`
	...
	HighEntropyDataSurgeNotifyPercent *int64 `json:"high_entropy_data_surge_notify_percent,omitempty" yaml:"high_entropy_data_surge_notify_percent,omitempty"`

	// Specifies the number of files found with a never seen before file extension up to which it is considered normal behavior.
	NeverSeenBeforeFileExtensionCountNotifyThreshold *int64 `json:"never_seen_before_file_extension_count_notify_threshold,omitempty" yaml:"never_seen_before_file_extension_count_notify_threshold,omitempty"`
	...
	NeverSeenBeforeFileExtensionDurationInHours *int64 `json:"never_seen_before_file_extension_duration_in_hours,omitempty" yaml:"never_seen_before_file_extension_duration_in_hours,omitempty"`
	...
	RelaxingPopularFileExtensions *bool `json:"relaxing_popular_file_extensions,omitempty" yaml:"relaxing_popular_file_extensions,omitempty"`
}
