...
type TopMetricsSvmUserExcludedVolume struct {
	...
	// reason
	Reason *TopMetricsSvmUserExcludedVolumeInlineReason `json:"reason,omitempty" yaml:"reason,omitempty"`

	// volume
	Volume *TopMetricsSvmUserExcludedVolumeInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type TopMetricsSvmUserExcludedVolumeInlineVolume struct {
	...
	// links
	Links *TopMetricsSvmUserExcludedVolumeInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
