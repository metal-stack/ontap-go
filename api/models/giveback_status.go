...
type GivebackStatus struct {
	...
	// aggregate
	Aggregate *GivebackStatusInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// error
	Error *GivebackStatusInlineError `json:"error,omitempty" yaml:"error,omitempty"`
...
type GivebackStatusInlineAggregate struct {
	...
	// links
	Links *GivebackStatusInlineAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
