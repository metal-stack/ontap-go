...
type VscanServerStatusResponse struct {
	...
	// links
	Links *VscanServerStatusResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	VscanServerStatusResponseInlineRecords []*VscanServerStatus `json:"records,omitempty" yaml:"records,omitempty"`
}
