...
type SnapmirrorConsistencyGroupFailover struct {
	...
	// error
	Error *SnapmirrorConsistencyGroupFailoverInlineError `json:"error,omitempty" yaml:"error,omitempty"`
	...
	// status
	Status *SnapmirrorConsistencyGroupFailoverInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
