...
type LocalCifsGroupMembersResponse struct {
	...
	// links
	Links *LocalCifsGroupMembersResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// local cifs group members response inline records
	LocalCifsGroupMembersResponseInlineRecords []*LocalCifsGroupMembers `json:"records,omitempty" yaml:"records,omitempty"`
