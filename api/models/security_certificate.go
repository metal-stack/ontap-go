...
type SecurityCertificate struct {
	...
	// links
	Links *SecurityCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	AuthorityKeyIdentifier *string `json:"authority_key_identifier,omitempty" yaml:"authority_key_identifier,omitempty"`

	// azure
	Azure *SecurityCertificateInlineAzure `json:"azure,omitempty" yaml:"azure,omitempty"`
	...
	KeySize *int64 `json:"key_size,omitempty" yaml:"key_size,omitempty"`
	...
	PublicCertificate *string `json:"public_certificate,omitempty" yaml:"public_certificate,omitempty"`
	...
	SecurityCertificateInlineIntermediateCertificates []*string `json:"intermediate_certificates,omitempty" yaml:"intermediate_certificates,omitempty"`
	...
	SubjectAlternatives *SecurityCertificateInlineSubjectAlternatives `json:"subject_alternatives,omitempty" yaml:"subject_alternatives,omitempty"`
	...
	// Read Only: true
	SubjectKeyIdentifier *string `json:"subject_key_identifier,omitempty" yaml:"subject_key_identifier,omitempty"`

	// svm
	Svm *SecurityCertificateInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type SecurityCertificateInlineAzure struct {
	...
	// Format: uri
	KeyVault *strfmt.URI `json:"key_vault,omitempty" yaml:"key_vault,omitempty"`
	...
	// proxy
	Proxy *SecurityCertificateInlineAzureInlineProxy `json:"proxy,omitempty" yaml:"proxy,omitempty"`
...
type SecurityCertificateInlineSvm struct {
	...
	// links
	Links *SecurityCertificateInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
