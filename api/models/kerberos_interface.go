...
type KerberosInterface struct {
	...
	// links
	Links *KerberosInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// encryption types
	// Read Only: true
	EncryptionTypes []*string `json:"encryption_types,omitempty" yaml:"encryption_types,omitempty"`
	...
	// interface
	Interface *KerberosInterfaceInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// Load keytab from URI
	KeytabURI *string `json:"keytab_uri,omitempty" yaml:"keytab_uri,omitempty"`

	// Specifies the machine account to create in Active Directory.
	MachineAccount *string `json:"machine_account,omitempty" yaml:"machine_account,omitempty"`
	...
	Spn *string `json:"spn,omitempty" yaml:"spn,omitempty"`

	// svm
	Svm *KerberosInterfaceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type KerberosInterfaceInlineInterface struct {
	...
	// links
	Links *KerberosInterfaceInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *KerberosInterfaceInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type KerberosInterfaceInlineSvm struct {
	...
	// links
	Links *KerberosInterfaceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
