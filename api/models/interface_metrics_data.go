...
type InterfaceMetricsData struct {
	...
	// links
	Links *InterfaceMetricsDataInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *InterfaceMetricsDataInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
