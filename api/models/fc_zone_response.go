...
type FcZoneResponse struct {
	...
	// links
	Links *FcZoneResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fc zone response inline records
	FcZoneResponseInlineRecords []*FcZone `json:"records,omitempty" yaml:"records,omitempty"`
