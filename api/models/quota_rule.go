...
type QuotaRule struct {
	...
	// links
	Links *QuotaRuleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// files
	Files *QuotaRuleInlineFiles `json:"files,omitempty" yaml:"files,omitempty"`

	// group
	Group *QuotaRuleInlineGroup `json:"group,omitempty" yaml:"group,omitempty"`

	// qtree
	Qtree *QuotaRuleInlineQtree `json:"qtree,omitempty" yaml:"qtree,omitempty"`
	...
	QuotaRuleInlineUsers []*QuotaRuleInlineUsersInlineArrayItem `json:"users,omitempty" yaml:"users,omitempty"`

	// space
	Space *QuotaRuleInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// svm
	Svm *QuotaRuleInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	UserMapping *bool `json:"user_mapping,omitempty" yaml:"user_mapping,omitempty"`
	...
	// volume
	Volume *QuotaRuleInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type QuotaRuleInlineFiles struct {
	...
	HardLimit *int64 `json:"hard_limit,omitempty" yaml:"hard_limit,omitempty"`

	// This parameter specifies the soft limit for files. This is valid in POST or PATCH.
	SoftLimit *int64 `json:"soft_limit,omitempty" yaml:"soft_limit,omitempty"`
}
...
type QuotaRuleInlineQtree struct {
	...
	// links
	Links *QuotaRuleInlineQtreeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type QuotaRuleInlineSvm struct {
	...
	// links
	Links *QuotaRuleInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type QuotaRuleInlineVolume struct {
	...
	// links
	Links *QuotaRuleInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
