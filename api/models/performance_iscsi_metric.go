...
type PerformanceIscsiMetric struct {
	...
	// links
	Links *PerformanceIscsiMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceIscsiMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceIscsiMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// svm
	Svm *PerformanceIscsiMetricInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *PerformanceIscsiMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
