...
type GroupPolicyObjectRestrictAnonymous struct {
	...
	AnonymousAccessToSharesAndNamedPipesRestricted *bool `json:"anonymous_access_to_shares_and_named_pipes_restricted,omitempty" yaml:"anonymous_access_to_shares_and_named_pipes_restricted,omitempty"`

	// Combined restriction for anonymous user.
	// Example: no_access
	// Enum: ["no_restriction","no_enumeration","no_access"]
	CombinedRestrictionForAnonymousUser *string `json:"combined_restriction_for_anonymous_user,omitempty" yaml:"combined_restriction_for_anonymous_user,omitempty"`

	// No enumeration of SAM accounts.
	NoEnumerationOfSamAccounts *bool `json:"no_enumeration_of_sam_accounts,omitempty" yaml:"no_enumeration_of_sam_accounts,omitempty"`

	// No enumeration of SAM accounts and shares.
	NoEnumerationOfSamAccountsAndShares *bool `json:"no_enumeration_of_sam_accounts_and_shares,omitempty" yaml:"no_enumeration_of_sam_accounts_and_shares,omitempty"`
}
