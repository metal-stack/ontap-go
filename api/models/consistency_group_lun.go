...
type ConsistencyGroupLun struct {
	...
	// clone
	Clone *ConsistencyGroupLunInlineClone `json:"clone,omitempty" yaml:"clone,omitempty"`
	...
	//
	ConsistencyGroupLunInlineLunMaps []*ConsistencyGroupLunInlineLunMapsInlineArrayItem `json:"lun_maps,omitempty" yaml:"lun_maps,omitempty"`
	...
	ProvisioningOptions *ConsistencyGroupLunInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`

	// qos
	Qos *ConsistencyGroupLunInlineQos `json:"qos,omitempty" yaml:"qos,omitempty"`
	...
	// space
	Space *ConsistencyGroupLunInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`
...
type ConsistencyGroupLunInlineClone struct {
	...
	// source
	Source *ConsistencyGroupLunInlineCloneInlineSource `json:"source,omitempty" yaml:"source,omitempty"`
}
...
type ConsistencyGroupLunInlineLunMapsInlineArrayItem struct {
	...
	// igroup
	Igroup *ConsistencyGroupLunInlineLunMapsInlineArrayItemInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`
...
type ConsistencyGroupLunInlineLunMapsInlineArrayItemInlineIgroup struct {
	...
	//
	Igroups []*ConsistencyGroupLunLunMapsItems0IgroupIgroupsItems0 `json:"igroups" yaml:"igroups"`

	// The initiators that are members of the group.
	//
	Initiators []*ConsistencyGroupLunLunMapsItems0IgroupInitiatorsItems0 `json:"initiators" yaml:"initiators"`
...
type ConsistencyGroupLunInlineQos struct {
	...
	// policy
	Policy *ConsistencyGroupLunInlineQosInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
}
...
type ConsistencyGroupLunInlineSpace struct {
	...
	// guarantee
	Guarantee *ConsistencyGroupLunInlineSpaceInlineGuarantee `json:"guarantee,omitempty" yaml:"guarantee,omitempty"`
