...
type CifsDomainResponse struct {
	...
	// links
	Links *CifsDomainResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cifs domain response inline records
	CifsDomainResponseInlineRecords []*CifsDomain `json:"records,omitempty" yaml:"records,omitempty"`
