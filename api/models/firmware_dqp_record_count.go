...
type FirmwareDqpRecordCount struct {
	...
	// Example: 200
	// Read Only: true
	Alias *int64 `json:"alias,omitempty" yaml:"alias,omitempty"`

	// Device record count
	// Example: 29
	// Read Only: true
	Device *int64 `json:"device,omitempty" yaml:"device,omitempty"`

	// Drive record count
	// Example: 680
	// Read Only: true
	Drive *int64 `json:"drive,omitempty" yaml:"drive,omitempty"`
