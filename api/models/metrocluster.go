...
type Metrocluster struct {
	...
	ConfigurationType *string `json:"configuration_type,omitempty" yaml:"configuration_type,omitempty"`
	...
	// local
	Local *MetroclusterInlineLocal `json:"local,omitempty" yaml:"local,omitempty"`

	// mediator
	Mediator *MetroclusterInlineMediator `json:"mediator,omitempty" yaml:"mediator,omitempty"`

	// DR Pairs to create as part of a MetroCluster configure.
	MetroclusterInlineDrPairs []*MetroclusterInlineDrPairsInlineArrayItem `json:"dr_pairs,omitempty" yaml:"dr_pairs,omitempty"`

	// List of Port specifications.
	MetroclusterInlineMccipPorts []*MetroclusterInlineMccipPortsInlineArrayItem `json:"mccip_ports,omitempty" yaml:"mccip_ports,omitempty"`

	// partner cluster
	PartnerCluster *MetroclusterInlinePartnerCluster `json:"partner_cluster,omitempty" yaml:"partner_cluster,omitempty"`

	// remote
	Remote *MetroclusterInlineRemote `json:"remote,omitempty" yaml:"remote,omitempty"`
}
...
type MetroclusterInlineDrPairsInlineArrayItem struct {
	...
	// node
	Node *MetroclusterInlineDrPairsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// partner
	Partner *MetroclusterInlineDrPairsInlineArrayItemInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
}
...
type MetroclusterInlineDrPairsInlineArrayItemInlineNode struct {
	...
	// links
	Links *MetroclusterInlineDrPairsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterInlineDrPairsInlineArrayItemInlinePartner struct {
	...
	// links
	Links *MetroclusterInlineDrPairsInlineArrayItemInlinePartnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterInlineLocal struct {
	...
	AutomaticUsoFailureDomain *string `json:"automatic_uso_failure_domain,omitempty" yaml:"automatic_uso_failure_domain,omitempty"`

	// cluster
	Cluster *MetroclusterInlineLocalInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`
	...
	// Read Only: true
	PartnerClusterReachable *bool `json:"partner_cluster_reachable,omitempty" yaml:"partner_cluster_reachable,omitempty"`

	// Indicates whether or not a periodic check is enabled on the local cluster.
	// Read Only: true
	PeriodicCheckEnabled *bool `json:"periodic_check_enabled,omitempty" yaml:"periodic_check_enabled,omitempty"`
}
...
type MetroclusterInlineLocalInlineCluster struct {
	...
	// links
	Links *MetroclusterInlineLocalInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterInlineMccipPortsInlineArrayItem struct {
	...
	// l3 config
	L3Config *MetroclusterInlineMccipPortsInlineArrayItemInlineL3Config `json:"l3_config,omitempty" yaml:"l3_config,omitempty"`
	...
	// node
	Node *MetroclusterInlineMccipPortsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type MetroclusterInlineMccipPortsInlineArrayItemInlineL3Config struct {
	...
	// ipv4 interface
	IPV4Interface *MetroclusterInlineMccipPortsInlineArrayItemInlineL3ConfigInlineIPV4Interface `json:"ipv4_interface,omitempty" yaml:"ipv4_interface,omitempty"`
}
...
type MetroclusterInlineMccipPortsInlineArrayItemInlineNode struct {
	...
	// links
	Links *MetroclusterInlineMccipPortsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterInlineMediator struct {
	...
	// dr group
	DrGroup *MetroclusterInlineMediatorInlineDrGroup `json:"dr_group,omitempty" yaml:"dr_group,omitempty"`
	...
	// peer cluster
	PeerCluster *MetroclusterInlineMediatorInlinePeerCluster `json:"peer_cluster,omitempty" yaml:"peer_cluster,omitempty"`

	// Indicates the mediator connectivity status of the peer cluster. Possible values are connected, unreachable, unknown.
	// Example: connected
	// Read Only: true
	PeerMediatorConnectivity *string `json:"peer_mediator_connectivity,omitempty" yaml:"peer_mediator_connectivity,omitempty"`
...
type MetroclusterInlineMediatorInlinePeerCluster struct {
	...
	// links
	Links *MetroclusterInlineMediatorInlinePeerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterInlinePartnerCluster struct {
	...
	// links
	Links *MetroclusterInlinePartnerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterInlineRemote struct {
	...
	// cluster
	Cluster *MetroclusterInlineRemoteInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`
...
type MetroclusterInlineRemoteInlineCluster struct {
	...
	// links
	Links *MetroclusterInlineRemoteInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
