...
type UserGroupPrivileges struct {
	...
	// links
	Links *UserGroupPrivilegesInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *UserGroupPrivilegesInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type UserGroupPrivilegesInlineSvm struct {
	...
	// links
	Links *UserGroupPrivilegesInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
