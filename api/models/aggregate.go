...
type Aggregate struct {
	...
	// links
	Links *AggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Max Items: 64
	AggregateInlineTags []*string `json:"_tags,omitempty" yaml:"_tags,omitempty"`

	// block storage
	BlockStorage *AggregateInlineBlockStorage `json:"block_storage,omitempty" yaml:"block_storage,omitempty"`

	// cloud storage
	CloudStorage *AggregateInlineCloudStorage `json:"cloud_storage,omitempty" yaml:"cloud_storage,omitempty"`
	...
	// data encryption
	DataEncryption *AggregateInlineDataEncryption `json:"data_encryption,omitempty" yaml:"data_encryption,omitempty"`

	// dr home node
	DrHomeNode *AggregateInlineDrHomeNode `json:"dr_home_node,omitempty" yaml:"dr_home_node,omitempty"`

	// home node
	HomeNode *AggregateInlineHomeNode `json:"home_node,omitempty" yaml:"home_node,omitempty"`

	// inactive data reporting
	InactiveDataReporting *AggregateInlineInactiveDataReporting `json:"inactive_data_reporting,omitempty" yaml:"inactive_data_reporting,omitempty"`

	// inode attributes
	InodeAttributes *AggregateInlineInodeAttributes `json:"inode_attributes,omitempty" yaml:"inode_attributes,omitempty"`
	...
	// Example: false
	// Read Only: true
	IsSpareLow *bool `json:"is_spare_low,omitempty" yaml:"is_spare_low,omitempty"`

	// metric
	Metric *AggregateInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// node
	Node *AggregateInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// Specifies whether or not SIDL is enabled on the aggregate.
	SidlEnabled *bool `json:"sidl_enabled,omitempty" yaml:"sidl_enabled,omitempty"`
	...
	// snapshot
	Snapshot *AggregateInlineSnapshot `json:"snapshot,omitempty" yaml:"snapshot,omitempty"`

	// space
	Space *AggregateInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`
	...
	// statistics
	Statistics *AggregateInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`
...
type AggregateInlineBlockStorage struct {
	...
	// hybrid cache
	HybridCache *AggregateInlineBlockStorageInlineHybridCache `json:"hybrid_cache,omitempty" yaml:"hybrid_cache,omitempty"`

	// mirror
	Mirror *AggregateInlineBlockStorageInlineMirror `json:"mirror,omitempty" yaml:"mirror,omitempty"`

	// Plex reference for each plex in the aggregate.
	// Read Only: true
	Plexes []*PlexReference `json:"plexes,omitempty" yaml:"plexes,omitempty"`

	// primary
	Primary *AggregateInlineBlockStorageInlinePrimary `json:"primary,omitempty" yaml:"primary,omitempty"`
	...
	// Read Only: true
	UsesPartitions *bool `json:"uses_partitions,omitempty" yaml:"uses_partitions,omitempty"`
}
...
type AggregateInlineBlockStorageInlineHybridCache struct {
	...
	// Example: 6
	DiskCount *int64 `json:"disk_count,omitempty" yaml:"disk_count,omitempty"`
	...
	// Example: 24
	RaidSize *int64 `json:"raid_size,omitempty" yaml:"raid_size,omitempty"`
	...
	SimulatedRaidGroups []*AggregateBlockStorageHybridCacheSimulatedRaidGroupsItems0 `json:"simulated_raid_groups,omitempty" yaml:"simulated_raid_groups,omitempty"`
	...
	StoragePools []*AggregateBlockStorageHybridCacheStoragePoolsItems0 `json:"storage_pools,omitempty" yaml:"storage_pools,omitempty"`
...
type AggregateBlockStorageHybridCacheSimulatedRaidGroupsItems0 struct {
	...
	AddedDataDiskCount *int64 `json:"added_data_disk_count,omitempty" yaml:"added_data_disk_count,omitempty"`

	// Number of added parity disks in RAID group.
	AddedParityDiskCount *int64 `json:"added_parity_disk_count,omitempty" yaml:"added_parity_disk_count,omitempty"`

	// Number of existing data disks in the RAID group.
	ExistingDataDiskCount *int64 `json:"existing_data_disk_count,omitempty" yaml:"existing_data_disk_count,omitempty"`

	// Number of existing parity disks in the RAID group.
	ExistingParityDiskCount *int64 `json:"existing_parity_disk_count,omitempty" yaml:"existing_parity_disk_count,omitempty"`

	// Indicates whether the disk is partitioned (true) or whole (false).
	IsPartition *bool `json:"is_partition,omitempty" yaml:"is_partition,omitempty"`

	// Name of the raid group.
	Name *string `json:"name,omitempty" yaml:"name,omitempty"`

	// Usable size of each disk, in bytes.
	UsableSize *int64 `json:"usable_size,omitempty" yaml:"usable_size,omitempty"`
}
...
type AggregateBlockStorageHybridCacheStoragePoolsItems0 struct {
	...
	AllocationUnitsCount *int32 `json:"allocation_units_count,omitempty" yaml:"allocation_units_count,omitempty"`

	// storage pool
	StoragePool *StoragePoolReference `json:"storage_pool,omitempty" yaml:"storage_pool,omitempty"`
}
...
type AggregateInlineBlockStorageInlinePrimary struct {
	...
	ChecksumStyle *string `json:"checksum_style,omitempty" yaml:"checksum_style,omitempty"`
	...
	DiskClass *string `json:"disk_class,omitempty" yaml:"disk_class,omitempty"`
	...
	// simulated raid groups
	SimulatedRaidGroups []*AggregateBlockStoragePrimarySimulatedRaidGroupsItems0 `json:"simulated_raid_groups,omitempty" yaml:"simulated_raid_groups,omitempty"`
}
...
type AggregateBlockStoragePrimarySimulatedRaidGroupsItems0 struct {
	...
	DataDiskCount *int64 `json:"data_disk_count,omitempty" yaml:"data_disk_count,omitempty"`
	...
	ParityDiskCount *int64 `json:"parity_disk_count,omitempty" yaml:"parity_disk_count,omitempty"`
...
type AggregateInlineCloudStorage struct {
	...
	// Read Only: true
	AttachEligible *bool `json:"attach_eligible,omitempty" yaml:"attach_eligible,omitempty"`
	...
	MigrateThreshold *int64 `json:"migrate_threshold,omitempty" yaml:"migrate_threshold,omitempty"`

	// Configuration information for each cloud storage portion of the aggregate.
	// Read Only: true
	Stores []*CloudStorageTier `json:"stores,omitempty" yaml:"stores,omitempty"`
	...
	TieringFullnessThreshold *int64 `json:"tiering_fullness_threshold,omitempty" yaml:"tiering_fullness_threshold,omitempty"`
}
...
type AggregateInlineDataEncryption struct {
	...
	// Read Only: true
	DriveProtectionEnabled *bool `json:"drive_protection_enabled,omitempty" yaml:"drive_protection_enabled,omitempty"`

	// Specifies whether NetApp aggregate encryption is enabled. All data in the aggregate is encrypted.
	SoftwareEncryptionEnabled *bool `json:"software_encryption_enabled,omitempty" yaml:"software_encryption_enabled,omitempty"`
}
...
type AggregateInlineHomeNode struct {
	...
	// links
	Links *AggregateInlineHomeNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type AggregateInlineInodeAttributes struct {
	...
	//
	// Example: 31136
	FilePublicCapacity *int64 `json:"file_public_capacity,omitempty" yaml:"file_public_capacity,omitempty"`

	// Number of system metadata files used. If the referenced file system is restricted or offline, a value of 0 is returned.
	// This is an advanced property; there is an added computational cost to retrieving its value. The field is not populated for either a collection GET or an instance GET unless it is explicitly requested using the <i>fields</i> query parameter containing either footprint or **.
	//
	// Example: 502
	FilesPrivateUsed *int64 `json:"files_private_used,omitempty" yaml:"files_private_used,omitempty"`
	...
	// Example: 2844525
	MaxFilesPossible *int64 `json:"max_files_possible,omitempty" yaml:"max_files_possible,omitempty"`
...
type AggregateInlineMetric struct {
	...
	// links
	Links *AggregateInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *AggregateInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *AggregateInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *AggregateInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type AggregateInlineNode struct {
	...
	// links
	Links *AggregateInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type AggregateInlineSpace struct {
	...
	// block storage
	BlockStorage *AggregateInlineSpaceInlineBlockStorage `json:"block_storage,omitempty" yaml:"block_storage,omitempty"`

	// cloud storage
	CloudStorage *AggregateInlineSpaceInlineCloudStorage `json:"cloud_storage,omitempty" yaml:"cloud_storage,omitempty"`

	// efficiency
	Efficiency *AggregateInlineSpaceInlineEfficiency `json:"efficiency,omitempty" yaml:"efficiency,omitempty"`

	// efficiency without snapshots
	EfficiencyWithoutSnapshots *AggregateInlineSpaceInlineEfficiencyWithoutSnapshots `json:"efficiency_without_snapshots,omitempty" yaml:"efficiency_without_snapshots,omitempty"`

	// efficiency without snapshots flexclones
	EfficiencyWithoutSnapshotsFlexclones *AggregateInlineSpaceInlineEfficiencyWithoutSnapshotsFlexclones `json:"efficiency_without_snapshots_flexclones,omitempty" yaml:"efficiency_without_snapshots_flexclones,omitempty"`
	...
	// snapshot
	Snapshot *AggregateInlineSpaceInlineSnapshot `json:"snapshot,omitempty" yaml:"snapshot,omitempty"`
}
...
type AggregateInlineSpaceInlineBlockStorage struct {
	...
	// Example: 2655
	// Read Only: true
	AggregateMetadata *int64 `json:"aggregate_metadata,omitempty" yaml:"aggregate_metadata,omitempty"`

	// Aggregate metadata as a percentage.
	// Example: 8
	// Read Only: true
	AggregateMetadataPercent *int64 `json:"aggregate_metadata_percent,omitempty" yaml:"aggregate_metadata_percent,omitempty"`
	...
	// Example: 1990000
	// Read Only: true
	DataCompactedCount *int64 `json:"data_compacted_count,omitempty" yaml:"data_compacted_count,omitempty"`

	// Space saved in bytes by compacting the data.
	// Example: 1996000
	// Read Only: true
	DataCompactionSpaceSaved *int64 `json:"data_compaction_space_saved,omitempty" yaml:"data_compaction_space_saved,omitempty"`

	// Percentage saved by compacting the data.
	// Example: 27
	// Read Only: true
	DataCompactionSpaceSavedPercent *int64 `json:"data_compaction_space_saved_percent,omitempty" yaml:"data_compaction_space_saved_percent,omitempty"`
	...
	// Example: 304448
	// Read Only: true
	InactiveUserData *int64 `json:"inactive_user_data,omitempty" yaml:"inactive_user_data,omitempty"`
	...
	//
	// Read Only: true
	InactiveUserDataPercent *int64 `json:"inactive_user_data_percent,omitempty" yaml:"inactive_user_data_percent,omitempty"`
	...
	// Example: 35
	// Read Only: true
	UsedIncludingSnapshotReservePercent *int64 `json:"used_including_snapshot_reserve_percent,omitempty" yaml:"used_including_snapshot_reserve_percent,omitempty"`
	...
	// Example: 1990000
	// Read Only: true
	VolumeDeduplicationSharedCount *int64 `json:"volume_deduplication_shared_count,omitempty" yaml:"volume_deduplication_shared_count,omitempty"`

	// Amount of space saved in bytes by storage efficiency.
	// Example: 1996000
	// Read Only: true
	VolumeDeduplicationSpaceSaved *int64 `json:"volume_deduplication_space_saved,omitempty" yaml:"volume_deduplication_space_saved,omitempty"`

	// Percentage of space saved by storage efficiency.
	// Example: 27
	// Read Only: true
	VolumeDeduplicationSpaceSavedPercent *int64 `json:"volume_deduplication_space_saved_percent,omitempty" yaml:"volume_deduplication_space_saved_percent,omitempty"`
	...
	// Example: 14
	// Read Only: true
	VolumeFootprintsPercent *int64 `json:"volume_footprints_percent,omitempty" yaml:"volume_footprints_percent,omitempty"`
}
...
type AggregateInlineSpaceInlineEfficiency struct {
	...
	// Read Only: true
	AutoAdaptiveCompressionSavings *bool `json:"auto_adaptive_compression_savings,omitempty" yaml:"auto_adaptive_compression_savings,omitempty"`

	// Indicates whether or not cross volume background deduplication is enabled.
	// Read Only: true
	CrossVolumeBackgroundDedupe *bool `json:"cross_volume_background_dedupe,omitempty" yaml:"cross_volume_background_dedupe,omitempty"`

	// Indicates whether or not aggregate has cross volume deduplication savings.
	// Read Only: true
	CrossVolumeDedupeSavings *bool `json:"cross_volume_dedupe_savings,omitempty" yaml:"cross_volume_dedupe_savings,omitempty"`

	// Indicates whether or not cross volume inline deduplication is enabled.
	// Read Only: true
	CrossVolumeInlineDedupe *bool `json:"cross_volume_inline_dedupe,omitempty" yaml:"cross_volume_inline_dedupe,omitempty"`

	// Indicates whether Workload Informed TSSE is enabled on the system.
	EnableWorkloadInformedTsse *bool `json:"enable_workload_informed_tsse,omitempty" yaml:"enable_workload_informed_tsse,omitempty"`
	...
	WiseTsseMinUsedCapacityPct *int64 `json:"wise_tsse_min_used_capacity_pct,omitempty" yaml:"wise_tsse_min_used_capacity_pct,omitempty"`
}
...
type AggregateInlineStatistics struct {
	...
	// iops raw
	IopsRaw *AggregateInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *AggregateInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *AggregateInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
