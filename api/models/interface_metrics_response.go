...
type InterfaceMetricsResponse struct {
	...
	// links
	Links *InterfaceMetricsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// interface metrics response inline records
	InterfaceMetricsResponseInlineRecords []*InterfaceMetricsResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type InterfaceMetricsResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *InterfaceMetricsResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *InterfaceMetricsResponseInlineRecordsInlineArrayItemInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
