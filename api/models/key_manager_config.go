...
type KeyManagerConfig struct {
	...
	CcModeEnabled *bool `json:"cc_mode_enabled,omitempty" yaml:"cc_mode_enabled,omitempty"`

	// Cloud key manager connection retry count. Supported value range of 0-10.
	// Example: 3
	CloudKmsRetryCount *int64 `json:"cloud_kms_retry_count,omitempty" yaml:"cloud_kms_retry_count,omitempty"`

	// health monitor policy
	HealthMonitorPolicy *KeyManagerConfigInlineHealthMonitorPolicy `json:"health_monitor_policy,omitempty" yaml:"health_monitor_policy,omitempty"`

	// Health Monitor Polling Period, in minutes. Supported value range of 15-30 minutes.
	// Example: 20
	HealthMonitorPollingInterval *int64 `json:"health_monitor_polling_interval,omitempty" yaml:"health_monitor_polling_interval,omitempty"`
...
type KeyManagerConfigInlineHealthMonitorPolicy struct {
	...
	// akv
	Akv *KeyManagerConfigInlineHealthMonitorPolicyInlineAkv `json:"akv,omitempty" yaml:"akv,omitempty"`

	// aws
	Aws *KeyManagerConfigInlineHealthMonitorPolicyInlineAws `json:"aws,omitempty" yaml:"aws,omitempty"`

	// gcp
	Gcp *KeyManagerConfigInlineHealthMonitorPolicyInlineGcp `json:"gcp,omitempty" yaml:"gcp,omitempty"`

	// ikp
	Ikp *KeyManagerConfigInlineHealthMonitorPolicyInlineIkp `json:"ikp,omitempty" yaml:"ikp,omitempty"`

	// kmip
	Kmip *KeyManagerConfigInlineHealthMonitorPolicyInlineKmip `json:"kmip,omitempty" yaml:"kmip,omitempty"`

	// okm
	Okm *KeyManagerConfigInlineHealthMonitorPolicyInlineOkm `json:"okm,omitempty" yaml:"okm,omitempty"`
}
...
type KeyManagerConfigInlineHealthMonitorPolicyInlineAkv struct {
	...
	ManageVolumeOffline *bool `json:"manage_volume_offline,omitempty" yaml:"manage_volume_offline,omitempty"`
}
