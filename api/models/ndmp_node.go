...
type NdmpNode struct {
	...
	// links
	Links *NdmpNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	NdmpNodeInlineAuthenticationTypes []*NdmpAuthType `json:"authentication_types,omitempty" yaml:"authentication_types,omitempty"`

	// node
	Node *NdmpNodeInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type NdmpNodeInlineNode struct {
	...
	// links
	Links *NdmpNodeInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
