...
type StoragePort struct {
	...
	// cable
	Cable *StoragePortInlineCable `json:"cable,omitempty" yaml:"cable,omitempty"`
	...
	// error
	Error *StoragePortInlineError `json:"error,omitempty" yaml:"error,omitempty"`
	...
	// Read Only: true
	InUse *bool `json:"in_use,omitempty" yaml:"in_use,omitempty"`
	...
	// node
	Node *StoragePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type StoragePortInlineCable struct {
	...
	Transceiver *string `json:"transceiver,omitempty" yaml:"transceiver,omitempty"`
...
type StoragePortInlineNode struct {
	...
	// links
	Links *StoragePortInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
