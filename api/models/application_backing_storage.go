...
type ApplicationBackingStorage struct {
	...
	ApplicationBackingStorageInlineLuns []*ApplicationLunObject `json:"luns,omitempty" yaml:"luns,omitempty"`

	// application backing storage inline namespaces
	ApplicationBackingStorageInlineNamespaces []*ApplicationNamespaceObject `json:"namespaces,omitempty" yaml:"namespaces,omitempty"`

	// application backing storage inline volumes
	ApplicationBackingStorageInlineVolumes []*ApplicationVolumeObject `json:"volumes,omitempty" yaml:"volumes,omitempty"`
}
