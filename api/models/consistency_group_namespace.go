...
type ConsistencyGroupNamespace struct {
	...
	ProvisioningOptions *ConsistencyGroupNamespaceInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`

	// space
	Space *ConsistencyGroupNamespaceInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// status
	Status *ConsistencyGroupNamespaceInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`

	// subsystem map
	SubsystemMap *ConsistencyGroupNamespaceInlineSubsystemMap `json:"subsystem_map,omitempty" yaml:"subsystem_map,omitempty"`
...
type ConsistencyGroupNamespaceInlineSpace struct {
	...
	// guarantee
	Guarantee *ConsistencyGroupNamespaceInlineSpaceInlineGuarantee `json:"guarantee,omitempty" yaml:"guarantee,omitempty"`
