...
type AggregateWarning struct {
	...
	// action
	Action *AggregateWarningInlineAction `json:"action,omitempty" yaml:"action,omitempty"`

	// Name of the entity that returns the warning.
	Name *string `json:"name,omitempty" yaml:"name,omitempty"`

	// warning
	Warning *AggregateWarningInlineWarning `json:"warning,omitempty" yaml:"warning,omitempty"`
}
