...
type Rfc2307bis struct {
	...
	GroupOfUniqueNames *string `json:"group_of_unique_names,omitempty" yaml:"group_of_unique_names,omitempty"`

	// Maximum number of groups supported when RFC 2307bis is enabled.
	// Example: 256
	// Maximum: 1024
	// Minimum: 1
	MaximumGroups *int64 `json:"maximum_groups,omitempty" yaml:"maximum_groups,omitempty"`

	// RFC 2307bis uniqueMember attribute.
	// Example: uniqueMember
	UniqueMember *string `json:"unique_member,omitempty" yaml:"unique_member,omitempty"`
}
