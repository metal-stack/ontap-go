...
type VscanServerStatus struct {
	...
	//   - server_removed
	//
	DisconnectedReason *string `json:"disconnected_reason,omitempty" yaml:"disconnected_reason,omitempty"`

	// interface
	Interface *VscanServerStatusInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// IP address of the Vscan server.
	IP *string `json:"ip,omitempty" yaml:"ip,omitempty"`

	// node
	Node *VscanServerStatusInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *VscanServerStatusInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type VscanServerStatusInlineInterface struct {
	...
	// links
	Links *VscanServerStatusInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *VscanServerStatusInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type VscanServerStatusInlineNode struct {
	...
	// links
	Links *VscanServerStatusInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VscanServerStatusInlineSvm struct {
	...
	// links
	Links *VscanServerStatusInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
