...
type PerformanceFcInterfaceMetric struct {
	...
	// links
	Links *PerformanceFcInterfaceMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceFcInterfaceMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceFcInterfaceMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceFcInterfaceMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
