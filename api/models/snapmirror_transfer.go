...
type SnapmirrorTransfer struct {
	...
	// links
	Links *SnapmirrorTransferInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	CheckpointSize *int64 `json:"checkpoint_size,omitempty" yaml:"checkpoint_size,omitempty"`
	...
	// error info
	ErrorInfo *SnapmirrorTransferInlineErrorInfo `json:"error_info,omitempty" yaml:"error_info,omitempty"`
	...
	// Example: 61
	// Read Only: true
	NetworkCompressionRatio *string `json:"network_compression_ratio,omitempty" yaml:"network_compression_ratio,omitempty"`
	...
	OnDemandAttrs *string `json:"on_demand_attrs,omitempty" yaml:"on_demand_attrs,omitempty"`

	// relationship
	Relationship *SnapmirrorTransferInlineRelationship `json:"relationship,omitempty" yaml:"relationship,omitempty"`
	...
	SnapmirrorTransferInlineFiles []*SnapmirrorTransferInlineFilesInlineArrayItem `json:"files,omitempty" yaml:"files,omitempty"`
	...
	StorageEfficiencyEnabled *bool `json:"storage_efficiency_enabled,omitempty" yaml:"storage_efficiency_enabled,omitempty"`
