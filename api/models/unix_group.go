...
type UnixGroup struct {
	...
	// links
	Links *UnixGroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *UnixGroupInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// unix group inline users
	// Read Only: true
	UnixGroupInlineUsers []*UnixGroupInlineUsersInlineArrayItem `json:"users,omitempty" yaml:"users,omitempty"`
}
...
type UnixGroupInlineSvm struct {
	...
	// links
	Links *UnixGroupInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
