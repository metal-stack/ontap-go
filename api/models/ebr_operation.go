...
type EbrOperation struct {
	...
	// links
	Links *EbrOperationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: 0
	// Read Only: true
	NumFilesFailed *int64 `json:"num_files_failed,omitempty" yaml:"num_files_failed,omitempty"`

	// Specifies the number of files on which EBR policy was applied successfully.
	// Example: 50
	// Read Only: true
	NumFilesProcessed *int64 `json:"num_files_processed,omitempty" yaml:"num_files_processed,omitempty"`

	// Specifies the number of files on which the application of EBR policy was skipped.
	// Example: 2
	// Read Only: true
	NumFilesSkipped *int64 `json:"num_files_skipped,omitempty" yaml:"num_files_skipped,omitempty"`
	...
	// Example: 2
	// Read Only: true
	NumInodesIgnored *int64 `json:"num_inodes_ignored,omitempty" yaml:"num_inodes_ignored,omitempty"`
	...
	// policy
	Policy *EbrOperationInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
	...
	// svm
	Svm *EbrOperationInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *EbrOperationInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type EbrOperationInlinePolicy struct {
	...
	// links
	Links *EbrOperationInlinePolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EbrOperationInlineSvm struct {
	...
	// links
	Links *EbrOperationInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EbrOperationInlineVolume struct {
	...
	// links
	Links *EbrOperationInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
