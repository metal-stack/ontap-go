...
type VscanScannerPool struct {
	...
	// cluster
	Cluster *ClusterReference `json:"cluster,omitempty" yaml:"cluster,omitempty"`
	...
	// svm
	Svm *VscanScannerPoolInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	VscanScannerPoolInlinePrivilegedUsers []*string `json:"privileged_users,omitempty" yaml:"privileged_users,omitempty"`
	...
	VscanScannerPoolInlineServers []*string `json:"servers,omitempty" yaml:"servers,omitempty"`
}
...
type VscanScannerPoolInlineSvm struct {
	...
	// links
	Links *VscanScannerPoolInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
