...
type SecurityAuditLogForward struct {
	...
	HostnameFormatOverride *string `json:"hostname_format_override,omitempty" yaml:"hostname_format_override,omitempty"`

	// ipspace
	Ipspace *SecurityAuditLogForwardInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
	...
	TimestampFormatOverride *string `json:"timestamp_format_override,omitempty" yaml:"timestamp_format_override,omitempty"`
	...
	VerifyServer *bool `json:"verify_server,omitempty" yaml:"verify_server,omitempty"`
}
...
type SecurityAuditLogForwardInlineIpspace struct {
	...
	// links
	Links *SecurityAuditLogForwardInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
