...
type CloudStore struct {
	...
	// links
	Links *CloudStoreInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// aggregate
	Aggregate *CloudStoreInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`
	...
	// Read Only: true
	// Enum: ["available","unavailable"]
	AvailabilityAtPartner *string `json:"availability_at_partner,omitempty" yaml:"availability_at_partner,omitempty"`

	// This field identifies if the mirror cloud store is in sync with the primary cloud store of a FabricPool.
	// Read Only: true
	MirrorDegraded *bool `json:"mirror_degraded,omitempty" yaml:"mirror_degraded,omitempty"`
	...
	// Read Only: true
	ResyncProgress *int64 `json:"resync-progress,omitempty" yaml:"resync-progress,omitempty"`

	// target
	Target *CloudStoreInlineTarget `json:"target,omitempty" yaml:"target,omitempty"`

	// unavailable reason
	UnavailableReason *CloudStoreInlineUnavailableReason `json:"unavailable_reason,omitempty" yaml:"unavailable_reason,omitempty"`
	...
	// Example: 20
	UnreclaimedSpaceThreshold *int64 `json:"unreclaimed_space_threshold,omitempty" yaml:"unreclaimed_space_threshold,omitempty"`
...
type CloudStoreInlineTarget struct {
	...
	// links
	Links *CloudStoreInlineTargetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
