...
type SoftwareHistoryResponse struct {
	...
	// links
	Links *SoftwareHistoryResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SoftwareHistoryResponseInlineRecords []*SoftwareHistory `json:"records,omitempty" yaml:"records,omitempty"`
}
