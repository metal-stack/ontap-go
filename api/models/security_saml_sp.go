...
type SecuritySamlSp struct {
	...
	// links
	Links *SecuritySamlSpInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// certificate
	Certificate *SecuritySamlSpInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
	...
	IdpURI *string `json:"idp_uri,omitempty" yaml:"idp_uri,omitempty"`
}
