...
type SnapmirrorPolicy struct {
	...
	// links
	Links *SnapmirrorPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	NetworkCompressionEnabled *bool `json:"network_compression_enabled,omitempty" yaml:"network_compression_enabled,omitempty"`
	...
	Rpo *int64 `json:"rpo,omitempty" yaml:"rpo,omitempty"`
	...
	// svm
	Svm *SnapmirrorPolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// sync common snapshot schedule
	SyncCommonSnapshotSchedule *SnapmirrorPolicyInlineSyncCommonSnapshotSchedule `json:"sync_common_snapshot_schedule,omitempty" yaml:"sync_common_snapshot_schedule,omitempty"`
	...
	// transfer schedule
	TransferSchedule *SnapmirrorPolicyInlineTransferSchedule `json:"transfer_schedule,omitempty" yaml:"transfer_schedule,omitempty"`
...
type SnapmirrorPolicyInlineSvm struct {
	...
	// links
	Links *SnapmirrorPolicyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapmirrorPolicyInlineSyncCommonSnapshotSchedule struct {
	...
	// links
	Links *SnapmirrorPolicyInlineSyncCommonSnapshotScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapmirrorPolicyInlineTransferSchedule struct {
	...
	// links
	Links *SnapmirrorPolicyInlineTransferScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
