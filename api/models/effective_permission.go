...
type EffectivePermission struct {
	...
	FilePermissions []*string `json:"file_permissions,omitempty" yaml:"file_permissions,omitempty"`
	...
	// share
	Share *Share `json:"share,omitempty" yaml:"share,omitempty"`

	// Specifies the effective permission granted to a user on the specified file or folder path.
	SharePermissions []*string `json:"share_permissions,omitempty" yaml:"share_permissions,omitempty"`
