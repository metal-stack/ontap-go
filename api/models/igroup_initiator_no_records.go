...
type IgroupInitiatorNoRecords struct {
	...
	// links
	Links *IgroupInitiatorNoRecordsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// proximity
	Proximity *IgroupInitiatorNoRecordsInlineProximity `json:"proximity,omitempty" yaml:"proximity,omitempty"`
}
...
type IgroupInitiatorNoRecordsInlineProximity struct {
	...
	//
	PeerSvms []*IgroupInitiatorNoRecordsProximityPeerSvmsItems0 `json:"peer_svms,omitempty" yaml:"peer_svms,omitempty"`
}
...
type IgroupInitiatorNoRecordsProximityPeerSvmsItems0 struct {
	...
	// links
	Links *IgroupInitiatorNoRecordsProximityPeerSvmsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
