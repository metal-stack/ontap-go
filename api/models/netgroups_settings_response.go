...
type NetgroupsSettingsResponse struct {
	...
	// links
	Links *NetgroupsSettingsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// netgroups settings response inline records
	NetgroupsSettingsResponseInlineRecords []*NetgroupsSettings `json:"records,omitempty" yaml:"records,omitempty"`
