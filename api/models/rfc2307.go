...
type Rfc2307 struct {
	...
	// attribute
	Attribute *Rfc2307InlineAttribute `json:"attribute,omitempty" yaml:"attribute,omitempty"`

	// cn
	Cn *Rfc2307InlineCn `json:"cn,omitempty" yaml:"cn,omitempty"`

	// member
	Member *Rfc2307InlineMember `json:"member,omitempty" yaml:"member,omitempty"`

	// nis
	Nis *Rfc2307InlineNis `json:"nis,omitempty" yaml:"nis,omitempty"`

	// posix
	Posix *Rfc2307InlinePosix `json:"posix,omitempty" yaml:"posix,omitempty"`
}
...
type Rfc2307InlineAttribute struct {
	...
	GidNumber *string `json:"gid_number,omitempty" yaml:"gid_number,omitempty"`

	// RFC 2307 homeDirectory attribute.
	// Example: msSFU30HomeDirectory
	HomeDirectory *string `json:"home_directory,omitempty" yaml:"home_directory,omitempty"`

	// RFC 2307 loginShell attribute.
	// Example: msSFU30LoginShell
	LoginShell *string `json:"login_shell,omitempty" yaml:"login_shell,omitempty"`
	...
	UIDNumber *string `json:"uid_number,omitempty" yaml:"uid_number,omitempty"`

	// RFC 2256 userPassword attribute used by RFC 2307.
	// Example: msSFU30Password
	UserPassword *string `json:"user_password,omitempty" yaml:"user_password,omitempty"`
}
