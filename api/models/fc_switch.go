...
type FcSwitch struct {
	...
	// links
	Links *FcSwitchInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cache
	Cache *FcSwitchInlineCache `json:"cache,omitempty" yaml:"cache,omitempty"`
	...
	// fabric
	Fabric *FcSwitchInlineFabric `json:"fabric,omitempty" yaml:"fabric,omitempty"`

	// An array of the Fibre Channel (FC) switch's ports and their attached FC devices.
	//
	// Read Only: true
	FcSwitchInlinePorts []*FcSwitchInlinePortsInlineArrayItem `json:"ports,omitempty" yaml:"ports,omitempty"`
...
type FcSwitchInlineFabric struct {
	...
	// links
	Links *FcSwitchInlineFabricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FcSwitchInlinePortsInlineArrayItem struct {
	...
	// attached device
	AttachedDevice *FcSwitchInlinePortsInlineArrayItemInlineAttachedDevice `json:"attached_device,omitempty" yaml:"attached_device,omitempty"`
