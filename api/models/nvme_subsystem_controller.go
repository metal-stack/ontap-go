...
type NvmeSubsystemController struct {
	...
	// links
	Links *NvmeSubsystemControllerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// admin queue
	AdminQueue *NvmeSubsystemControllerInlineAdminQueue `json:"admin_queue,omitempty" yaml:"admin_queue,omitempty"`

	// dh hmac chap
	DhHmacChap *NvmeSubsystemControllerInlineDhHmacChap `json:"dh_hmac_chap,omitempty" yaml:"dh_hmac_chap,omitempty"`

	// digest
	Digest *NvmeSubsystemControllerInlineDigest `json:"digest,omitempty" yaml:"digest,omitempty"`

	// host
	Host *NvmeSubsystemControllerInlineHost `json:"host,omitempty" yaml:"host,omitempty"`
	...
	// interface
	Interface *NvmeSubsystemControllerInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// io queue
	IoQueue *NvmeSubsystemControllerInlineIoQueue `json:"io_queue,omitempty" yaml:"io_queue,omitempty"`
	...
	// Example: 1500
	// Read Only: true
	KeepAliveTimeout *int64 `json:"keep_alive_timeout,omitempty" yaml:"keep_alive_timeout,omitempty"`

	// node
	Node *NvmeSubsystemControllerInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// subsystem
	Subsystem *NvmeSubsystemControllerInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`
...
type NvmeSubsystemControllerInlineNode struct {
	...
	// links
	Links *NvmeSubsystemControllerInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeSubsystemControllerInlineSubsystem struct {
	...
	// links
	Links *NvmeSubsystemControllerInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeSubsystemControllerInlineSvm struct {
	...
	// links
	Links *NvmeSubsystemControllerInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
