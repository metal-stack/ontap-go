...
type MetroclusterDiagnostics struct {
	...
	// aggregate
	Aggregate *MetroclusterDiagnosticsInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// cluster
	Cluster *MetroclusterDiagnosticsInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// config replication
	ConfigReplication *MetroclusterDiagnosticsInlineConfigReplication `json:"config-replication,omitempty" yaml:"config-replication,omitempty"`

	// connection
	Connection *MetroclusterDiagnosticsInlineConnection `json:"connection,omitempty" yaml:"connection,omitempty"`

	// interface
	Interface *MetroclusterDiagnosticsInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// node
	Node *MetroclusterDiagnosticsInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// volume
	Volume *MetroclusterDiagnosticsInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type MetroclusterDiagnosticsInlineAggregate struct {
	...
	// Read Only: true
	Details []*MetroclusterDiagDetails `json:"details,omitempty" yaml:"details,omitempty"`
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineAggregateInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
...
type MetroclusterDiagnosticsInlineCluster struct {
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineClusterInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
...
type MetroclusterDiagnosticsInlineConfigReplication struct {
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineConfigReplicationInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
...
type MetroclusterDiagnosticsInlineConnection struct {
	...
	// Read Only: true
	Details []*MetroclusterDiagConnectionDetails `json:"details,omitempty" yaml:"details,omitempty"`
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineConnectionInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
...
type MetroclusterDiagnosticsInlineInterface struct {
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineInterfaceInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
...
type MetroclusterDiagnosticsInlineNode struct {
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineNodeInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
...
type MetroclusterDiagnosticsInlineVolume struct {
	...
	// summary
	Summary *MetroclusterDiagnosticsInlineVolumeInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
