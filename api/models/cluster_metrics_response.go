...
type ClusterMetricsResponse struct {
	...
	// links
	Links *ClusterMetricsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cluster metrics response inline records
	ClusterMetricsResponseInlineRecords []*ClusterMetricsResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type ClusterMetricsResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *ClusterMetricsResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *ClusterMetricsResponseInlineRecordsInlineArrayItemInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *ClusterMetricsResponseInlineRecordsInlineArrayItemInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *ClusterMetricsResponseInlineRecordsInlineArrayItemInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
