...
type ApplicationSnapshot struct {
	...
	// links
	Links *ApplicationSnapshotInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// application
	Application *ApplicationSnapshotInlineApplication `json:"application,omitempty" yaml:"application,omitempty"`

	// application snapshot inline components
	// Read Only: true
	ApplicationSnapshotInlineComponents []*ApplicationSnapshotInlineComponentsInlineArrayItem `json:"components,omitempty" yaml:"components,omitempty"`
	...
	// svm
	Svm *ApplicationSnapshotInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type ApplicationSnapshotInlineApplication struct {
	...
	// links
	Links *ApplicationSnapshotInlineApplicationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ApplicationSnapshotInlineComponentsInlineArrayItem struct {
	...
	// links
	Links *ApplicationSnapshotInlineComponentsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
