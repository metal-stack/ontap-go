...
type Job struct {
	...
	// links
	Links *JobInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// error
	Error *JobInlineError `json:"error,omitempty" yaml:"error,omitempty"`
	...
	// node
	Node *JobInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *JobInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type JobInlineSvm struct {
	...
	// links
	Links *JobInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
