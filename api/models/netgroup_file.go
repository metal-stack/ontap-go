...
type NetgroupFile struct {
	...
	// links
	Links *NetgroupFileInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	HashValue *string `json:"hash_value,omitempty" yaml:"hash_value,omitempty"`

	// Hash value of the netgroup-by-host database.
	// Example: e012b7f62e4810936725ed1239018314
	HashValueByHost *string `json:"hash_value_by_host,omitempty" yaml:"hash_value_by_host,omitempty"`

	// svm
	Svm *NetgroupFileInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type NetgroupFileInlineSvm struct {
	...
	// links
	Links *NetgroupFileInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
