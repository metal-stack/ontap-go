...
type ApplicationComponent struct {
	...
	// links
	Links *ApplicationComponentInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// application
	Application *ApplicationComponentInlineApplication `json:"application,omitempty" yaml:"application,omitempty"`

	// application component inline cifs access
	ApplicationComponentInlineCifsAccess []*ApplicationCifsProperties `json:"cifs_access,omitempty" yaml:"cifs_access,omitempty"`

	// application component inline nfs access
	ApplicationComponentInlineNfsAccess []*ApplicationNfsProperties `json:"nfs_access,omitempty" yaml:"nfs_access,omitempty"`

	// application component inline nvme access
	ApplicationComponentInlineNvmeAccess []*ApplicationNvmeAccess `json:"nvme_access,omitempty" yaml:"nvme_access,omitempty"`

	// application component inline protection groups
	ApplicationComponentInlineProtectionGroups []*ApplicationProtectionGroups `json:"protection_groups,omitempty" yaml:"protection_groups,omitempty"`

	// application component inline san access
	ApplicationComponentInlineSanAccess []*ApplicationSanAccess `json:"san_access,omitempty" yaml:"san_access,omitempty"`

	// backing storage
	BackingStorage *ApplicationBackingStorage `json:"backing_storage,omitempty" yaml:"backing_storage,omitempty"`
	...
	// Host management URL
	// Read Only: true
	HostManagementURL *string `json:"host_management_url,omitempty" yaml:"host_management_url,omitempty"`
	...
	// storage service
	StorageService *ApplicationComponentInlineStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`

	// svm
	Svm *ApplicationComponentInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type ApplicationComponentInlineApplication struct {
	...
	// links
	Links *ApplicationComponentInlineApplicationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
