...
type SnaplockLitigationGet struct {
	...
	// links
	Links *SnaplockLitigationGetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	SnaplockLitigationGetInlineOperations []*SnaplockLitigationGetInlineOperationsInlineArrayItem `json:"operations,omitempty" yaml:"operations,omitempty"`

	// svm
	Svm *SnaplockLitigationGetInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *SnaplockLitigationGetInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SnaplockLitigationGetInlineSvm struct {
	...
	// links
	Links *SnaplockLitigationGetInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnaplockLitigationGetInlineVolume struct {
	...
	// links
	Links *SnaplockLitigationGetInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
