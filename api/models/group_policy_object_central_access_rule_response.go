...
type GroupPolicyObjectCentralAccessRuleResponse struct {
	...
	// links
	Links *GroupPolicyObjectCentralAccessRuleResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// group policy object central access rule response inline records
	GroupPolicyObjectCentralAccessRuleResponseInlineRecords []*GroupPolicyObjectCentralAccessRule `json:"records,omitempty" yaml:"records,omitempty"`
