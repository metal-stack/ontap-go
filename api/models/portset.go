...
type Portset struct {
	...
	// links
	Links *PortsetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	// Read Only: true
	PortsetInlineIgroups []*PortsetInlineIgroupsInlineArrayItem `json:"igroups,omitempty" yaml:"igroups,omitempty"`
	...
	//
	PortsetInlineInterfaces []*PortsetInlineInterfacesInlineArrayItem `json:"interfaces,omitempty" yaml:"interfaces,omitempty"`
	...
	// svm
	Svm *PortsetInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type PortsetInlineIgroupsInlineArrayItem struct {
	...
	// links
	Links *PortsetInlineIgroupsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PortsetInlineInterfacesInlineArrayItem struct {
	...
	// links
	Links *PortsetInlineInterfacesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fc
	Fc *PortsetInlineInterfacesInlineArrayItemInlineFc `json:"fc,omitempty" yaml:"fc,omitempty"`

	// ip
	IP *PortsetInlineInterfacesInlineArrayItemInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type PortsetInlineInterfacesInlineArrayItemInlineFc struct {
	...
	// links
	Links *PortsetInlineInterfacesInlineArrayItemInlineFcInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PortsetInlineInterfacesInlineArrayItemInlineIP struct {
	...
	// links
	Links *PortsetInlineInterfacesInlineArrayItemInlineIPInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *PortsetInlineInterfacesInlineArrayItemInlineIPInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type PortsetInlineSvm struct {
	...
	// links
	Links *PortsetInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
