...
type EmsConnectivityError struct {
	...
	// message
	Message *EmsConnectivityErrorInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`

	// node
	Node *EmsConnectivityErrorInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type EmsConnectivityErrorInlineMessage struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsConnectivityErrorMessageArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type EmsConnectivityErrorInlineNode struct {
	...
	// links
	Links *EmsConnectivityErrorInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
