...
type FpolicyEngine struct {
	...
	// buffer size
	BufferSize *FpolicyEngineInlineBufferSize `json:"buffer_size,omitempty" yaml:"buffer_size,omitempty"`

	// certificate
	Certificate *FpolicyEngineInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
	...
	FpolicyEngineInlinePrimaryServers []*string `json:"primary_servers,omitempty" yaml:"primary_servers,omitempty"`

	// fpolicy engine inline secondary servers
	// Example: ["10.132.145.20","10.132.145.21"]
	FpolicyEngineInlineSecondaryServers []*string `json:"secondary_servers,omitempty" yaml:"secondary_servers,omitempty"`
	...
	// Maximum: 10000
	// Minimum: 1
	MaxServerRequests *int64 `json:"max_server_requests,omitempty" yaml:"max_server_requests,omitempty"`
	...
	// Example: PT40S
	RequestAbortTimeout *string `json:"request_abort_timeout,omitempty" yaml:"request_abort_timeout,omitempty"`
	...
	// Example: PT20S
	RequestCancelTimeout *string `json:"request_cancel_timeout,omitempty" yaml:"request_cancel_timeout,omitempty"`

	// resiliency
	Resiliency *FpolicyEngineInlineResiliency `json:"resiliency,omitempty" yaml:"resiliency,omitempty"`
	...
	// Example: PT1M
	ServerProgressTimeout *string `json:"server_progress_timeout,omitempty" yaml:"server_progress_timeout,omitempty"`
	...
	SslOption *string `json:"ssl_option,omitempty" yaml:"ssl_option,omitempty"`
	...
	// Example: PT10S
	StatusRequestInterval *string `json:"status_request_interval,omitempty" yaml:"status_request_interval,omitempty"`

	// svm
	Svm *FpolicyEngineInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type FpolicyEngineInlineBufferSize struct {
	...
	// Maximum: 7.89516e+06
	// Minimum: 0
	RecvBuffer *int64 `json:"recv_buffer,omitempty" yaml:"recv_buffer,omitempty"`

	// Specifies the send buffer size of the connected socket for the FPolicy server. Default value 1MB.
	// Maximum: 7.89516e+06
	// Minimum: 0
	SendBuffer *int64 `json:"send_buffer,omitempty" yaml:"send_buffer,omitempty"`
}
...
type FpolicyEngineInlineResiliency struct {
	...
	//
	// Example: /dir1
	DirectoryPath *string `json:"directory_path,omitempty" yaml:"directory_path,omitempty"`
	...
	//
	// Example: PT3M
	RetentionDuration *string `json:"retention_duration,omitempty" yaml:"retention_duration,omitempty"`
}
