...
type SecurityAssociationResponse struct {
	...
	// links
	Links *SecurityAssociationResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// error
	Error *SecurityAssociationResponseInlineError `json:"error,omitempty" yaml:"error,omitempty"`
	...
	SecurityAssociationResponseInlineRecords []*SecurityAssociationResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
}
...
type SecurityAssociationResponseInlineRecordsInlineArrayItem struct {
	...
	// ike
	Ike *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIke `json:"ike,omitempty" yaml:"ike,omitempty"`

	// ipsec
	Ipsec *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIpsec `json:"ipsec,omitempty" yaml:"ipsec,omitempty"`
	...
	// node
	Node *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIke struct {
	...
	InitiatorSecurityParameterIndex *string `json:"initiator_security_parameter_index,omitempty" yaml:"initiator_security_parameter_index,omitempty"`

	// Indicates whether or not IKE has been initiated by this node.
	IsInitiator *bool `json:"is_initiator,omitempty" yaml:"is_initiator,omitempty"`

	// Responder's security parameter index for the IKE security association.
	ResponderSecurityParameterIndex *string `json:"responder_security_parameter_index,omitempty" yaml:"responder_security_parameter_index,omitempty"`
...
type SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIpsec struct {
	...
	// inbound
	Inbound *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIpsecInlineInbound `json:"inbound,omitempty" yaml:"inbound,omitempty"`

	// outbound
	Outbound *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIpsecInlineOutbound `json:"outbound,omitempty" yaml:"outbound,omitempty"`
...
type SecurityAssociationResponseInlineRecordsInlineArrayItemInlineIpsecInlineInbound struct {
	...
	SecurityParameterIndex *string `json:"security_parameter_index,omitempty" yaml:"security_parameter_index,omitempty"`
}
...
type SecurityAssociationResponseInlineRecordsInlineArrayItemInlineNode struct {
	...
	// links
	Links *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SecurityAssociationResponseInlineRecordsInlineArrayItemInlineSvm struct {
	...
	// links
	Links *SecurityAssociationResponseInlineRecordsInlineArrayItemInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
