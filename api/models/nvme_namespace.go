...
type NvmeNamespace struct {
	...
	// links
	Links *NvmeNamespaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// clone
	Clone *NvmeNamespaceInlineClone `json:"clone,omitempty" yaml:"clone,omitempty"`
	...
	// consistency group
	ConsistencyGroup *NvmeNamespaceInlineConsistencyGroup `json:"consistency_group,omitempty" yaml:"consistency_group,omitempty"`

	// convert
	Convert *NvmeNamespaceInlineConvert `json:"convert,omitempty" yaml:"convert,omitempty"`
	...
	// location
	Location *NvmeNamespaceInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`

	// metric
	Metric *NvmeNamespaceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	ProvisioningOptions *NvmeNamespaceInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`

	// space
	Space *NvmeNamespaceInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// statistics
	Statistics *NvmeNamespaceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// status
	Status *NvmeNamespaceInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`

	// subsystem map
	SubsystemMap *NvmeNamespaceInlineSubsystemMap `json:"subsystem_map,omitempty" yaml:"subsystem_map,omitempty"`

	// svm
	Svm *NvmeNamespaceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type NvmeNamespaceInlineClone struct {
	...
	// source
	Source *NvmeNamespaceInlineCloneInlineSource `json:"source,omitempty" yaml:"source,omitempty"`
}
...
type NvmeNamespaceInlineConsistencyGroup struct {
	...
	// links
	Links *NvmeNamespaceInlineConsistencyGroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeNamespaceInlineConvert struct {
	...
	// lun
	Lun *NvmeNamespaceInlineConvertInlineLun `json:"lun,omitempty" yaml:"lun,omitempty"`
}
...
type NvmeNamespaceInlineLocation struct {
	...
	// node
	Node *NvmeNamespaceInlineLocationInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// qtree
	Qtree *NvmeNamespaceInlineLocationInlineQtree `json:"qtree,omitempty" yaml:"qtree,omitempty"`

	// volume
	Volume *NvmeNamespaceInlineLocationInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type NvmeNamespaceInlineLocationInlineNode struct {
	...
	// links
	Links *NvmeNamespaceInlineLocationInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeNamespaceInlineLocationInlineQtree struct {
	...
	// links
	Links *NvmeNamespaceInlineLocationInlineQtreeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeNamespaceInlineLocationInlineVolume struct {
	...
	// links
	Links *NvmeNamespaceInlineLocationInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeNamespaceInlineMetric struct {
	...
	// links
	Links *NvmeNamespaceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *NvmeNamespaceInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *NvmeNamespaceInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *NvmeNamespaceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type NvmeNamespaceInlineProvisioningOptions struct {
	...
	// qos policy
	QosPolicy *NvmeNamespaceInlineProvisioningOptionsInlineQosPolicy `json:"qos_policy,omitempty" yaml:"qos_policy,omitempty"`
	...
	// storage service
	StorageService *NvmeNamespaceInlineProvisioningOptionsInlineStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`

	// tiering
	Tiering *NvmeNamespaceInlineProvisioningOptionsInlineTiering `json:"tiering,omitempty" yaml:"tiering,omitempty"`
...
type NvmeNamespaceInlineProvisioningOptionsInlineTiering struct {
	...
	// Max Items: 2
	// Min Items: 0
	ObjectStores []*NvmeNamespaceProvisioningOptionsTieringObjectStoresItems0 `json:"object_stores,omitempty" yaml:"object_stores,omitempty"`
...
type NvmeNamespaceInlineSpace struct {
	...
	// guarantee
	Guarantee *NvmeNamespaceInlineSpaceInlineGuarantee `json:"guarantee,omitempty" yaml:"guarantee,omitempty"`
...
type NvmeNamespaceInlineStatistics struct {
	...
	// iops raw
	IopsRaw *NvmeNamespaceInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *NvmeNamespaceInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *NvmeNamespaceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type NvmeNamespaceInlineSubsystemMap struct {
	...
	// links
	Links *NvmeNamespaceInlineSubsystemMapInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// subsystem
	Subsystem *NvmeNamespaceInlineSubsystemMapInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`
}
...
type NvmeNamespaceInlineSubsystemMapInlineSubsystem struct {
	...
	// links
	Links *NvmeNamespaceInlineSubsystemMapInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Optional in POST.
	//
	Hosts []*NvmeNamespaceSubsystemMapSubsystemHostsItems0 `json:"hosts,omitempty" yaml:"hosts,omitempty"`
...
type NvmeNamespaceSubsystemMapSubsystemHostsItems0 struct {
	...
	// tls
	TLS *NvmeNamespaceSubsystemMapSubsystemHostsItems0TLS `json:"tls,omitempty" yaml:"tls,omitempty"`
}
...
type NvmeNamespaceInlineSvm struct {
	...
	// links
	Links *NvmeNamespaceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
