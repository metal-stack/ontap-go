...
type UnixGroupUsersResponse struct {
	...
	// links
	Links *UnixGroupUsersResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	UnixGroupUsersResponseInlineRecords []*UnixGroupUsers `json:"records,omitempty" yaml:"records,omitempty"`
}
