...
type ReferenceFileMoveFile struct {
	...
	// svm
	Svm *ReferenceFileMoveFileInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *ReferenceFileMoveFileInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type ReferenceFileMoveFileInlineSvm struct {
	...
	// links
	Links *ReferenceFileMoveFileInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ReferenceFileMoveFileInlineVolume struct {
	...
	// links
	Links *ReferenceFileMoveFileInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
