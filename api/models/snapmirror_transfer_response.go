...
type SnapmirrorTransferResponse struct {
	...
	// links
	Links *SnapmirrorTransferResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnapmirrorTransferResponseInlineRecords []*SnapmirrorTransfer `json:"records,omitempty" yaml:"records,omitempty"`
}
