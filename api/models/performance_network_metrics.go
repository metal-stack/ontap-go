...
type PerformanceNetworkMetrics struct {
	...
	// links
	Links *PerformanceNetworkMetricsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *PerformanceNetworkMetricsInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
