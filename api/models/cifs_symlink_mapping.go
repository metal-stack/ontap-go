...
type CifsSymlinkMapping struct {
	...
	// links
	Links *CifsSymlinkMappingInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// svm
	Svm *CifsSymlinkMappingInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// target
	Target *CifsTarget `json:"target,omitempty" yaml:"target,omitempty"`
...
type CifsSymlinkMappingInlineSvm struct {
	...
	// links
	Links *CifsSymlinkMappingInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
