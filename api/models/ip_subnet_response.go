...
type IPSubnetResponse struct {
	...
	// links
	Links *IPSubnetResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip subnet response inline records
	IPSubnetResponseInlineRecords []*IPSubnet `json:"records,omitempty" yaml:"records,omitempty"`
