...
type FcPort struct {
	...
	// links
	Links *FcPortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// fabric
	Fabric *FcPortInlineFabric `json:"fabric,omitempty" yaml:"fabric,omitempty"`
	...
	// metric
	Metric *FcPortInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// node
	Node *FcPortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// The physical network protocol of the FC port.
	//
	// Read Only: true
	// Enum: ["fibre_channel","ethernet"]
	PhysicalProtocol *string `json:"physical_protocol,omitempty" yaml:"physical_protocol,omitempty"`

	// speed
	Speed *FcPortInlineSpeed `json:"speed,omitempty" yaml:"speed,omitempty"`
	...
	// statistics
	Statistics *FcPortInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// The network protocols supported by the FC port.
	//
	// Read Only: true
	SupportedProtocols []*string `json:"supported_protocols,omitempty" yaml:"supported_protocols,omitempty"`

	// transceiver
	Transceiver *FcPortInlineTransceiver `json:"transceiver,omitempty" yaml:"transceiver,omitempty"`
...
type FcPortInlineFabric struct {
	...
	// Example: 16
	// Read Only: true
	ConnectedSpeed *int64 `json:"connected_speed,omitempty" yaml:"connected_speed,omitempty"`
	...
	// Read Only: true
	SwitchPort *string `json:"switch_port,omitempty" yaml:"switch_port,omitempty"`
}
...
type FcPortInlineMetric struct {
	...
	// links
	Links *FcPortInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *FcPortInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *FcPortInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *FcPortInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type FcPortInlineNode struct {
	...
	// links
	Links *FcPortInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FcPortInlineStatistics struct {
	...
	// iops raw
	IopsRaw *FcPortInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *FcPortInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *FcPortInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type FcPortInlineTransceiver struct {
	...
	//
	// Read Only: true
	Capabilities []*int64 `json:"capabilities,omitempty" yaml:"capabilities,omitempty"`
