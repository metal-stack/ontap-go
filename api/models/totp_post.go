...
type TotpPost struct {
	...
	// links
	Links *TotpPostInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// owner
	Owner *TotpPostInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
	...
	// Example: 17503785
	// Read Only: true
	TotpPostInlineEmergencyCodes []*string `json:"emergency_codes,omitempty" yaml:"emergency_codes,omitempty"`

	// TOTP profile verification code for a user.
	// Read Only: true
	VerificationCode *string `json:"verification_code,omitempty" yaml:"verification_code,omitempty"`
}
...
type TotpPostInlineOwner struct {
	...
	// links
	Links *TotpPostInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
