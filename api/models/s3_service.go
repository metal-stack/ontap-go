...
type S3Service struct {
	...
	// certificate
	Certificate *S3ServiceInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
	...
	S3ServiceInlineBuckets []*S3Bucket `json:"buckets,omitempty" yaml:"buckets,omitempty"`

	// This field cannot be specified in a PATCH method.
	S3ServiceInlineUsers []*S3User `json:"users,omitempty" yaml:"users,omitempty"`
	...
	// statistics
	Statistics *S3ServiceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// svm
	Svm *S3ServiceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type S3ServiceInlineCertificate struct {
	...
	// links
	Links *S3ServiceInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3ServiceInlineMetric struct {
	...
	// links
	Links *S3ServiceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *S3ServiceInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *S3ServiceInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *S3ServiceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type S3ServiceInlineStatistics struct {
	...
	// iops raw
	IopsRaw *S3ServiceInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *S3ServiceInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *S3ServiceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type S3ServiceInlineSvm struct {
	...
	// links
	Links *S3ServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
