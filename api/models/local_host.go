...
type LocalHost struct {
	...
	// links
	Links *LocalHostInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	LocalHostInlineAliases []*string `json:"aliases,omitempty" yaml:"aliases,omitempty"`

	// owner
	Owner *LocalHostInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
...
type LocalHostInlineOwner struct {
	...
	// links
	Links *LocalHostInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
