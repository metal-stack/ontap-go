...
type PortsetInterfaceNoRecords struct {
	...
	// links
	Links *PortsetInterfaceNoRecordsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fc
	Fc *PortsetInterfaceNoRecordsInlineFc `json:"fc,omitempty" yaml:"fc,omitempty"`

	// ip
	IP *PortsetInterfaceNoRecordsInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type PortsetInterfaceNoRecordsInlineFc struct {
	...
	// links
	Links *PortsetInterfaceNoRecordsInlineFcInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PortsetInterfaceNoRecordsInlineIP struct {
	...
	// links
	Links *PortsetInterfaceNoRecordsInlineIPInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *PortsetInterfaceNoRecordsInlineIPInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
