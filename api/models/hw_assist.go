...
type HwAssist struct {
	...
	// status
	Status *HwAssistInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
}
...
type HwAssistInlineStatus struct {
	...
	// local
	Local *HwAssistInlineStatusInlineLocal `json:"local,omitempty" yaml:"local,omitempty"`

	// partner
	Partner *HwAssistInlineStatusInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
}
