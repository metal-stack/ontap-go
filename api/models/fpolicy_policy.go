...
type FpolicyPolicy struct {
	...
	//
	AllowPrivilegedAccess *bool `json:"allow_privileged_access,omitempty" yaml:"allow_privileged_access,omitempty"`
	...
	// engine
	Engine *FpolicyEngineReference `json:"engine,omitempty" yaml:"engine,omitempty"`

	// fpolicy policy inline events
	// Example: ["event_cifs","event_open"]
	FpolicyPolicyInlineEvents []*FpolicyEventReference `json:"events,omitempty" yaml:"events,omitempty"`
	...
	//
	PassthroughRead *bool `json:"passthrough_read,omitempty" yaml:"passthrough_read,omitempty"`

	// Specifies the persistent storage name. This can then be used
	// to enable persistent mode for FPolicy events.
	//
	// Example: ps1
	PersistentStore *string `json:"persistent_store,omitempty" yaml:"persistent_store,omitempty"`
	...
	PrivilegedUser *string `json:"privileged_user,omitempty" yaml:"privileged_user,omitempty"`

	// scope
	Scope *FpolicyPolicyInlineScope `json:"scope,omitempty" yaml:"scope,omitempty"`

	// svm
	Svm *FpolicyPolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type FpolicyPolicyInlineScope struct {
	...
	//
	CheckExtensionsOnDirectories *bool `json:"check_extensions_on_directories,omitempty" yaml:"check_extensions_on_directories,omitempty"`

	// exclude export policies
	ExcludeExportPolicies []*string `json:"exclude_export_policies,omitempty" yaml:"exclude_export_policies,omitempty"`

	// exclude extension
	ExcludeExtension []*string `json:"exclude_extension,omitempty" yaml:"exclude_extension,omitempty"`

	// exclude shares
	ExcludeShares []*string `json:"exclude_shares,omitempty" yaml:"exclude_shares,omitempty"`

	// exclude volumes
	// Example: ["vol1","vol_svm1","*"]
	ExcludeVolumes []*string `json:"exclude_volumes,omitempty" yaml:"exclude_volumes,omitempty"`

	// include export policies
	IncludeExportPolicies []*string `json:"include_export_policies,omitempty" yaml:"include_export_policies,omitempty"`

	// include extension
	IncludeExtension []*string `json:"include_extension,omitempty" yaml:"include_extension,omitempty"`

	// include shares
	// Example: ["sh1","share_cifs"]
	IncludeShares []*string `json:"include_shares,omitempty" yaml:"include_shares,omitempty"`

	// include volumes
	// Example: ["vol1","vol_svm1"]
	IncludeVolumes []*string `json:"include_volumes,omitempty" yaml:"include_volumes,omitempty"`
	...
	//
	ObjectMonitoringWithNoExtension *bool `json:"object_monitoring_with_no_extension,omitempty" yaml:"object_monitoring_with_no_extension,omitempty"`
}
