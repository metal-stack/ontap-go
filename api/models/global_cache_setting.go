...
type GlobalCacheSetting struct {
	...
	// links
	Links *GlobalCacheSettingInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Specifies the time interval, in ISO 8601 format after which a periodic cache eviction happens. Default is 4 hours.
	//
	// Example: PT2H
	EvictionTimeInterval *string `json:"eviction_time_interval,omitempty" yaml:"eviction_time_interval,omitempty"`

	// Indicates whether or not a node is allowed to fetch the data from a remote node.
	//
	RemoteFetchEnabled *bool `json:"remote_fetch_enabled,omitempty" yaml:"remote_fetch_enabled,omitempty"`
}
