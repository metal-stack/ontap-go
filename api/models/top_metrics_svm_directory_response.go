...
type TopMetricsSvmDirectoryResponse struct {
	...
	// links
	Links *TopMetricsSvmDirectoryResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// notice
	Notice *TopMetricsSvmDirectoryResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsSvmDirectoryResponseInlineExcludedVolumes []*TopMetricsSvmDirectoryExcludedVolume `json:"excluded_volumes,omitempty" yaml:"excluded_volumes,omitempty"`

	// top metrics svm directory response inline records
	TopMetricsSvmDirectoryResponseInlineRecords []*TopMetricsSvmDirectory `json:"records,omitempty" yaml:"records,omitempty"`
}
