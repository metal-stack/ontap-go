...
type CounterTable struct {
	...
	// links
	Links *CounterTableInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Array of counter schema definitions.
	CounterTableInlineCounterSchemas []*CounterSchema `json:"counter_schemas,omitempty" yaml:"counter_schemas,omitempty"`
