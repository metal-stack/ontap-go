...
type IscsiSessionResponse struct {
	...
	// links
	Links *IscsiSessionResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// iscsi session response inline records
	IscsiSessionResponseInlineRecords []*IscsiSession `json:"records,omitempty" yaml:"records,omitempty"`
