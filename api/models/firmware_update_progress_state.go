...
type FirmwareUpdateProgressState struct {
	...
	// worker node
	WorkerNode *FirmwareUpdateProgressStateInlineWorkerNode `json:"worker_node,omitempty" yaml:"worker_node,omitempty"`
}
...
type FirmwareUpdateProgressStateInlineWorkerNode struct {
	...
	// links
	Links *FirmwareUpdateProgressStateInlineWorkerNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
