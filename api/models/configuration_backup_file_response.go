...
type ConfigurationBackupFileResponse struct {
	...
	// links
	Links *ConfigurationBackupFileResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// configuration backup file response inline records
	ConfigurationBackupFileResponseInlineRecords []*ConfigurationBackupFile `json:"records,omitempty" yaml:"records,omitempty"`
