...
type IPInterfaceResponse struct {
	...
	// links
	Links *IPInterfaceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip interface response inline records
	IPInterfaceResponseInlineRecords []*IPInterface `json:"records,omitempty" yaml:"records,omitempty"`
	...
	// recommend
	Recommend *IPInterfaceResponseInlineRecommend `json:"recommend,omitempty" yaml:"recommend,omitempty"`
}
...
type IPInterfaceResponseInlineRecommend struct {
	...
	//
	// Read Only: true
	Messages []IPInterfaceRecommendMessage `json:"messages,omitempty" yaml:"messages,omitempty"`
}
