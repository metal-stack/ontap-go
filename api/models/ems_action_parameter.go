...
type EmsActionParameter struct {
	...
	// description
	Description *EmsActionParameterInlineDescription `json:"description,omitempty" yaml:"description,omitempty"`

	// Specifies the possible values of the parameter.
	// Example: ["value-1","value-2"]
	// Read Only: true
	EmsActionParameterInlineEnum []*string `json:"enum,omitempty" yaml:"enum,omitempty"`
	...
	// Read Only: true
	EmsActionParameterInlineItems interface{} `json:"items,omitempty" yaml:"items,omitempty"`
	...
	// Example: ["end-time"]
	// Read Only: true
	EmsActionParameterInlineOptional []*string `json:"optional,omitempty" yaml:"optional,omitempty"`
	...
	// Read Only: true
	EmsActionParameterInlineProperties interface{} `json:"properties,omitempty" yaml:"properties,omitempty"`

	// Specifies the current value(s) for the parameter encoded in the appropriate JSON type.
	// Read Only: true
	EmsActionParameterInlineValue interface{} `json:"value,omitempty" yaml:"value,omitempty"`
	...
	// help
	Help *EmsActionParameterInlineHelp `json:"help,omitempty" yaml:"help,omitempty"`
	...
	// title
	Title *EmsActionParameterInlineTitle `json:"title,omitempty" yaml:"title,omitempty"`
	...
	ValidationErrorMessage *EmsActionParameterInlineValidationErrorMessage `json:"validation_error_message,omitempty" yaml:"validation_error_message,omitempty"`
}
...
type EmsActionParameterInlineDescription struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsActionParameterDescriptionArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type EmsActionParameterInlineHelp struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsActionParameterHelpArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type EmsActionParameterInlineTitle struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsActionParameterTitleArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type EmsActionParameterInlineValidationErrorMessage struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsActionParameterValidationErrorMessageArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
