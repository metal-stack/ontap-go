...
type EmsDestination struct {
	...
	// links
	Links *EmsDestinationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access control role
	AccessControlRole *EmsDestinationInlineAccessControlRole `json:"access_control_role,omitempty" yaml:"access_control_role,omitempty"`

	// certificate
	Certificate *EmsDestinationInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`

	// connectivity
	Connectivity *EmsDestinationInlineConnectivity `json:"connectivity,omitempty" yaml:"connectivity,omitempty"`
	...
	EmsDestinationInlineFilters []*EmsDestinationInlineFiltersInlineArrayItem `json:"filters,omitempty" yaml:"filters,omitempty"`
	...
	// syslog
	Syslog *EmsDestinationInlineSyslog `json:"syslog,omitempty" yaml:"syslog,omitempty"`
...
type EmsDestinationInlineAccessControlRole struct {
	...
	// links
	Links *EmsDestinationInlineAccessControlRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationInlineCertificate struct {
	...
	// links
	Links *EmsDestinationInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationInlineConnectivity struct {
	...
	// Read Only: true
	Errors []*EmsDestinationConnectivityErrorsItems0 `json:"errors,omitempty" yaml:"errors,omitempty"`
...
type EmsDestinationConnectivityErrorsItems0 struct {
	...
	// message
	Message *EmsDestinationConnectivityErrorsItems0Message `json:"message,omitempty" yaml:"message,omitempty"`

	// node
	Node *EmsDestinationConnectivityErrorsItems0Node `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type EmsDestinationConnectivityErrorsItems0Message struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsDestinationConnectivityErrorsItems0MessageArgumentsItems0 `json:"arguments" yaml:"arguments"`
...
type EmsDestinationConnectivityErrorsItems0Node struct {
	...
	// links
	Links *EmsDestinationConnectivityErrorsItems0NodeLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationInlineFiltersInlineArrayItem struct {
	...
	// links
	Links *EmsDestinationInlineFiltersInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationInlineSyslog struct {
	...
	// format
	Format *EmsDestinationInlineSyslogInlineFormat `json:"format,omitempty" yaml:"format,omitempty"`
