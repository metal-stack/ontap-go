...
type LdapSchema struct {
	...
	// links
	Links *LdapSchemaInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: true
	// Read Only: true
	GlobalSchema *bool `json:"global_schema,omitempty" yaml:"global_schema,omitempty"`
	...
	// name mapping
	NameMapping *LdapSchemaNameMapping `json:"name_mapping,omitempty" yaml:"name_mapping,omitempty"`

	// owner
	Owner *LdapSchemaInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`

	// rfc2307
	Rfc2307 *Rfc2307 `json:"rfc2307,omitempty" yaml:"rfc2307,omitempty"`

	// rfc2307bis
	Rfc2307bis *Rfc2307bis `json:"rfc2307bis,omitempty" yaml:"rfc2307bis,omitempty"`
	...
	// template
	Template *LdapSchemaInlineTemplate `json:"template,omitempty" yaml:"template,omitempty"`
}
...
type LdapSchemaInlineOwner struct {
	...
	// links
	Links *LdapSchemaInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LdapSchemaInlineTemplate struct {
	...
	// links
	Links *LdapSchemaInlineTemplateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
