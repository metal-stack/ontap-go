...
type S3BucketSvm struct {
	...
	AuditEventSelector *S3BucketSvmInlineAuditEventSelector `json:"audit_event_selector,omitempty" yaml:"audit_event_selector,omitempty"`
	...
	// cors
	Cors *S3BucketSvmInlineCors `json:"cors,omitempty" yaml:"cors,omitempty"`

	// encryption
	Encryption *S3BucketSvmInlineEncryption `json:"encryption,omitempty" yaml:"encryption,omitempty"`

	// lifecycle management
	LifecycleManagement *S3BucketSvmInlineLifecycleManagement `json:"lifecycle_management,omitempty" yaml:"lifecycle_management,omitempty"`

	// Specifies the bucket logical used size up to this point. This field cannot be set using the PATCH method.
	// Read Only: true
	LogicalUsedSize *int64 `json:"logical_used_size,omitempty" yaml:"logical_used_size,omitempty"`
	...
	// policy
	Policy *S3BucketSvmInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`

	// protection status
	ProtectionStatus *S3BucketSvmInlineProtectionStatus `json:"protection_status,omitempty" yaml:"protection_status,omitempty"`

	// qos policy
	QosPolicy *S3BucketSvmInlineQosPolicy `json:"qos_policy,omitempty" yaml:"qos_policy,omitempty"`

	// retention
	Retention *S3BucketSvmInlineRetention `json:"retention,omitempty" yaml:"retention,omitempty"`
	...
	S3BucketSvmInlineAggregates []*S3BucketSvmInlineAggregatesInlineArrayItem `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`
	...
	// snapshot policy
	SnapshotPolicy *S3BucketSvmInlineSnapshotPolicy `json:"snapshot_policy,omitempty" yaml:"snapshot_policy,omitempty"`
	...
	StorageServiceLevel *string `json:"storage_service_level,omitempty" yaml:"storage_service_level,omitempty"`

	// svm
	Svm *S3BucketSvmInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume
	Volume *S3BucketSvmInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type S3BucketSvmInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *S3BucketSvmInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmInlineCors struct {
	...
	Rules []*S3BucketSvmCorsRulesItems0 `json:"rules,omitempty" yaml:"rules,omitempty"`
}
...
type S3BucketSvmCorsRulesItems0 struct {
	...
	// links
	Links *S3BucketSvmCorsRulesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmInlineLifecycleManagement struct {
	...
	Rules []*S3BucketSvmLifecycleManagementRulesItems0 `json:"rules,omitempty" yaml:"rules,omitempty"`
}
...
type S3BucketSvmLifecycleManagementRulesItems0 struct {
	...
	// links
	Links *S3BucketSvmLifecycleManagementRulesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`

	// abort incomplete multipart upload
	AbortIncompleteMultipartUpload *S3BucketSvmLifecycleManagementRulesItems0AbortIncompleteMultipartUpload `json:"abort_incomplete_multipart_upload,omitempty" yaml:"abort_incomplete_multipart_upload,omitempty"`
	...
	// expiration
	Expiration *S3BucketSvmLifecycleManagementRulesItems0Expiration `json:"expiration,omitempty" yaml:"expiration,omitempty"`
	...
	NonCurrentVersionExpiration *S3BucketSvmLifecycleManagementRulesItems0NonCurrentVersionExpiration `json:"non_current_version_expiration,omitempty" yaml:"non_current_version_expiration,omitempty"`

	// object filter
	ObjectFilter *S3BucketSvmLifecycleManagementRulesItems0ObjectFilter `json:"object_filter,omitempty" yaml:"object_filter,omitempty"`

	// svm
	Svm *S3BucketSvmLifecycleManagementRulesItems0Svm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type S3BucketSvmLifecycleManagementRulesItems0AbortIncompleteMultipartUpload struct {
	...
	// links
	Links *S3BucketSvmLifecycleManagementRulesItems0AbortIncompleteMultipartUploadLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Number of days of initiation after which uploads can be aborted.
	AfterInitiationDays *int64 `json:"after_initiation_days,omitempty" yaml:"after_initiation_days,omitempty"`
}
...
type S3BucketSvmLifecycleManagementRulesItems0Expiration struct {
	...
	// links
	Links *S3BucketSvmLifecycleManagementRulesItems0ExpirationLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmLifecycleManagementRulesItems0NonCurrentVersionExpiration struct {
	...
	// links
	Links *S3BucketSvmLifecycleManagementRulesItems0NonCurrentVersionExpirationLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Number of latest non-current versions to be retained.
	NewNonCurrentVersions *int64 `json:"new_non_current_versions,omitempty" yaml:"new_non_current_versions,omitempty"`

	// Number of days after which non-current versions can be deleted.
	NonCurrentDays *int64 `json:"non_current_days,omitempty" yaml:"non_current_days,omitempty"`
}
...
type S3BucketSvmLifecycleManagementRulesItems0ObjectFilter struct {
	...
	// links
	Links *S3BucketSvmLifecycleManagementRulesItems0ObjectFilterLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmLifecycleManagementRulesItems0Svm struct {
	...
	// links
	Links *S3BucketSvmLifecycleManagementRulesItems0SvmLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmInlinePolicy struct {
	...
	Statements []*S3BucketPolicyStatement `json:"statements,omitempty" yaml:"statements,omitempty"`
}
...
type S3BucketSvmInlineProtectionStatus struct {
	...
	// destination
	Destination *S3BucketSvmInlineProtectionStatusInlineDestination `json:"destination,omitempty" yaml:"destination,omitempty"`
...
type S3BucketSvmInlineProtectionStatusInlineDestination struct {
	...
	// Read Only: true
	IsExternalCloud *bool `json:"is_external_cloud,omitempty" yaml:"is_external_cloud,omitempty"`
...
type S3BucketSvmInlineQosPolicy struct {
	...
	// links
	Links *S3BucketSvmInlineQosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmInlineRetention struct {
	...
	// Example: P10Y
	DefaultPeriod *string `json:"default_period,omitempty" yaml:"default_period,omitempty"`
...
type S3BucketSvmInlineSvm struct {
	...
	// links
	Links *S3BucketSvmInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketSvmInlineVolume struct {
	...
	// links
	Links *S3BucketSvmInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
