...
type CertificateSigningRequest struct {
	...
	// links
	Links *CertificateSigningRequestInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ExtendedKeyUsages []*string `json:"extended_key_usages,omitempty" yaml:"extended_key_usages,omitempty"`

	// Private key generated for the CSR.
	// Read Only: true
	GeneratedPrivateKey *string `json:"generated_private_key,omitempty" yaml:"generated_private_key,omitempty"`
	...
	// Enum: [112,128,192]
	SecurityStrength *int64 `json:"security_strength,omitempty" yaml:"security_strength,omitempty"`

	// subject alternatives
	SubjectAlternatives *CertificateSigningRequestInlineSubjectAlternatives `json:"subject_alternatives,omitempty" yaml:"subject_alternatives,omitempty"`
