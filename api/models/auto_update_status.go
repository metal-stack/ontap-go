...
type AutoUpdateStatus struct {
	...
	// links
	Links *AutoUpdateStatusInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: Firmware
	// Read Only: true
	ContentCategory *string `json:"content_category,omitempty" yaml:"content_category,omitempty"`
	...
	// Read Only: true
	// Format: date-time
	LastStateChangeTime *strfmt.DateTime `json:"last_state_change_time,omitempty" yaml:"last_state_change_time,omitempty"`
	...
	// Example: PT1H45M13S
	// Read Only: true
	RemainingTime *string `json:"remaining_time,omitempty" yaml:"remaining_time,omitempty"`
	...
	// Format: date-time
	ScheduleTime *strfmt.DateTime `json:"schedule_time,omitempty" yaml:"schedule_time,omitempty"`

	// The date and time at which the update request is currently scheduled for.
	// Example: 2020-12-05 09:12:23
	// Read Only: true
	// Format: date-time
	ScheduledTime *strfmt.DateTime `json:"scheduled_time,omitempty" yaml:"scheduled_time,omitempty"`
	...
	// status
	Status *AutoUpdateStatusInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
...
type AutoUpdateStatusInlineLinks struct {
	...
	// self
	Self *AutoUpdateStatusInlineLinksInlineSelf `json:"self,omitempty" yaml:"self,omitempty"`
}
