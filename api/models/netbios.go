...
type Netbios struct {
	...
	NameRegistrationType *string `json:"name_registration_type,omitempty" yaml:"name_registration_type,omitempty"`

	// netbios inline interfaces
	NetbiosInlineInterfaces []*string `json:"interfaces,omitempty" yaml:"interfaces,omitempty"`

	// List of WINS
	NetbiosInlineWinsServers []*Server `json:"wins_servers,omitempty" yaml:"wins_servers,omitempty"`

	// node
	Node *NetbiosInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *NetbiosInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// Specifies the registration time left with WINS, in minutes.
	// Read Only: true
	TimeLeft *int64 `json:"time_left,omitempty" yaml:"time_left,omitempty"`
}
...
type NetbiosInlineNode struct {
	...
	// links
	Links *NetbiosInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NetbiosInlineSvm struct {
	...
	// links
	Links *NetbiosInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
