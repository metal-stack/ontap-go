...
type LicensePackageResponse struct {
	...
	// links
	Links *LicensePackageResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// license package response inline records
	LicensePackageResponseInlineRecords []*LicensePackageResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type LicensePackageResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *LicensePackageResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// entitlement
	Entitlement *LicensePackageResponseInlineRecordsInlineArrayItemInlineEntitlement `json:"entitlement,omitempty" yaml:"entitlement,omitempty"`
	...
	// Read Only: true
	Licenses []*LicensePackageResponseRecordsItems0LicensesItems0 `json:"licenses" yaml:"licenses"`
...
type LicensePackageResponseRecordsItems0LicensesItems0 struct {
	...
	// capacity
	Capacity *LicensePackageResponseRecordsItems0LicensesItems0Capacity `json:"capacity,omitempty" yaml:"capacity,omitempty"`

	// compliance
	Compliance *LicensePackageResponseRecordsItems0LicensesItems0Compliance `json:"compliance,omitempty" yaml:"compliance,omitempty"`
