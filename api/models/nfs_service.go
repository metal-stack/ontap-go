...
type NfsService struct {
	...
	// links
	Links *NfsServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access cache config
	AccessCacheConfig *NfsServiceInlineAccessCacheConfig `json:"access_cache_config,omitempty" yaml:"access_cache_config,omitempty"`

	// Specifies whether or not extended groups support over AUTH_SYS is enabled.
	AuthSysExtendedGroupsEnabled *bool `json:"auth_sys_extended_groups_enabled,omitempty" yaml:"auth_sys_extended_groups_enabled,omitempty"`

	// credential cache
	CredentialCache *NfsServiceInlineCredentialCache `json:"credential_cache,omitempty" yaml:"credential_cache,omitempty"`
	...
	// exports
	Exports *NfsServiceInlineExports `json:"exports,omitempty" yaml:"exports,omitempty"`

	// Specifies the maximum auxiliary groups supported over AUTH_SYS and RPCSEC_GSS.
	// Example: 32
	// Maximum: 1024
	// Minimum: 32
	ExtendedGroupsLimit *int64 `json:"extended_groups_limit,omitempty" yaml:"extended_groups_limit,omitempty"`
	...
	// metric
	Metric *NfsServiceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// protocol
	Protocol *NfsServiceInlineProtocol `json:"protocol,omitempty" yaml:"protocol,omitempty"`

	// protocol access rules
	ProtocolAccessRules *NfsServiceInlineProtocolAccessRules `json:"protocol_access_rules,omitempty" yaml:"protocol_access_rules,omitempty"`

	// qtree
	Qtree *NfsServiceInlineQtree `json:"qtree,omitempty" yaml:"qtree,omitempty"`

	// root
	Root *NfsServiceInlineRoot `json:"root,omitempty" yaml:"root,omitempty"`

	// Specifies whether or not the remote quota feature is enabled.
	RquotaEnabled *bool `json:"rquota_enabled,omitempty" yaml:"rquota_enabled,omitempty"`

	// security
	Security *NfsServiceInlineSecurity `json:"security,omitempty" yaml:"security,omitempty"`

	// Specifies whether or not the showmount feature is enabled.
	ShowmountEnabled *bool `json:"showmount_enabled,omitempty" yaml:"showmount_enabled,omitempty"`
	...
	// statistics
	Statistics *NfsServiceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// svm
	Svm *NfsServiceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// transport
	Transport *NfsServiceInlineTransport `json:"transport,omitempty" yaml:"transport,omitempty"`

	// Specifies whether or not the VMware vstorage feature is enabled.
	VstorageEnabled *bool `json:"vstorage_enabled,omitempty" yaml:"vstorage_enabled,omitempty"`

	// windows
	Windows *NfsServiceInlineWindows `json:"windows,omitempty" yaml:"windows,omitempty"`
}
...
type NfsServiceInlineAccessCacheConfig struct {
	...
	// Example: 3600
	HarvestTimeout *int64 `json:"harvest_timeout,omitempty" yaml:"harvest_timeout,omitempty"`

	// Specifies whether Dns TTL is enabled.
	IsDNSTTLEnabled *bool `json:"isDnsTTLEnabled,omitempty" yaml:"isDnsTTLEnabled,omitempty"`

	// Specifies the time to live value for entries for which a failure was encountered, in seconds.
	// Example: 1
	TTLFailure *int64 `json:"ttl_failure,omitempty" yaml:"ttl_failure,omitempty"`

	// Specifies the time to live value of a negative access cache, in seconds.
	// Example: 30
	TTLNegative *int64 `json:"ttl_negative,omitempty" yaml:"ttl_negative,omitempty"`

	// Specifies the time to live value of a positive access cache, in seconds.
	// Example: 60
	TTLPositive *int64 `json:"ttl_positive,omitempty" yaml:"ttl_positive,omitempty"`
}
...
type NfsServiceInlineCredentialCache struct {
	...
	// Maximum: 6.048e+08
	// Minimum: 60000
	PositiveTTL *int64 `json:"positive_ttl,omitempty" yaml:"positive_ttl,omitempty"`

	// Specifies the age in milliseconds, of the cached entries during a transient error situation.
	// Example: 72000
	// Maximum: 300000
	// Minimum: 30000
	TransientErrorTTL *int64 `json:"transient_error_ttl,omitempty" yaml:"transient_error_ttl,omitempty"`
}
...
type NfsServiceInlineExports struct {
	...
	// Enum: ["tcp","udp"]
	NameServiceLookupProtocol *string `json:"name_service_lookup_protocol,omitempty" yaml:"name_service_lookup_protocol,omitempty"`
	...
	NetgroupTrustAnyNsswitchNoMatch *bool `json:"netgroup_trust_any_nsswitch_no_match,omitempty" yaml:"netgroup_trust_any_nsswitch_no_match,omitempty"`
}
...
type NfsServiceInlineMetric struct {
	...
	// v3
	V3 *NfsServiceInlineMetricInlineV3 `json:"v3,omitempty" yaml:"v3,omitempty"`

	// v4
	V4 *NfsServiceInlineMetricInlineV4 `json:"v4,omitempty" yaml:"v4,omitempty"`

	// v41
	V41 *NfsServiceInlineMetricInlineV41 `json:"v41,omitempty" yaml:"v41,omitempty"`
}
...
type NfsServiceInlineMetricInlineV3 struct {
	...
	// links
	Links *NfsServiceInlineMetricInlineV3InlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *NfsServiceInlineMetricInlineV3InlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *NfsServiceInlineMetricInlineV3InlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *NfsServiceInlineMetricInlineV3InlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type NfsServiceInlineMetricInlineV4 struct {
	...
	// links
	Links *NfsServiceInlineMetricInlineV4InlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *NfsServiceInlineMetricInlineV4InlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *NfsServiceInlineMetricInlineV4InlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *NfsServiceInlineMetricInlineV4InlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type NfsServiceInlineMetricInlineV41 struct {
	...
	// links
	Links *NfsServiceInlineMetricInlineV41InlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *NfsServiceInlineMetricInlineV41InlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *NfsServiceInlineMetricInlineV41InlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *NfsServiceInlineMetricInlineV41InlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type NfsServiceInlineProtocol struct {
	...
	V364bitIdentifiersEnabled *bool `json:"v3_64bit_identifiers_enabled,omitempty" yaml:"v3_64bit_identifiers_enabled,omitempty"`

	// Specifies whether NFSv3 protocol is enabled.
	V3Enabled *bool `json:"v3_enabled,omitempty" yaml:"v3_enabled,omitempty"`

	// v3 features
	V3Features *NfsServiceInlineProtocolInlineV3Features `json:"v3_features,omitempty" yaml:"v3_features,omitempty"`

	// Specifies whether NFSv4.0 protocol is enabled.
	V40Enabled *bool `json:"v40_enabled,omitempty" yaml:"v40_enabled,omitempty"`

	// v40 features
	V40Features *NfsServiceInlineProtocolInlineV40Features `json:"v40_features,omitempty" yaml:"v40_features,omitempty"`

	// Specifies whether NFSv4.1 or later protocol is enabled.
	V41Enabled *bool `json:"v41_enabled,omitempty" yaml:"v41_enabled,omitempty"`

	// v41 features
	V41Features *NfsServiceInlineProtocolInlineV41Features `json:"v41_features,omitempty" yaml:"v41_features,omitempty"`

	// v42 features
	V42Features *NfsServiceInlineProtocolInlineV42Features `json:"v42_features,omitempty" yaml:"v42_features,omitempty"`

	// Specifies whether 64-bit support for NFSv4.x FSIDs and file IDs is enabled.
	V464bitIdentifiersEnabled *bool `json:"v4_64bit_identifiers_enabled,omitempty" yaml:"v4_64bit_identifiers_enabled,omitempty"`

	// Specifies whether the change in FSID when NFSv4 clients traverse file systems is displayed.
	V4FsidChange *bool `json:"v4_fsid_change,omitempty" yaml:"v4_fsid_change,omitempty"`

	// Specifies the grace period for clients to reclaim file locks after a server failure.
	V4GraceSeconds *int64 `json:"v4_grace_seconds,omitempty" yaml:"v4_grace_seconds,omitempty"`

	// Specifies the domain portion of the string form of user and group
	// names as defined by the NFSv4 protocol.
	//
	V4IDDomain *string `json:"v4_id_domain,omitempty" yaml:"v4_id_domain,omitempty"`
	...
	V4LeaseSeconds *int64 `json:"v4_lease_seconds,omitempty" yaml:"v4_lease_seconds,omitempty"`

	// Specifies the number of bytes of the reply that is cached in each NFSv4.x session slot.
	// Maximum: 4096
	// Minimum: 512
	V4SessionSlotReplyCacheSize *int64 `json:"v4_session_slot_reply_cache_size,omitempty" yaml:"v4_session_slot_reply_cache_size,omitempty"`

	// Specifies the number of entries in NFSv4.x session slot table.
	// Maximum: 2000
	// Minimum: 1
	V4SessionSlots *int64 `json:"v4_session_slots,omitempty" yaml:"v4_session_slots,omitempty"`
}
...
type NfsServiceInlineProtocolAccessRules struct {
	...
	CifsAccessType *string `json:"cifs_access_type,omitempty" yaml:"cifs_access_type,omitempty"`

	// Access available for the NFSv3 protocol.
	// Read Only: true
	// Enum: ["read","read_write","denied"]
	Nfs3AccessType *string `json:"nfs3_access_type,omitempty" yaml:"nfs3_access_type,omitempty"`

	// Access available for the NFSv4 protocol.
	// Read Only: true
	// Enum: ["read","read_write","denied"]
	Nfs4AccessType *string `json:"nfs4_access_type,omitempty" yaml:"nfs4_access_type,omitempty"`
}
...
type NfsServiceInlineProtocolInlineV3Features struct {
	...
	EjukeboxEnabled *bool `json:"ejukebox_enabled,omitempty" yaml:"ejukebox_enabled,omitempty"`
	...
	MountDaemonPort *int64 `json:"mount_daemon_port,omitempty" yaml:"mount_daemon_port,omitempty"`

	// Specifies whether the SVM allows MOUNT protocol calls only from privileged ports (port numbers less than 1024).
	MountRootOnly *bool `json:"mount_root_only,omitempty" yaml:"mount_root_only,omitempty"`

	// Specifies which port the Network lock manager uses.
	NetworkLockManagerPort *int64 `json:"network_lock_manager_port,omitempty" yaml:"network_lock_manager_port,omitempty"`

	// Specifies which port the Network status monitor port uses.
	NetworkStatusMonitorPort *int64 `json:"network_status_monitor_port,omitempty" yaml:"network_status_monitor_port,omitempty"`

	// Specifies which port the NFS quota daemon port uses.
	RquotaDaemonPort *int64 `json:"rquota_daemon_port,omitempty" yaml:"rquota_daemon_port,omitempty"`
}
...
type NfsServiceInlineProtocolInlineV40Features struct {
	...
	ACLEnabled *bool `json:"acl_enabled,omitempty" yaml:"acl_enabled,omitempty"`

	// Specifies the maximum number of aces in a NFSv4.0 ACL.
	// Example: 500
	// Maximum: 1024
	// Minimum: 192
	ACLMaxAces *int64 `json:"acl_max_aces,omitempty" yaml:"acl_max_aces,omitempty"`
	...
	ACLPreserve *bool `json:"acl_preserve,omitempty" yaml:"acl_preserve,omitempty"`

	// Specifies whether NFSv4.0 Read Delegation is enabled.
	ReadDelegationEnabled *bool `json:"read_delegation_enabled,omitempty" yaml:"read_delegation_enabled,omitempty"`

	// Specifies whether NFSv4.0 referrals is enabled.
	ReferralsEnabled *bool `json:"referrals_enabled,omitempty" yaml:"referrals_enabled,omitempty"`

	// Specifies whether NFSv4.0 Write Delegation is enabled.
	WriteDelegationEnabled *bool `json:"write_delegation_enabled,omitempty" yaml:"write_delegation_enabled,omitempty"`
}
...
type NfsServiceInlineProtocolInlineV41Features struct {
	...
	ImplementationDomain *string `json:"implementation_domain,omitempty" yaml:"implementation_domain,omitempty"`

	// Specifies the NFSv4.1 or later implementation ID name.
	ImplementationName *string `json:"implementation_name,omitempty" yaml:"implementation_name,omitempty"`

	// Specifies whether NFSv4.1 or later Parallel NFS is enabled.
	PnfsEnabled *bool `json:"pnfs_enabled,omitempty" yaml:"pnfs_enabled,omitempty"`
	...
	TrunkingEnabled *bool `json:"trunking_enabled,omitempty" yaml:"trunking_enabled,omitempty"`
...
type NfsServiceInlineProtocolInlineV42Features struct {
	...
	SeclabelEnabled *bool `json:"seclabel_enabled,omitempty" yaml:"seclabel_enabled,omitempty"`

	// Specifies whether NFSv4.2 or later sparsefile operation is enabled.
	SparsefileOpsEnabled *bool `json:"sparsefile_ops_enabled,omitempty" yaml:"sparsefile_ops_enabled,omitempty"`

	// Specifies whether NFSv4.2 or later extended attributes is enabled.
	XattrsEnabled *bool `json:"xattrs_enabled,omitempty" yaml:"xattrs_enabled,omitempty"`
}
...
type NfsServiceInlineQtree struct {
	...
	// Read Only: true
	ExportEnabled *bool `json:"export_enabled,omitempty" yaml:"export_enabled,omitempty"`

	// Specifies whether qtree export validation is enabled.
	ValidateExport *bool `json:"validate_export,omitempty" yaml:"validate_export,omitempty"`
}
...
type NfsServiceInlineRoot struct {
	...
	IgnoreNtACL *bool `json:"ignore_nt_acl,omitempty" yaml:"ignore_nt_acl,omitempty"`
	...
	SkipWritePermissionCheck *bool `json:"skip_write_permission_check,omitempty" yaml:"skip_write_permission_check,omitempty"`
}
...
type NfsServiceInlineSecurity struct {
	...
	NtACLDisplayPermission *bool `json:"nt_acl_display_permission,omitempty" yaml:"nt_acl_display_permission,omitempty"`
	...
	PermittedEncryptionTypes []*string `json:"permitted_encryption_types,omitempty" yaml:"permitted_encryption_types,omitempty"`

	// Specifies, in seconds, the amount of time a RPCSEC_GSS context is permitted to remain unused before it is deleted.
	RpcsecContextIdle *int64 `json:"rpcsec_context_idle,omitempty" yaml:"rpcsec_context_idle,omitempty"`
}
...
type NfsServiceInlineStatistics struct {
	...
	// v3
	V3 *NfsServiceInlineStatisticsInlineV3 `json:"v3,omitempty" yaml:"v3,omitempty"`

	// v4
	V4 *NfsServiceInlineStatisticsInlineV4 `json:"v4,omitempty" yaml:"v4,omitempty"`

	// v41
	V41 *NfsServiceInlineStatisticsInlineV41 `json:"v41,omitempty" yaml:"v41,omitempty"`
}
...
type NfsServiceInlineStatisticsInlineV3 struct {
	...
	// iops raw
	IopsRaw *NfsServiceInlineStatisticsInlineV3InlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *NfsServiceInlineStatisticsInlineV3InlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *NfsServiceInlineStatisticsInlineV3InlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type NfsServiceInlineStatisticsInlineV4 struct {
	...
	// iops raw
	IopsRaw *NfsServiceInlineStatisticsInlineV4InlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *NfsServiceInlineStatisticsInlineV4InlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *NfsServiceInlineStatisticsInlineV4InlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type NfsServiceInlineStatisticsInlineV41 struct {
	...
	// iops raw
	IopsRaw *NfsServiceInlineStatisticsInlineV41InlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *NfsServiceInlineStatisticsInlineV41InlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *NfsServiceInlineStatisticsInlineV41InlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type NfsServiceInlineSvm struct {
	...
	// links
	Links *NfsServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NfsServiceInlineTransport struct {
	...
	//
	RdmaEnabled *bool `json:"rdma_enabled,omitempty" yaml:"rdma_enabled,omitempty"`

	// Specifies whether TCP transports are enabled on the server.
	//
	TCPEnabled *bool `json:"tcp_enabled,omitempty" yaml:"tcp_enabled,omitempty"`
	...
	// Minimum: 8192
	TCPMaxTransferSize *int64 `json:"tcp_max_transfer_size,omitempty" yaml:"tcp_max_transfer_size,omitempty"`

	// Specifies whether UDP transports are enabled on the server.
	//
	UDPEnabled *bool `json:"udp_enabled,omitempty" yaml:"udp_enabled,omitempty"`
}
...
type NfsServiceInlineWindows struct {
	...
	MapUnknownUIDToDefaultUser *bool `json:"map_unknown_uid_to_default_user,omitempty" yaml:"map_unknown_uid_to_default_user,omitempty"`

	// Specifies whether NFSv3 MS-DOS client support is enabled.
	V3MsDosClientEnabled *bool `json:"v3_ms_dos_client_enabled,omitempty" yaml:"v3_ms_dos_client_enabled,omitempty"`
}
