...
type ConsistencyGroupTiering struct {
	...
	// Max Items: 2
	// Min Items: 0
	ConsistencyGroupTieringInlineObjectStores []*ConsistencyGroupTieringInlineObjectStoresInlineArrayItem `json:"object_stores,omitempty" yaml:"object_stores,omitempty"`
