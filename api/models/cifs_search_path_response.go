...
type CifsSearchPathResponse struct {
	...
	// links
	Links *CifsSearchPathResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cifs search path response inline records
	CifsSearchPathResponseInlineRecords []*CifsSearchPath `json:"records,omitempty" yaml:"records,omitempty"`
