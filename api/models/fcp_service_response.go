...
type FcpServiceResponse struct {
	...
	// links
	Links *FcpServiceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fcp service response inline records
	FcpServiceResponseInlineRecords []*FcpService `json:"records,omitempty" yaml:"records,omitempty"`
