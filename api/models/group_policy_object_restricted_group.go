...
type GroupPolicyObjectRestrictedGroup struct {
	...
	GroupPolicyObjectRestrictedGroupInlineMembers []*string `json:"members,omitempty" yaml:"members,omitempty"`

	// Group is member of Group/OU.
	// Example: ["DOMAIN/AdministratorGrp","DOMAIN/deptMark"]
	GroupPolicyObjectRestrictedGroupInlineMemberships []*string `json:"memberships,omitempty" yaml:"memberships,omitempty"`
	...
	// svm
	Svm *GroupPolicyObjectRestrictedGroupInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type GroupPolicyObjectRestrictedGroupInlineSvm struct {
	...
	// links
	Links *GroupPolicyObjectRestrictedGroupInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
