...
type CifsShare struct {
	...
	// links
	Links *CifsShareInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	AccessBasedEnumeration *bool `json:"access_based_enumeration,omitempty" yaml:"access_based_enumeration,omitempty"`

	// Specifies whether or not the SMB2 clients are allowed to access the encrypted share.
	//
	AllowUnencryptedAccess *bool `json:"allow_unencrypted_access,omitempty" yaml:"allow_unencrypted_access,omitempty"`

	// Specifies that connections through this share cache attributes for a short time to improve performance.
	//
	AttributeCache *bool `json:"attribute_cache,omitempty" yaml:"attribute_cache,omitempty"`

	// Specifies whether or not the Windows clients can browse the share.
	//
	Browsable *bool `json:"browsable,omitempty" yaml:"browsable,omitempty"`

	// Specifies whether CIFS clients can request for change notifications for directories on this share.
	ChangeNotify *bool `json:"change_notify,omitempty" yaml:"change_notify,omitempty"`

	// cifs share inline acls
	CifsShareInlineAcls []*CifsShareInlineAclsInlineArrayItem `json:"acls,omitempty" yaml:"acls,omitempty"`
	...
	// security style.
	//
	ForceGroupForCreate *string `json:"force_group_for_create,omitempty" yaml:"force_group_for_create,omitempty"`
	...
	//
	HomeDirectory *bool `json:"home_directory,omitempty" yaml:"home_directory,omitempty"`

	// Maximum number of tree connections on share.
	//
	MaxConnectionsPerShare *int64 `json:"max_connections_per_share,omitempty" yaml:"max_connections_per_share,omitempty"`
	...
	//
	NamespaceCaching *bool `json:"namespace_caching,omitempty" yaml:"namespace_caching,omitempty"`

	// Specifies whether or not CIFS clients can follow a unix symlinks outside the share boundaries.
	//
	NoStrictSecurity *bool `json:"no_strict_security,omitempty" yaml:"no_strict_security,omitempty"`
	...
	OfflineFiles *string `json:"offline_files,omitempty" yaml:"offline_files,omitempty"`
	...
	// svm
	Svm *CifsShareInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	UnixSymlink *string `json:"unix_symlink,omitempty" yaml:"unix_symlink,omitempty"`

	// volume
	Volume *CifsShareInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
	...
	VscanProfile *string `json:"vscan_profile,omitempty" yaml:"vscan_profile,omitempty"`
}
...
type CifsShareInlineAclsInlineArrayItem struct {
	...
	// links
	Links *CifsShareInlineAclsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsShareInlineSvm struct {
	...
	// links
	Links *CifsShareInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
