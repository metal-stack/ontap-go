...
type AggregateResponse struct {
	...
	// links
	Links *AggregateResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Information on the aggregate's remaining hot spare disks.
	AggregateResponseInlineRecommendationSpares []*AggregateSpare `json:"recommendation_spares,omitempty" yaml:"recommendation_spares,omitempty"`

	// aggregate response inline records
	AggregateResponseInlineRecords []*Aggregate `json:"records,omitempty" yaml:"records,omitempty"`

	// aggregate response inline spares
	AggregateResponseInlineSpares []*AggregateSpare `json:"spares,omitempty" yaml:"spares,omitempty"`

	// List of warnings and remediation advice for the aggregate recommendation.
	AggregateResponseInlineWarnings []*AggregateWarning `json:"warnings,omitempty" yaml:"warnings,omitempty"`
