...
type ScheduleResponse struct {
	...
	// links
	Links *ScheduleResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ScheduleResponseInlineRecords []*Schedule `json:"records,omitempty" yaml:"records,omitempty"`
}
