...
type LicensePackage struct {
	...
	// links
	Links *LicensePackageInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// entitlement
	Entitlement *LicensePackageInlineEntitlement `json:"entitlement,omitempty" yaml:"entitlement,omitempty"`

	// license package inline keys
	LicensePackageInlineKeys []*string `json:"keys,omitempty" yaml:"keys,omitempty"`

	// Installed licenses of the package.
	// Read Only: true
	LicensePackageInlineLicenses []*LicensePackageInlineLicensesInlineArrayItem `json:"licenses,omitempty" yaml:"licenses,omitempty"`
...
type LicensePackageInlineLicensesInlineArrayItem struct {
	...
	// capacity
	Capacity *LicensePackageInlineLicensesInlineArrayItemInlineCapacity `json:"capacity,omitempty" yaml:"capacity,omitempty"`

	// compliance
	Compliance *LicensePackageInlineLicensesInlineArrayItemInlineCompliance `json:"compliance,omitempty" yaml:"compliance,omitempty"`
