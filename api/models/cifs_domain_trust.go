...
type CifsDomainTrust struct {
	...
	// Trusted Domain Name
	//
	CifsDomainTrustInlineTrustedDomains []*string `json:"trusted_domains,omitempty" yaml:"trusted_domains,omitempty"`
	...
	// node
	Node *CifsDomainTrustInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type CifsDomainTrustInlineNode struct {
	...
	// links
	Links *CifsDomainTrustInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
