...
type CifsShareResponse struct {
	...
	// links
	Links *CifsShareResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cifs share response inline records
	CifsShareResponseInlineRecords []*CifsShare `json:"records,omitempty" yaml:"records,omitempty"`
