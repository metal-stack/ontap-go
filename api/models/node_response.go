...
type NodeResponse struct {
	...
	// links
	Links *NodeResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// node response inline records
	NodeResponseInlineRecords []*NodeResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type NodeResponseInlineRecordsInlineArrayItem struct {
	...
	// cluster interfaces
	// Read Only: true
	ClusterInterfaces []*NodeResponseRecordsItems0ClusterInterfacesItems0 `json:"cluster_interfaces" yaml:"cluster_interfaces"`

	// controller
	Controller *NodeResponseInlineRecordsInlineArrayItemInlineController `json:"controller,omitempty" yaml:"controller,omitempty"`
	...
	// external cache
	ExternalCache *NodeResponseInlineRecordsInlineArrayItemInlineExternalCache `json:"external_cache,omitempty" yaml:"external_cache,omitempty"`

	// ha
	Ha *NodeResponseInlineRecordsInlineArrayItemInlineHa `json:"ha,omitempty" yaml:"ha,omitempty"`

	// hw assist
	HwAssist *NodeResponseInlineRecordsInlineArrayItemInlineHwAssist `json:"hw_assist,omitempty" yaml:"hw_assist,omitempty"`
	...
	ManagementInterface *NodeResponseInlineRecordsInlineArrayItemInlineManagementInterface `json:"management_interface,omitempty" yaml:"management_interface,omitempty"`

	// management interfaces
	// Read Only: true
	ManagementInterfaces []*NodeResponseRecordsItems0ManagementInterfacesItems0 `json:"management_interfaces" yaml:"management_interfaces"`
	...
	// metric
	Metric *NodeResponseInlineRecordsInlineArrayItemInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// metrocluster
	Metrocluster *NodeResponseInlineRecordsInlineArrayItemInlineMetrocluster `json:"metrocluster,omitempty" yaml:"metrocluster,omitempty"`
	...
	// nvram
	Nvram *NodeResponseInlineRecordsInlineArrayItemInlineNvram `json:"nvram,omitempty" yaml:"nvram,omitempty"`
	...
	// service processor
	ServiceProcessor *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessor `json:"service_processor,omitempty" yaml:"service_processor,omitempty"`

	// snaplock
	Snaplock *NodeResponseInlineRecordsInlineArrayItemInlineSnaplock `json:"snaplock,omitempty" yaml:"snaplock,omitempty"`
	...
	// statistics
	Statistics *NodeResponseInlineRecordsInlineArrayItemInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`
	...
	// system aggregate
	SystemAggregate *NodeResponseInlineRecordsInlineArrayItemInlineSystemAggregate `json:"system_aggregate,omitempty" yaml:"system_aggregate,omitempty"`
	...
	// version
	Version *NodeResponseInlineRecordsInlineArrayItemInlineVersion `json:"version,omitempty" yaml:"version,omitempty"`

	// vm
	VM *NodeResponseInlineRecordsInlineArrayItemInlineVM `json:"vm,omitempty" yaml:"vm,omitempty"`
}
...
type NodeResponseRecordsItems0ClusterInterfacesItems0 struct {
	...
	// links
	Links *NodeResponseRecordsItems0ClusterInterfacesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *NodeResponseRecordsItems0ClusterInterfacesItems0IP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineController struct {
	...
	// cpu
	CPU *NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineCPU `json:"cpu,omitempty" yaml:"cpu,omitempty"`

	// failed fan
	FailedFan *NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineFailedFan `json:"failed_fan,omitempty" yaml:"failed_fan,omitempty"`

	// failed power supply
	FailedPowerSupply *NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineFailedPowerSupply `json:"failed_power_supply,omitempty" yaml:"failed_power_supply,omitempty"`

	// A list of Flash-Cache devices. Only returned when requested by name.
	// Read Only: true
	FlashCache []*NodeResponseRecordsItems0ControllerFlashCacheItems0 `json:"flash_cache" yaml:"flash_cache"`

	// List of FRUs on the node. Only returned when requested by name.
	Frus []*NodeResponseRecordsItems0ControllerFrusItems0 `json:"frus" yaml:"frus"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineFailedFan struct {
	...
	// message
	Message *NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineFailedFanInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`
}
...
type NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineFailedPowerSupply struct {
	...
	// message
	Message *NodeResponseInlineRecordsInlineArrayItemInlineControllerInlineFailedPowerSupplyInlineMessage `json:"message,omitempty" yaml:"message,omitempty"`
}
...
type NodeResponseInlineRecordsInlineArrayItemInlineHa struct {
	...
	// giveback
	Giveback *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGiveback `json:"giveback,omitempty" yaml:"giveback,omitempty"`

	// interconnect
	Interconnect *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineInterconnect `json:"interconnect,omitempty" yaml:"interconnect,omitempty"`

	// Nodes in this node's High Availability (HA) group.
	// Read Only: true
	Partners []*NodeResponseRecordsItems0HaPartnersItems0 `json:"partners" yaml:"partners"`

	// ports
	// Read Only: true
	Ports []*NodeResponseRecordsItems0HaPortsItems0 `json:"ports" yaml:"ports"`

	// takeover
	Takeover *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeover `json:"takeover,omitempty" yaml:"takeover,omitempty"`

	// takeover check
	TakeoverCheck *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverCheck `json:"takeover_check,omitempty" yaml:"takeover_check,omitempty"`
}
...
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGiveback struct {
	...
	// failure
	Failure *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackInlineFailure `json:"failure,omitempty" yaml:"failure,omitempty"`
...
type NodeResponseRecordsItems0HaGivebackStatusItems0 struct {
	...
	// aggregate
	Aggregate *NodeResponseRecordsItems0HaGivebackStatusItems0Aggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// error
	Error *NodeResponseRecordsItems0HaGivebackStatusItems0Error `json:"error,omitempty" yaml:"error,omitempty"`
...
type NodeResponseRecordsItems0HaGivebackStatusItems0Aggregate struct {
	...
	// links
	Links *NodeResponseRecordsItems0HaGivebackStatusItems0AggregateLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NodeResponseRecordsItems0HaPartnersItems0 struct {
	...
	// links
	Links *NodeResponseRecordsItems0HaPartnersItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeover struct {
	...
	// failure
	Failure *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverInlineFailure `json:"failure,omitempty" yaml:"failure,omitempty"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineHwAssist struct {
	...
	// status
	Status *NodeResponseInlineRecordsInlineArrayItemInlineHwAssistInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
}
...
type NodeResponseInlineRecordsInlineArrayItemInlineHwAssistInlineStatus struct {
	...
	// local
	Local *NodeResponseInlineRecordsInlineArrayItemInlineHwAssistInlineStatusInlineLocal `json:"local,omitempty" yaml:"local,omitempty"`

	// partner
	Partner *NodeResponseInlineRecordsInlineArrayItemInlineHwAssistInlineStatusInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
}
...
type NodeResponseRecordsItems0ManagementInterfacesItems0 struct {
	...
	// links
	Links *NodeResponseRecordsItems0ManagementInterfacesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *NodeResponseRecordsItems0ManagementInterfacesItems0IP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineMetric struct {
	...
	// links
	Links *NodeResponseInlineRecordsInlineArrayItemInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineMetrocluster struct {
	...
	// Read Only: true
	Ports []*NodeResponseRecordsItems0MetroclusterPortsItems0 `json:"ports" yaml:"ports"`
...
type NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessor struct {
	...
	// api service
	APIService *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineAPIService `json:"api_service,omitempty" yaml:"api_service,omitempty"`

	// auto config
	AutoConfig *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineAutoConfig `json:"auto_config,omitempty" yaml:"auto_config,omitempty"`
	...
	// backup
	Backup *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineBackup `json:"backup,omitempty" yaml:"backup,omitempty"`
	...
	// ipv4 interface
	IPV4Interface *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineIPV4Interface `json:"ipv4_interface,omitempty" yaml:"ipv4_interface,omitempty"`

	// ipv6 interface
	IPV6Interface *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineIPV6Interface `json:"ipv6_interface,omitempty" yaml:"ipv6_interface,omitempty"`
	...
	// primary
	Primary *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlinePrimary `json:"primary,omitempty" yaml:"primary,omitempty"`

	// ssh info
	SSHInfo *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineSSHInfo `json:"ssh_info,omitempty" yaml:"ssh_info,omitempty"`
	...
	// web service
	WebService *NodeResponseInlineRecordsInlineArrayItemInlineServiceProcessorInlineWebService `json:"web_service,omitempty" yaml:"web_service,omitempty"`
}
...
type NodeResponseInlineRecordsInlineArrayItemInlineSystemAggregate struct {
	...
	// links
	Links *NodeResponseInlineRecordsInlineArrayItemInlineSystemAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
