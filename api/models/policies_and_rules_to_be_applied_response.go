...
type PoliciesAndRulesToBeAppliedResponse struct {
	...
	// links
	Links *PoliciesAndRulesToBeAppliedResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	PoliciesAndRulesToBeAppliedResponseInlineRecords []*PoliciesAndRulesToBeApplied `json:"records,omitempty" yaml:"records,omitempty"`
}
