...
type MultiAdminVerifyRequest struct {
	...
	// Read Only: true
	// Format: date-time
	ApproveExpiryTime *strfmt.DateTime `json:"approve_expiry_time,omitempty" yaml:"approve_expiry_time,omitempty"`

	// approve time
	// Read Only: true
	// Format: date-time
	ApproveTime *strfmt.DateTime `json:"approve_time,omitempty" yaml:"approve_time,omitempty"`
	...
	ExecuteOnApproval *bool `json:"execute_on_approval,omitempty" yaml:"execute_on_approval,omitempty"`

	// execution expiry time
	// Read Only: true
	// Format: date-time
	ExecutionExpiryTime *strfmt.DateTime `json:"execution_expiry_time,omitempty" yaml:"execution_expiry_time,omitempty"`
	...
	// Read Only: true
	MultiAdminVerifyRequestInlineApprovedUsers []*string `json:"approved_users,omitempty" yaml:"approved_users,omitempty"`

	// List of users that can execute the operation once approved. If not set, any authorized user can perform the operation.
	MultiAdminVerifyRequestInlinePermittedUsers []*string `json:"permitted_users,omitempty" yaml:"permitted_users,omitempty"`

	// The users that are able to approve the request.
	// Read Only: true
	MultiAdminVerifyRequestInlinePotentialApprovers []*string `json:"potential_approvers,omitempty" yaml:"potential_approvers,omitempty"`

	// The command to execute.
	Operation *string `json:"operation,omitempty" yaml:"operation,omitempty"`

	// owner
	Owner *MultiAdminVerifyRequestInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`

	// The number of approvers remaining that are required to approve.
	// Read Only: true
	PendingApprovers *int64 `json:"pending_approvers,omitempty" yaml:"pending_approvers,omitempty"`
	...
	// Read Only: true
	RequiredApprovers *int64 `json:"required_approvers,omitempty" yaml:"required_approvers,omitempty"`
	...
	// Read Only: true
	UserRequested *string `json:"user_requested,omitempty" yaml:"user_requested,omitempty"`

	// The user that vetoed the request.
	// Read Only: true
	UserVetoed *string `json:"user_vetoed,omitempty" yaml:"user_vetoed,omitempty"`
}
...
type MultiAdminVerifyRequestInlineOwner struct {
	...
	// links
	Links *MultiAdminVerifyRequestInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
