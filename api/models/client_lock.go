...
type ClientLock struct {
	...
	// byte lock
	ByteLock *ByteLock `json:"byte_lock,omitempty" yaml:"byte_lock,omitempty"`
	...
	// interface
	Interface *ClientLockInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// node
	Node *ClientLockInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// The oplock level determines which operations the client may cache locally.
	// Read Only: true
	// Enum: ["exclusive","level2","batch","null","read_batch"]
	OplockLevel *string `json:"oplock_level,omitempty" yaml:"oplock_level,omitempty"`
	...
	// share lock
	ShareLock *ShareLock `json:"share_lock,omitempty" yaml:"share_lock,omitempty"`

	// smb
	Smb *Smb `json:"smb,omitempty" yaml:"smb,omitempty"`
	...
	// svm
	Svm *ClientLockInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume
	Volume *ClientLockInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type ClientLockInlineInterface struct {
	...
	// links
	Links *ClientLockInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *ClientLockInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type ClientLockInlineNode struct {
	...
	// links
	Links *ClientLockInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClientLockInlineSvm struct {
	...
	// links
	Links *ClientLockInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
