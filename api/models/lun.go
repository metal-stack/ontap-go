...
type Lun struct {
	...
	// links
	Links *LunInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// clone
	Clone *LunInlineClone `json:"clone,omitempty" yaml:"clone,omitempty"`
	...
	// consistency group
	ConsistencyGroup *LunInlineConsistencyGroup `json:"consistency_group,omitempty" yaml:"consistency_group,omitempty"`

	// convert
	Convert *LunInlineConvert `json:"convert,omitempty" yaml:"convert,omitempty"`

	// copy
	Copy *LunInlineCopy `json:"copy,omitempty" yaml:"copy,omitempty"`
	...
	// location
	Location *LunInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`
	...
	// metric
	Metric *LunInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// space
	Space *LunInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// statistics
	Statistics *LunInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// status
	Status *LunInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
	...
	// vvol
	Vvol *LunInlineVvol `json:"vvol,omitempty" yaml:"vvol,omitempty"`
}
...
type LunInlineAttributesInlineArrayItem struct {
	...
	// links
	Links *LunInlineAttributesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineClone struct {
	...
	// source
	Source *LunInlineCloneInlineSource `json:"source,omitempty" yaml:"source,omitempty"`
}
...
type LunInlineConsistencyGroup struct {
	...
	// links
	Links *LunInlineConsistencyGroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineConvert struct {
	...
	// namespace
	Namespace *LunInlineConvertInlineNamespace `json:"namespace,omitempty" yaml:"namespace,omitempty"`
}
...
type LunInlineCopy struct {
	...
	//
	// Read Only: true
	Destinations []*LunCopyDestinationsItems0 `json:"destinations,omitempty" yaml:"destinations,omitempty"`

	// source
	Source *LunInlineCopyInlineSource `json:"source,omitempty" yaml:"source,omitempty"`
}
...
type LunCopyDestinationsItems0 struct {
	...
	// links
	Links *LunCopyDestinationsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// peer
	Peer *LunCopyDestinationsItems0Peer `json:"peer,omitempty" yaml:"peer,omitempty"`

	// progress
	Progress *LunCopyDestinationsItems0Progress `json:"progress,omitempty" yaml:"progress,omitempty"`
...
type LunCopyDestinationsItems0Peer struct {
	...
	// links
	Links *LunCopyDestinationsItems0PeerLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunCopyDestinationsItems0Progress struct {
	...
	//
	// Read Only: true
	Failure *Error `json:"failure,omitempty" yaml:"failure,omitempty"`
...
type LunInlineCopyInlineSource struct {
	...
	// links
	Links *LunInlineCopyInlineSourceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// peer
	Peer *LunInlineCopyInlineSourceInlinePeer `json:"peer,omitempty" yaml:"peer,omitempty"`

	// progress
	Progress *LunInlineCopyInlineSourceInlineProgress `json:"progress,omitempty" yaml:"progress,omitempty"`
...
type LunInlineCopyInlineSourceInlinePeer struct {
	...
	// links
	Links *LunInlineCopyInlineSourceInlinePeerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineLocation struct {
	...
	// node
	Node *LunInlineLocationInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// qtree
	Qtree *LunInlineLocationInlineQtree `json:"qtree,omitempty" yaml:"qtree,omitempty"`

	// volume
	Volume *LunInlineLocationInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type LunInlineLocationInlineNode struct {
	...
	// links
	Links *LunInlineLocationInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineLocationInlineQtree struct {
	...
	// links
	Links *LunInlineLocationInlineQtreeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineLunMapsInlineArrayItem struct {
	...
	// links
	Links *LunInlineLunMapsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineMetric struct {
	...
	// links
	Links *LunInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *LunInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *LunInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *LunInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type LunInlineMovement struct {
	...
	// paths
	Paths *LunInlineMovementInlinePaths `json:"paths,omitempty" yaml:"paths,omitempty"`

	// progress
	Progress *LunInlineMovementInlineProgress `json:"progress,omitempty" yaml:"progress,omitempty"`
}
...
type LunInlineQosPolicy struct {
	...
	// links
	Links *LunInlineQosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineStatistics struct {
	...
	// iops raw
	IopsRaw *LunInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *LunInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *LunInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type LunInlineSvm struct {
	...
	// links
	Links *LunInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunInlineVvol struct {
	...
	//
	// Read Only: true
	IsBound *bool `json:"is_bound,omitempty" yaml:"is_bound,omitempty"`
}
...
type LunVvolBindingsItems0 struct {
	...
	// Read Only: true
	SecondaryID *string `json:"secondary_id,omitempty" yaml:"secondary_id,omitempty"`
}
...
type LunVvolBindingsItems0Partner struct {
	...
	// links
	Links *LunVvolBindingsItems0PartnerLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
