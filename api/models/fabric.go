...
type Fabric struct {
	...
	// links
	Links *FabricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cache
	Cache *FabricInlineCache `json:"cache,omitempty" yaml:"cache,omitempty"`

	// An array of the connections between the cluster and the switches Fibre Channel fabric.
	//
	// Read Only: true
	FabricInlineConnections []*FabricInlineConnectionsInlineArrayItem `json:"connections,omitempty" yaml:"connections,omitempty"`
	...
	// zoneset
	Zoneset *FabricInlineZoneset `json:"zoneset,omitempty" yaml:"zoneset,omitempty"`
}
...
type FabricInlineConnectionsInlineArrayItem struct {
	...
	// cluster port
	ClusterPort *FabricInlineConnectionsInlineArrayItemInlineClusterPort `json:"cluster_port,omitempty" yaml:"cluster_port,omitempty"`

	// switch
	Switch *FabricInlineConnectionsInlineArrayItemInlineSwitch `json:"switch,omitempty" yaml:"switch,omitempty"`
}
...
type FabricInlineConnectionsInlineArrayItemInlineClusterPort struct {
	...
	// links
	Links *FabricInlineConnectionsInlineArrayItemInlineClusterPortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *FabricInlineConnectionsInlineArrayItemInlineClusterPortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type FabricInlineConnectionsInlineArrayItemInlineSwitch struct {
	...
	// links
	Links *FabricInlineConnectionsInlineArrayItemInlineSwitchInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// port
	Port *FabricInlineConnectionsInlineArrayItemInlineSwitchInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
