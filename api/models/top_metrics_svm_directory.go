...
type TopMetricsSvmDirectory struct {
	...
	// links
	Links *TopMetricsSvmDirectoryInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// iops
	Iops *TopMetricsSvmDirectoryInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// Junction path of the file.
	// Example: /fv
	// Read Only: true
	JunctionPath *string `json:"junction-path,omitempty" yaml:"junction-path,omitempty"`
	...
	// svm
	Svm *TopMetricsSvmDirectoryInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsSvmDirectoryInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`

	// volume
	Volume *TopMetricsSvmDirectoryInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type TopMetricsSvmDirectoryInlineSvm struct {
	...
	// links
	Links *TopMetricsSvmDirectoryInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type TopMetricsSvmDirectoryInlineVolume struct {
	...
	// links
	Links *TopMetricsSvmDirectoryInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
