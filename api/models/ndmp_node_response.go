...
type NdmpNodeResponse struct {
	...
	// links
	Links *NdmpNodeResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ndmp node response inline records
	NdmpNodeResponseInlineRecords []*NdmpNode `json:"records,omitempty" yaml:"records,omitempty"`
