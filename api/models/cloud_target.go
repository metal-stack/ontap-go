...
type CloudTarget struct {
	...
	// links
	Links *CloudTargetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	AuthenticationType *string `json:"authentication_type,omitempty" yaml:"authentication_type,omitempty"`
	...
	CertificateValidationEnabled *bool `json:"certificate_validation_enabled,omitempty" yaml:"certificate_validation_enabled,omitempty"`

	// cluster
	Cluster *CloudTargetInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`
	...
	// ipspace
	Ipspace *CloudTargetInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
	...
	ReadLatencyWarningThreshold *int64 `json:"read_latency_warning_threshold,omitempty" yaml:"read_latency_warning_threshold,omitempty"`
	...
	// Format: password
	SecretPassword *strfmt.Password `json:"secret_password,omitempty" yaml:"secret_password,omitempty"`
	...
	// Enum: ["data","metadata"]
	SnapmirrorUse *string `json:"snapmirror_use,omitempty" yaml:"snapmirror_use,omitempty"`

	// SSL/HTTPS enabled or not
	SslEnabled *bool `json:"ssl_enabled,omitempty" yaml:"ssl_enabled,omitempty"`

	// svm
	Svm *CloudTargetInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// URL style used to access S3 bucket.
	// Enum: ["path_style","virtual_hosted_style"]
	URLStyle *string `json:"url_style,omitempty" yaml:"url_style,omitempty"`

	// Use HTTP proxy when connecting to the object store.
	UseHTTPProxy *bool `json:"use_http_proxy,omitempty" yaml:"use_http_proxy,omitempty"`
...
type CloudTargetInlineIpspace struct {
	...
	// links
	Links *CloudTargetInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CloudTargetInlineSvm struct {
	...
	// links
	Links *CloudTargetInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
