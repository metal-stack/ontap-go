...
type S3BucketCorsRule struct {
	...
	// links
	Links *S3BucketCorsRuleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	S3BucketCorsRuleInlineAllowedHeaders []*string `json:"allowed_headers,omitempty" yaml:"allowed_headers,omitempty"`

	// An array of HTTP methods allowed in the cross-origin requests.
	//
	// Example: ["PUT","DELETE"]
	S3BucketCorsRuleInlineAllowedMethods []*string `json:"allowed_methods,omitempty" yaml:"allowed_methods,omitempty"`

	// List of origins from where a cross-origin request is allowed to originate from for the S3 bucket.
	//
	// Example: ["http://www.example.com"]
	S3BucketCorsRuleInlineAllowedOrigins []*string `json:"allowed_origins,omitempty" yaml:"allowed_origins,omitempty"`

	// List of extra headers sent in the response that customers can access from their applications.
	//
	// Example: ["x-amz-date"]
	S3BucketCorsRuleInlineExposeHeaders []*string `json:"expose_headers,omitempty" yaml:"expose_headers,omitempty"`
}
