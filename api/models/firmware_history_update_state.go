...
type FirmwareHistoryUpdateState struct {
	...
	// worker
	Worker *FirmwareHistoryUpdateStateInlineWorker `json:"worker,omitempty" yaml:"worker,omitempty"`
}
...
type FirmwareHistoryUpdateStateInlineWorker struct {
	...
	// error
	Error *FirmwareHistoryUpdateStateError `json:"error,omitempty" yaml:"error,omitempty"`

	// node
	Node *FirmwareHistoryUpdateStateInlineWorkerInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type FirmwareHistoryUpdateStateInlineWorkerInlineNode struct {
	...
	// links
	Links *FirmwareHistoryUpdateStateInlineWorkerInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
