...
type PerformanceQtreeMetricData struct {
	...
	// links
	Links *PerformanceQtreeMetricDataInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceQtreeMetricDataInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceQtreeMetricDataInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceQtreeMetricDataInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
