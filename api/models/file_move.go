...
type FileMove struct {
	...
	// destination
	Destination *FileMoveInlineDestination `json:"destination,omitempty" yaml:"destination,omitempty"`

	// Time elapsed since the start of the file move operation, in seconds.
	// Example: 100
	// Read Only: true
	ElapsedTime *int64 `json:"elapsed_time,omitempty" yaml:"elapsed_time,omitempty"`
	...
	// files to move
	FilesToMove *FileMoveInlineFilesToMove `json:"files_to_move,omitempty" yaml:"files_to_move,omitempty"`
	...
	// Read Only: true
	IsDestinationReady *bool `json:"is_destination_ready,omitempty" yaml:"is_destination_ready,omitempty"`
	...
	//
	// Example: 10
	MaxCutoverTime *int64 `json:"max_cutover_time,omitempty" yaml:"max_cutover_time,omitempty"`
	...
	// node
	Node *FileMoveInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// reference
	Reference *FileMoveInlineReference `json:"reference,omitempty" yaml:"reference,omitempty"`

	// scanner
	Scanner *FileMoveInlineScanner `json:"scanner,omitempty" yaml:"scanner,omitempty"`

	// source
	Source *FileMoveInlineSource `json:"source,omitempty" yaml:"source,omitempty"`

	// svm
	Svm *FileMoveInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume
	Volume *FileMoveInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveInlineDestination struct {
	...
	// svm
	Svm *FileMoveInlineDestinationInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FileMoveInlineDestinationInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveInlineDestinationInlineSvm struct {
	...
	// links
	Links *FileMoveInlineDestinationInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveInlineFilesToMove struct {
	...
	Destinations []*FileMoveFilesToMoveDestinationsItems0 `json:"destinations,omitempty" yaml:"destinations,omitempty"`

	// The source file information.
	Sources []*FileMoveFilesToMoveSourcesItems0 `json:"sources,omitempty" yaml:"sources,omitempty"`
}
...
type FileMoveFilesToMoveDestinationsItems0 struct {
	...
	// svm
	Svm *FileMoveFilesToMoveDestinationsItems0Svm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FileMoveFilesToMoveDestinationsItems0Volume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveFilesToMoveDestinationsItems0Svm struct {
	...
	// links
	Links *FileMoveFilesToMoveDestinationsItems0SvmLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveFilesToMoveSourcesItems0 struct {
	...
	// svm
	Svm *FileMoveFilesToMoveSourcesItems0Svm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FileMoveFilesToMoveSourcesItems0Volume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveFilesToMoveSourcesItems0Svm struct {
	...
	// links
	Links *FileMoveFilesToMoveSourcesItems0SvmLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveInlineNode struct {
	...
	// links
	Links *FileMoveInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveInlineReference struct {
	...
	// svm
	Svm *FileMoveInlineReferenceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FileMoveInlineReferenceInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveInlineReferenceInlineSvm struct {
	...
	// links
	Links *FileMoveInlineReferenceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveInlineSource struct {
	...
	// svm
	Svm *FileMoveInlineSourceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FileMoveInlineSourceInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveInlineSourceInlineSvm struct {
	...
	// links
	Links *FileMoveInlineSourceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveInlineSvm struct {
	...
	// links
	Links *FileMoveInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
