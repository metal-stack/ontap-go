...
type NisServiceResponse struct {
	...
	// links
	Links *NisServiceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// nis service response inline records
	NisServiceResponseInlineRecords []*NisService `json:"records,omitempty" yaml:"records,omitempty"`
