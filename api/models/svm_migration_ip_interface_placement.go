...
type SvmMigrationIPInterfacePlacement struct {
	...
	SvmMigrationIPInterfacePlacementInlineIPInterfaces []*SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItem `json:"ip_interfaces,omitempty" yaml:"ip_interfaces,omitempty"`
}
...
type SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItem struct {
	...
	// interface
	Interface *SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// port
	Port *SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlineInterface struct {
	...
	// links
	Links *SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlinePort struct {
	...
	// links
	Links *SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlinePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *SvmMigrationIPInterfacePlacementInlineIPInterfacesInlineArrayItemInlinePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
