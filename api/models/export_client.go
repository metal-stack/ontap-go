...
type ExportClient struct {
	...
	// policy
	Policy *ExportClientInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`

	// svm
	Svm *ExportClientInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type ExportClientInlineSvm struct {
	...
	// links
	Links *ExportClientInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
