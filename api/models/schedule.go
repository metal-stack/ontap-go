...
type Schedule struct {
	...
	// links
	Links *ScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cluster
	Cluster *ScheduleInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// cron
	Cron *ScheduleInlineCron `json:"cron,omitempty" yaml:"cron,omitempty"`
	...
	// svm
	Svm *ScheduleInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type ScheduleInlineCron struct {
	...
	Days []*int64 `json:"days,omitempty" yaml:"days,omitempty"`

	// The hours of the day the schedule runs. Leave empty for all.
	Hours []*int64 `json:"hours,omitempty" yaml:"hours,omitempty"`
	...
	Weekdays []*int64 `json:"weekdays,omitempty" yaml:"weekdays,omitempty"`
}
...
type ScheduleInlineSvm struct {
	...
	// links
	Links *ScheduleInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
