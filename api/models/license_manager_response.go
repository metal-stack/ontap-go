...
type LicenseManagerResponse struct {
	...
	LicenseManagerResponseInlineRecords []*LicenseManagerResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type LicenseManagerResponseInlineRecordsInlineArrayItem struct {
	...
	// uri
	URI *LicenseManagerResponseInlineRecordsInlineArrayItemInlineURI `json:"uri,omitempty" yaml:"uri,omitempty"`
