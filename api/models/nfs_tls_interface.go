...
type NfsTLSInterface struct {
	...
	// links
	Links *NfsTLSInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// certificate
	Certificate *NfsTLSInterfaceInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`

	// Indicates whether NFS over TLS is enabled.
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty"`

	// interface
	Interface *NfsTLSInterfaceInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// svm
	Svm *NfsTLSInterfaceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type NfsTLSInterfaceInlineCertificate struct {
	...
	// links
	Links *NfsTLSInterfaceInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NfsTLSInterfaceInlineInterface struct {
	...
	// links
	Links *NfsTLSInterfaceInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *NfsTLSInterfaceInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type NfsTLSInterfaceInlineSvm struct {
	...
	// links
	Links *NfsTLSInterfaceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
