...
type OracleRacOnSanNewIgroups struct {
	...
	// igroups
	Igroups []*OracleRacOnSanNewIgroupsIgroupsItems0 `json:"igroups" yaml:"igroups"`

	// initiator objects
	InitiatorObjects []*OracleRacOnSanNewIgroupsInitiatorObjectsItems0 `json:"initiator_objects" yaml:"initiator_objects"`
