...
type UnixUserSettings struct {
	...
	// links
	Links *UnixUserSettingsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *UnixUserSettingsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type UnixUserSettingsInlineSvm struct {
	...
	// links
	Links *UnixUserSettingsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
