...
type FirmwareHistory struct {
	...
	// links
	Links *FirmwareHistoryInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	FirmwareHistoryInlineUpdateStatus []*FirmwareHistoryUpdateState `json:"update_status,omitempty" yaml:"update_status,omitempty"`

	// Name of the firmware file.
	// Example: all_disk_fw.zip
	FwFileName *string `json:"fw_file_name,omitempty" yaml:"fw_file_name,omitempty"`

	// fw update state
	// Read Only: true
	// Enum: ["downloading","moving_firmware","starting_workers","waiting_on_workers","completed","failed"]
	FwUpdateState *string `json:"fw_update_state,omitempty" yaml:"fw_update_state,omitempty"`

	// job
	Job *JobLink `json:"job,omitempty" yaml:"job,omitempty"`

	// node
	Node *FirmwareHistoryInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type FirmwareHistoryInlineNode struct {
	...
	// links
	Links *FirmwareHistoryInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
