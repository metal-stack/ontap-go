...
type QuotaReport struct {
	...
	// links
	Links *QuotaReportInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// files
	Files *QuotaReportInlineFiles `json:"files,omitempty" yaml:"files,omitempty"`

	// group
	Group *QuotaReportInlineGroup `json:"group,omitempty" yaml:"group,omitempty"`
	...
	// volume
	Volume *QuotaReportInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type QuotaReportInlineFiles struct {
	...
	// used
	Used *QuotaReportInlineFilesInlineUsed `json:"used,omitempty" yaml:"used,omitempty"`
}
...
type QuotaReportInlineFilesInlineUsed struct {
	...
	// Read Only: true
	HardLimitPercent *int64 `json:"hard_limit_percent,omitempty" yaml:"hard_limit_percent,omitempty"`

	// Total files used as a percentage of file soft limit
	// Read Only: true
	SoftLimitPercent *int64 `json:"soft_limit_percent,omitempty" yaml:"soft_limit_percent,omitempty"`
...
type QuotaReportInlineQtree struct {
	...
	// links
	Links *QuotaReportInlineQtreeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type QuotaReportInlineSpace struct {
	...
	// used
	Used *QuotaReportInlineSpaceInlineUsed `json:"used,omitempty" yaml:"used,omitempty"`
}
...
type QuotaReportInlineSvm struct {
	...
	// links
	Links *QuotaReportInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
