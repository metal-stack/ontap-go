...
type ResourceTagResourceResponse struct {
	...
	// links
	Links *ResourceTagResourceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ResourceTagResourceResponseInlineRecords []*ResourceTagResource `json:"records,omitempty" yaml:"records,omitempty"`
}
