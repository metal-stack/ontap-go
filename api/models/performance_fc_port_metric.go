...
type PerformanceFcPortMetric struct {
	...
	// links
	Links *PerformanceFcPortMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceFcPortMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceFcPortMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceFcPortMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
