...
type LocalCifsUser struct {
	...
	// links
	Links *LocalCifsUserInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Indicates whether the user account is enabled or disabled.
	//
	AccountDisabled *bool `json:"account_disabled,omitempty" yaml:"account_disabled,omitempty"`
	...
	//
	// Read Only: true
	LocalCifsUserInlineMembership []*LocalCifsUserInlineMembershipInlineArrayItem `json:"membership,omitempty" yaml:"membership,omitempty"`
	...
	// svm
	Svm *LocalCifsUserInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type LocalCifsUserInlineMembershipInlineArrayItem struct {
	...
	// links
	Links *LocalCifsUserInlineMembershipInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LocalCifsUserInlineSvm struct {
	...
	// links
	Links *LocalCifsUserInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
