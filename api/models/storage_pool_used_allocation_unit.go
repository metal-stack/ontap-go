...
type StoragePoolUsedAllocationUnit struct {
	...
	// aggregate
	Aggregate *StoragePoolUsedAllocationUnitInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`
	...
	// Read Only: true
	CurrentUsage *int64 `json:"current_usage,omitempty" yaml:"current_usage,omitempty"`

	// node
	Node *StoragePoolUsedAllocationUnitInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type StoragePoolUsedAllocationUnitInlineAggregate struct {
	...
	// links
	Links *StoragePoolUsedAllocationUnitInlineAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type StoragePoolUsedAllocationUnitInlineNode struct {
	...
	// links
	Links *StoragePoolUsedAllocationUnitInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
