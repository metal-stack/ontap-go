...
type SnapmirrorDestinationCreation struct {
	...
	// bucket retention
	BucketRetention *SnapmirrorDestinationCreationInlineBucketRetention `json:"bucket_retention,omitempty" yaml:"bucket_retention,omitempty"`
	...
	// storage service
	StorageService *SnapmirrorDestinationCreationInlineStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`

	// tiering
	Tiering *SnapmirrorDestinationCreationInlineTiering `json:"tiering,omitempty" yaml:"tiering,omitempty"`
}
...
type SnapmirrorDestinationCreationInlineStorageService struct {
	...
	EnforcePerformance *bool `json:"enforce_performance,omitempty" yaml:"enforce_performance,omitempty"`
