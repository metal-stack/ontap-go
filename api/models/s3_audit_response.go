...
type S3AuditResponse struct {
	...
	// links
	Links *S3AuditResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	S3AuditResponseInlineRecords []*S3Audit `json:"records,omitempty" yaml:"records,omitempty"`
}
