...
type PeerReference struct {
	...
	// cluster
	Cluster *PeerReferenceInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// svm
	Svm *PeerReferenceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type PeerReferenceInlineCluster struct {
	...
	// links
	Links *PeerReferenceInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PeerReferenceInlineSvm struct {
	...
	// links
	Links *PeerReferenceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
