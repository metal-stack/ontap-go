...
type VscanOnAccessResponse struct {
	...
	// links
	Links *VscanOnAccessResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	VscanOnAccessResponseInlineRecords []*VscanOnAccess `json:"records,omitempty" yaml:"records,omitempty"`
}
