...
type AggregateSpare struct {
	...
	AggregateSpareInlineLayoutRequirements []*LayoutRequirement `json:"layout_requirements,omitempty" yaml:"layout_requirements,omitempty"`
	...
	// node
	Node *AggregateSpareInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// Read Only: true
	// Enum: ["pool0","pool1"]
	SyncmirrorPool *string `json:"syncmirror_pool,omitempty" yaml:"syncmirror_pool,omitempty"`
	...
	// Example: 9
	// Read Only: true
	Usable *int64 `json:"usable,omitempty" yaml:"usable,omitempty"`
}
...
type AggregateSpareInlineNode struct {
	...
	// links
	Links *AggregateSpareInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
