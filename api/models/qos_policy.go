...
type QosPolicy struct {
	...
	// links
	Links *QosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// adaptive
	Adaptive *QosPolicyInlineAdaptive `json:"adaptive,omitempty" yaml:"adaptive,omitempty"`

	// fixed
	Fixed *QosPolicyInlineFixed `json:"fixed,omitempty" yaml:"fixed,omitempty"`
	...
	// Read Only: true
	ObjectCount *int64 `json:"object_count,omitempty" yaml:"object_count,omitempty"`

	// Policy group ID of the QoS policy.
	// Read Only: true
	Pgid *int64 `json:"pgid,omitempty" yaml:"pgid,omitempty"`

	// Class of the QoS policy.
	// Read Only: true
	// Enum: ["undefined","preset","user_defined","system_defined","autovolume","load_control"]
	PolicyClass *string `json:"policy_class,omitempty" yaml:"policy_class,omitempty"`
	...
	// svm
	Svm *QosPolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type QosPolicyInlineAdaptive struct {
	...
	AbsoluteMinIops *int64 `json:"absolute_min_iops,omitempty" yaml:"absolute_min_iops,omitempty"`

	// Specifies the block size
	// Enum: ["any","4k","8k","16k","32k","64k","128k"]
	BlockSize *string `json:"block_size,omitempty" yaml:"block_size,omitempty"`
	...
	ExpectedIops *int64 `json:"expected_iops,omitempty" yaml:"expected_iops,omitempty"`
	...
	ExpectedIopsAllocation *string `json:"expected_iops_allocation,omitempty" yaml:"expected_iops_allocation,omitempty"`
	...
	PeakIops *int64 `json:"peak_iops,omitempty" yaml:"peak_iops,omitempty"`
	...
	// Enum: ["used_space","allocated_space"]
	PeakIopsAllocation *string `json:"peak_iops_allocation,omitempty" yaml:"peak_iops_allocation,omitempty"`
}
...
type QosPolicyInlineFixed struct {
	...
	CapacityShared *bool `json:"capacity_shared,omitempty" yaml:"capacity_shared,omitempty"`
...
type QosPolicyInlineSvm struct {
	...
	// links
	Links *QosPolicyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
