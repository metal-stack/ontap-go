...
type SecurityAssociation struct {
	...
	// ike
	Ike *SecurityAssociationInlineIke `json:"ike,omitempty" yaml:"ike,omitempty"`

	// ipsec
	Ipsec *SecurityAssociationInlineIpsec `json:"ipsec,omitempty" yaml:"ipsec,omitempty"`
	...
	// node
	Node *SecurityAssociationInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *SecurityAssociationInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type SecurityAssociationInlineIpsec struct {
	...
	// inbound
	Inbound *SecurityAssociationInlineIpsecInlineInbound `json:"inbound,omitempty" yaml:"inbound,omitempty"`

	// outbound
	Outbound *SecurityAssociationInlineIpsecInlineOutbound `json:"outbound,omitempty" yaml:"outbound,omitempty"`
...
type SecurityAssociationInlineNode struct {
	...
	// links
	Links *SecurityAssociationInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SecurityAssociationInlineSvm struct {
	...
	// links
	Links *SecurityAssociationInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
