...
type LunMapReportingNode struct {
	...
	// links
	Links *LunMapReportingNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// igroup
	Igroup *LunMapReportingNodeInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`

	// lun
	Lun *LunMapReportingNodeInlineLun `json:"lun,omitempty" yaml:"lun,omitempty"`
...
type LunMapReportingNodeInlineIgroup struct {
	...
	// links
	Links *LunMapReportingNodeInlineIgroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type LunMapReportingNodeInlineLun struct {
	...
	// links
	Links *LunMapReportingNodeInlineLunInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
