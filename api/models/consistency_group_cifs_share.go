...
type ConsistencyGroupCifsShare struct {
	...
	// links
	Links *ConsistencyGroupCifsShareInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ConsistencyGroupCifsShareInlineAcls []*ConsistencyGroupCifsShareInlineAclsInlineArrayItem `json:"acls,omitempty" yaml:"acls,omitempty"`
...
type ConsistencyGroupCifsShareInlineAclsInlineArrayItem struct {
	...
	// links
	Links *ConsistencyGroupCifsShareInlineAclsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
