...
type SnaplockComplianceClock struct {
	...
	// links
	Links *SnaplockComplianceClockInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// node
	Node *SnaplockComplianceClockInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type SnaplockComplianceClockInlineNode struct {
	...
	// links
	Links *SnaplockComplianceClockInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
