...
type Counter struct {
	...
	CounterInlineCounters []*Counter2d `json:"counters,omitempty" yaml:"counters,omitempty"`

	// List of labels for the first dimension.
	CounterInlineLabels []*string `json:"labels,omitempty" yaml:"labels,omitempty"`

	// List of values in a one-dimensional counter.
	CounterInlineValues []*int64 `json:"values,omitempty" yaml:"values,omitempty"`
