...
type Volume struct {
	...
	// links
	Links *VolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Indicates whether or not access time updates are enabled on the volume.
	AccessTimeEnabled *bool `json:"access_time_enabled,omitempty" yaml:"access_time_enabled,omitempty"`
	...
	// analytics
	Analytics *VolumeInlineAnalytics `json:"analytics,omitempty" yaml:"analytics,omitempty"`

	// anti ransomware
	AntiRansomware *VolumeInlineAntiRansomware `json:"anti_ransomware,omitempty" yaml:"anti_ransomware,omitempty"`

	// application
	Application *VolumeInlineApplication `json:"application,omitempty" yaml:"application,omitempty"`

	// asynchronous directory delete
	AsynchronousDirectoryDelete *VolumeInlineAsynchronousDirectoryDelete `json:"asynchronous_directory_delete,omitempty" yaml:"asynchronous_directory_delete,omitempty"`

	// autosize
	Autosize *VolumeInlineAutosize `json:"autosize,omitempty" yaml:"autosize,omitempty"`

	// clone
	Clone *VolumeInlineClone `json:"clone,omitempty" yaml:"clone,omitempty"`
	...
	CloudRetrievalPolicy *string `json:"cloud_retrieval_policy,omitempty" yaml:"cloud_retrieval_policy,omitempty"`
	...
	//
	CloudWriteEnabled *bool `json:"cloud_write_enabled,omitempty" yaml:"cloud_write_enabled,omitempty"`
	...
	// consistency group
	ConsistencyGroup *VolumeInlineConsistencyGroup `json:"consistency_group,omitempty" yaml:"consistency_group,omitempty"`
	...
	ConvertUnicode *bool `json:"convert_unicode,omitempty" yaml:"convert_unicode,omitempty"`
	...
	// efficiency
	Efficiency *VolumeInlineEfficiency `json:"efficiency,omitempty" yaml:"efficiency,omitempty"`

	// encryption
	Encryption *VolumeInlineEncryption `json:"encryption,omitempty" yaml:"encryption,omitempty"`

	// error state
	ErrorState *VolumeInlineErrorState `json:"error_state,omitempty" yaml:"error_state,omitempty"`

	// files
	Files *VolumeInlineFiles `json:"files,omitempty" yaml:"files,omitempty"`

	// flash pool
	FlashPool *VolumeInlineFlashPool `json:"flash_pool,omitempty" yaml:"flash_pool,omitempty"`
	...
	FlexcacheEndpointType *string `json:"flexcache_endpoint_type,omitempty" yaml:"flexcache_endpoint_type,omitempty"`
	...
	// Read Only: true
	IsObjectStore *bool `json:"is_object_store,omitempty" yaml:"is_object_store,omitempty"`

	// Specifies whether the volume is a root volume of the SVM it belongs to.
	// Read Only: true
	IsSvmRoot *bool `json:"is_svm_root,omitempty" yaml:"is_svm_root,omitempty"`
	...
	MaxDirSize *int64 `json:"max_dir_size,omitempty" yaml:"max_dir_size,omitempty"`

	// metric
	Metric *VolumeInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// movement
	Movement *VolumeInlineMovement `json:"movement,omitempty" yaml:"movement,omitempty"`
	...
	// qos
	Qos *VolumeInlineQos `json:"qos,omitempty" yaml:"qos,omitempty"`

	// Specifies whether the volume is queued for encryption.
	QueueForEncryption *bool `json:"queue_for_encryption,omitempty" yaml:"queue_for_encryption,omitempty"`

	// quota
	Quota *VolumeInlineQuota `json:"quota,omitempty" yaml:"quota,omitempty"`
	...
	ScheduledSnapshotNamingScheme *string `json:"scheduled_snapshot_naming_scheme,omitempty" yaml:"scheduled_snapshot_naming_scheme,omitempty"`
	...
	// snaplock
	Snaplock *VolumeInlineSnaplock `json:"snaplock,omitempty" yaml:"snaplock,omitempty"`
	...
	SnapshotDirectoryAccessEnabled *bool `json:"snapshot_directory_access_enabled,omitempty" yaml:"snapshot_directory_access_enabled,omitempty"`
	...
	// snapshot policy
	SnapshotPolicy *VolumeInlineSnapshotPolicy `json:"snapshot_policy,omitempty" yaml:"snapshot_policy,omitempty"`

	// space
	Space *VolumeInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`
	...
	// svm
	Svm *VolumeInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// tiering
	Tiering *VolumeInlineTiering `json:"tiering,omitempty" yaml:"tiering,omitempty"`
	...
	// Max Items: 64
	VolumeInlineTags []*string `json:"_tags,omitempty" yaml:"_tags,omitempty"`
	...
	// Read Only: true
	VolumeInlineStatus []*string `json:"status,omitempty" yaml:"status,omitempty"`
}
...
type VolumeInlineActivityTracking struct {
	...
	// unsupported reason
	UnsupportedReason *VolumeInlineActivityTrackingInlineUnsupportedReason `json:"unsupported_reason,omitempty" yaml:"unsupported_reason,omitempty"`
}
...
type VolumeInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *VolumeInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineAnalytics struct {
	...
	// Example: 43002
	// Read Only: true
	FilesScanned *int64 `json:"files_scanned,omitempty" yaml:"files_scanned,omitempty"`

	// initialization
	Initialization *VolumeInlineAnalyticsInlineInitialization `json:"initialization,omitempty" yaml:"initialization,omitempty"`
	...
	// Example: 17
	// Read Only: true
	ScanProgress *int64 `json:"scan_progress,omitempty" yaml:"scan_progress,omitempty"`

	// scan throttle reason
	ScanThrottleReason *VolumeInlineAnalyticsInlineScanThrottleReason `json:"scan_throttle_reason,omitempty" yaml:"scan_throttle_reason,omitempty"`
	...
	// Example: 101890
	// Read Only: true
	TotalFiles *int64 `json:"total_files,omitempty" yaml:"total_files,omitempty"`

	// unsupported reason
	UnsupportedReason *VolumeInlineAnalyticsInlineUnsupportedReason `json:"unsupported_reason,omitempty" yaml:"unsupported_reason,omitempty"`
}
...
type VolumeInlineAntiRansomware struct {
	...
	// attack reports
	// Read Only: true
	AttackReports []*AntiRansomwareAttackReport `json:"attack_reports,omitempty" yaml:"attack_reports,omitempty"`
	...
	// event log
	EventLog *VolumeInlineAntiRansomwareInlineEventLog `json:"event_log,omitempty" yaml:"event_log,omitempty"`

	// space
	Space *VolumeInlineAntiRansomwareInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`
...
type VolumeInlineAsynchronousDirectoryDelete struct {
	...
	TrashBin *string `json:"trash_bin,omitempty" yaml:"trash_bin,omitempty"`
}
...
type VolumeInlineAutosize struct {
	...
	ShrinkThreshold *int64 `json:"shrink_threshold,omitempty" yaml:"shrink_threshold,omitempty"`
}
...
type VolumeInlineClone struct {
	...
	// parent snapshot
	ParentSnapshot *SnapshotReference `json:"parent_snapshot,omitempty" yaml:"parent_snapshot,omitempty"`

	// parent svm
	ParentSvm *VolumeInlineCloneInlineParentSvm `json:"parent_svm,omitempty" yaml:"parent_svm,omitempty"`
...
type VolumeInlineCloneInlineParentSvm struct {
	...
	// links
	Links *VolumeInlineCloneInlineParentSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineConstituentsInlineArrayItem struct {
	...
	// aggregates
	Aggregates *VolumeInlineConstituentsInlineArrayItemInlineAggregates `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`
	...
	// space
	Space *VolumeInlineConstituentsInlineArrayItemInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`
}
...
type VolumeInlineConstituentsInlineArrayItemInlineMovement struct {
	...
	// Example: 30
	CutoverWindow *int64 `json:"cutover_window,omitempty" yaml:"cutover_window,omitempty"`

	// destination aggregate
	DestinationAggregate *VolumeInlineConstituentsInlineArrayItemInlineMovementInlineDestinationAggregate `json:"destination_aggregate,omitempty" yaml:"destination_aggregate,omitempty"`

	// Completion percentage
	// Read Only: true
	PercentComplete *int64 `json:"percent_complete,omitempty" yaml:"percent_complete,omitempty"`
	...
	TieringPolicy *string `json:"tiering_policy,omitempty" yaml:"tiering_policy,omitempty"`
}
...
type VolumeInlineConstituentsInlineArrayItemInlineMovementInlineDestinationAggregate struct {
	...
	// links
	Links *VolumeInlineConstituentsInlineArrayItemInlineMovementInlineDestinationAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineConstituentsInlineArrayItemInlineSpace struct {
	...
	AfsTotal *int64 `json:"afs_total,omitempty" yaml:"afs_total,omitempty"`
	...
	AvailablePercent *int64 `json:"available_percent,omitempty" yaml:"available_percent,omitempty"`
	...
	// Read Only: true
	BlockStorageInactiveUserData *int64 `json:"block_storage_inactive_user_data,omitempty" yaml:"block_storage_inactive_user_data,omitempty"`

	// Space used by capacity tier for this volume in the FabricPool aggregate, in bytes.
	// Read Only: true
	CapacityTierFootprint *int64 `json:"capacity_tier_footprint,omitempty" yaml:"capacity_tier_footprint,omitempty"`

	// Data used for this volume in the aggregate, in bytes.
	// Read Only: true
	Footprint *int64 `json:"footprint,omitempty" yaml:"footprint,omitempty"`

	// Specifies whether the support for large volumes and large files is enabled on the volume.
	LargeSizeEnabled *bool `json:"large_size_enabled,omitempty" yaml:"large_size_enabled,omitempty"`

	// Space used by the local tier for this volume in the aggregate, in bytes.
	// Read Only: true
	LocalTierFootprint *int64 `json:"local_tier_footprint,omitempty" yaml:"local_tier_footprint,omitempty"`

	// logical space
	LogicalSpace *VolumeInlineConstituentsInlineArrayItemInlineSpaceInlineLogicalSpace `json:"logical_space,omitempty" yaml:"logical_space,omitempty"`
	...
	// Read Only: true
	Metadata *int64 `json:"metadata,omitempty" yaml:"metadata,omitempty"`

	// The amount of space not available for this volume in the aggregate, in bytes.
	// Read Only: true
	OverProvisioned *int64 `json:"over_provisioned,omitempty" yaml:"over_provisioned,omitempty"`

	// Space used by the performance tier for this volume in the FabricPool aggregate, in bytes.
	// Read Only: true
	PerformanceTierFootprint *int64 `json:"performance_tier_footprint,omitempty" yaml:"performance_tier_footprint,omitempty"`

	// Total provisioned size. The default size is equal to the minimum size of 20MB, in bytes.
	Size *int64 `json:"size,omitempty" yaml:"size,omitempty"`

	// snapshot
	Snapshot *VolumeInlineConstituentsInlineArrayItemInlineSpaceInlineSnapshot `json:"snapshot,omitempty" yaml:"snapshot,omitempty"`

	// Data and metadata used for this volume in the aggregate, in bytes.
	// Read Only: true
	TotalFootprint *int64 `json:"total_footprint,omitempty" yaml:"total_footprint,omitempty"`

	// Space used by the total metadata in the volume, in bytes.
	// Read Only: true
	TotalMetadata *int64 `json:"total_metadata,omitempty" yaml:"total_metadata,omitempty"`

	// Space used by the volume metadata footprint in the aggregate, in bytes.
	// Read Only: true
	TotalMetadataFootprint *int64 `json:"total_metadata_footprint,omitempty" yaml:"total_metadata_footprint,omitempty"`
...
type VolumeInlineConstituentsInlineArrayItemInlineSpaceInlineLogicalSpace struct {
	...
	Enforcement *bool `json:"enforcement,omitempty" yaml:"enforcement,omitempty"`

	// Specifies whether space reporting on the volume is done along with storage efficiency.
	Reporting *bool `json:"reporting,omitempty" yaml:"reporting,omitempty"`
...
type VolumeInlineEfficiency struct {
	...
	ApplicationIoSize *string `json:"application_io_size,omitempty" yaml:"application_io_size,omitempty"`
	...
	// Read Only: true
	HasSavings *bool `json:"has_savings,omitempty" yaml:"has_savings,omitempty"`

	// idcs scanner
	IdcsScanner *VolumeInlineEfficiencyInlineIdcsScanner `json:"idcs_scanner,omitempty" yaml:"idcs_scanner,omitempty"`

	// Last sis operation begin timestamp.
	// Read Only: true
	LastOpBegin *string `json:"last_op_begin,omitempty" yaml:"last_op_begin,omitempty"`

	// Last sis operation end timestamp.
	// Read Only: true
	LastOpEnd *string `json:"last_op_end,omitempty" yaml:"last_op_end,omitempty"`

	// Last sis operation error text.
	// Read Only: true
	LastOpErr *string `json:"last_op_err,omitempty" yaml:"last_op_err,omitempty"`

	// Last sis operation size.
	// Read Only: true
	LastOpSize *int64 `json:"last_op_size,omitempty" yaml:"last_op_size,omitempty"`

	// Last sis operation state.
	// Read Only: true
	LastOpState *string `json:"last_op_state,omitempty" yaml:"last_op_state,omitempty"`

	// When true, indicates that space savings for any newly-written data are being logged.
	// Read Only: true
	LoggingEnabled *bool `json:"logging_enabled,omitempty" yaml:"logging_enabled,omitempty"`

	// Sis status of the volume.
	// Read Only: true
	// Enum: ["idle","initializing","active","undoing","pending","downgrading","disabled"]
	OpState *string `json:"op_state,omitempty" yaml:"op_state,omitempty"`

	// policy
	Policy *VolumeInlineEfficiencyInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
	...
	// scanner
	Scanner *VolumeInlineEfficiencyInlineScanner `json:"scanner,omitempty" yaml:"scanner,omitempty"`
	...
	// space savings
	SpaceSavings *VolumeInlineEfficiencyInlineSpaceSavings `json:"space_savings,omitempty" yaml:"space_savings,omitempty"`
	...
	StorageEfficiencyMode *string `json:"storage_efficiency_mode,omitempty" yaml:"storage_efficiency_mode,omitempty"`
...
type VolumeInlineEfficiencyInlineIdcsScanner struct {
	...
	InactiveDays *int64 `json:"inactive_days,omitempty" yaml:"inactive_days,omitempty"`
	...
	// Enum: ["idle","active"]
	OperationState *string `json:"operation_state,omitempty" yaml:"operation_state,omitempty"`
	...
	// Example: P14D
	// Read Only: true
	ThresholdInactiveTime *string `json:"threshold_inactive_time,omitempty" yaml:"threshold_inactive_time,omitempty"`
}
...
type VolumeInlineEfficiencyInlineScanner struct {
	...
	ScanOldData *bool `json:"scan_old_data,omitempty" yaml:"scan_old_data,omitempty"`
...
type VolumeInlineEfficiencyInlineSpaceSavings struct {
	...
	// Read Only: true
	Compression *int64 `json:"compression,omitempty" yaml:"compression,omitempty"`

	// Percentage of total disk space that is saved by compressing blocks on the referenced file system.
	// Read Only: true
	CompressionPercent *int64 `json:"compression_percent,omitempty" yaml:"compression_percent,omitempty"`

	// Total disk space that is saved by deduplication and file cloning, in bytes.
	// Read Only: true
	Dedupe *int64 `json:"dedupe,omitempty" yaml:"dedupe,omitempty"`

	// Percentage of total disk space that is saved by deduplication and file cloning.
	// Read Only: true
	DedupePercent *int64 `json:"dedupe_percent,omitempty" yaml:"dedupe_percent,omitempty"`

	// Total disk space that is shared due to deduplication and file cloning.
	// Read Only: true
	DedupeSharing *int64 `json:"dedupe_sharing,omitempty" yaml:"dedupe_sharing,omitempty"`
	...
	// Read Only: true
	TotalPercent *int64 `json:"total_percent,omitempty" yaml:"total_percent,omitempty"`
}
...
type VolumeInlineEncryption struct {
	...
	// Read Only: true
	// Format: date-time
	KeyCreateTime *strfmt.DateTime `json:"key_create_time,omitempty" yaml:"key_create_time,omitempty"`
	...
	KeyManagerAttribute *string `json:"key_manager_attribute,omitempty" yaml:"key_manager_attribute,omitempty"`

	// If set to 'true', re-encrypts the volume with a new key. Valid in PATCH.
	Rekey *bool `json:"rekey,omitempty" yaml:"rekey,omitempty"`
	...
	// status
	Status *VolumeInlineEncryptionInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
...
type VolumeInlineErrorState struct {
	...
	// Read Only: true
	HasBadBlocks *bool `json:"has_bad_blocks,omitempty" yaml:"has_bad_blocks,omitempty"`
	...
	// Read Only: true
	IsInconsistent *bool `json:"is_inconsistent,omitempty" yaml:"is_inconsistent,omitempty"`
}
...
type VolumeInlineFlashPool struct {
	...
	CacheEligibility *string `json:"cache_eligibility,omitempty" yaml:"cache_eligibility,omitempty"`
	...
	CacheRetentionPriority *string `json:"cache_retention_priority,omitempty" yaml:"cache_retention_priority,omitempty"`
	...
	CachingPolicy *string `json:"caching_policy,omitempty" yaml:"caching_policy,omitempty"`
}
...
type VolumeInlineGuarantee struct {
	...
	// Read Only: true
	Honored *bool `json:"honored,omitempty" yaml:"honored,omitempty"`
...
type VolumeInlineMetric struct {
	...
	// links
	Links *VolumeInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cloud
	Cloud *VolumeInlineMetricInlineCloud `json:"cloud,omitempty" yaml:"cloud,omitempty"`
	...
	// flexcache
	Flexcache *VolumeInlineMetricInlineFlexcache `json:"flexcache,omitempty" yaml:"flexcache,omitempty"`

	// iops
	Iops *VolumeInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *VolumeInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *VolumeInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type VolumeInlineMetricInlineCloud struct {
	...
	// iops
	Iops *VolumeInlineMetricInlineCloudInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *VolumeInlineMetricInlineCloudInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
...
type VolumeInlineMetricInlineFlexcache struct {
	...
	// Example: 4096
	BandwidthSavings *int64 `json:"bandwidth_savings,omitempty" yaml:"bandwidth_savings,omitempty"`

	// Cache miss percentage.
	// Example: 20
	CacheMissPercent *int64 `json:"cache_miss_percent,omitempty" yaml:"cache_miss_percent,omitempty"`
...
type VolumeInlineMovement struct {
	...
	CapacityTierOptimized *bool `json:"capacity_tier_optimized,omitempty" yaml:"capacity_tier_optimized,omitempty"`
	...
	// destination aggregate
	DestinationAggregate *VolumeInlineMovementInlineDestinationAggregate `json:"destination_aggregate,omitempty" yaml:"destination_aggregate,omitempty"`
...
type VolumeInlineMovementInlineDestinationAggregate struct {
	...
	// links
	Links *VolumeInlineMovementInlineDestinationAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineNas struct {
	...
	// export policy
	ExportPolicy *VolumeInlineNasInlineExportPolicy `json:"export_policy,omitempty" yaml:"export_policy,omitempty"`

	// The UNIX group ID of the volume. Valid in POST or PATCH.
	Gid *int64 `json:"gid,omitempty" yaml:"gid,omitempty"`

	// junction parent
	JunctionParent *VolumeInlineNasInlineJunctionParent `json:"junction_parent,omitempty" yaml:"junction_parent,omitempty"`
...
type VolumeInlineNasInlineExportPolicy struct {
	...
	// links
	Links *VolumeInlineNasInlineExportPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineNasInlineJunctionParent struct {
	...
	// links
	Links *VolumeInlineNasInlineJunctionParentInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineQos struct {
	...
	// policy
	Policy *VolumeInlineQosInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
}
...
type VolumeInlineQosInlinePolicy struct {
	...
	// links
	Links *VolumeInlineQosInlinePolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineRebalancing struct {
	...
	// links
	Links *VolumeInlineRebalancingInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	DataMoved *int64 `json:"data_moved,omitempty" yaml:"data_moved,omitempty"`
	...
	// Read Only: true
	ImbalancePercent *int64 `json:"imbalance_percent,omitempty" yaml:"imbalance_percent,omitempty"`

	// Represents how much the volume is out of balance, in bytes.
	// Read Only: true
	ImbalanceSize *int64 `json:"imbalance_size,omitempty" yaml:"imbalance_size,omitempty"`
	...
	// Read Only: true
	MaxConstituentImbalancePercent *int64 `json:"max_constituent_imbalance_percent,omitempty" yaml:"max_constituent_imbalance_percent,omitempty"`
	...
	MaxFileMoves *int64 `json:"max_file_moves,omitempty" yaml:"max_file_moves,omitempty"`
	...
	MaxThreshold *int64 `json:"max_threshold,omitempty" yaml:"max_threshold,omitempty"`
	...
	MinFileSize *int64 `json:"min_file_size,omitempty" yaml:"min_file_size,omitempty"`
	...
	MinThreshold *int64 `json:"min_threshold,omitempty" yaml:"min_threshold,omitempty"`

	// Capacity rebalancing notice messages.
	// Read Only: true
	Notices []*Error `json:"notices,omitempty" yaml:"notices,omitempty"`
	...
	// Read Only: true
	// Format: date-time
	StopTime *strfmt.DateTime `json:"stop_time,omitempty" yaml:"stop_time,omitempty"`
...
type VolumeInlineRebalancingInlineEngine struct {
	...
	// movement
	Movement *VolumeInlineRebalancingInlineEngineInlineMovement `json:"movement,omitempty" yaml:"movement,omitempty"`

	// scanner
	Scanner *VolumeInlineRebalancingInlineEngineInlineScanner `json:"scanner,omitempty" yaml:"scanner,omitempty"`
}
...
type VolumeInlineRebalancingInlineEngineInlineMovement struct {
	...
	// Read Only: true
	FileMovesStarted *int64 `json:"file_moves_started,omitempty" yaml:"file_moves_started,omitempty"`

	// last error
	LastError *VolumeInlineRebalancingInlineEngineInlineMovementInlineLastError `json:"last_error,omitempty" yaml:"last_error,omitempty"`

	// Start time of the most recent file move on the constituent.
	// Example: 2018-06-04 19:00:00
	// Read Only: true
	// Format: date-time
	MostRecentStartTime *strfmt.DateTime `json:"most_recent_start_time,omitempty" yaml:"most_recent_start_time,omitempty"`
}
...
type VolumeInlineRebalancingInlineEngineInlineMovementInlineLastError struct {
	...
	// Read Only: true
	Destination *int64 `json:"destination,omitempty" yaml:"destination,omitempty"`

	// File ID of the last file move error on the constituent.
	// Read Only: true
	FileID *int64 `json:"file_id,omitempty" yaml:"file_id,omitempty"`
...
type VolumeInlineRebalancingInlineEngineInlineScanner struct {
	...
	// Read Only: true
	BlocksScanned *int64 `json:"blocks_scanned,omitempty" yaml:"blocks_scanned,omitempty"`

	// blocks skipped
	BlocksSkipped *VolumeInlineRebalancingInlineEngineInlineScannerInlineBlocksSkipped `json:"blocks_skipped,omitempty" yaml:"blocks_skipped,omitempty"`
	...
	// files skipped
	FilesSkipped *VolumeInlineRebalancingInlineEngineInlineScannerInlineFilesSkipped `json:"files_skipped,omitempty" yaml:"files_skipped,omitempty"`
}
...
type VolumeInlineRebalancingInlineEngineInlineScannerInlineBlocksSkipped struct {
	...
	// Read Only: true
	EfficiencyBlocks *int64 `json:"efficiency_blocks,omitempty" yaml:"efficiency_blocks,omitempty"`

	// Number of blocks skipped by the scanner on this constituent because storage efficiency lost, in percent, would be too high.
	// Read Only: true
	EfficiencyPercent *int64 `json:"efficiency_percent,omitempty" yaml:"efficiency_percent,omitempty"`

	// Number of blocks skipped by the scanner on this constituent because fast truncate is currently running on files.
	// Read Only: true
	FastTruncate *int64 `json:"fast_truncate,omitempty" yaml:"fast_truncate,omitempty"`
	...
	// Read Only: true
	Incompatible *int64 `json:"incompatible,omitempty" yaml:"incompatible,omitempty"`
	...
	// Read Only: true
	OnDemandDestination *int64 `json:"on_demand_destination,omitempty" yaml:"on_demand_destination,omitempty"`
	...
	// Read Only: true
	RemoteCache *int64 `json:"remote_cache,omitempty" yaml:"remote_cache,omitempty"`
	...
	// Read Only: true
	TooLarge *int64 `json:"too_large,omitempty" yaml:"too_large,omitempty"`
	...
	// Read Only: true
	TooSmall *int64 `json:"too_small,omitempty" yaml:"too_small,omitempty"`

	// Number of blocks skipped by the scanner on this constituent because of files fenced for write operations.
	// Read Only: true
	WriteFenced *int64 `json:"write_fenced,omitempty" yaml:"write_fenced,omitempty"`
}
...
type VolumeInlineSnaplock struct {
	...
	// Example: true
	// Read Only: true
	IsAuditLog *bool `json:"is_audit_log,omitempty" yaml:"is_audit_log,omitempty"`

	// Litigation count indicates the number of active legal-holds on the volume.
	// Example: 10
	// Read Only: true
	LitigationCount *int64 `json:"litigation_count,omitempty" yaml:"litigation_count,omitempty"`
	...
	PrivilegedDelete *string `json:"privileged_delete,omitempty" yaml:"privileged_delete,omitempty"`

	// retention
	Retention *VolumeInlineSnaplockInlineRetention `json:"retention,omitempty" yaml:"retention,omitempty"`
	...
	// Example: 10
	// Read Only: true
	UnspecifiedRetentionFileCount *int64 `json:"unspecified_retention_file_count,omitempty" yaml:"unspecified_retention_file_count,omitempty"`
}
...
type VolumeInlineSnapmirror struct {
	...
	// destinations
	Destinations *VolumeInlineSnapmirrorInlineDestinations `json:"destinations,omitempty" yaml:"destinations,omitempty"`

	// Specifies whether a volume is a SnapMirror source volume, using SnapMirror to protect its data.
	// Read Only: true
	IsProtected *bool `json:"is_protected,omitempty" yaml:"is_protected,omitempty"`
}
...
type VolumeInlineSnapmirrorInlineDestinations struct {
	...
	// Read Only: true
	IsOntap *bool `json:"is_ontap,omitempty" yaml:"is_ontap,omitempty"`
}
...
type VolumeInlineSnapshotPolicy struct {
	...
	// links
	Links *VolumeInlineSnapshotPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineSpace struct {
	...
	// Read Only: true
	AutoAdaptiveCompressionFootprintDataReduction *int64 `json:"auto_adaptive_compression_footprint_data_reduction,omitempty" yaml:"auto_adaptive_compression_footprint_data_reduction,omitempty"`
	...
	// Read Only: true
	BlockStorageInactiveUserDataPercent *int64 `json:"block_storage_inactive_user_data_percent,omitempty" yaml:"block_storage_inactive_user_data_percent,omitempty"`
	...
	// Read Only: true
	CapacityTierFootprintDataReduction *int64 `json:"capacity_tier_footprint_data_reduction,omitempty" yaml:"capacity_tier_footprint_data_reduction,omitempty"`

	// Savings achieved due to Data Compaction, in bytes.
	// Read Only: true
	CompactionFootprintDataReduction *int64 `json:"compaction_footprint_data_reduction,omitempty" yaml:"compaction_footprint_data_reduction,omitempty"`

	// Cross volume deduplication metadata footprint, in bytes.
	// Read Only: true
	CrossVolumeDedupeMetafilesFootprint *int64 `json:"cross_volume_dedupe_metafiles_footprint,omitempty" yaml:"cross_volume_dedupe_metafiles_footprint,omitempty"`

	// Cross volume temporary deduplication metadata footprint, in bytes.
	// Read Only: true
	CrossVolumeDedupeMetafilesTemporaryFootprint *int64 `json:"cross_volume_dedupe_metafiles_temporary_footprint,omitempty" yaml:"cross_volume_dedupe_metafiles_temporary_footprint,omitempty"`

	// Deduplication metadata footprint, in bytes.
	// Read Only: true
	DedupeMetafilesFootprint *int64 `json:"dedupe_metafiles_footprint,omitempty" yaml:"dedupe_metafiles_footprint,omitempty"`

	// Temporary deduplication metadata footprint, in bytes.
	// Read Only: true
	DedupeMetafilesTemporaryFootprint *int64 `json:"dedupe_metafiles_temporary_footprint,omitempty" yaml:"dedupe_metafiles_temporary_footprint,omitempty"`

	// Delayed free blocks footprint, in bytes.
	// Read Only: true
	DelayedFreeFootprint *int64 `json:"delayed_free_footprint,omitempty" yaml:"delayed_free_footprint,omitempty"`
	...
	// Read Only: true
	EffectiveTotalFootprint *int64 `json:"effective_total_footprint,omitempty" yaml:"effective_total_footprint,omitempty"`

	// Size that should be available for the volume, irrespective of available size in the aggregate, in bytes.
	ExpectedAvailable *int64 `json:"expected_available,omitempty" yaml:"expected_available,omitempty"`

	// File operation metadata footprint, in bytes.
	// Read Only: true
	FileOperationMetadata *int64 `json:"file_operation_metadata,omitempty" yaml:"file_operation_metadata,omitempty"`

	// Total usable size of the volume, in bytes.
	// Read Only: true
	FilesystemSize *int64 `json:"filesystem_size,omitempty" yaml:"filesystem_size,omitempty"`
	...
	FilesystemSizeFixed *bool `json:"filesystem_size_fixed,omitempty" yaml:"filesystem_size_fixed,omitempty"`
	...
	FractionalReserve *int64 `json:"fractional_reserve,omitempty" yaml:"fractional_reserve,omitempty"`

	// Volume full threshold percentage at which EMS warnings can be sent.
	FullThresholdPercent *int64 `json:"full_threshold_percent,omitempty" yaml:"full_threshold_percent,omitempty"`

	// Specifies if the virtual space used is stale.
	// Read Only: true
	IsUsedStale *bool `json:"is_used_stale,omitempty" yaml:"is_used_stale,omitempty"`
	...
	// logical space
	LogicalSpace *VolumeInlineSpaceInlineLogicalSpace `json:"logical_space,omitempty" yaml:"logical_space,omitempty"`
	...
	NearlyFullThresholdPercent *int64 `json:"nearly_full_threshold_percent,omitempty" yaml:"nearly_full_threshold_percent,omitempty"`
	...
	// Read Only: true
	OverwriteReserve *int64 `json:"overwrite_reserve,omitempty" yaml:"overwrite_reserve,omitempty"`

	// Overwrite logical reserve space used, in bytes.
	// Read Only: true
	OverwriteReserveUsed *int64 `json:"overwrite_reserve_used,omitempty" yaml:"overwrite_reserve_used,omitempty"`

	// Percentage of the volume size that is used.
	// Read Only: true
	PercentUsed *int64 `json:"percent_used,omitempty" yaml:"percent_used,omitempty"`
	...
	// Read Only: true
	SnapmirrorDestinationFootprint *int64 `json:"snapmirror_destination_footprint,omitempty" yaml:"snapmirror_destination_footprint,omitempty"`
	...
	// Read Only: true
	SnapshotSpill *int64 `json:"snapshot_spill,omitempty" yaml:"snapshot_spill,omitempty"`
	...
	// User data, in bytes.
	// Read Only: true
	UserData *int64 `json:"user_data,omitempty" yaml:"user_data,omitempty"`

	// Space reserved for future writes in the volume, in bytes.
	// Read Only: true
	VolumeGuaranteeFootprint *int64 `json:"volume_guarantee_footprint,omitempty" yaml:"volume_guarantee_footprint,omitempty"`
}
...
type VolumeInlineStatistics struct {
	...
	// cifs ops raw
	CifsOpsRaw *VolumeInlineStatisticsInlineCifsOpsRaw `json:"cifs_ops_raw,omitempty" yaml:"cifs_ops_raw,omitempty"`

	// cloud
	Cloud *VolumeInlineStatisticsInlineCloud `json:"cloud,omitempty" yaml:"cloud,omitempty"`

	// flexcache raw
	FlexcacheRaw *VolumeInlineStatisticsInlineFlexcacheRaw `json:"flexcache_raw,omitempty" yaml:"flexcache_raw,omitempty"`

	// iops raw
	IopsRaw *VolumeInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *VolumeInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`

	// nfs ops raw
	NfsOpsRaw *VolumeInlineStatisticsInlineNfsOpsRaw `json:"nfs_ops_raw,omitempty" yaml:"nfs_ops_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *VolumeInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type VolumeInlineStatisticsInlineCifsOpsRaw struct {
	...
	// access
	Access *VolumeInlineStatisticsInlineCifsOpsRawInlineAccess `json:"access,omitempty" yaml:"access,omitempty"`

	// audit
	Audit *VolumeInlineStatisticsInlineCifsOpsRawInlineAudit `json:"audit,omitempty" yaml:"audit,omitempty"`

	// create
	Create *VolumeInlineStatisticsInlineCifsOpsRawInlineCreate `json:"create,omitempty" yaml:"create,omitempty"`

	// getattr
	Getattr *VolumeInlineStatisticsInlineCifsOpsRawInlineGetattr `json:"getattr,omitempty" yaml:"getattr,omitempty"`

	// link
	Link *VolumeInlineStatisticsInlineCifsOpsRawInlineLink `json:"link,omitempty" yaml:"link,omitempty"`

	// lock
	Lock *VolumeInlineStatisticsInlineCifsOpsRawInlineLock `json:"lock,omitempty" yaml:"lock,omitempty"`

	// lookup
	Lookup *VolumeInlineStatisticsInlineCifsOpsRawInlineLookup `json:"lookup,omitempty" yaml:"lookup,omitempty"`

	// open
	Open *VolumeInlineStatisticsInlineCifsOpsRawInlineOpen `json:"open,omitempty" yaml:"open,omitempty"`

	// read
	Read *VolumeInlineStatisticsInlineCifsOpsRawInlineRead `json:"read,omitempty" yaml:"read,omitempty"`

	// readdir
	Readdir *VolumeInlineStatisticsInlineCifsOpsRawInlineReaddir `json:"readdir,omitempty" yaml:"readdir,omitempty"`

	// readlink
	Readlink *VolumeInlineStatisticsInlineCifsOpsRawInlineReadlink `json:"readlink,omitempty" yaml:"readlink,omitempty"`

	// rename
	Rename *VolumeInlineStatisticsInlineCifsOpsRawInlineRename `json:"rename,omitempty" yaml:"rename,omitempty"`

	// setattr
	Setattr *VolumeInlineStatisticsInlineCifsOpsRawInlineSetattr `json:"setattr,omitempty" yaml:"setattr,omitempty"`

	// unlink
	Unlink *VolumeInlineStatisticsInlineCifsOpsRawInlineUnlink `json:"unlink,omitempty" yaml:"unlink,omitempty"`

	// watch
	Watch *VolumeInlineStatisticsInlineCifsOpsRawInlineWatch `json:"watch,omitempty" yaml:"watch,omitempty"`

	// write
	Write *VolumeInlineStatisticsInlineCifsOpsRawInlineWrite `json:"write,omitempty" yaml:"write,omitempty"`
}
...
type VolumeInlineStatisticsInlineCifsOpsRawInlineAccess struct {
	...
	// Example: 200
	TotalTime *int64 `json:"total_time,omitempty" yaml:"total_time,omitempty"`
}
...
type VolumeInlineStatisticsInlineCifsOpsRawInlineCreate struct {
	...
	// dir
	Dir *VolumeInlineStatisticsInlineCifsOpsRawInlineCreateInlineDir `json:"dir,omitempty" yaml:"dir,omitempty"`

	// file
	File *VolumeInlineStatisticsInlineCifsOpsRawInlineCreateInlineFile `json:"file,omitempty" yaml:"file,omitempty"`

	// other
	Other *VolumeInlineStatisticsInlineCifsOpsRawInlineCreateInlineOther `json:"other,omitempty" yaml:"other,omitempty"`

	// symlink
	Symlink *VolumeInlineStatisticsInlineCifsOpsRawInlineCreateInlineSymlink `json:"symlink,omitempty" yaml:"symlink,omitempty"`
}
...
type VolumeInlineStatisticsInlineCifsOpsRawInlineRead struct {
	...
	VolumeProtocolLatencyHistogramCounts []*int64 `json:"volume_protocol_latency_histogram_counts,omitempty" yaml:"volume_protocol_latency_histogram_counts,omitempty"`
	...
	VolumeProtocolLatencyHistogramLabels []*string `json:"volume_protocol_latency_histogram_labels,omitempty" yaml:"volume_protocol_latency_histogram_labels,omitempty"`

	// volume protocol size histogram counts
	// Example: [2400,1055,1100,700,500,300,200,100,100,50,50,75,25,0,0]
	VolumeProtocolSizeHistogramCounts []*int64 `json:"volume_protocol_size_histogram_counts,omitempty" yaml:"volume_protocol_size_histogram_counts,omitempty"`
	...
	VolumeProtocolSizeHistogramLabels []*string `json:"volume_protocol_size_histogram_labels,omitempty" yaml:"volume_protocol_size_histogram_labels,omitempty"`
}
...
type VolumeInlineStatisticsInlineCloud struct {
	...
	// iops raw
	IopsRaw *VolumeInlineStatisticsInlineCloudInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *VolumeInlineStatisticsInlineCloudInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
...
type VolumeInlineStatisticsInlineFlexcacheRaw struct {
	...
	// Example: 10
	CacheMissBlocks *int64 `json:"cache_miss_blocks,omitempty" yaml:"cache_miss_blocks,omitempty"`

	// Total blocks requested by the client.
	// Example: 500
	ClientRequestedBlocks *int64 `json:"client_requested_blocks,omitempty" yaml:"client_requested_blocks,omitempty"`
...
type VolumeInlineStatisticsInlineNfsOpsRaw struct {
	...
	// access
	Access *VolumeInlineStatisticsInlineNfsOpsRawInlineAccess `json:"access,omitempty" yaml:"access,omitempty"`

	// audit
	Audit *VolumeInlineStatisticsInlineNfsOpsRawInlineAudit `json:"audit,omitempty" yaml:"audit,omitempty"`

	// create
	Create *VolumeInlineStatisticsInlineNfsOpsRawInlineCreate `json:"create,omitempty" yaml:"create,omitempty"`

	// getattr
	Getattr *VolumeInlineStatisticsInlineNfsOpsRawInlineGetattr `json:"getattr,omitempty" yaml:"getattr,omitempty"`

	// link
	Link *VolumeInlineStatisticsInlineNfsOpsRawInlineLink `json:"link,omitempty" yaml:"link,omitempty"`

	// lock
	Lock *VolumeInlineStatisticsInlineNfsOpsRawInlineLock `json:"lock,omitempty" yaml:"lock,omitempty"`

	// lookup
	Lookup *VolumeInlineStatisticsInlineNfsOpsRawInlineLookup `json:"lookup,omitempty" yaml:"lookup,omitempty"`

	// open
	Open *VolumeInlineStatisticsInlineNfsOpsRawInlineOpen `json:"open,omitempty" yaml:"open,omitempty"`

	// read
	Read *VolumeInlineStatisticsInlineNfsOpsRawInlineRead `json:"read,omitempty" yaml:"read,omitempty"`

	// readdir
	Readdir *VolumeInlineStatisticsInlineNfsOpsRawInlineReaddir `json:"readdir,omitempty" yaml:"readdir,omitempty"`

	// readlink
	Readlink *VolumeInlineStatisticsInlineNfsOpsRawInlineReadlink `json:"readlink,omitempty" yaml:"readlink,omitempty"`

	// rename
	Rename *VolumeInlineStatisticsInlineNfsOpsRawInlineRename `json:"rename,omitempty" yaml:"rename,omitempty"`

	// setattr
	Setattr *VolumeInlineStatisticsInlineNfsOpsRawInlineSetattr `json:"setattr,omitempty" yaml:"setattr,omitempty"`

	// unlink
	Unlink *VolumeInlineStatisticsInlineNfsOpsRawInlineUnlink `json:"unlink,omitempty" yaml:"unlink,omitempty"`

	// watch
	Watch *VolumeInlineStatisticsInlineNfsOpsRawInlineWatch `json:"watch,omitempty" yaml:"watch,omitempty"`

	// write
	Write *VolumeInlineStatisticsInlineNfsOpsRawInlineWrite `json:"write,omitempty" yaml:"write,omitempty"`
}
...
type VolumeInlineStatisticsInlineNfsOpsRawInlineCreate struct {
	...
	// dir
	Dir *VolumeInlineStatisticsInlineNfsOpsRawInlineCreateInlineDir `json:"dir,omitempty" yaml:"dir,omitempty"`

	// file
	File *VolumeInlineStatisticsInlineNfsOpsRawInlineCreateInlineFile `json:"file,omitempty" yaml:"file,omitempty"`

	// other
	Other *VolumeInlineStatisticsInlineNfsOpsRawInlineCreateInlineOther `json:"other,omitempty" yaml:"other,omitempty"`

	// symlink
	Symlink *VolumeInlineStatisticsInlineNfsOpsRawInlineCreateInlineSymlink `json:"symlink,omitempty" yaml:"symlink,omitempty"`
}
...
type VolumeInlineSvm struct {
	...
	// links
	Links *VolumeInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VolumeInlineTiering struct {
	...
	// Maximum: 183
	// Minimum: 2
	MinCoolingDays *int64 `json:"min_cooling_days,omitempty" yaml:"min_cooling_days,omitempty"`
