...
type SnaplockFileFingerprint struct {
	...
	// links
	Links *SnaplockFileFingerprintInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	DataFingerprint *string `json:"data_fingerprint,omitempty" yaml:"data_fingerprint,omitempty"`
	...
	// Read Only: true
	MetadataFingerprint *string `json:"metadata_fingerprint,omitempty" yaml:"metadata_fingerprint,omitempty"`
	...
	// svm
	Svm *SnaplockFileFingerprintInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *SnaplockFileFingerprintInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SnaplockFileFingerprintInlineSvm struct {
	...
	// links
	Links *SnaplockFileFingerprintInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnaplockFileFingerprintInlineVolume struct {
	...
	// links
	Links *SnaplockFileFingerprintInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
