...
type EmsRoleConfigResponse struct {
	...
	// links
	Links *EmsRoleConfigResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ems role config response inline records
	EmsRoleConfigResponseInlineRecords []*EmsRoleConfigResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type EmsRoleConfigResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access control role
	AccessControlRole *EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineAccessControlRole `json:"access_control_role,omitempty" yaml:"access_control_role,omitempty"`

	// event filter
	EventFilter *EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineEventFilter `json:"event_filter,omitempty" yaml:"event_filter,omitempty"`

	// Indicates whether the access control has limited access to global EMS configurations.
	LimitAccessToGlobalConfigs *bool `json:"limit_access_to_global_configs,omitempty" yaml:"limit_access_to_global_configs,omitempty"`
}
...
type EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineAccessControlRole struct {
	...
	// links
	Links *EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineAccessControlRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineEventFilter struct {
	...
	// links
	Links *EmsRoleConfigResponseInlineRecordsInlineArrayItemInlineEventFilterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
