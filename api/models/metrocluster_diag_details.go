...
type MetroclusterDiagDetails struct {
	...
	// aggregate
	Aggregate *MetroclusterDiagDetailsInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// cluster
	Cluster *MetroclusterDiagDetailsInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// Collection of MetroCluster checks done for component.
	// Read Only: true
	MetroclusterDiagDetailsInlineChecks []*MetroclusterDiagCheck `json:"checks,omitempty" yaml:"checks,omitempty"`

	// node
	Node *MetroclusterDiagDetailsInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// volume
	Volume *MetroclusterDiagDetailsInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type MetroclusterDiagDetailsInlineAggregate struct {
	...
	// links
	Links *MetroclusterDiagDetailsInlineAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterDiagDetailsInlineCluster struct {
	...
	// links
	Links *MetroclusterDiagDetailsInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterDiagDetailsInlineNode struct {
	...
	// links
	Links *MetroclusterDiagDetailsInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterDiagDetailsInlineVolume struct {
	...
	// links
	Links *MetroclusterDiagDetailsInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
