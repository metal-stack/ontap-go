...
type EmsApplicationLog struct {
	...
	// Example: false
	AutosupportRequired *bool `json:"autosupport_required,omitempty" yaml:"autosupport_required,omitempty"`
	...
	EventDescription *string `json:"event_description,omitempty" yaml:"event_description,omitempty"`
	...
	EventSource *string `json:"event_source,omitempty" yaml:"event_source,omitempty"`
