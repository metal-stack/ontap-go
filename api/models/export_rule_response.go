...
type ExportRuleResponse struct {
	...
	// links
	Links *ExportRuleResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// export rule response inline records
	ExportRuleResponseInlineRecords []*ExportRule `json:"records,omitempty" yaml:"records,omitempty"`
