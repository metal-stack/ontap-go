...
type SnaplockRetentionPolicy struct {
	...
	// links
	Links *SnaplockRetentionPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *SnaplockRetentionPolicyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type SnaplockRetentionPolicyInlineSvm struct {
	...
	// links
	Links *SnaplockRetentionPolicyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
