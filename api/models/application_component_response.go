...
type ApplicationComponentResponse struct {
	...
	// links
	Links *ApplicationComponentResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// application component response inline records
	ApplicationComponentResponseInlineRecords []*ApplicationComponent `json:"records,omitempty" yaml:"records,omitempty"`
