...
type S3PolicyStatement struct {
	...
	//
	// Example: ["*"]
	S3PolicyStatementInlineActions []*string `json:"actions,omitempty" yaml:"actions,omitempty"`

	// s3 policy statement inline resources
	// Example: ["bucket1","bucket1/*"]
	S3PolicyStatementInlineResources []*string `json:"resources,omitempty" yaml:"resources,omitempty"`
