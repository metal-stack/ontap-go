...
type MetroclusterInterconnect struct {
	...
	MetroclusterInterconnectInlineInterfaces []*MetroclusterInterconnectInlineInterfacesInlineArrayItem `json:"interfaces,omitempty" yaml:"interfaces,omitempty"`

	// mirror
	Mirror *MetroclusterInterconnectInlineMirror `json:"mirror,omitempty" yaml:"mirror,omitempty"`
	...
	MultipathPolicy *string `json:"multipath_policy,omitempty" yaml:"multipath_policy,omitempty"`

	// node
	Node *MetroclusterInterconnectInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// Partner type
	// Required: true
	// Read Only: true
	// Enum: ["aux","dr","ha"]
	PartnerType *string `json:"partner_type" yaml:"partner_type"`
...
type MetroclusterInterconnectInlineNode struct {
	...
	// links
	Links *MetroclusterInterconnectInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
