...
type FpolicyEvents struct {
	...
	// file operations
	FileOperations *FpolicyEventsInlineFileOperations `json:"file_operations,omitempty" yaml:"file_operations,omitempty"`

	// filters
	Filters *FpolicyEventsInlineFilters `json:"filters,omitempty" yaml:"filters,omitempty"`
