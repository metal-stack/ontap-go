...
type ShadowcopyResponse struct {
	...
	// links
	Links *ShadowcopyResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ShadowcopyResponseInlineRecords []*Shadowcopy `json:"records,omitempty" yaml:"records,omitempty"`
}
