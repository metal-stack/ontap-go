...
type NetworkHTTPProxy struct {
	...
	// links
	Links *NetworkHTTPProxyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Specifies whether or not authentication with the HTTP proxy server is enabled.
	//
	AuthenticationEnabled *bool `json:"authentication_enabled,omitempty" yaml:"authentication_enabled,omitempty"`

	// ipspace
	Ipspace *NetworkHTTPProxyInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
	...
	// svm
	Svm *NetworkHTTPProxyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type NetworkHTTPProxyInlineIpspace struct {
	...
	// links
	Links *NetworkHTTPProxyInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NetworkHTTPProxyInlineSvm struct {
	...
	// links
	Links *NetworkHTTPProxyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
