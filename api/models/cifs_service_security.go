...
type CifsServiceSecurity struct {
	...
	AdvertisedKdcEncryptions []*string `json:"advertised_kdc_encryptions,omitempty" yaml:"advertised_kdc_encryptions,omitempty"`

	// Specifies whether or not an AES session key is enabled for the Netlogon channel.
	//
	AesNetlogonEnabled *bool `json:"aes_netlogon_enabled,omitempty" yaml:"aes_netlogon_enabled,omitempty"`

	// Specifies whether encryption is required for domain controller connections.
	EncryptDcConnection *bool `json:"encrypt_dc_connection,omitempty" yaml:"encrypt_dc_connection,omitempty"`
	...
	//
	KdcEncryption *bool `json:"kdc_encryption,omitempty" yaml:"kdc_encryption,omitempty"`

	// Specifies whether or not LDAP referral chasing is enabled for AD LDAP connections.
	//
	LdapReferralEnabled *bool `json:"ldap_referral_enabled,omitempty" yaml:"ldap_referral_enabled,omitempty"`
	...
	LmCompatibilityLevel *string `json:"lm_compatibility_level,omitempty" yaml:"lm_compatibility_level,omitempty"`
	...
	RestrictAnonymous *string `json:"restrict_anonymous,omitempty" yaml:"restrict_anonymous,omitempty"`
	...
	SmbEncryption *bool `json:"smb_encryption,omitempty" yaml:"smb_encryption,omitempty"`
	...
	//
	TryLdapChannelBinding *bool `json:"try_ldap_channel_binding,omitempty" yaml:"try_ldap_channel_binding,omitempty"`

	// Specifies whether or not to use use LDAPS for secure Active Directory LDAP connections
	// by using the TLS/SSL protocols.
	//
	UseLdaps *bool `json:"use_ldaps,omitempty" yaml:"use_ldaps,omitempty"`
