...
type SnapmirrorRelationship struct {
	...
	// links
	Links *SnapmirrorRelationshipInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Specifies the SnapMirror backoff level due to Client Ops for FlexVol SnapMirror relationships.
	// Example: medium
	// Enum: ["high","medium","none"]
	BackoffLevel *string `json:"backoff_level,omitempty" yaml:"backoff_level,omitempty"`

	// consistency group failover
	ConsistencyGroupFailover *SnapmirrorConsistencyGroupFailover `json:"consistency_group_failover,omitempty" yaml:"consistency_group_failover,omitempty"`
	...
	IdentityPreservation *string `json:"identity_preservation,omitempty" yaml:"identity_preservation,omitempty"`
	...
	// Example: 61
	// Read Only: true
	LastTransferNetworkCompressionRatio *string `json:"last_transfer_network_compression_ratio,omitempty" yaml:"last_transfer_network_compression_ratio,omitempty"`
	...
	LastTransferType *string `json:"last_transfer_type,omitempty" yaml:"last_transfer_type,omitempty"`
	...
	MasterBiasActivatedSite *string `json:"master_bias_activated_site,omitempty" yaml:"master_bias_activated_site,omitempty"`

	// policy
	Policy *SnapmirrorRelationshipInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
	...
	SnapmirrorRelationshipInlineSvmdrVolumes []*SnapmirrorRelationshipInlineSvmdrVolumesInlineArrayItem `json:"svmdr_volumes,omitempty" yaml:"svmdr_volumes,omitempty"`
	...
	// Example: 1098210312
	// Read Only: true
	TotalTransferBytes *int64 `json:"total_transfer_bytes,omitempty" yaml:"total_transfer_bytes,omitempty"`
	...
	// Example: PT3M21S
	// Read Only: true
	TotalTransferDuration *string `json:"total_transfer_duration,omitempty" yaml:"total_transfer_duration,omitempty"`

	// transfer
	Transfer *SnapmirrorRelationshipInlineTransfer `json:"transfer,omitempty" yaml:"transfer,omitempty"`

	// transfer schedule
	TransferSchedule *SnapmirrorRelationshipInlineTransferSchedule `json:"transfer_schedule,omitempty" yaml:"transfer_schedule,omitempty"`
...
type SnapmirrorRelationshipInlinePolicy struct {
	...
	// links
	Links *SnapmirrorRelationshipInlinePolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapmirrorRelationshipInlineTransfer struct {
	...
	// links
	Links *SnapmirrorRelationshipInlineTransferInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Format: date-time
	LastUpdatedTime *strfmt.DateTime `json:"last_updated_time,omitempty" yaml:"last_updated_time,omitempty"`
...
type SnapmirrorRelationshipInlineTransferSchedule struct {
	...
	// links
	Links *SnapmirrorRelationshipInlineTransferScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
