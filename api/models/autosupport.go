...
type Autosupport struct {
	...
	// Read Only: true
	AutosupportInlineIssues []*AutosupportIssues `json:"issues,omitempty" yaml:"issues,omitempty"`
	...
	// Max Items: 5
	AutosupportInlineMailHosts []*strfmt.URI `json:"mail_hosts,omitempty" yaml:"mail_hosts,omitempty"`

	// The list of partner addresses.
	// Example: ["user1@partner.com","user2@partner.com"]
	// Max Items: 5
	AutosupportInlinePartnerAddresses []*strfmt.Email `json:"partner_addresses,omitempty" yaml:"partner_addresses,omitempty"`

	// The e-mail addresses to which the AutoSupport messages are sent.
	// Example: ["user1@example.com","user2@example.com"]
	// Max Items: 5
	AutosupportInlineTo []*strfmt.Email `json:"to,omitempty" yaml:"to,omitempty"`

	// Specifies whether to send the AutoSupport messages to vendor support.
	// Example: true
	ContactSupport *bool `json:"contact_support,omitempty" yaml:"contact_support,omitempty"`
	...
	// Format: email
	From *strfmt.Email `json:"from,omitempty" yaml:"from,omitempty"`
	...
	// Format: uri
	ProxyURL *strfmt.URI `json:"proxy_url,omitempty" yaml:"proxy_url,omitempty"`

	// The encryption protocol used to deliver AutoSupport messages via SMTP to the configured mail_hosts.
	//
	// Example: none
	// Enum: ["none","start_tls"]
	SMTPEncryption *string `json:"smtp_encryption,omitempty" yaml:"smtp_encryption,omitempty"`
