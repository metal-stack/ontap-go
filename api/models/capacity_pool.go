...
type CapacityPool struct {
	...
	CapacityPoolInlineNodes []*CapacityPoolInlineNodesInlineArrayItem `json:"nodes,omitempty" yaml:"nodes,omitempty"`

	// license manager
	LicenseManager *CapacityPoolInlineLicenseManager `json:"license_manager,omitempty" yaml:"license_manager,omitempty"`
