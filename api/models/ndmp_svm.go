...
type NdmpSvm struct {
	...
	// links
	Links *NdmpSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	NdmpSvmInlineAuthenticationTypes []*NdmpAuthType `json:"authentication_types,omitempty" yaml:"authentication_types,omitempty"`

	// svm
	Svm *NdmpSvmInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type NdmpSvmInlineSvm struct {
	...
	// links
	Links *NdmpSvmInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
