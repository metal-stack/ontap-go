...
type BgpPeerGroup struct {
	...
	// ipspace
	Ipspace *BgpPeerGroupInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// local
	Local *BgpPeerGroupInlineLocal `json:"local,omitempty" yaml:"local,omitempty"`
	...
	// peer
	Peer *BgpPeerGroupInlinePeer `json:"peer,omitempty" yaml:"peer,omitempty"`
...
type BgpPeerGroupInlineIpspace struct {
	...
	// links
	Links *BgpPeerGroupInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type BgpPeerGroupInlineLocal struct {
	...
	// interface
	Interface *BgpPeerGroupInlineLocalInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// ip
	IP *BgpPeerGroupInlineLocalInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`

	// port
	Port *BgpPeerGroupInlineLocalInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type BgpPeerGroupInlineLocalInlineInterface struct {
	...
	// links
	Links *BgpPeerGroupInlineLocalInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *BgpPeerGroupInlineLocalInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type BgpPeerGroupInlineLocalInlinePort struct {
	...
	// links
	Links *BgpPeerGroupInlineLocalInlinePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *BgpPeerGroupInlineLocalInlinePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type BgpPeerGroupInlinePeer struct {
	...
	IsNextHop *bool `json:"is_next_hop,omitempty" yaml:"is_next_hop,omitempty"`

	// Enable or disable TCP MD5 signatures per RFC 2385.
	// Example: true
	Md5Enabled *bool `json:"md5_enabled,omitempty" yaml:"md5_enabled,omitempty"`

	// The shared TCP MD5 secret key. This can either be given as a password or hexadecimal key.
	// Example: SECRET_WORD
	// Max Length: 79
	// Min Length: 1
	Md5Secret *string `json:"md5_secret,omitempty" yaml:"md5_secret,omitempty"`
}
