...
type CloudStorageTier struct {
	...
	// cloud store
	CloudStore *CloudStorageTierInlineCloudStore `json:"cloud_store,omitempty" yaml:"cloud_store,omitempty"`
...
type CloudStorageTierInlineCloudStore struct {
	...
	// links
	Links *CloudStorageTierInlineCloudStoreInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
