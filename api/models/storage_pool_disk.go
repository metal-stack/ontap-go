...
type StoragePoolDisk struct {
	...
	// disk
	Disk *StoragePoolDiskInlineDisk `json:"disk,omitempty" yaml:"disk,omitempty"`
...
type StoragePoolDiskInlineDisk struct {
	...
	// links
	Links *StoragePoolDiskInlineDiskInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
