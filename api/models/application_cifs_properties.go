...
type ApplicationCifsProperties struct {
	...
	ApplicationCifsPropertiesInlineIps []*string `json:"ips,omitempty" yaml:"ips,omitempty"`

	// application cifs properties inline permissions
	// Read Only: true
	ApplicationCifsPropertiesInlinePermissions []*ApplicationCifsPropertiesInlinePermissionsInlineArrayItem `json:"permissions,omitempty" yaml:"permissions,omitempty"`

	// backing storage
	BackingStorage *ApplicationCifsPropertiesInlineBackingStorage `json:"backing_storage,omitempty" yaml:"backing_storage,omitempty"`
	...
	// server
	Server *ApplicationCifsPropertiesInlineServer `json:"server,omitempty" yaml:"server,omitempty"`

	// share
	Share *ApplicationCifsPropertiesInlineShare `json:"share,omitempty" yaml:"share,omitempty"`
}
