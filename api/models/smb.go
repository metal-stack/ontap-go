...
type Smb struct {
	...
	ConnectState *string `json:"connect_state,omitempty" yaml:"connect_state,omitempty"`

	// SMB open group ID.
	// Read Only: true
	OpenGroupID *string `json:"open_group_id,omitempty" yaml:"open_group_id,omitempty"`

	// SMB open type.
	// Read Only: true
	// Enum: ["none","durable","persistent"]
	OpenType *string `json:"open_type,omitempty" yaml:"open_type,omitempty"`
}
