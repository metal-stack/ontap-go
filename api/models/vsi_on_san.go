...
type VsiOnSan struct {
	...
	// datastore
	// Required: true
	Datastore *VsiOnSanDatastore `json:"datastore" yaml:"datastore"`
	...
	// Max Items: 1
	// Min Items: 0
	NewIgroups []*VsiOnSanNewIgroups `json:"new_igroups" yaml:"new_igroups"`

	// protection type
	ProtectionType *VsiOnSanProtectionType `json:"protection_type,omitempty" yaml:"protection_type,omitempty"`
}
...
type VsiOnSanDatastore struct {
	...
	// storage service
	StorageService *VsiOnSanDatastoreStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
