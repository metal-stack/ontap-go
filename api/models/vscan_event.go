...
type VscanEvent struct {
	...
	// Format: date-time
	EventTime *strfmt.DateTime `json:"event_time,omitempty" yaml:"event_time,omitempty"`
	...
	// interface
	Interface *VscanEventInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// node
	Node *VscanEventInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *VscanEventInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type VscanEventInlineInterface struct {
	...
	// links
	Links *VscanEventInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *VscanEventInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type VscanEventInlineNode struct {
	...
	// links
	Links *VscanEventInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VscanEventInlineSvm struct {
	...
	// links
	Links *VscanEventInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
