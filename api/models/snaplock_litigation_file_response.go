...
type SnaplockLitigationFileResponse struct {
	...
	// links
	Links *SnaplockLitigationFileResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnaplockLitigationFileResponseInlineRecords []*SnaplockLitigationFileResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
}
...
type SnaplockLitigationFileResponseInlineRecordsInlineArrayItem struct {
	...
	SequenceIndex *int64 `json:"sequence_index,omitempty" yaml:"sequence_index,omitempty"`
}
