...
type Svm struct {
	...
	// links
	Links *SvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// This property is true when the administrator has delegated the aggregates for the SVM volumes.
	// Read Only: true
	AggregatesDelegated *bool `json:"aggregates_delegated,omitempty" yaml:"aggregates_delegated,omitempty"`

	// Anti-ransomware related information for the SVM.
	AntiRansomware *ArwVserver `json:"anti_ransomware,omitempty" yaml:"anti_ransomware,omitempty"`
	...
	AntiRansomwareAutoSwitchDurationWithoutNewFileExtension *int64 `json:"anti_ransomware_auto_switch_duration_without_new_file_extension,omitempty" yaml:"anti_ransomware_auto_switch_duration_without_new_file_extension,omitempty"`
	...
	AntiRansomwareAutoSwitchFromLearningToEnabled *bool `json:"anti_ransomware_auto_switch_from_learning_to_enabled,omitempty" yaml:"anti_ransomware_auto_switch_from_learning_to_enabled,omitempty"`
	...
	AntiRansomwareAutoSwitchMinimumFileCount *int64 `json:"anti_ransomware_auto_switch_minimum_file_count,omitempty" yaml:"anti_ransomware_auto_switch_minimum_file_count,omitempty"`
	...
	AntiRansomwareIncomingWriteThresholdPercent *string `json:"anti_ransomware_incoming_write_threshold_percent,omitempty" yaml:"anti_ransomware_incoming_write_threshold_percent,omitempty"`
	...
	// certificate
	Certificate *SvmInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`

	// cifs
	Cifs *SvmInlineCifs `json:"cifs,omitempty" yaml:"cifs,omitempty"`
	...
	// dns
	DNS *SvmInlineDNS `json:"dns,omitempty" yaml:"dns,omitempty"`

	// fcp
	Fcp *SvmInlineFcp `json:"fcp,omitempty" yaml:"fcp,omitempty"`

	// ipspace
	Ipspace *SvmInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// Indicates whether logical space enforcement for the SVM is enabled.
	IsSpaceEnforcementLogical *bool `json:"is_space_enforcement_logical,omitempty" yaml:"is_space_enforcement_logical,omitempty"`

	// Indicates whether logical space reporting for the SVM is enabled.
	IsSpaceReportingLogical *bool `json:"is_space_reporting_logical,omitempty" yaml:"is_space_reporting_logical,omitempty"`

	// iscsi
	Iscsi *SvmInlineIscsi `json:"iscsi,omitempty" yaml:"iscsi,omitempty"`
	...
	// ldap
	Ldap *SvmInlineLdap `json:"ldap,omitempty" yaml:"ldap,omitempty"`
	...
	MaxVolumes *string `json:"max_volumes,omitempty" yaml:"max_volumes,omitempty"`
	...
	// ndmp
	Ndmp *SvmInlineNdmp `json:"ndmp,omitempty" yaml:"ndmp,omitempty"`

	// nfs
	Nfs *SvmInlineNfs `json:"nfs,omitempty" yaml:"nfs,omitempty"`

	// nis
	Nis *SvmInlineNis `json:"nis,omitempty" yaml:"nis,omitempty"`

	// nsswitch
	Nsswitch *SvmInlineNsswitch `json:"nsswitch,omitempty" yaml:"nsswitch,omitempty"`

	// Number of volumes in the recovery queue.
	// Read Only: true
	NumberOfVolumesInRecoveryQueue *int64 `json:"number_of_volumes_in_recovery_queue,omitempty" yaml:"number_of_volumes_in_recovery_queue,omitempty"`

	// nvme
	Nvme *SvmInlineNvme `json:"nvme,omitempty" yaml:"nvme,omitempty"`

	// qos adaptive policy group template
	QosAdaptivePolicyGroupTemplate *SvmInlineQosAdaptivePolicyGroupTemplate `json:"qos_adaptive_policy_group_template,omitempty" yaml:"qos_adaptive_policy_group_template,omitempty"`
	...
	// snapmirror
	Snapmirror *SvmInlineSnapmirror `json:"snapmirror,omitempty" yaml:"snapmirror,omitempty"`

	// snapshot policy
	SnapshotPolicy *SvmInlineSnapshotPolicy `json:"snapshot_policy,omitempty" yaml:"snapshot_policy,omitempty"`
	...
	// storage
	Storage *SvmInlineStorage `json:"storage,omitempty" yaml:"storage,omitempty"`
	...
	SvmInlineAggregates []*SvmInlineAggregatesInlineArrayItem `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`

	// FC Interface for the SVM
	SvmInlineFcInterfaces []*FcInterfaceSvm `json:"fc_interfaces,omitempty" yaml:"fc_interfaces,omitempty"`

	// IP interfaces for the SVM
	SvmInlineIPInterfaces []*IPInterfaceSvm `json:"ip_interfaces,omitempty" yaml:"ip_interfaces,omitempty"`

	// Optional array of routes for the SVM
	SvmInlineRoutes []*NetworkRouteForSvm `json:"routes,omitempty" yaml:"routes,omitempty"`

	// Sum of the sizes of the volumes in the recovery queue.
	// Read Only: true
	TotalVolumeSizeInRecoveryQueue *int64 `json:"total_volume_size_in_recovery_queue,omitempty" yaml:"total_volume_size_in_recovery_queue,omitempty"`
...
type SvmInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *SvmInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Space available, in bytes.
	// Example: 10156560384
	// Read Only: true
	AvailableSize *int64 `json:"available_size,omitempty" yaml:"available_size,omitempty"`
...
type SvmInlineCertificate struct {
	...
	// links
	Links *SvmInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineCifs struct {
	...
	// links
	Links *SvmInlineCifsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ad domain
	AdDomain *SvmInlineCifsInlineAdDomain `json:"ad_domain,omitempty" yaml:"ad_domain,omitempty"`
	...
	//
	// Read Only: true
	DomainWorkgroup *string `json:"domain_workgroup,omitempty" yaml:"domain_workgroup,omitempty"`
...
type SvmInlineCifsInlineAdDomain struct {
	...
	//
	DefaultSite *string `json:"default_site,omitempty" yaml:"default_site,omitempty"`
...
type SvmInlineDNS struct {
	...
	// links
	Links *SvmInlineDNSInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// domains
	Domains DNSDomainsArrayInline `json:"domains,omitempty" yaml:"domains,omitempty"`

	// servers
	Servers NameServersArrayInline `json:"servers,omitempty" yaml:"servers,omitempty"`
}
...
type SvmInlineFcp struct {
	...
	// links
	Links *SvmInlineFcpInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineIpspace struct {
	...
	// links
	Links *SvmInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineIscsi struct {
	...
	// links
	Links *SvmInlineIscsiInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineLdap struct {
	...
	//
	AdDomain *string `json:"ad_domain,omitempty" yaml:"ad_domain,omitempty"`
	...
	//
	RestrictDiscoveryToSite *bool `json:"restrict_discovery_to_site,omitempty" yaml:"restrict_discovery_to_site,omitempty"`
...
type SvmInlineNfs struct {
	...
	// links
	Links *SvmInlineNfsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineNis struct {
	...
	// links
	Links *SvmInlineNisInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// domain
	Domain *NisDomain `json:"domain,omitempty" yaml:"domain,omitempty"`

	// Enable NIS? Setting to true creates a configuration if not already created.
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty"`

	// servers
	Servers NisServersArrayInline `json:"servers,omitempty" yaml:"servers,omitempty"`
}
...
type SvmInlineNsswitch struct {
	...
	// Group sources
	Group []*NsswitchSource `json:"group,omitempty" yaml:"group,omitempty"`

	// Host sources
	Hosts []*NsswitchSource `json:"hosts,omitempty" yaml:"hosts,omitempty"`

	// NameMap sources
	Namemap []*NsswitchSource `json:"namemap,omitempty" yaml:"namemap,omitempty"`

	// NetGroup sources
	Netgroup []*NsswitchSource `json:"netgroup,omitempty" yaml:"netgroup,omitempty"`

	// Password sources
	Passwd []*NsswitchSource `json:"passwd,omitempty" yaml:"passwd,omitempty"`
}
...
type SvmInlineNvme struct {
	...
	// links
	Links *SvmInlineNvmeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineQosAdaptivePolicyGroupTemplate struct {
	...
	// links
	Links *SvmInlineQosAdaptivePolicyGroupTemplateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineQosPolicy struct {
	...
	// links
	Links *SvmInlineQosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineS3 struct {
	...
	DefaultUnixUser *string `json:"default_unix_user,omitempty" yaml:"default_unix_user,omitempty"`

	// Specifies the default Windows user for NAS Access.
	DefaultWinUser *string `json:"default_win_user,omitempty" yaml:"default_win_user,omitempty"`
	...
	IsHTTPEnabled *bool `json:"is_http_enabled,omitempty" yaml:"is_http_enabled,omitempty"`

	// Specifies whether HTTPS is enabled on the S3 server. By default, HTTPS is enabled on the S3 server.
	IsHTTPSEnabled *bool `json:"is_https_enabled,omitempty" yaml:"is_https_enabled,omitempty"`
	...
	SecurePort *int64 `json:"secure_port,omitempty" yaml:"secure_port,omitempty"`
}
...
type SvmInlineS3InlineCertificate struct {
	...
	// links
	Links *SvmInlineS3InlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineSnapmirror struct {
	...
	// Read Only: true
	ProtectedConsistencyGroupCount *int64 `json:"protected_consistency_group_count,omitempty" yaml:"protected_consistency_group_count,omitempty"`

	// Specifies the number of SVM DR protected volumes in the SVM.
	// Read Only: true
	ProtectedVolumesCount *int64 `json:"protected_volumes_count,omitempty" yaml:"protected_volumes_count,omitempty"`
}
...
type SvmInlineSnapshotPolicy struct {
	...
	// links
	Links *SvmInlineSnapshotPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmInlineStorage struct {
	...
	// Read Only: true
	Allocated *int64 `json:"allocated,omitempty" yaml:"allocated,omitempty"`
	...
	LimitThresholdAlert *int64 `json:"limit_threshold_alert,omitempty" yaml:"limit_threshold_alert,omitempty"`

	// Indicates whether the total storage capacity exceeds the alert percentage.
	// Read Only: true
	LimitThresholdExceeded *bool `json:"limit_threshold_exceeded,omitempty" yaml:"limit_threshold_exceeded,omitempty"`

	// The percentage of storage capacity used.
	// Read Only: true
	UsedPercentage *int64 `json:"used_percentage,omitempty" yaml:"used_percentage,omitempty"`
}
