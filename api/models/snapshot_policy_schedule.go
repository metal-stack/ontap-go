...
type SnapshotPolicySchedule struct {
	...
	// links
	Links *SnapshotPolicyScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// schedule
	Schedule *SnapshotPolicyScheduleInlineSchedule `json:"schedule,omitempty" yaml:"schedule,omitempty"`

	// Label for SnapMirror operations
	SnapmirrorLabel *string `json:"snapmirror_label,omitempty" yaml:"snapmirror_label,omitempty"`

	// snapshot policy
	SnapshotPolicy *SnapshotPolicyScheduleInlineSnapshotPolicy `json:"snapshot_policy,omitempty" yaml:"snapshot_policy,omitempty"`
}
...
type SnapshotPolicyScheduleInlineSchedule struct {
	...
	// links
	Links *SnapshotPolicyScheduleInlineScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapshotPolicyScheduleInlineSnapshotPolicy struct {
	...
	// links
	Links *SnapshotPolicyScheduleInlineSnapshotPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
