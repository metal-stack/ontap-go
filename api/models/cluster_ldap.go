...
type ClusterLdap struct {
	...
	// links
	Links *ClusterLdapInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ClusterLdapInlineServers []*string `json:"servers,omitempty" yaml:"servers,omitempty"`
	...
	// status
	Status *ClusterLdapInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
...
type ClusterLdapInlineStatus struct {
	...
	// ipv4
	IPV4 *ClusterLdapInlineStatusInlineIPV4 `json:"ipv4,omitempty" yaml:"ipv4,omitempty"`
	...
	// ipv6
	IPV6 *ClusterLdapInlineStatusInlineIPV6 `json:"ipv6,omitempty" yaml:"ipv6,omitempty"`
