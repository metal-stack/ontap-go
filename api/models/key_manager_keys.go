...
type KeyManagerKeys struct {
	...
	Crn *string `json:"crn,omitempty" yaml:"crn,omitempty"`

	// Encryption algorithm for the key
	// Example: XTS-AES-256
	EncryptionAlgorithm *string `json:"encryption_algorithm,omitempty" yaml:"encryption_algorithm,omitempty"`
	...
	KeyManager *string `json:"key_manager,omitempty" yaml:"key_manager,omitempty"`

	// External key server for key management.
	// Example: keyserver1.com:5698
	KeyServer *string `json:"key_server,omitempty" yaml:"key_server,omitempty"`
	...
	KeyStore *string `json:"key_store,omitempty" yaml:"key_store,omitempty"`
	...
	KeyStoreType *string `json:"key_store_type,omitempty" yaml:"key_store_type,omitempty"`
	...
	// Example: vs1
	KeyUser *string `json:"key_user,omitempty" yaml:"key_user,omitempty"`

	// node
	Node *KeyManagerKeysInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// Example: true
	Restored *bool `json:"restored,omitempty" yaml:"restored,omitempty"`

	// scope
	Scope *NetworkScopeReadonly `json:"scope,omitempty" yaml:"scope,omitempty"`

	// security key manager
	SecurityKeyManager *KeyManagerKeysInlineSecurityKeyManager `json:"security_key_manager,omitempty" yaml:"security_key_manager,omitempty"`

	// svm
	Svm *KeyManagerKeysInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type KeyManagerKeysInlineNode struct {
	...
	// links
	Links *KeyManagerKeysInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type KeyManagerKeysInlineSecurityKeyManager struct {
	...
	// links
	Links *KeyManagerKeysInlineSecurityKeyManagerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type KeyManagerKeysInlineSvm struct {
	...
	// links
	Links *KeyManagerKeysInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
