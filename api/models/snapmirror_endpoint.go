...
type SnapmirrorEndpoint struct {
	...
	// cluster
	Cluster *SnapmirrorEndpointInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// Optional property to specify the IPSpace of the SVM.
	// Example: Default
	Ipspace *string `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// luns
	Luns *SnapmirrorEndpointInlineLuns `json:"luns,omitempty" yaml:"luns,omitempty"`
	...
	SnapmirrorEndpointInlineConsistencyGroupVolumes []*SnapmirrorEndpointInlineConsistencyGroupVolumesInlineArrayItem `json:"consistency_group_volumes,omitempty" yaml:"consistency_group_volumes,omitempty"`

	// svm
	Svm *SnapmirrorEndpointInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type SnapmirrorEndpointInlineCluster struct {
	...
	// links
	Links *SnapmirrorEndpointInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapmirrorEndpointInlineLuns struct {
	...
	// links
	Links *SnapmirrorEndpointInlineLunsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapmirrorEndpointInlineSvm struct {
	...
	// links
	Links *SnapmirrorEndpointInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
