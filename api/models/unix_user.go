...
type UnixUser struct {
	...
	// links
	Links *UnixUserInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	PrimaryGid *int64 `json:"primary_gid,omitempty" yaml:"primary_gid,omitempty"`
	...
	// svm
	Svm *UnixUserInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type UnixUserInlineSvm struct {
	...
	// links
	Links *UnixUserInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
