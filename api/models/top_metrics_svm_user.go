...
type TopMetricsSvmUser struct {
	...
	// iops
	Iops *TopMetricsSvmUserInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// svm
	Svm *TopMetricsSvmUserInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsSvmUserInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`

	// List of volumes where the user is generating traffic.
	TopMetricsSvmUserInlineVolumes []*TopMetricsSvmUserInlineVolumesInlineArrayItem `json:"volumes,omitempty" yaml:"volumes,omitempty"`
...
type TopMetricsSvmUserInlineSvm struct {
	...
	// links
	Links *TopMetricsSvmUserInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type TopMetricsSvmUserInlineVolumesInlineArrayItem struct {
	...
	// links
	Links *TopMetricsSvmUserInlineVolumesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
