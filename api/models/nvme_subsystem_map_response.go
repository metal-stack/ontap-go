...
type NvmeSubsystemMapResponse struct {
	...
	// links
	Links *NvmeSubsystemMapResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	NvmeSubsystemMapResponseInlineRecords []*NvmeSubsystemMap `json:"records,omitempty" yaml:"records,omitempty"`
}
