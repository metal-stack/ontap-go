...
type NfsClientsMap struct {
	...
	// links
	Links *NfsClientsMapInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Specifies the IP address of the client.
	//
	// Example: ["127.0.0.1"]
	NfsClientsMapInlineClientIps []*string `json:"client_ips,omitempty" yaml:"client_ips,omitempty"`

	// node
	Node *NfsClientsMapInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *NfsClientsMapInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type NfsClientsMapInlineNode struct {
	...
	// links
	Links *NfsClientsMapInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NfsClientsMapInlineSvm struct {
	...
	// links
	Links *NfsClientsMapInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
