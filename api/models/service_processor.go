...
type ServiceProcessor struct {
	...
	// api service
	APIService *ServiceProcessorInlineAPIService `json:"api_service,omitempty" yaml:"api_service,omitempty"`

	// auto config
	AutoConfig *ServiceProcessorInlineAutoConfig `json:"auto_config,omitempty" yaml:"auto_config,omitempty"`
	...
	// backup
	Backup *ServiceProcessorInlineBackup `json:"backup,omitempty" yaml:"backup,omitempty"`
	...
	// ipv4 interface
	IPV4Interface *ServiceProcessorInlineIPV4Interface `json:"ipv4_interface,omitempty" yaml:"ipv4_interface,omitempty"`

	// ipv6 interface
	IPV6Interface *ServiceProcessorInlineIPV6Interface `json:"ipv6_interface,omitempty" yaml:"ipv6_interface,omitempty"`
	...
	// primary
	Primary *ServiceProcessorInlinePrimary `json:"primary,omitempty" yaml:"primary,omitempty"`

	// ssh info
	SSHInfo *ServiceProcessorInlineSSHInfo `json:"ssh_info,omitempty" yaml:"ssh_info,omitempty"`
	...
	// web service
	WebService *ServiceProcessorInlineWebService `json:"web_service,omitempty" yaml:"web_service,omitempty"`
}
