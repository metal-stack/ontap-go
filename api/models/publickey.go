...
type Publickey struct {
	...
	// links
	Links *PublickeyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	CertificateDetails *string `json:"certificate_details,omitempty" yaml:"certificate_details,omitempty"`

	// The expiration details of the certificate (READONLY).
	// Read Only: true
	CertificateExpired *string `json:"certificate_expired,omitempty" yaml:"certificate_expired,omitempty"`

	// The revocation details of the certificate (READONLY).
	// Read Only: true
	CertificateRevoked *string `json:"certificate_revoked,omitempty" yaml:"certificate_revoked,omitempty"`
	...
	// Read Only: true
	ObfuscatedFingerprint *string `json:"obfuscated_fingerprint,omitempty" yaml:"obfuscated_fingerprint,omitempty"`

	// owner
	Owner *PublickeyInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
...
type PublickeyInlineOwner struct {
	...
	// links
	Links *PublickeyInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
