...
type PortMetrics struct {
	...
	// links
	Links *PortMetricsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *PortMetricsInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
