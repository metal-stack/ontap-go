...
type StoragePoolSpareAllocationUnit struct {
	...
	// node
	Node *StoragePoolSpareAllocationUnitInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type StoragePoolSpareAllocationUnitInlineNode struct {
	...
	// links
	Links *StoragePoolSpareAllocationUnitInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
