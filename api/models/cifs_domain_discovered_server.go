...
type CifsDomainDiscoveredServer struct {
	...
	// node
	Node *CifsDomainDiscoveredServerInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type CifsDomainDiscoveredServerInlineNode struct {
	...
	// links
	Links *CifsDomainDiscoveredServerInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
