...
type ClusterPeer struct {
	...
	// links
	Links *ClusterPeerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// authentication
	Authentication *ClusterPeerInlineAuthentication `json:"authentication,omitempty" yaml:"authentication,omitempty"`
	...
	ClusterPeerInlineInitialAllowedSvms []*ClusterPeerInlineInitialAllowedSvmsInlineArrayItem `json:"initial_allowed_svms,omitempty" yaml:"initial_allowed_svms,omitempty"`

	// Peering applications against which allowed SVMs are configured.
	// Example: ["snapmirror","flexcache"]
	ClusterPeerInlinePeerApplications []*SvmPeerPermissionApplications `json:"peer_applications,omitempty" yaml:"peer_applications,omitempty"`

	// encryption
	Encryption *ClusterPeerInlineEncryption `json:"encryption,omitempty" yaml:"encryption,omitempty"`
	...
	// Read Only: true
	IPAddress *IPAddress `json:"ip_address,omitempty" yaml:"ip_address,omitempty"`

	// ipspace
	Ipspace *ClusterPeerInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// local network
	LocalNetwork *ClusterPeerInlineLocalNetwork `json:"local_network,omitempty" yaml:"local_network,omitempty"`
	...
	// remote
	Remote *ClusterPeerInlineRemote `json:"remote,omitempty" yaml:"remote,omitempty"`

	// status
	Status *ClusterPeerInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`
	...
	// version
	Version *ClusterPeerInlineVersion `json:"version,omitempty" yaml:"version,omitempty"`
}
...
type ClusterPeerInlineAuthentication struct {
	...
	GeneratePassphrase *bool `json:"generate_passphrase,omitempty" yaml:"generate_passphrase,omitempty"`

	// in use
	// Enum: ["ok","absent","revoked"]
	InUse *string `json:"in_use,omitempty" yaml:"in_use,omitempty"`
...
type ClusterPeerInlineInitialAllowedSvmsInlineArrayItem struct {
	...
	// links
	Links *ClusterPeerInlineInitialAllowedSvmsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClusterPeerInlineIpspace struct {
	...
	// links
	Links *ClusterPeerInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ClusterPeerInlineLinks struct {
	...
	// interfaces
	Interfaces *Href `json:"interfaces,omitempty" yaml:"interfaces,omitempty"`
...
type ClusterPeerInlineLocalNetwork struct {
	...
	// Example: bd1
	BroadcastDomain *string `json:"broadcast_domain,omitempty" yaml:"broadcast_domain,omitempty"`
	...
	// interfaces
	Interfaces []*ClusterPeerLocalNetworkInterfacesItems0 `json:"interfaces,omitempty" yaml:"interfaces,omitempty"`
