...
type BroadcastDomain struct {
	...
	// links
	Links *BroadcastDomainInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Ports that belong to the broadcast domain
	// Read Only: true
	BroadcastDomainInlinePorts []*BroadcastDomainInlinePortsInlineArrayItem `json:"ports,omitempty" yaml:"ports,omitempty"`

	// ipspace
	Ipspace *BroadcastDomainInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
...
type BroadcastDomainInlineIpspace struct {
	...
	// links
	Links *BroadcastDomainInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type BroadcastDomainInlinePortsInlineArrayItem struct {
	...
	// links
	Links *BroadcastDomainInlinePortsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *BroadcastDomainInlinePortsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
