...
type Shadowcopy struct {
	...
	// links
	Links *ShadowcopyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// The universally-unique identifier of the client's shadow copy.
	// Example: abc13450-1f19-40ba-9b82-ebf277517e7e
	// Read Only: true
	ClientUUID *string `json:"client_uuid,omitempty" yaml:"client_uuid,omitempty"`
	...
	//
	// Example: ["/vhd1","/vhd2"]
	ShadowcopyInlineFiles []*string `json:"files,omitempty" yaml:"files,omitempty"`

	// shadowcopy set
	ShadowcopySet *ShadowcopyInlineShadowcopySet `json:"shadowcopy_set,omitempty" yaml:"shadowcopy_set,omitempty"`

	// share
	Share *ShadowcopyInlineShare `json:"share,omitempty" yaml:"share,omitempty"`
	...
	// svm
	Svm *ShadowcopyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume
	Volume *ShadowcopyInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`

	// Specifies what needs to be restored. False specifies the directory only.
	// True indicates the directory and its content.
	//
	WithContent *bool `json:"with_content,omitempty" yaml:"with_content,omitempty"`
}
...
type ShadowcopyInlineShare struct {
	...
	// links
	Links *ShadowcopyInlineShareInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ShadowcopyInlineSvm struct {
	...
	// links
	Links *ShadowcopyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ShadowcopyInlineVolume struct {
	...
	// links
	Links *ShadowcopyInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
