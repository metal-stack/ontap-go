...
type NfsClientsCache struct {
	...
	// links
	Links *NfsClientsCacheInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	ClientRetentionInterval *string `json:"client_retention_interval,omitempty" yaml:"client_retention_interval,omitempty"`
	...
	//
	EnableNfsClientsDeletion *bool `json:"enable_nfs_clients_deletion,omitempty" yaml:"enable_nfs_clients_deletion,omitempty"`
