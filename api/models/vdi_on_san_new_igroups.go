...
type VdiOnSanNewIgroups struct {
	...
	// igroups
	Igroups []*VdiOnSanNewIgroupsIgroupsItems0 `json:"igroups" yaml:"igroups"`

	// initiator objects
	InitiatorObjects []*VdiOnSanNewIgroupsInitiatorObjectsItems0 `json:"initiator_objects" yaml:"initiator_objects"`
