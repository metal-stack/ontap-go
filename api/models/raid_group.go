...
type RaidGroup struct {
	...
	// Read Only: true
	CacheTier *bool `json:"cache_tier,omitempty" yaml:"cache_tier,omitempty"`
	...
	// Read Only: true
	RaidGroupInlineDisks []*RaidGroupDisk `json:"disks,omitempty" yaml:"disks,omitempty"`
	...
	// recomputing parity
	RecomputingParity *RaidGroupInlineRecomputingParity `json:"recomputing_parity,omitempty" yaml:"recomputing_parity,omitempty"`

	// reconstruct
	Reconstruct *RaidGroupInlineReconstruct `json:"reconstruct,omitempty" yaml:"reconstruct,omitempty"`
}
