...
type ClusterNisService struct {
	...
	// links
	Links *ClusterNisServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	ClusterNisServiceInlineBindingDetails []*ClusterNisServiceInlineBindingDetailsInlineArrayItem `json:"binding_details,omitempty" yaml:"binding_details,omitempty"`

	// cluster nis service inline bound servers
	// Read Only: true
	ClusterNisServiceInlineBoundServers []*string `json:"bound_servers,omitempty" yaml:"bound_servers,omitempty"`

	// A list of hostnames or IP addresses of NIS servers used
	// by the NIS domain configuration.
	//
	// Max Items: 10
	ClusterNisServiceInlineServers []*string `json:"servers,omitempty" yaml:"servers,omitempty"`
