...
type SnaplockRetentionPolicyResponse struct {
	...
	// links
	Links *SnaplockRetentionPolicyResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnaplockRetentionPolicyResponseInlineRecords []*SnaplockRetentionPolicy `json:"records,omitempty" yaml:"records,omitempty"`
}
