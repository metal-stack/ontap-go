...
type SnaplockLogVolume struct {
	...
	// links
	Links *SnaplockLogVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Maximum size of log file in bytes
	// Example: 20971520
	MaxLogSize *int64 `json:"max_log_size,omitempty" yaml:"max_log_size,omitempty"`
	...
	// volume
	Volume *SnaplockLogVolumeInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SnaplockLogVolumeInlineVolume struct {
	...
	// links
	Links *SnaplockLogVolumeInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
