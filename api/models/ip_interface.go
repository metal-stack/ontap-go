...
type IPInterface struct {
	...
	// links
	Links *IPInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	FailIfSubnetConflicts *bool `json:"fail_if_subnet_conflicts,omitempty" yaml:"fail_if_subnet_conflicts,omitempty"`

	// ip
	IP *IPInfo `json:"ip,omitempty" yaml:"ip,omitempty"`

	// The services associated with the interface.
	// Read Only: true
	IPInterfaceInlineServices []*IPService `json:"services,omitempty" yaml:"services,omitempty"`

	// ipspace
	Ipspace *IPInterfaceInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// location
	Location *IPInterfaceInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`

	// metric
	Metric *IPInterfaceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// Example: 64001
	ProbePort *int64 `json:"probe_port,omitempty" yaml:"probe_port,omitempty"`
	...
	// service policy
	ServicePolicy *IPInterfaceInlineServicePolicy `json:"service_policy,omitempty" yaml:"service_policy,omitempty"`
	...
	// statistics
	Statistics *IPInterfaceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// Use this field to allocate an interface address from a subnet. If needed, a default route is created for this subnet.
	Subnet *IPSubnetReference `json:"subnet,omitempty" yaml:"subnet,omitempty"`

	// svm
	Svm *IPInterfaceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type IPInterfaceInlineIpspace struct {
	...
	// links
	Links *IPInterfaceInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPInterfaceInlineLocation struct {
	...
	// broadcast domain
	BroadcastDomain *IPInterfaceInlineLocationInlineBroadcastDomain `json:"broadcast_domain,omitempty" yaml:"broadcast_domain,omitempty"`

	// failover
	Failover *FailoverScope `json:"failover,omitempty" yaml:"failover,omitempty"`

	// home node
	HomeNode *IPInterfaceInlineLocationInlineHomeNode `json:"home_node,omitempty" yaml:"home_node,omitempty"`

	// home port
	HomePort *IPInterfaceInlineLocationInlineHomePort `json:"home_port,omitempty" yaml:"home_port,omitempty"`

	// is home
	IsHome *bool `json:"is_home,omitempty" yaml:"is_home,omitempty"`

	// node
	Node *IPInterfaceInlineLocationInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// port
	Port *IPInterfaceInlineLocationInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type IPInterfaceInlineLocationInlineBroadcastDomain struct {
	...
	// links
	Links *IPInterfaceInlineLocationInlineBroadcastDomainInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPInterfaceInlineLocationInlineHomeNode struct {
	...
	// links
	Links *IPInterfaceInlineLocationInlineHomeNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPInterfaceInlineLocationInlineHomePort struct {
	...
	// links
	Links *IPInterfaceInlineLocationInlineHomePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *IPInterfaceInlineLocationInlineHomePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type IPInterfaceInlineLocationInlineNode struct {
	...
	// links
	Links *IPInterfaceInlineLocationInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPInterfaceInlineLocationInlinePort struct {
	...
	// links
	Links *IPInterfaceInlineLocationInlinePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *IPInterfaceInlineLocationInlinePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type IPInterfaceInlineMetric struct {
	...
	// links
	Links *IPInterfaceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *IPInterfaceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type IPInterfaceInlineServicePolicy struct {
	...
	// links
	Links *IPInterfaceInlineServicePolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPInterfaceInlineStatistics struct {
	...
	// throughput raw
	ThroughputRaw *IPInterfaceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type IPInterfaceInlineSvm struct {
	...
	// links
	Links *IPInterfaceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
