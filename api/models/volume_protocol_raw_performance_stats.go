...
type VolumeProtocolRawPerformanceStats struct {
	...
	// access
	Access *VolumeProtocolRawPerformanceStatsInlineAccess `json:"access,omitempty" yaml:"access,omitempty"`

	// audit
	Audit *VolumeProtocolRawPerformanceStatsInlineAudit `json:"audit,omitempty" yaml:"audit,omitempty"`

	// create
	Create *VolumeProtocolRawPerformanceStatsInlineCreate `json:"create,omitempty" yaml:"create,omitempty"`

	// getattr
	Getattr *VolumeProtocolRawPerformanceStatsInlineGetattr `json:"getattr,omitempty" yaml:"getattr,omitempty"`

	// link
	Link *VolumeProtocolRawPerformanceStatsInlineLink `json:"link,omitempty" yaml:"link,omitempty"`

	// lock
	Lock *VolumeProtocolRawPerformanceStatsInlineLock `json:"lock,omitempty" yaml:"lock,omitempty"`

	// lookup
	Lookup *VolumeProtocolRawPerformanceStatsInlineLookup `json:"lookup,omitempty" yaml:"lookup,omitempty"`

	// open
	Open *VolumeProtocolRawPerformanceStatsInlineOpen `json:"open,omitempty" yaml:"open,omitempty"`

	// read
	Read *VolumeProtocolRawPerformanceStatsInlineRead `json:"read,omitempty" yaml:"read,omitempty"`

	// readdir
	Readdir *VolumeProtocolRawPerformanceStatsInlineReaddir `json:"readdir,omitempty" yaml:"readdir,omitempty"`

	// readlink
	Readlink *VolumeProtocolRawPerformanceStatsInlineReadlink `json:"readlink,omitempty" yaml:"readlink,omitempty"`

	// rename
	Rename *VolumeProtocolRawPerformanceStatsInlineRename `json:"rename,omitempty" yaml:"rename,omitempty"`

	// setattr
	Setattr *VolumeProtocolRawPerformanceStatsInlineSetattr `json:"setattr,omitempty" yaml:"setattr,omitempty"`

	// unlink
	Unlink *VolumeProtocolRawPerformanceStatsInlineUnlink `json:"unlink,omitempty" yaml:"unlink,omitempty"`

	// watch
	Watch *VolumeProtocolRawPerformanceStatsInlineWatch `json:"watch,omitempty" yaml:"watch,omitempty"`

	// write
	Write *VolumeProtocolRawPerformanceStatsInlineWrite `json:"write,omitempty" yaml:"write,omitempty"`
}
...
type VolumeProtocolRawPerformanceStatsInlineCreate struct {
	...
	// dir
	Dir *VolumeProtocolRawPerformanceStatsInlineCreateInlineDir `json:"dir,omitempty" yaml:"dir,omitempty"`

	// file
	File *VolumeProtocolRawPerformanceStatsInlineCreateInlineFile `json:"file,omitempty" yaml:"file,omitempty"`

	// other
	Other *VolumeProtocolRawPerformanceStatsInlineCreateInlineOther `json:"other,omitempty" yaml:"other,omitempty"`

	// symlink
	Symlink *VolumeProtocolRawPerformanceStatsInlineCreateInlineSymlink `json:"symlink,omitempty" yaml:"symlink,omitempty"`
}
