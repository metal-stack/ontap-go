...
type PerformanceMetricReducedThroughput struct {
	...
	// links
	Links *PerformanceMetricReducedThroughputInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceMetricReducedThroughputInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceMetricReducedThroughputInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceMetricReducedThroughputInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
