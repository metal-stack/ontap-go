...
type AnalyticsCollectionInfo struct {
	...
	// by accessed time
	ByAccessedTime *AnalyticsCollectionInfoInlineByAccessedTime `json:"by_accessed_time,omitempty" yaml:"by_accessed_time,omitempty"`

	// by modified time
	ByModifiedTime *AnalyticsCollectionInfoInlineByModifiedTime `json:"by_modified_time,omitempty" yaml:"by_modified_time,omitempty"`
}
...
type AnalyticsCollectionInfoInlineByAccessedTime struct {
	...
	// bytes used
	BytesUsed *AnalyticsCollectionInfoInlineByAccessedTimeInlineBytesUsed `json:"bytes_used,omitempty" yaml:"bytes_used,omitempty"`
}
...
type AnalyticsCollectionInfoInlineByModifiedTime struct {
	...
	// bytes used
	BytesUsed *AnalyticsCollectionInfoInlineByModifiedTimeInlineBytesUsed `json:"bytes_used,omitempty" yaml:"bytes_used,omitempty"`
}
