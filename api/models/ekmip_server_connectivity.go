...
type EkmipServerConnectivity struct {
	...
	// node
	Node *EkmipServerConnectivityInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type EkmipServerConnectivityInlineNode struct {
	...
	// links
	Links *EkmipServerConnectivityInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
