...
type DNS struct {
	...
	// links
	Links *DNSInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	DNSInlineServiceIps []*string `json:"service_ips,omitempty" yaml:"service_ips,omitempty"`

	// Status of all the DNS name servers configured for the specified SVM.
	//
	// Read Only: true
	DNSInlineStatus []*Status `json:"status,omitempty" yaml:"status,omitempty"`

	// domains
	Domains DNSDomainsArrayInline `json:"domains,omitempty" yaml:"domains,omitempty"`

	// dynamic dns
	DynamicDNS *DNSInlineDynamicDNS `json:"dynamic_dns,omitempty" yaml:"dynamic_dns,omitempty"`

	// Indicates whether or not the query section of the reply packet is equal to that of the query packet.
	//
	PacketQueryMatch *bool `json:"packet_query_match,omitempty" yaml:"packet_query_match,omitempty"`
	...
	//
	SourceAddressMatch *bool `json:"source_address_match,omitempty" yaml:"source_address_match,omitempty"`

	// svm
	Svm *DNSInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	//
	TldQueryEnabled *bool `json:"tld_query_enabled,omitempty" yaml:"tld_query_enabled,omitempty"`
...
type DNSInlineDynamicDNS struct {
	...
	//
	SkipFqdnValidation *bool `json:"skip_fqdn_validation,omitempty" yaml:"skip_fqdn_validation,omitempty"`
	...
	//
	// Example: P2D
	TimeToLive *string `json:"time_to_live,omitempty" yaml:"time_to_live,omitempty"`

	// Enable or disable secure dynamic DNS updates for the specified SVM.
	//
	UseSecure *bool `json:"use_secure,omitempty" yaml:"use_secure,omitempty"`
}
...
type DNSInlineSvm struct {
	...
	// links
	Links *DNSInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
