...
type ConsistencyGroupClone struct {
	...
	ParentConsistencyGroup *ConsistencyGroupCloneInlineParentConsistencyGroup `json:"parent_consistency_group,omitempty" yaml:"parent_consistency_group,omitempty"`

	// parent snapshot
	ParentSnapshot *ConsistencyGroupCloneInlineParentSnapshot `json:"parent_snapshot,omitempty" yaml:"parent_snapshot,omitempty"`

	// parent svm
	ParentSvm *ConsistencyGroupCloneInlineParentSvm `json:"parent_svm,omitempty" yaml:"parent_svm,omitempty"`
	...
	// volume
	Volume *ConsistencyGroupCloneInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type ConsistencyGroupCloneInlineParentSnapshot struct {
	...
	// links
	Links *ConsistencyGroupCloneInlineParentSnapshotInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ConsistencyGroupCloneInlineParentSvm struct {
	...
	// links
	Links *ConsistencyGroupCloneInlineParentSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
