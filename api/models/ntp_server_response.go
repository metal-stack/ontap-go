...
type NtpServerResponse struct {
	...
	// links
	Links *NtpServerResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ntp server response inline records
	NtpServerResponseInlineRecords []*NtpServer `json:"records,omitempty" yaml:"records,omitempty"`
