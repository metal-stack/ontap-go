...
type ApplicationSanAccessIscsiEndpoint struct {
	...
	// links
	Links *ApplicationSanAccessIscsiEndpointInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// interface
	Interface *ApplicationSanAccessIscsiEndpointInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`
...
type ApplicationSanAccessIscsiEndpointInlineInterface struct {
	...
	// links
	Links *ApplicationSanAccessIscsiEndpointInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *ApplicationSanAccessIscsiEndpointInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
