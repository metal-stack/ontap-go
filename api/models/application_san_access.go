...
type ApplicationSanAccess struct {
	...
	ApplicationSanAccessInlineLunMappings []*ApplicationLunMappingObject `json:"lun_mappings,omitempty" yaml:"lun_mappings,omitempty"`

	// backing storage
	BackingStorage *ApplicationSanAccessInlineBackingStorage `json:"backing_storage,omitempty" yaml:"backing_storage,omitempty"`
