...
type TopMetricsUser struct {
	...
	// iops
	Iops *TopMetricsUserInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// svm
	Svm *TopMetricsUserInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsUserInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
	...
	// volume
	Volume *TopMetricsUserInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type TopMetricsUserInlineSvm struct {
	...
	// links
	Links *TopMetricsUserInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type TopMetricsUserInlineVolume struct {
	...
	// links
	Links *TopMetricsUserInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
