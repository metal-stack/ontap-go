...
type LocalCifsUsersAndGroupsImport struct {
	...
	// links
	Links *LocalCifsUsersAndGroupsImportInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Password to decrypt the compressed file.
	// Max Length: 128
	DecryptionPassword *string `json:"decryption_password,omitempty" yaml:"decryption_password,omitempty"`

	// detailed status
	DetailedStatus *LocalCifsUsersAndGroupsImportInlineDetailedStatus `json:"detailed_status,omitempty" yaml:"detailed_status,omitempty"`

	// Number of elements ignored.
	// Read Only: true
	ElementsIgnored *int64 `json:"elements_ignored,omitempty" yaml:"elements_ignored,omitempty"`

	// Number of elements successfully imported.
	// Read Only: true
	ElementsImported *int64 `json:"elements_imported,omitempty" yaml:"elements_imported,omitempty"`

	// import uri
	ImportURI *LocalCifsUsersAndGroupsImportInlineImportURI `json:"import_uri,omitempty" yaml:"import_uri,omitempty"`
	...
	// status uri
	StatusURI *LocalCifsUsersAndGroupsImportInlineStatusURI `json:"status_uri,omitempty" yaml:"status_uri,omitempty"`

	// svm
	Svm *LocalCifsUsersAndGroupsImportInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type LocalCifsUsersAndGroupsImportInlineSvm struct {
	...
	// links
	Links *LocalCifsUsersAndGroupsImportInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
