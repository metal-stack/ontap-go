...
type QosWorkload struct {
	...
	// links
	Links *QosWorkloadInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	Lun *string `json:"lun,omitempty" yaml:"lun,omitempty"`
	...
	// policy
	Policy *QosWorkloadInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`

	// Name of the Qtree.
	// Read Only: true
	Qtree *string `json:"qtree,omitempty" yaml:"qtree,omitempty"`

	// svm
	Svm *QosWorkloadInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// Example: 123
	// Read Only: true
	Wid *int64 `json:"wid,omitempty" yaml:"wid,omitempty"`

	// Class of the QoS workload.
	// Example: autovolume
	// Read Only: true
	// Enum: ["undefined","preset","user_defined","system_defined","autovolume","load_control"]
	WorkloadClass *string `json:"workload_class,omitempty" yaml:"workload_class,omitempty"`
}
...
type QosWorkloadInlinePolicy struct {
	...
	// links
	Links *QosWorkloadInlinePolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type QosWorkloadInlineSvm struct {
	...
	// links
	Links *QosWorkloadInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
