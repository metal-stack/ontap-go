...
type PerformanceMetricSvmReference struct {
	...
	// links
	Links *PerformanceMetricSvmReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceMetricSvmReferenceInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceMetricSvmReferenceInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceMetricSvmReferenceInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
