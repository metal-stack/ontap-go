...
type Port struct {
	...
	// links
	Links *PortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// broadcast domain
	BroadcastDomain *PortInlineBroadcastDomain `json:"broadcast_domain,omitempty" yaml:"broadcast_domain,omitempty"`
	...
	FlowcontrolAdmin *string `json:"flowcontrol_admin,omitempty" yaml:"flowcontrol_admin,omitempty"`
	...
	// Read Only: true
	InterfaceCount *int64 `json:"interface_count,omitempty" yaml:"interface_count,omitempty"`

	// lag
	Lag *PortInlineLag `json:"lag,omitempty" yaml:"lag,omitempty"`
	...
	// metric
	Metric *PortInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// node
	Node *PortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// Discovered devices
	// Read Only: true
	PortInlineDiscoveredDevices []*PortInlineDiscoveredDevicesInlineArrayItem `json:"discovered_devices,omitempty" yaml:"discovered_devices,omitempty"`

	// List of PFC queues
	PortInlinePfcQueuesAdmin []*int64 `json:"pfc_queues_admin,omitempty" yaml:"pfc_queues_admin,omitempty"`

	// Reachable broadcast domains.
	// Read Only: true
	PortInlineReachableBroadcastDomains []*PortInlineReachableBroadcastDomainsInlineArrayItem `json:"reachable_broadcast_domains,omitempty" yaml:"reachable_broadcast_domains,omitempty"`

	// Supported RDMA offload protocols
	// Read Only: true
	RdmaProtocols []*string `json:"rdma_protocols,omitempty" yaml:"rdma_protocols,omitempty"`
	...
	// statistics
	Statistics *PortInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`
	...
	// vlan
	Vlan *PortInlineVlan `json:"vlan,omitempty" yaml:"vlan,omitempty"`
}
...
type PortInlineBroadcastDomain struct {
	...
	// links
	Links *PortInlineBroadcastDomainInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ipspace
	Ipspace *PortInlineBroadcastDomainInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
...
type PortInlineDiscoveredDevicesInlineArrayItem struct {
	...
	IPAddresses []*IPAddressReadonly `json:"ip_addresses" yaml:"ip_addresses"`
	...
	RemainingHoldTime *int64 `json:"remaining_hold_time,omitempty" yaml:"remaining_hold_time,omitempty"`
...
type PortInlineLag struct {
	...
	// Read Only: true
	ActivePorts []*PortLagActivePortsItems0 `json:"active_ports,omitempty" yaml:"active_ports,omitempty"`
	...
	MemberPorts []*PortLagMemberPortsItems0 `json:"member_ports,omitempty" yaml:"member_ports,omitempty"`
...
type PortLagActivePortsItems0 struct {
	...
	// links
	Links *PortLagActivePortsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *PortLagActivePortsItems0Node `json:"node,omitempty" yaml:"node,omitempty"`
...
type PortLagMemberPortsItems0 struct {
	...
	// links
	Links *PortLagMemberPortsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *PortLagMemberPortsItems0Node `json:"node,omitempty" yaml:"node,omitempty"`
...
type PortInlineMetric struct {
	...
	// links
	Links *PortInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *PortInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type PortInlineNode struct {
	...
	// links
	Links *PortInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PortInlineReachableBroadcastDomainsInlineArrayItem struct {
	...
	// links
	Links *PortInlineReachableBroadcastDomainsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ipspace
	Ipspace *PortInlineReachableBroadcastDomainsInlineArrayItemInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
...
type PortInlineStatistics struct {
	...
	// device
	Device *PortInlineStatisticsInlineDevice `json:"device,omitempty" yaml:"device,omitempty"`
	...
	// throughput raw
	ThroughputRaw *PortInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type PortInlineStatisticsInlineDevice struct {
	...
	// Example: 3
	LinkDownCountRaw *int64 `json:"link_down_count_raw,omitempty" yaml:"link_down_count_raw,omitempty"`

	// receive raw
	ReceiveRaw *PortInlineStatisticsInlineDeviceInlineReceiveRaw `json:"receive_raw,omitempty" yaml:"receive_raw,omitempty"`
	...
	// transmit raw
	TransmitRaw *PortInlineStatisticsInlineDeviceInlineTransmitRaw `json:"transmit_raw,omitempty" yaml:"transmit_raw,omitempty"`
}
...
type PortInlineStatisticsInlineDeviceInlineReceiveRaw struct {
	...
	// Example: 100
	Discards *int64 `json:"discards,omitempty" yaml:"discards,omitempty"`

	// Number of packet errors.
	// Example: 200
	Errors *int64 `json:"errors,omitempty" yaml:"errors,omitempty"`
...
type PortInlineVlan struct {
	...
	// base port
	BasePort *PortInlineVlanInlineBasePort `json:"base_port,omitempty" yaml:"base_port,omitempty"`

	// VLAN ID
	// Example: 100
	// Maximum: 4094
	// Minimum: 1
	Tag *int64 `json:"tag,omitempty" yaml:"tag,omitempty"`
}
...
type PortInlineVlanInlineBasePort struct {
	...
	// links
	Links *PortInlineVlanInlineBasePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *PortInlineVlanInlineBasePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
