...
type VvolBinding struct {
	...
	// links
	Links *VvolBindingInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: true
	// Read Only: true
	IsOptimal *bool `json:"is_optimal,omitempty" yaml:"is_optimal,omitempty"`

	// protocol endpoint
	ProtocolEndpoint *VvolBindingInlineProtocolEndpoint `json:"protocol_endpoint,omitempty" yaml:"protocol_endpoint,omitempty"`
	...
	// svm
	Svm *VvolBindingInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// vvol
	Vvol *VvolBindingInlineVvol `json:"vvol,omitempty" yaml:"vvol,omitempty"`
}
...
type VvolBindingInlineProtocolEndpoint struct {
	...
	// links
	Links *VvolBindingInlineProtocolEndpointInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VvolBindingInlineSvm struct {
	...
	// links
	Links *VvolBindingInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type VvolBindingInlineVvol struct {
	...
	// links
	Links *VvolBindingInlineVvolInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
