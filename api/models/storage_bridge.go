...
type StorageBridge struct {
	...
	// Example: ok
	// Enum: ["ok","warning"]
	ChassisThroughputState *string `json:"chassis_throughput_state,omitempty" yaml:"chassis_throughput_state,omitempty"`

	// dram single bit error count
	DramSingleBitErrorCount *int64 `json:"dram_single_bit_error_count,omitempty" yaml:"dram_single_bit_error_count,omitempty"`
	...
	// last reboot
	LastReboot *StorageBridgeInlineLastReboot `json:"last_reboot,omitempty" yaml:"last_reboot,omitempty"`
	...
	SecurityEnabled *bool `json:"security_enabled,omitempty" yaml:"security_enabled,omitempty"`
	...
	StorageBridgeInlineErrors []*StorageBridgeInlineErrorsInlineArrayItem `json:"errors,omitempty" yaml:"errors,omitempty"`

	// storage bridge inline fc ports
	StorageBridgeInlineFcPorts []*StorageBridgeInlineFcPortsInlineArrayItem `json:"fc_ports,omitempty" yaml:"fc_ports,omitempty"`

	// storage bridge inline paths
	StorageBridgeInlinePaths []*StorageBridgeInlinePathsInlineArrayItem `json:"paths,omitempty" yaml:"paths,omitempty"`

	// storage bridge inline power supply units
	StorageBridgeInlinePowerSupplyUnits []*StorageBridgeInlinePowerSupplyUnitsInlineArrayItem `json:"power_supply_units,omitempty" yaml:"power_supply_units,omitempty"`

	// storage bridge inline sas ports
	StorageBridgeInlineSasPorts []*StorageBridgeInlineSasPortsInlineArrayItem `json:"sas_ports,omitempty" yaml:"sas_ports,omitempty"`

	// Bridge symbolic name
	// Example: rtp-fcsas03-41kk11
	SymbolicName *string `json:"symbolic_name,omitempty" yaml:"symbolic_name,omitempty"`

	// temperature sensor
	TemperatureSensor *StorageBridgeInlineTemperatureSensor `json:"temperature_sensor,omitempty" yaml:"temperature_sensor,omitempty"`
...
type StorageBridgeInlineErrorsInlineArrayItem struct {
	...
	// component
	Component *StorageBridgeInlineErrorsInlineArrayItemInlineComponent `json:"component,omitempty" yaml:"component,omitempty"`
...
type StorageBridgeInlineFcPortsInlineArrayItem struct {
	...
	// Enum: [0,2,4,8,16,32]
	ConfiguredDataRate *float64 `json:"configured_data_rate,omitempty" yaml:"configured_data_rate,omitempty"`
	...
	// Enum: [2,4,8,16,32]
	DataRateCapability *float64 `json:"data_rate_capability,omitempty" yaml:"data_rate_capability,omitempty"`
	...
	// Enum: [0,2,4,8,16,32]
	NegotiatedDataRate *float64 `json:"negotiated_data_rate,omitempty" yaml:"negotiated_data_rate,omitempty"`

	// Bridge FC port peer port world wide name
	// Example: 200650eb1a238892
	PeerWwn *string `json:"peer_wwn,omitempty" yaml:"peer_wwn,omitempty"`

	// sfp
	Sfp *StorageBridgeInlineFcPortsInlineArrayItemInlineSfp `json:"sfp,omitempty" yaml:"sfp,omitempty"`
...
type StorageBridgeInlinePathsInlineArrayItem struct {
	...
	// node
	Node *StorageBridgeInlinePathsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// source port
	SourcePort *StorageBridgeInlinePathsInlineArrayItemInlineSourcePort `json:"source_port,omitempty" yaml:"source_port,omitempty"`

	// target port
	TargetPort *StorageBridgeInlinePathsInlineArrayItemInlineTargetPort `json:"target_port,omitempty" yaml:"target_port,omitempty"`
}
...
type StorageBridgeInlinePathsInlineArrayItemInlineNode struct {
	...
	// links
	Links *StorageBridgeInlinePathsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type StorageBridgeInlineSasPortsInlineArrayItem struct {
	...
	// cable
	Cable *StorageBridgeInlineSasPortsInlineArrayItemInlineCable `json:"cable,omitempty" yaml:"cable,omitempty"`
	...
	// phy 1
	Phy1 *StorageBridgeInlineSasPortsInlineArrayItemInlinePhy1 `json:"phy_1,omitempty" yaml:"phy_1,omitempty"`

	// phy 2
	Phy2 *StorageBridgeInlineSasPortsInlineArrayItemInlinePhy2 `json:"phy_2,omitempty" yaml:"phy_2,omitempty"`

	// phy 3
	Phy3 *StorageBridgeInlineSasPortsInlineArrayItemInlinePhy3 `json:"phy_3,omitempty" yaml:"phy_3,omitempty"`

	// phy 4
	Phy4 *StorageBridgeInlineSasPortsInlineArrayItemInlinePhy4 `json:"phy_4,omitempty" yaml:"phy_4,omitempty"`
...
type StorageBridgeInlineTemperatureSensor struct {
	...
	Reading *int64 `json:"reading,omitempty" yaml:"reading,omitempty"`
