...
type AutoUpdateInfo struct {
	...
	// links
	Links *AutoUpdateInfoInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// eula
	Eula *AutoUpdateInfoInlineEula `json:"eula,omitempty" yaml:"eula,omitempty"`
}
...
type AutoUpdateInfoInlineEula struct {
	...
	// Read Only: true
	AcceptedIPAddress *string `json:"accepted_ip_address,omitempty" yaml:"accepted_ip_address,omitempty"`

	// Date and time when the EULA was accepted.
	// Example: 2020-12-01 13:12:23
	// Read Only: true
	// Format: date-time
	AcceptedTimestamp *strfmt.DateTime `json:"accepted_timestamp,omitempty" yaml:"accepted_timestamp,omitempty"`

	// User ID that provided the EULA acceptance.
	// Example: admin
	// Read Only: true
	UserIDAccepted *string `json:"user_id_accepted,omitempty" yaml:"user_id_accepted,omitempty"`
}
...
type AutoUpdateInfoInlineLinks struct {
	...
	// self
	Self *AutoUpdateInfoInlineLinksInlineSelf `json:"self,omitempty" yaml:"self,omitempty"`
}
