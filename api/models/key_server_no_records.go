...
type KeyServerNoRecords struct {
	...
	// links
	Links *KeyServerNoRecordsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// connectivity
	Connectivity *KeyServerNoRecordsInlineConnectivity `json:"connectivity,omitempty" yaml:"connectivity,omitempty"`
