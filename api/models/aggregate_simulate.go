...
type AggregateSimulate struct {
	...
	AggregateSimulateInlineRecords []*Aggregate `json:"records,omitempty" yaml:"records,omitempty"`

	// List of validation warnings and remediation advice for the aggregate simulate behavior.
	AggregateSimulateInlineWarnings []*AggregateWarning `json:"warnings,omitempty" yaml:"warnings,omitempty"`
