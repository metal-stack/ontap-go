...
type EmsDestinationResponse struct {
	...
	// links
	Links *EmsDestinationResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ems destination response inline records
	EmsDestinationResponseInlineRecords []*EmsDestinationResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type EmsDestinationResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *EmsDestinationResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access control role
	AccessControlRole *EmsDestinationResponseInlineRecordsInlineArrayItemInlineAccessControlRole `json:"access_control_role,omitempty" yaml:"access_control_role,omitempty"`

	// certificate
	Certificate *EmsDestinationResponseInlineRecordsInlineArrayItemInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`

	// connectivity
	Connectivity *EmsDestinationResponseInlineRecordsInlineArrayItemInlineConnectivity `json:"connectivity,omitempty" yaml:"connectivity,omitempty"`
	...
	// filters
	Filters []*EmsDestinationResponseRecordsItems0FiltersItems0 `json:"filters" yaml:"filters"`
	...
	// syslog
	Syslog *EmsDestinationResponseInlineRecordsInlineArrayItemInlineSyslog `json:"syslog,omitempty" yaml:"syslog,omitempty"`
...
type EmsDestinationResponseInlineRecordsInlineArrayItemInlineAccessControlRole struct {
	...
	// links
	Links *EmsDestinationResponseInlineRecordsInlineArrayItemInlineAccessControlRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationResponseInlineRecordsInlineArrayItemInlineCertificate struct {
	...
	// links
	Links *EmsDestinationResponseInlineRecordsInlineArrayItemInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationResponseInlineRecordsInlineArrayItemInlineConnectivity struct {
	...
	// Read Only: true
	Errors []*EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0 `json:"errors" yaml:"errors"`
...
type EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0 struct {
	...
	// message
	Message *EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0Message `json:"message,omitempty" yaml:"message,omitempty"`

	// node
	Node *EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0Node `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0Message struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0MessageArgumentsItems0 `json:"arguments" yaml:"arguments"`
...
type EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0Node struct {
	...
	// links
	Links *EmsDestinationResponseRecordsItems0ConnectivityErrorsItems0NodeLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationResponseRecordsItems0FiltersItems0 struct {
	...
	// links
	Links *EmsDestinationResponseRecordsItems0FiltersItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsDestinationResponseInlineRecordsInlineArrayItemInlineSyslog struct {
	...
	// format
	Format *EmsDestinationResponseInlineRecordsInlineArrayItemInlineSyslogInlineFormat `json:"format,omitempty" yaml:"format,omitempty"`
...
type EmsDestinationResponseInlineRecordsInlineArrayItemInlineSyslogInlineFormat struct {
	...
	HostnameOverride *string `json:"hostname_override,omitempty" yaml:"hostname_override,omitempty"`
	...
	TimestampOverride *string `json:"timestamp_override,omitempty" yaml:"timestamp_override,omitempty"`
}
