...
type FcPortResponse struct {
	...
	// links
	Links *FcPortResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fc port response inline records
	FcPortResponseInlineRecords []*FcPort `json:"records,omitempty" yaml:"records,omitempty"`
