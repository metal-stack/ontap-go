...
type TopMetricsFileResponse struct {
	...
	// links
	Links *TopMetricsFileResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// incomplete response reason
	IncompleteResponseReason *TopMetricsFileResponseInlineIncompleteResponseReason `json:"incomplete_response_reason,omitempty" yaml:"incomplete_response_reason,omitempty"`

	// notice
	Notice *TopMetricsFileResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsFileResponseInlineRecords []*TopMetricsFile `json:"records,omitempty" yaml:"records,omitempty"`
}
