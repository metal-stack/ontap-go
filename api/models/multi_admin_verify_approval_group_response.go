...
type MultiAdminVerifyApprovalGroupResponse struct {
	...
	// links
	Links *MultiAdminVerifyApprovalGroupResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// multi admin verify approval group response inline records
	MultiAdminVerifyApprovalGroupResponseInlineRecords []*MultiAdminVerifyApprovalGroup `json:"records,omitempty" yaml:"records,omitempty"`
