...
type StorageSwitch struct {
	...
	// director class
	DirectorClass *bool `json:"director_class,omitempty" yaml:"director_class,omitempty"`

	// Domain ID
	DomainID *int64 `json:"domain_id,omitempty" yaml:"domain_id,omitempty"`

	// Storage switch fabric name
	FabricName *string `json:"fabric_name,omitempty" yaml:"fabric_name,omitempty"`
	...
	StorageSwitchInlineConnections []*StorageSwitchInlineConnectionsInlineArrayItem `json:"connections,omitempty" yaml:"connections,omitempty"`

	// storage switch inline errors
	StorageSwitchInlineErrors []*StorageSwitchInlineErrorsInlineArrayItem `json:"errors,omitempty" yaml:"errors,omitempty"`

	// storage switch inline fans
	StorageSwitchInlineFans []*StorageSwitchInlineFansInlineArrayItem `json:"fans,omitempty" yaml:"fans,omitempty"`

	// Indicates the blades that are being monitored for a director-class switch.
	StorageSwitchInlineMonitoredBlades []*int64 `json:"monitored_blades,omitempty" yaml:"monitored_blades,omitempty"`

	// storage switch inline paths
	StorageSwitchInlinePaths []*StorageSwitchInlinePathsInlineArrayItem `json:"paths,omitempty" yaml:"paths,omitempty"`

	// storage switch inline ports
	StorageSwitchInlinePorts []*StorageSwitchInlinePortsInlineArrayItem `json:"ports,omitempty" yaml:"ports,omitempty"`

	// storage switch inline power supply units
	StorageSwitchInlinePowerSupplyUnits []*StorageSwitchInlinePowerSupplyUnitsInlineArrayItem `json:"power_supply_units,omitempty" yaml:"power_supply_units,omitempty"`

	// storage switch inline temperature sensors
	StorageSwitchInlineTemperatureSensors []*StorageSwitchInlineTemperatureSensorsInlineArrayItem `json:"temperature_sensors,omitempty" yaml:"temperature_sensors,omitempty"`

	// storage switch inline vsans
	StorageSwitchInlineVsans []*StorageSwitchInlineVsansInlineArrayItem `json:"vsans,omitempty" yaml:"vsans,omitempty"`

	// storage switch inline zones
	StorageSwitchInlineZones []*StorageSwitchInlineZonesInlineArrayItem `json:"zones,omitempty" yaml:"zones,omitempty"`
...
type StorageSwitchInlineConnectionsInlineArrayItem struct {
	...
	// peer port
	PeerPort *StorageSwitchInlineConnectionsInlineArrayItemInlinePeerPort `json:"peer_port,omitempty" yaml:"peer_port,omitempty"`

	// source port
	SourcePort *StorageSwitchInlineConnectionsInlineArrayItemInlineSourcePort `json:"source_port,omitempty" yaml:"source_port,omitempty"`
}
...
type StorageSwitchInlineErrorsInlineArrayItem struct {
	...
	// component
	Component *StorageSwitchInlineErrorsInlineArrayItemInlineComponent `json:"component,omitempty" yaml:"component,omitempty"`
...
type StorageSwitchInlinePathsInlineArrayItem struct {
	...
	// adapter
	Adapter *StorageSwitchInlinePathsInlineArrayItemInlineAdapter `json:"adapter,omitempty" yaml:"adapter,omitempty"`

	// node
	Node *StorageSwitchInlinePathsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// port
	Port *StorageSwitchInlinePathsInlineArrayItemInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type StorageSwitchInlinePathsInlineArrayItemInlineNode struct {
	...
	// links
	Links *StorageSwitchInlinePathsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type StorageSwitchInlinePortsInlineArrayItem struct {
	...
	// sfp
	Sfp *StorageSwitchInlinePortsInlineArrayItemInlineSfp `json:"sfp,omitempty" yaml:"sfp,omitempty"`
...
type StorageSwitchInlinePortsInlineArrayItemInlineSfp struct {
	...
	TransmitterType *string `json:"transmitter_type,omitempty" yaml:"transmitter_type,omitempty"`
...
type StorageSwitchInlineVsansInlineArrayItem struct {
	...
	Iod *bool `json:"iod,omitempty" yaml:"iod,omitempty"`

	// Storage switch VSAN load balancing type
	LoadBalancingTypes *string `json:"load_balancing_types,omitempty" yaml:"load_balancing_types,omitempty"`
...
type StorageSwitchInlineZonesInlineArrayItem struct {
	...
	// port
	Port *StorageSwitchInlineZonesInlineArrayItemInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
