...
type SvmCifsServiceReference struct {
	...
	// links
	Links *SvmCifsServiceReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ad domain
	AdDomain *SvmCifsServiceReferenceInlineAdDomain `json:"ad_domain,omitempty" yaml:"ad_domain,omitempty"`
