...
type IscsiService struct {
	...
	// links
	Links *IscsiServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// metric
	Metric *IscsiServiceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// statistics
	Statistics *IscsiServiceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// svm
	Svm *IscsiServiceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// target
	Target *IscsiServiceInlineTarget `json:"target,omitempty" yaml:"target,omitempty"`
}
...
type IscsiServiceInlineMetric struct {
	...
	// links
	Links *IscsiServiceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *IscsiServiceInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *IscsiServiceInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *IscsiServiceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type IscsiServiceInlineStatistics struct {
	...
	// iops raw
	IopsRaw *IscsiServiceInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *IscsiServiceInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *IscsiServiceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type IscsiServiceInlineSvm struct {
	...
	// links
	Links *IscsiServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
