...
type S3BucketLifecycleRule struct {
	...
	// links
	Links *S3BucketLifecycleRuleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// abort incomplete multipart upload
	AbortIncompleteMultipartUpload *S3BucketLifecycleRuleInlineAbortIncompleteMultipartUpload `json:"abort_incomplete_multipart_upload,omitempty" yaml:"abort_incomplete_multipart_upload,omitempty"`
	...
	// expiration
	Expiration *S3BucketLifecycleRuleInlineExpiration `json:"expiration,omitempty" yaml:"expiration,omitempty"`
	...
	NonCurrentVersionExpiration *S3BucketLifecycleRuleInlineNonCurrentVersionExpiration `json:"non_current_version_expiration,omitempty" yaml:"non_current_version_expiration,omitempty"`

	// object filter
	ObjectFilter *S3BucketLifecycleRuleInlineObjectFilter `json:"object_filter,omitempty" yaml:"object_filter,omitempty"`

	// svm
	Svm *S3BucketLifecycleRuleInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type S3BucketLifecycleRuleInlineAbortIncompleteMultipartUpload struct {
	...
	// links
	Links *S3BucketLifecycleRuleInlineAbortIncompleteMultipartUploadInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleRuleInlineExpiration struct {
	...
	// links
	Links *S3BucketLifecycleRuleInlineExpirationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleRuleInlineNonCurrentVersionExpiration struct {
	...
	// links
	Links *S3BucketLifecycleRuleInlineNonCurrentVersionExpirationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleRuleInlineObjectFilter struct {
	...
	// links
	Links *S3BucketLifecycleRuleInlineObjectFilterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleRuleInlineSvm struct {
	...
	// links
	Links *S3BucketLifecycleRuleInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
