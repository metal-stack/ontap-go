...
type UnixGroupUsers struct {
	...
	// links
	Links *UnixGroupUsersInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SkipNameValidation *bool `json:"skip_name_validation,omitempty" yaml:"skip_name_validation,omitempty"`

	// svm
	Svm *UnixGroupUsersInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// unix group
	UnixGroup *UnixGroupUsersInlineUnixGroup `json:"unix_group,omitempty" yaml:"unix_group,omitempty"`
	...
	//
	UnixGroupUsersInlineRecords []*UnixGroupUsersInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
}
...
type UnixGroupUsersInlineSvm struct {
	...
	// links
	Links *UnixGroupUsersInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
