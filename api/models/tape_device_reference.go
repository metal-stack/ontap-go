...
type TapeDeviceReference struct {
	...
	// links
	Links *TapeDeviceReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *TapeDeviceReferenceInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type TapeDeviceReferenceInlineNode struct {
	...
	// links
	Links *TapeDeviceReferenceInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
