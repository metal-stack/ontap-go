...
type SplitStatus struct {
	...
	// Read Only: true
	PendingSplits *int64 `json:"pending_splits,omitempty" yaml:"pending_splits,omitempty"`

	// svm
	Svm *SplitStatusInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// Specifies the space occupied by unsplit file clones in the volume.
	// Read Only: true
	UnsplitSize *int64 `json:"unsplit_size,omitempty" yaml:"unsplit_size,omitempty"`

	// volume
	Volume *SplitStatusInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SplitStatusInlineSvm struct {
	...
	// links
	Links *SplitStatusInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SplitStatusInlineVolume struct {
	...
	// links
	Links *SplitStatusInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
