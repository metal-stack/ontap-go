...
type GroupPolicyObjectEventAudit struct {
	...
	LogonType *string `json:"logon_type,omitempty" yaml:"logon_type,omitempty"`

	// Type of object access to be audited.
	// Example: failure
	// Enum: ["none","success","failure","both"]
	ObjectAccessType *string `json:"object_access_type,omitempty" yaml:"object_access_type,omitempty"`
}
