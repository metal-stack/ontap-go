...
type AntiRansomwareVolumeWorkload struct {
	...
	// Read Only: true
	AntiRansomwareVolumeWorkloadInlineFileExtensionsObserved []*string `json:"file_extensions_observed,omitempty" yaml:"file_extensions_observed,omitempty"`

	// New file extensions observed in the volume during surge.
	// Read Only: true
	AntiRansomwareVolumeWorkloadInlineNewlyObservedFileExtensions []*AntiRansomwareVolumeWorkloadInlineNewlyObservedFileExtensionsInlineArrayItem `json:"newly_observed_file_extensions,omitempty" yaml:"newly_observed_file_extensions,omitempty"`

	// Count of types of file extensions observed in the volume.
	// Example: 3
	// Read Only: true
	FileExtensionTypesCount *int64 `json:"file_extension_types_count,omitempty" yaml:"file_extension_types_count,omitempty"`

	// historical statistics
	HistoricalStatistics *AntiRansomwareVolumeWorkloadInlineHistoricalStatistics `json:"historical_statistics,omitempty" yaml:"historical_statistics,omitempty"`

	// surge statistics
	SurgeStatistics *AntiRansomwareVolumeWorkloadInlineSurgeStatistics `json:"surge_statistics,omitempty" yaml:"surge_statistics,omitempty"`

	// surge usage
	SurgeUsage *AntiRansomwareVolumeWorkloadInlineSurgeUsage `json:"surge_usage,omitempty" yaml:"surge_usage,omitempty"`

	// typical usage
	TypicalUsage *AntiRansomwareVolumeWorkloadInlineTypicalUsage `json:"typical_usage,omitempty" yaml:"typical_usage,omitempty"`
}
...
type AntiRansomwareVolumeWorkloadInlineSurgeUsage struct {
	...
	// New file extensions observed in the volume during surge.
	// Read Only: true
	NewlyObservedFileExtensions []*AntiRansomwareVolumeWorkloadSurgeUsageNewlyObservedFileExtensionsItems0 `json:"newly_observed_file_extensions,omitempty" yaml:"newly_observed_file_extensions,omitempty"`
