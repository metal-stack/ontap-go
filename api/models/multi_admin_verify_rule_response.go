...
type MultiAdminVerifyRuleResponse struct {
	...
	// links
	Links *MultiAdminVerifyRuleResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// multi admin verify rule response inline records
	MultiAdminVerifyRuleResponseInlineRecords []*MultiAdminVerifyRule `json:"records,omitempty" yaml:"records,omitempty"`
