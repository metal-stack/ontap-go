...
type NodeMetricsResponse struct {
	...
	// links
	Links *NodeMetricsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// node metrics response inline records
	NodeMetricsResponseInlineRecords []*NodeMetricsResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type NodeMetricsResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *NodeMetricsResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
