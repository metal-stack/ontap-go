...
type WebauthnGlobal struct {
	...
	// Example: false
	// Read Only: true
	RequireRk *bool `json:"require_rk,omitempty" yaml:"require_rk,omitempty"`

	// Resident key.
	// Example: discouraged
	// Read Only: true
	// Enum: ["required","preferred","discouraged"]
	ResidentKey *string `json:"resident_key,omitempty" yaml:"resident_key,omitempty"`
	...
	// Read Only: true
	// Enum: ["required","preferred","discouraged"]
	UserVerification *string `json:"user_verification,omitempty" yaml:"user_verification,omitempty"`
}
