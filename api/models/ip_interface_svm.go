...
type IPInterfaceSvm struct {
	...
	// links
	Links *IPInterfaceSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *IPInterfaceSvmInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`

	// The services associated with the interface.
	// Read Only: true
	IPInterfaceSvmInlineServices []*IPService `json:"services,omitempty" yaml:"services,omitempty"`

	// location
	Location *IPInterfaceSvmInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`
	...
	// service policy
	ServicePolicy *IPServicePolicySvmEnum `json:"service_policy,omitempty" yaml:"service_policy,omitempty"`
...
type IPInterfaceSvmInlineIP struct {
	...
	// address
	Address *IPAddressReadcreate `json:"address,omitempty" yaml:"address,omitempty"`

	// netmask
	Netmask *IPNetmaskCreateonly `json:"netmask,omitempty" yaml:"netmask,omitempty"`
}
...
type IPInterfaceSvmInlineLocation struct {
	...
	// broadcast domain
	BroadcastDomain *IPInterfaceSvmInlineLocationInlineBroadcastDomain `json:"broadcast_domain,omitempty" yaml:"broadcast_domain,omitempty"`

	// home node
	HomeNode *IPInterfaceSvmInlineLocationInlineHomeNode `json:"home_node,omitempty" yaml:"home_node,omitempty"`

	// home port
	HomePort *PortSvm `json:"home_port,omitempty" yaml:"home_port,omitempty"`
}
...
type IPInterfaceSvmInlineLocationInlineBroadcastDomain struct {
	...
	// links
	Links *IPInterfaceSvmInlineLocationInlineBroadcastDomainInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IPInterfaceSvmInlineLocationInlineHomeNode struct {
	...
	// links
	Links *IPInterfaceSvmInlineLocationInlineHomeNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
