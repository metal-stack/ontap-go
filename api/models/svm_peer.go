...
type SvmPeer struct {
	...
	// links
	Links *SvmPeerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// peer
	Peer *SvmPeerInlinePeer `json:"peer,omitempty" yaml:"peer,omitempty"`
	...
	// svm
	Svm *SvmPeerInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// A list of applications for an SVM peer relationship.
	// Example: ["snapmirror","lun_copy"]
	SvmPeerInlineApplications []*SvmPeerApplications `json:"applications,omitempty" yaml:"applications,omitempty"`
...
type SvmPeerInlinePeer struct {
	...
	// cluster
	Cluster *SvmPeerInlinePeerInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// svm
	Svm *SvmPeerInlinePeerInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type SvmPeerInlinePeerInlineCluster struct {
	...
	// links
	Links *SvmPeerInlinePeerInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmPeerInlinePeerInlineSvm struct {
	...
	// links
	Links *SvmPeerInlinePeerInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmPeerInlineSvm struct {
	...
	// links
	Links *SvmPeerInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
