...
type SnapshotPolicyResponse struct {
	...
	// links
	Links *SnapshotPolicyResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnapshotPolicyResponseInlineRecords []*SnapshotPolicy `json:"records,omitempty" yaml:"records,omitempty"`
}
