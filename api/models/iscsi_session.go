...
type IscsiSession struct {
	...
	// links
	Links *IscsiSessionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// initiator
	Initiator *IscsiSessionInlineInitiator `json:"initiator,omitempty" yaml:"initiator,omitempty"`

	// The iSCSI connections that make up the iSCSI session.
	//
	// Read Only: true
	IscsiSessionInlineConnections []*IscsiConnection `json:"connections,omitempty" yaml:"connections,omitempty"`

	// The initiator groups in which the initiator is a member.
	//
	// Read Only: true
	IscsiSessionInlineIgroups []*IscsiSessionInlineIgroupsInlineArrayItem `json:"igroups,omitempty" yaml:"igroups,omitempty"`

	// The initiator portion of the session identifier specified by the initiator during login.
	//
	// Example: 61:62:63:64:65:00
	// Read Only: true
	Isid *string `json:"isid,omitempty" yaml:"isid,omitempty"`

	// svm
	Svm *IscsiSessionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// The target portal group to which the session belongs.
	//
	// Example: tpgroup1
	// Read Only: true
	TargetPortalGroup *string `json:"target_portal_group,omitempty" yaml:"target_portal_group,omitempty"`

	// The target portal group tag of the session.
	//
	// Read Only: true
	TargetPortalGroupTag *int64 `json:"target_portal_group_tag,omitempty" yaml:"target_portal_group_tag,omitempty"`

	// The target session identifier handle (TSIH) of the session.
	//
	// Read Only: true
	Tsih *int64 `json:"tsih,omitempty" yaml:"tsih,omitempty"`
}
...
type IscsiSessionInlineIgroupsInlineArrayItem struct {
	...
	// links
	Links *IscsiSessionInlineIgroupsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IscsiSessionInlineSvm struct {
	...
	// links
	Links *IscsiSessionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
