...
type NdmpMover struct {
	...
	// Example: 645120
	BytesMoved *int64 `json:"bytes_moved,omitempty" yaml:"bytes_moved,omitempty"`

	// Indicates the NDMP connection attributes.
	Connection *NdmpConnect `json:"connection,omitempty" yaml:"connection,omitempty"`

	// Indicates the NDMP mover mode of operation.
	// Example: read
	Mode *NdmpMoverMode `json:"mode,omitempty" yaml:"mode,omitempty"`

	// Indicates the reason for the NDMP mover pause or halt.
	// Example: end_of_media
	Reason *NdmpReason `json:"reason,omitempty" yaml:"reason,omitempty"`

	// Indicates the NDMP mover state.
	// Example: connected
	State *NdmpState `json:"state,omitempty" yaml:"state,omitempty"`
}
