...
type Flexcache struct {
	...
	// links
	Links *FlexcacheInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// atime scrub
	AtimeScrub *FlexcacheInlineAtimeScrub `json:"atime_scrub,omitempty" yaml:"atime_scrub,omitempty"`

	// cifs change notify
	CifsChangeNotify *FlexcacheInlineCifsChangeNotify `json:"cifs_change_notify,omitempty" yaml:"cifs_change_notify,omitempty"`
	...
	FlexcacheInlineAggregates []*FlexcacheInlineAggregatesInlineArrayItem `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`

	// flexcache inline origins
	FlexcacheInlineOrigins []*FlexcacheRelationship `json:"origins,omitempty" yaml:"origins,omitempty"`
	...
	GlobalFileLockingEnabled *bool `json:"global_file_locking_enabled,omitempty" yaml:"global_file_locking_enabled,omitempty"`

	// guarantee
	Guarantee *FlexcacheInlineGuarantee `json:"guarantee,omitempty" yaml:"guarantee,omitempty"`
	...
	OverrideEncryption *bool `json:"override_encryption,omitempty" yaml:"override_encryption,omitempty"`
	...
	// prepopulate
	Prepopulate *FlexcacheInlinePrepopulate `json:"prepopulate,omitempty" yaml:"prepopulate,omitempty"`

	// relative size
	RelativeSize *FlexcacheInlineRelativeSize `json:"relative_size,omitempty" yaml:"relative_size,omitempty"`
	...
	// svm
	Svm *FlexcacheInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	UseTieredAggregate *bool `json:"use_tiered_aggregate,omitempty" yaml:"use_tiered_aggregate,omitempty"`
	...
	// writeback
	Writeback *FlexcacheInlineWriteback `json:"writeback,omitempty" yaml:"writeback,omitempty"`
}
...
type FlexcacheInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *FlexcacheInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FlexcacheInlineAtimeScrub struct {
	...
	Period *int16 `json:"period,omitempty" yaml:"period,omitempty"`
}
...
type FlexcacheInlinePrepopulate struct {
	...
	// dir paths
	DirPaths []*string `json:"dir_paths,omitempty" yaml:"dir_paths,omitempty"`

	// exclude dir paths
	ExcludeDirPaths []*string `json:"exclude_dir_paths,omitempty" yaml:"exclude_dir_paths,omitempty"`
...
type FlexcacheInlineRelativeSize struct {
	...
	Percentage *int16 `json:"percentage,omitempty" yaml:"percentage,omitempty"`
}
...
type FlexcacheInlineSvm struct {
	...
	// links
	Links *FlexcacheInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
