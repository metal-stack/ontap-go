...
type PoliciesAndRulesToBeApplied struct {
	...
	// svm
	Svm *PoliciesAndRulesToBeAppliedInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// to be applied
	ToBeApplied *PoliciesAndRulesToBeAppliedInlineToBeApplied `json:"to_be_applied,omitempty" yaml:"to_be_applied,omitempty"`
}
...
type PoliciesAndRulesToBeAppliedInlineSvm struct {
	...
	// links
	Links *PoliciesAndRulesToBeAppliedInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type PoliciesAndRulesToBeAppliedInlineToBeApplied struct {
	...
	// access policies
	AccessPolicies []*GroupPolicyObjectCentralAccessPolicy `json:"access_policies,omitempty" yaml:"access_policies,omitempty"`

	// access rules
	AccessRules []*GroupPolicyObjectCentralAccessRule `json:"access_rules,omitempty" yaml:"access_rules,omitempty"`

	// objects
	Objects []*GroupPolicyObject `json:"objects,omitempty" yaml:"objects,omitempty"`

	// restricted groups
	RestrictedGroups []*GroupPolicyObjectRestrictedGroup `json:"restricted_groups,omitempty" yaml:"restricted_groups,omitempty"`
}
