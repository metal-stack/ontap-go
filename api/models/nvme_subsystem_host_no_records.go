...
type NvmeSubsystemHostNoRecords struct {
	...
	// links
	Links *NvmeSubsystemHostNoRecordsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// dh hmac chap
	DhHmacChap *NvmeSubsystemHostNoRecordsInlineDhHmacChap `json:"dh_hmac_chap,omitempty" yaml:"dh_hmac_chap,omitempty"`

	// io queue
	IoQueue *NvmeSubsystemHostNoRecordsInlineIoQueue `json:"io_queue,omitempty" yaml:"io_queue,omitempty"`
	...
	// subsystem
	Subsystem *NvmeSubsystemHostNoRecordsInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`

	// tls
	TLS *NvmeSubsystemHostNoRecordsInlineTLS `json:"tls,omitempty" yaml:"tls,omitempty"`
}
...
type NvmeSubsystemHostNoRecordsInlineSubsystem struct {
	...
	// links
	Links *NvmeSubsystemHostNoRecordsInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
