...
type S3Group struct {
	...
	S3GroupInlinePolicies []*S3GroupInlinePoliciesInlineArrayItem `json:"policies,omitempty" yaml:"policies,omitempty"`

	// Specifies the list of users who belong to the group.
	S3GroupInlineUsers []*S3GroupInlineUsersInlineArrayItem `json:"users,omitempty" yaml:"users,omitempty"`

	// svm
	Svm *S3GroupInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type S3GroupInlinePoliciesInlineArrayItem struct {
	...
	// links
	Links *S3GroupInlinePoliciesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3GroupInlineSvm struct {
	...
	// links
	Links *S3GroupInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3GroupInlineUsersInlineArrayItem struct {
	...
	// links
	Links *S3GroupInlineUsersInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
