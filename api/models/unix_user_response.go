...
type UnixUserResponse struct {
	...
	// links
	Links *UnixUserResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	UnixUserResponseInlineRecords []*UnixUser `json:"records,omitempty" yaml:"records,omitempty"`
}
