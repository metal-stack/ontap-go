...
type SecurityGroup struct {
	...
	// owner
	Owner *SecurityGroupInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
...
type SecurityGroupInlineOwner struct {
	...
	// links
	Links *SecurityGroupInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
