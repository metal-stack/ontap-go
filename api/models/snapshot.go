...
type Snapshot struct {
	...
	// Example: 1cd8a442-86d1-11e0-ae1c-123478563412
	// Read Only: true
	VersionUUID *string `json:"version_uuid,omitempty" yaml:"version_uuid,omitempty"`

	// volume
	Volume *SnapshotInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SnapshotInlineSvm struct {
	...
	// links
	Links *SnapshotInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
