...
type S3Bucket struct {
	...
	AuditEventSelector *S3BucketInlineAuditEventSelector `json:"audit_event_selector,omitempty" yaml:"audit_event_selector,omitempty"`
	...
	LifecycleManagement *S3BucketInlineLifecycleManagement `json:"lifecycle_management,omitempty" yaml:"lifecycle_management,omitempty"`
	...
	// policy
	Policy *S3BucketInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`

	// protection status
	ProtectionStatus *S3BucketInlineProtectionStatus `json:"protection_status,omitempty" yaml:"protection_status,omitempty"`

	// qos policy
	QosPolicy *S3BucketInlineQosPolicy `json:"qos_policy,omitempty" yaml:"qos_policy,omitempty"`

	// retention
	Retention *S3BucketInlineRetention `json:"retention,omitempty" yaml:"retention,omitempty"`
	...
	S3BucketInlineAggregates []*S3BucketInlineAggregatesInlineArrayItem `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`
	...
	// svm
	Svm *S3BucketInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume
	Volume *S3BucketInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type S3BucketInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *S3BucketInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketInlineLifecycleManagement struct {
	...
	Rules []*S3BucketLifecycleManagementRulesItems0 `json:"rules,omitempty" yaml:"rules,omitempty"`
}
...
type S3BucketLifecycleManagementRulesItems0 struct {
	...
	// links
	Links *S3BucketLifecycleManagementRulesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`

	// abort incomplete multipart upload
	AbortIncompleteMultipartUpload *S3BucketLifecycleManagementRulesItems0AbortIncompleteMultipartUpload `json:"abort_incomplete_multipart_upload,omitempty" yaml:"abort_incomplete_multipart_upload,omitempty"`
	...
	// expiration
	Expiration *S3BucketLifecycleManagementRulesItems0Expiration `json:"expiration,omitempty" yaml:"expiration,omitempty"`
	...
	NonCurrentVersionExpiration *S3BucketLifecycleManagementRulesItems0NonCurrentVersionExpiration `json:"non_current_version_expiration,omitempty" yaml:"non_current_version_expiration,omitempty"`

	// object filter
	ObjectFilter *S3BucketLifecycleManagementRulesItems0ObjectFilter `json:"object_filter,omitempty" yaml:"object_filter,omitempty"`

	// svm
	Svm *S3BucketLifecycleManagementRulesItems0Svm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type S3BucketLifecycleManagementRulesItems0AbortIncompleteMultipartUpload struct {
	...
	// links
	Links *S3BucketLifecycleManagementRulesItems0AbortIncompleteMultipartUploadLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleManagementRulesItems0Expiration struct {
	...
	// links
	Links *S3BucketLifecycleManagementRulesItems0ExpirationLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleManagementRulesItems0NonCurrentVersionExpiration struct {
	...
	// links
	Links *S3BucketLifecycleManagementRulesItems0NonCurrentVersionExpirationLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleManagementRulesItems0ObjectFilter struct {
	...
	// links
	Links *S3BucketLifecycleManagementRulesItems0ObjectFilterLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketLifecycleManagementRulesItems0Svm struct {
	...
	// links
	Links *S3BucketLifecycleManagementRulesItems0SvmLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketInlineProtectionStatus struct {
	...
	// destination
	Destination *S3BucketInlineProtectionStatusInlineDestination `json:"destination,omitempty" yaml:"destination,omitempty"`
...
type S3BucketInlineQosPolicy struct {
	...
	// links
	Links *S3BucketInlineQosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type S3BucketInlineSvm struct {
	...
	// links
	Links *S3BucketInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
