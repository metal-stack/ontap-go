...
type EmsRoleConfig struct {
	...
	// links
	Links *EmsRoleConfigInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access control role
	AccessControlRole *EmsRoleConfigInlineAccessControlRole `json:"access_control_role,omitempty" yaml:"access_control_role,omitempty"`

	// event filter
	EventFilter *EmsRoleConfigInlineEventFilter `json:"event_filter,omitempty" yaml:"event_filter,omitempty"`
...
type EmsRoleConfigInlineAccessControlRole struct {
	...
	// links
	Links *EmsRoleConfigInlineAccessControlRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsRoleConfigInlineEventFilter struct {
	...
	// links
	Links *EmsRoleConfigInlineEventFilterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
