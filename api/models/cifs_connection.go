...
type CifsConnection struct {
	...
	CifsConnectionInlineSessions []*CifsConnectionInlineSessionsInlineArrayItem `json:"sessions,omitempty" yaml:"sessions,omitempty"`
	...
	// Example: 22802
	// Read Only: true
	NetworkContextID *int64 `json:"network_context_id,omitempty" yaml:"network_context_id,omitempty"`

	// node
	Node *CifsConnectionInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// svm
	Svm *CifsConnectionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type CifsConnectionInlineNode struct {
	...
	// links
	Links *CifsConnectionInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsConnectionInlineSvm struct {
	...
	// links
	Links *CifsConnectionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
