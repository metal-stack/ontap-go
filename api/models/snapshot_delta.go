...
type SnapshotDelta struct {
	...
	// links
	Links *SnapshotDeltaInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Indicates the space that has changed between two specified WAFL file systems, in bytes.
	// Read Only: true
	SizeConsumed *int64 `json:"size_consumed,omitempty" yaml:"size_consumed,omitempty"`

	// Time elapsed between two specified WAFL file systems.
	// Read Only: true
	TimeElapsed *string `json:"time_elapsed,omitempty" yaml:"time_elapsed,omitempty"`
}
