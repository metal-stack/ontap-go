...
type FirmwareDisk struct {
	...
	// Example: 120
	// Read Only: true
	AverageDurationPerDisk *int64 `json:"average_duration_per_disk,omitempty" yaml:"average_duration_per_disk,omitempty"`

	// The number of disks waiting to download the firmware update.
	// Example: 0
	// Read Only: true
	NumWaitingDownload *int64 `json:"num_waiting_download,omitempty" yaml:"num_waiting_download,omitempty"`

	// Estimated firmware update duration to completion (in minutes).
	// Example: 0
	// Read Only: true
	TotalCompletionEstimate *int64 `json:"total_completion_estimate,omitempty" yaml:"total_completion_estimate,omitempty"`

	// Status of the background disk firmware update.
	// Read Only: true
	// Enum: ["running","idle"]
	UpdateStatus interface{} `json:"update_status,omitempty" yaml:"update_status,omitempty"`
}
