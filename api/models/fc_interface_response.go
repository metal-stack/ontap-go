...
type FcInterfaceResponse struct {
	...
	// links
	Links *FcInterfaceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fc interface response inline records
	FcInterfaceResponseInlineRecords []*FcInterface `json:"records,omitempty" yaml:"records,omitempty"`
	...
	// recommend
	Recommend *FcInterfaceResponseInlineRecommend `json:"recommend,omitempty" yaml:"recommend,omitempty"`
}
...
type FcInterfaceResponseInlineRecommend struct {
	...
	//
	// Read Only: true
	Messages []*FcInterfaceRecommendMessage `json:"messages,omitempty" yaml:"messages,omitempty"`
}
