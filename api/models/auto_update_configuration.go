...
type AutoUpdateConfiguration struct {
	...
	// links
	Links *AutoUpdateConfigurationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// description
	Description *AutoUpdateConfigurationInlineDescription `json:"description,omitempty" yaml:"description,omitempty"`
