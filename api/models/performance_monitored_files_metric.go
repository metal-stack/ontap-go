...
type PerformanceMonitoredFilesMetric struct {
	...
	// links
	Links *PerformanceMonitoredFilesMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceMonitoredFilesMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceMonitoredFilesMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceMonitoredFilesMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
