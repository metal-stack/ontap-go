...
type MetroclusterDrGroupResponse struct {
	...
	// links
	Links *MetroclusterDrGroupResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// metrocluster dr group response inline records
	MetroclusterDrGroupResponseInlineRecords []*MetroclusterDrGroup `json:"records,omitempty" yaml:"records,omitempty"`
