...
type SnaplockLogResponse struct {
	...
	// links
	Links *SnaplockLogResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnaplockLogResponseInlineRecords []*SnaplockLog `json:"records,omitempty" yaml:"records,omitempty"`
}
