...
type SecurityOauth2 struct {
	...
	// links
	Links *SecurityOauth2InlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	HashedClientSecret *string `json:"hashed_client_secret,omitempty" yaml:"hashed_client_secret,omitempty"`

	// introspection
	Introspection *SecurityOauth2InlineIntrospection `json:"introspection,omitempty" yaml:"introspection,omitempty"`
	...
	// jwks
	Jwks *SecurityOauth2InlineJwks `json:"jwks,omitempty" yaml:"jwks,omitempty"`
	...
	UseMutualTLS *string `json:"use_mutual_tls,omitempty" yaml:"use_mutual_tls,omitempty"`
}
...
type SecurityOauth2InlineIntrospection struct {
	...
	EndpointURI *string `json:"endpoint_uri,omitempty" yaml:"endpoint_uri,omitempty"`
...
type SecurityOauth2InlineJwks struct {
	...
	ProviderURI *string `json:"provider_uri,omitempty" yaml:"provider_uri,omitempty"`
