...
type SecurityAuditLogForwardResponse struct {
	...
	// links
	Links *SecurityAuditLogForwardResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SecurityAuditLogForwardResponseInlineRecords []*SecurityAuditLogForward `json:"records,omitempty" yaml:"records,omitempty"`
}
