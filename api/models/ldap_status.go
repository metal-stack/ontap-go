...
type LdapStatus struct {
	...
	// ipv4
	IPV4 *LdapStatusInlineIPV4 `json:"ipv4,omitempty" yaml:"ipv4,omitempty"`
	...
	// ipv6
	IPV6 *LdapStatusInlineIPV6 `json:"ipv6,omitempty" yaml:"ipv6,omitempty"`
	...
	LdapStatusInlineDnMessage []*string `json:"dn_message,omitempty" yaml:"dn_message,omitempty"`
