...
type SoftwareReference struct {
	...
	// links
	Links *SoftwareReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: 2140
	// Read Only: true
	ElapsedDuration *int64 `json:"elapsed_duration,omitempty" yaml:"elapsed_duration,omitempty"`

	// Overall estimated time for completion of the upgrade or validation operation.
	// Example: 5220
	// Read Only: true
	EstimatedDuration *int64 `json:"estimated_duration,omitempty" yaml:"estimated_duration,omitempty"`

	// metrocluster
	Metrocluster *SoftwareReferenceInlineMetrocluster `json:"metrocluster,omitempty" yaml:"metrocluster,omitempty"`
	...
	// Read Only: true
	SoftwareReferenceInlineNodes []*SoftwareNodeReference `json:"nodes,omitempty" yaml:"nodes,omitempty"`

	// List of failed post-update checks' warnings, errors, and advice.
	// Read Only: true
	SoftwareReferenceInlinePostUpdateChecks []*SoftwareValidationReference `json:"post_update_checks,omitempty" yaml:"post_update_checks,omitempty"`

	// Display status details.
	// Read Only: true
	SoftwareReferenceInlineStatusDetails []*SoftwareStatusDetailsReference `json:"status_details,omitempty" yaml:"status_details,omitempty"`

	// Display update progress details.
	// Read Only: true
	SoftwareReferenceInlineUpdateDetails []*SoftwareUpdateDetailsReference `json:"update_details,omitempty" yaml:"update_details,omitempty"`

	// List of validation warnings, errors, and advice.
	// Read Only: true
	SoftwareReferenceInlineValidationResults []*SoftwareValidationReference `json:"validation_results,omitempty" yaml:"validation_results,omitempty"`
...
type SoftwareReferenceInlineMetrocluster struct {
	...
	// Read Only: true
	Clusters []*SoftwareMccReference `json:"clusters,omitempty" yaml:"clusters,omitempty"`

	// progress details
	ProgressDetails *SoftwareReferenceInlineMetroclusterInlineProgressDetails `json:"progress_details,omitempty" yaml:"progress_details,omitempty"`

	// progress summary
	ProgressSummary *SoftwareReferenceInlineMetroclusterInlineProgressSummary `json:"progress_summary,omitempty" yaml:"progress_summary,omitempty"`
}
