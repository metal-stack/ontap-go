...
type SnapmirrorPolicyRule struct {
	...
	// creation schedule
	CreationSchedule *SnapmirrorPolicyRuleInlineCreationSchedule `json:"creation_schedule,omitempty" yaml:"creation_schedule,omitempty"`
	...
	// Example: 4
	Warn *int64 `json:"warn,omitempty" yaml:"warn,omitempty"`
}
...
type SnapmirrorPolicyRuleInlineCreationSchedule struct {
	...
	// links
	Links *SnapmirrorPolicyRuleInlineCreationScheduleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
