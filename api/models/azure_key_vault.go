...
type AzureKeyVault struct {
	...
	// links
	Links *AzureKeyVaultInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	AzureKeyVaultInlineEkmipReachability []*AzureKeyVaultInlineEkmipReachabilityInlineArrayItem `json:"ekmip_reachability,omitempty" yaml:"ekmip_reachability,omitempty"`

	// azure reachability
	AzureReachability *AzureKeyVaultInlineAzureReachability `json:"azure_reachability,omitempty" yaml:"azure_reachability,omitempty"`
	...
	// configuration
	Configuration *AzureKeyVaultInlineConfiguration `json:"configuration,omitempty" yaml:"configuration,omitempty"`
	...
	// Format: uri
	KeyID *strfmt.URI `json:"key_id,omitempty" yaml:"key_id,omitempty"`

	// Name of the deployed AKV that will be used by ONTAP for storing keys.
	// Example: https://kmip-akv-keyvault.vault.azure.net/
	// Format: uri
	Name *strfmt.URI `json:"name,omitempty" yaml:"name,omitempty"`
	...
	// svm
	Svm *AzureKeyVaultInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	VaultHost *string `json:"vault_host,omitempty" yaml:"vault_host,omitempty"`
...
type AzureKeyVaultInlineConfiguration struct {
	...
	// links
	Links *AzureKeyVaultInlineConfigurationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type AzureKeyVaultInlineEkmipReachabilityInlineArrayItem struct {
	...
	// node
	Node *AzureKeyVaultInlineEkmipReachabilityInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type AzureKeyVaultInlineEkmipReachabilityInlineArrayItemInlineNode struct {
	...
	// links
	Links *AzureKeyVaultInlineEkmipReachabilityInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type AzureKeyVaultInlineSvm struct {
	...
	// links
	Links *AzureKeyVaultInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
