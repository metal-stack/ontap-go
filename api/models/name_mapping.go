...
type NameMapping struct {
	...
	// links
	Links *NameMappingInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ClientMatch *string `json:"client_match,omitempty" yaml:"client_match,omitempty"`
	...
	// svm
	Svm *NameMappingInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type NameMappingInlineSvm struct {
	...
	// links
	Links *NameMappingInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
