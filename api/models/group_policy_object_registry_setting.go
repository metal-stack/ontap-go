...
type GroupPolicyObjectRegistrySetting struct {
	...
	// branchcache
	Branchcache *GroupPolicyObjectBranchcache `json:"branchcache,omitempty" yaml:"branchcache,omitempty"`

	// Refresh time interval in ISO-8601 format.
	// Example: P15M
	RefreshTimeInterval *string `json:"refresh_time_interval,omitempty" yaml:"refresh_time_interval,omitempty"`

	// Random offset in ISO-8601 format.
	// Example: P1D
	RefreshTimeRandomOffset *string `json:"refresh_time_random_offset,omitempty" yaml:"refresh_time_random_offset,omitempty"`
}
