...
type S3BucketSnapshot struct {
	...
	// links
	Links *S3BucketSnapshotInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// The unique identifier of the bucket.
	// Example: 2aec8270-58e3-11ef-861e-005056ae1130
	// Read Only: true
	// Format: uuid
	BucketUUID *strfmt.UUID `json:"bucket_uuid,omitempty" yaml:"bucket_uuid,omitempty"`
	...
	// svm
	Svm *S3BucketSnapshotInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type S3BucketSnapshotInlineSvm struct {
	...
	// links
	Links *S3BucketSnapshotInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
