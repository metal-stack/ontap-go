...
type ConsistencyGroupNas struct {
	...
	// cifs
	Cifs *ConsistencyGroupNasInlineCifs `json:"cifs,omitempty" yaml:"cifs,omitempty"`

	// export policy
	ExportPolicy *ConsistencyGroupNasInlineExportPolicy `json:"export_policy,omitempty" yaml:"export_policy,omitempty"`

	// The UNIX group ID of the volume. Valid in POST or PATCH.
	Gid *int64 `json:"gid,omitempty" yaml:"gid,omitempty"`

	// junction parent
	JunctionParent *ConsistencyGroupNasInlineJunctionParent `json:"junction_parent,omitempty" yaml:"junction_parent,omitempty"`
