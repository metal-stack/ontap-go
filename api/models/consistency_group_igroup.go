...
type ConsistencyGroupIgroup struct {
	...
	//
	ConsistencyGroupIgroupInlineIgroups []*ConsistencyGroupIgroupInlineIgroupsInlineArrayItem `json:"igroups,omitempty" yaml:"igroups,omitempty"`

	// The initiators that are members of the group.
	//
	ConsistencyGroupIgroupInlineInitiators []*ConsistencyGroupIgroupInlineInitiatorsInlineArrayItem `json:"initiators,omitempty" yaml:"initiators,omitempty"`
