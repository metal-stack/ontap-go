...
type IgroupNestedResponse struct {
	...
	// links
	Links *IgroupNestedResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// igroup nested response inline records
	IgroupNestedResponseInlineRecords []*IgroupNested `json:"records,omitempty" yaml:"records,omitempty"`
