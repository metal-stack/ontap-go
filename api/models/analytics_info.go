...
type AnalyticsInfo struct {
	...
	// by accessed time
	ByAccessedTime *AnalyticsInfoInlineByAccessedTime `json:"by_accessed_time,omitempty" yaml:"by_accessed_time,omitempty"`

	// by modified time
	ByModifiedTime *AnalyticsInfoInlineByModifiedTime `json:"by_modified_time,omitempty" yaml:"by_modified_time,omitempty"`
...
type AnalyticsInfoInlineByAccessedTime struct {
	...
	// bytes used
	BytesUsed *AnalyticsInfoInlineByAccessedTimeInlineBytesUsed `json:"bytes_used,omitempty" yaml:"bytes_used,omitempty"`
}
...
type AnalyticsInfoInlineByModifiedTime struct {
	...
	// bytes used
	BytesUsed *AnalyticsInfoInlineByModifiedTimeInlineBytesUsed `json:"bytes_used,omitempty" yaml:"bytes_used,omitempty"`
}
