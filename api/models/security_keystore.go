...
type SecurityKeystore struct {
	...
	// configuration
	Configuration *SecurityKeystoreInlineConfiguration `json:"configuration,omitempty" yaml:"configuration,omitempty"`
...
type SecurityKeystoreInlineConfiguration struct {
	...
	// links
	Links *SecurityKeystoreInlineConfigurationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SecurityKeystoreInlineSvm struct {
	...
	// links
	Links *SecurityKeystoreInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
