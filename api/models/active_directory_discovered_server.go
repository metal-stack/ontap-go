...
type ActiveDirectoryDiscoveredServer struct {
	...
	// node
	Node *ActiveDirectoryDiscoveredServerInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type ActiveDirectoryDiscoveredServerInlineNode struct {
	...
	// links
	Links *ActiveDirectoryDiscoveredServerInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
