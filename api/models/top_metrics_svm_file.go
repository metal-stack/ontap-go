...
type TopMetricsSvmFile struct {
	...
	// links
	Links *TopMetricsSvmFileInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// iops
	Iops *TopMetricsSvmFileInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`
	...
	// svm
	Svm *TopMetricsSvmFileInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsSvmFileInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`

	// volume
	Volume *TopMetricsSvmFileInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type TopMetricsSvmFileInlineSvm struct {
	...
	// links
	Links *TopMetricsSvmFileInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type TopMetricsSvmFileInlineVolume struct {
	...
	// links
	Links *TopMetricsSvmFileInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
