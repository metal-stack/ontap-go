...
type FcZone struct {
	...
	// links
	Links *FcZoneInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cache
	Cache *FcZoneInlineCache `json:"cache,omitempty" yaml:"cache,omitempty"`

	// fabric
	Fabric *FcZoneInlineFabric `json:"fabric,omitempty" yaml:"fabric,omitempty"`

	// An array of Fibre Channel zone members.
	//
	// Read Only: true
	FcZoneInlineMembers []*FcZoneInlineMembersInlineArrayItem `json:"members,omitempty" yaml:"members,omitempty"`
...
type FcZoneInlineFabric struct {
	...
	// links
	Links *FcZoneInlineFabricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
