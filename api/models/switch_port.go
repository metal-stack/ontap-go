...
type SwitchPort struct {
	...
	DuplexType *string `json:"duplex_type,omitempty" yaml:"duplex_type,omitempty"`

	// identity
	Identity *SwitchPortInlineIdentity `json:"identity,omitempty" yaml:"identity,omitempty"`

	// Is configured as an ISL link.
	// Read Only: true
	Isl *bool `json:"isl,omitempty" yaml:"isl,omitempty"`
	...
	// remote port
	RemotePort *SwitchPortInlineRemotePort `json:"remote_port,omitempty" yaml:"remote_port,omitempty"`
	...
	// statistics
	Statistics *SwitchPortInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// switch
	Switch *SwitchPortInlineSwitch `json:"switch,omitempty" yaml:"switch,omitempty"`

	// switch port inline vlan id
	SwitchPortInlineVlanID []*int64 `json:"vlan_id,omitempty" yaml:"vlan_id,omitempty"`
...
type SwitchPortInlineRemotePort struct {
	...
	// device
	Device *SwitchPortInlineRemotePortInlineDevice `json:"device,omitempty" yaml:"device,omitempty"`
...
type SwitchPortInlineRemotePortInlineDevice struct {
	...
	// node
	Node *SwitchPortInlineRemotePortInlineDeviceInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// shelf
	Shelf *SwitchPortInlineRemotePortInlineDeviceInlineShelf `json:"shelf,omitempty" yaml:"shelf,omitempty"`
}
...
type SwitchPortInlineRemotePortInlineDeviceInlineNode struct {
	...
	// links
	Links *SwitchPortInlineRemotePortInlineDeviceInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SwitchPortInlineRemotePortInlineDeviceInlineShelf struct {
	...
	// links
	Links *SwitchPortInlineRemotePortInlineDeviceInlineShelfInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SwitchPortInlineStatistics struct {
	...
	// receive raw
	ReceiveRaw *SwitchPortInlineStatisticsInlineReceiveRaw `json:"receive_raw,omitempty" yaml:"receive_raw,omitempty"`

	// transmit raw
	TransmitRaw *SwitchPortInlineStatisticsInlineTransmitRaw `json:"transmit_raw,omitempty" yaml:"transmit_raw,omitempty"`
}
