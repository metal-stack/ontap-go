...
type ConsistencyGroupMetrics struct {
	...
	// links
	Links *ConsistencyGroupMetricsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *ConsistencyGroupMetricsInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *ConsistencyGroupMetricsInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *ConsistencyGroupMetricsInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
