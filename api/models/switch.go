...
type Switch struct {
	...
	// monitoring
	Monitoring *SwitchInlineMonitoring `json:"monitoring,omitempty" yaml:"monitoring,omitempty"`
	...
	// snmp
	Snmp *SwitchInlineSnmp `json:"snmp,omitempty" yaml:"snmp,omitempty"`
...
type SwitchInlineMonitoring struct {
	...
	// Is Monitored.
	// Read Only: true
	Monitored *bool `json:"monitored,omitempty" yaml:"monitored,omitempty"`
