...
type SoftwareValidationReference struct {
	...
	// action
	Action *SoftwareValidationReferenceInlineAction `json:"action,omitempty" yaml:"action,omitempty"`

	// issue
	Issue *SoftwareValidationReferenceInlineIssue `json:"issue,omitempty" yaml:"issue,omitempty"`
	...
	// Example: nfs_mounts
	// Read Only: true
	UpdateCheck *string `json:"update_check,omitempty" yaml:"update_check,omitempty"`
}
