...
type LocalCifsGroup struct {
	...
	// links
	Links *LocalCifsGroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	LocalCifsGroupInlineMembers []*LocalCifsGroupInlineMembersInlineArrayItem `json:"members,omitempty" yaml:"members,omitempty"`
	...
	// svm
	Svm *LocalCifsGroupInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type LocalCifsGroupInlineSvm struct {
	...
	// links
	Links *LocalCifsGroupInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
