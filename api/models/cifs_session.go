...
type CifsSession struct {
	...
	// links
	Links *CifsSessionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	CifsSessionInlineVolumes []*CifsSessionInlineVolumesInlineArrayItem `json:"volumes,omitempty" yaml:"volumes,omitempty"`
	...
	// Read Only: true
	ConnectedDuration *string `json:"connected_duration,omitempty" yaml:"connected_duration,omitempty"`

	// A counter used to track requests that are sent to the volumes to the node.
	//
	// Example: 0
	// Read Only: true
	ConnectionCount *int64 `json:"connection_count,omitempty" yaml:"connection_count,omitempty"`

	// A unique 32-bit unsigned number used to represent each SMB session's connection ID.
	//
	// Example: 22802
	// Read Only: true
	ConnectionID *int64 `json:"connection_id,omitempty" yaml:"connection_id,omitempty"`
	...
	ContinuousAvailability *string `json:"continuous_availability,omitempty" yaml:"continuous_availability,omitempty"`
	...
	// Example: root
	// Read Only: true
	MappedUnixUser *string `json:"mapped_unix_user,omitempty" yaml:"mapped_unix_user,omitempty"`

	// node
	Node *CifsSessionInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	//
	// Read Only: true
	OpenOther *int64 `json:"open_other,omitempty" yaml:"open_other,omitempty"`

	// Number of shares the SMB session has opened.
	//
	// Read Only: true
	OpenShares *int64 `json:"open_shares,omitempty" yaml:"open_shares,omitempty"`
	...
	SmbEncryption *string `json:"smb_encryption,omitempty" yaml:"smb_encryption,omitempty"`

	// Specifies whether or not SMB signing is enabled.
	// Example: false
	// Read Only: true
	SmbSigning *bool `json:"smb_signing,omitempty" yaml:"smb_signing,omitempty"`

	// svm
	Svm *CifsSessionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type CifsSessionInlineNode struct {
	...
	// links
	Links *CifsSessionInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsSessionInlineSvm struct {
	...
	// links
	Links *CifsSessionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
