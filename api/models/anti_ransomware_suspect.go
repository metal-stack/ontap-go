...
type AntiRansomwareSuspect struct {
	...
	// links
	Links *AntiRansomwareSuspectInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type AntiRansomwareSuspectInlineFile struct {
	...
	// Read Only: true
	// Format: date-time
	SuspectTime *strfmt.DateTime `json:"suspect_time,omitempty" yaml:"suspect_time,omitempty"`
}
