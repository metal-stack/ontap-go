...
type S3Audit struct {
	...
	// events
	Events *S3AuditInlineEvents `json:"events,omitempty" yaml:"events,omitempty"`

	// log
	Log *S3Log `json:"log,omitempty" yaml:"log,omitempty"`
	...
	// svm
	Svm *S3AuditInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type S3AuditInlineSvm struct {
	...
	// links
	Links *S3AuditInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
