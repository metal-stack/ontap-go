...
type FlexcacheOrigin struct {
	...
	// links
	Links *FlexcacheOriginInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	BlockLevelInvalidation *bool `json:"block_level_invalidation,omitempty" yaml:"block_level_invalidation,omitempty"`

	// flexcache origin inline flexcaches
	FlexcacheOriginInlineFlexcaches []*FlexcacheRelationship `json:"flexcaches,omitempty" yaml:"flexcaches,omitempty"`
	...
	// svm
	Svm *FlexcacheOriginInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type FlexcacheOriginInlineSvm struct {
	...
	// links
	Links *FlexcacheOriginInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
