...
type PortStatisticsDevice struct {
	...
	// receive raw
	ReceiveRaw *PortStatisticsDeviceInlineReceiveRaw `json:"receive_raw,omitempty" yaml:"receive_raw,omitempty"`
	...
	// transmit raw
	TransmitRaw *PortStatisticsDeviceInlineTransmitRaw `json:"transmit_raw,omitempty" yaml:"transmit_raw,omitempty"`
}
