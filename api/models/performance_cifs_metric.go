...
type PerformanceCifsMetric struct {
	...
	// links
	Links *PerformanceCifsMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceCifsMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceCifsMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceCifsMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
