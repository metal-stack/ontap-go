...
type GroupPolicyObjectRestrictedGroupResponse struct {
	...
	// links
	Links *GroupPolicyObjectRestrictedGroupResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// group policy object restricted group response inline records
	GroupPolicyObjectRestrictedGroupResponseInlineRecords []*GroupPolicyObjectRestrictedGroup `json:"records,omitempty" yaml:"records,omitempty"`
