...
type AwsKms struct {
	...
	// links
	Links *AwsKmsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// amazon reachability
	AmazonReachability *AwsKmsInlineAmazonReachability `json:"amazon_reachability,omitempty" yaml:"amazon_reachability,omitempty"`

	// aws kms inline ekmip reachability
	// Read Only: true
	AwsKmsInlineEkmipReachability []*AwsKmsInlineEkmipReachabilityInlineArrayItem `json:"ekmip_reachability,omitempty" yaml:"ekmip_reachability,omitempty"`
	...
	EncryptionContext *string `json:"encryption_context,omitempty" yaml:"encryption_context,omitempty"`
	...
	// Example: 55
	PollingPeriod *int64 `json:"polling_period,omitempty" yaml:"polling_period,omitempty"`
	...
	// Format: password
	SecretAccessKey *strfmt.Password `json:"secret_access_key,omitempty" yaml:"secret_access_key,omitempty"`
	...
	// state
	State *AwsKmsInlineState `json:"state,omitempty" yaml:"state,omitempty"`

	// svm
	Svm *AwsKmsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type AwsKmsInlineEkmipReachabilityInlineArrayItem struct {
	...
	// node
	Node *AwsKmsInlineEkmipReachabilityInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type AwsKmsInlineEkmipReachabilityInlineArrayItemInlineNode struct {
	...
	// links
	Links *AwsKmsInlineEkmipReachabilityInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type AwsKmsInlineSvm struct {
	...
	// links
	Links *AwsKmsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
