...
type TopMetricsUserResponse struct {
	...
	// links
	Links *TopMetricsUserResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// incomplete response reason
	IncompleteResponseReason *TopMetricsUserResponseInlineIncompleteResponseReason `json:"incomplete_response_reason,omitempty" yaml:"incomplete_response_reason,omitempty"`

	// notice
	Notice *TopMetricsUserResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsUserResponseInlineRecords []*TopMetricsUser `json:"records,omitempty" yaml:"records,omitempty"`
}
