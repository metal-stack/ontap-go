...
type QuotaRuleResponse struct {
	...
	// links
	Links *QuotaRuleResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	QuotaRuleResponseInlineRecords []*QuotaRule `json:"records,omitempty" yaml:"records,omitempty"`
}
