...
type PerformanceS3Metric struct {
	...
	// links
	Links *PerformanceS3MetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *PerformanceS3MetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *PerformanceS3MetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *PerformanceS3MetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
