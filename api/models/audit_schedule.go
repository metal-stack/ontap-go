...
type AuditSchedule struct {
	...
	AuditScheduleInlineDays []*int64 `json:"days,omitempty" yaml:"days,omitempty"`

	// Specifies the hourly schedule to rotate audit log. Leave empty for all.
	AuditScheduleInlineHours []*int64 `json:"hours,omitempty" yaml:"hours,omitempty"`

	// Specifies the minutes schedule to rotate the audit log.
	AuditScheduleInlineMinutes []*int64 `json:"minutes,omitempty" yaml:"minutes,omitempty"`

	// Specifies the months schedule to rotate audit log. Leave empty for all.
	AuditScheduleInlineMonths []*int64 `json:"months,omitempty" yaml:"months,omitempty"`

	// Specifies the weekdays schedule to rotate audit log. Leave empty for all.
	AuditScheduleInlineWeekdays []*int64 `json:"weekdays,omitempty" yaml:"weekdays,omitempty"`
}
