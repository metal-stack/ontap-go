...
type RaidGroupDisk struct {
	...
	// disk
	Disk *RaidGroupDiskInlineDisk `json:"disk,omitempty" yaml:"disk,omitempty"`
...
type RaidGroupDiskInlineDisk struct {
	...
	// links
	Links *RaidGroupDiskInlineDiskInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
