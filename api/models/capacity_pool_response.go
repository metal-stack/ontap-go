...
type CapacityPoolResponse struct {
	...
	CapacityPoolResponseInlineRecords []*CapacityPoolResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type CapacityPoolResponseInlineRecordsInlineArrayItem struct {
	...
	// license manager
	LicenseManager *CapacityPoolResponseInlineRecordsInlineArrayItemInlineLicenseManager `json:"license_manager,omitempty" yaml:"license_manager,omitempty"`

	// Nodes in the cluster associated with this capacity pool.
	Nodes []*CapacityPoolResponseRecordsItems0NodesItems0 `json:"nodes" yaml:"nodes"`
...
type CapacityPoolResponseRecordsItems0NodesItems0 struct {
	...
	// node
	Node *NodeReference `json:"node,omitempty" yaml:"node,omitempty"`
