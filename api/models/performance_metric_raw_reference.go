...
type PerformanceMetricRawReference struct {
	...
	// iops raw
	IopsRaw *PerformanceMetricRawReferenceInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *PerformanceMetricRawReferenceInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *PerformanceMetricRawReferenceInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
