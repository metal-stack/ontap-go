...
type AutosupportMessage struct {
	...
	// error
	Error *AutosupportMessageInlineError `json:"error,omitempty" yaml:"error,omitempty"`

	// Date and Time of AutoSupport generation in ISO-8601 format
	// Example: 2019-03-25 21:30:04
	// Read Only: true
	// Format: date-time
	GeneratedOn *strfmt.DateTime `json:"generated_on,omitempty" yaml:"generated_on,omitempty"`
	...
	// node
	Node *AutosupportMessageInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// Format: uri
	URI *strfmt.URI `json:"uri,omitempty" yaml:"uri,omitempty"`
}
...
type AutosupportMessageInlineNode struct {
	...
	// links
	Links *AutosupportMessageInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
