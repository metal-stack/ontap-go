...
type ApplicationNvmeAccess struct {
	...
	// backing storage
	BackingStorage *ApplicationNvmeAccessInlineBackingStorage `json:"backing_storage,omitempty" yaml:"backing_storage,omitempty"`

	// Clone
	// Read Only: true
	IsClone *bool `json:"is_clone,omitempty" yaml:"is_clone,omitempty"`

	// subsystem map
	SubsystemMap *ApplicationNvmeAccessInlineSubsystemMap `json:"subsystem_map,omitempty" yaml:"subsystem_map,omitempty"`
}
...
type ApplicationNvmeAccessInlineSubsystemMap struct {
	...
	// subsystem
	Subsystem *ApplicationNvmeAccessInlineSubsystemMapInlineSubsystem `json:"subsystem,omitempty" yaml:"subsystem,omitempty"`
}
...
type ApplicationNvmeAccessInlineSubsystemMapInlineSubsystem struct {
	...
	// links
	Links *ApplicationNvmeAccessInlineSubsystemMapInlineSubsystemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// hosts
	// Read Only: true
	Hosts []*ApplicationNvmeAccessSubsystemMapSubsystemHostsItems0 `json:"hosts,omitempty" yaml:"hosts,omitempty"`
...
type ApplicationNvmeAccessSubsystemMapSubsystemHostsItems0 struct {
	...
	// links
	Links *ApplicationNvmeAccessSubsystemMapSubsystemHostsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ApplicationNvmeAccessSubsystemMapSubsystemHostsItems0Links struct {
	...
	// self
	Self *ApplicationNvmeAccessSubsystemMapSubsystemHostsItems0LinksSelf `json:"self,omitempty" yaml:"self,omitempty"`
}
