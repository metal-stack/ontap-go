...
type FpolicyConnectionResponse struct {
	...
	// links
	Links *FpolicyConnectionResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fpolicy connection response inline records
	FpolicyConnectionResponseInlineRecords []*FpolicyConnection `json:"records,omitempty" yaml:"records,omitempty"`
