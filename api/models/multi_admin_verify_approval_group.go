...
type MultiAdminVerifyApprovalGroup struct {
	...
	MultiAdminVerifyApprovalGroupInlineApprovers []*string `json:"approvers,omitempty" yaml:"approvers,omitempty"`

	// Email addresses that are notified when a request is created, approved, vetoed, or executed.
	MultiAdminVerifyApprovalGroupInlineEmail []*strfmt.Email `json:"email,omitempty" yaml:"email,omitempty"`

	// Name of the approval group.
	Name *string `json:"name,omitempty" yaml:"name,omitempty"`

	// owner
	Owner *MultiAdminVerifyApprovalGroupInlineOwner `json:"owner,omitempty" yaml:"owner,omitempty"`
}
...
type MultiAdminVerifyApprovalGroupInlineOwner struct {
	...
	// links
	Links *MultiAdminVerifyApprovalGroupInlineOwnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
