...
type StoragePortReference struct {
	...
	// links
	Links *StoragePortReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *StoragePortReferenceInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type StoragePortReferenceInlineNode struct {
	...
	// links
	Links *StoragePortReferenceInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
