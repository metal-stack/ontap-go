...
type ScannerPool struct {
	...
	ScannerPoolInlinePrivilegedUsers []*string `json:"privileged_users,omitempty" yaml:"privileged_users,omitempty"`
	...
	ScannerPoolInlineServers []*string `json:"servers,omitempty" yaml:"servers,omitempty"`
}
