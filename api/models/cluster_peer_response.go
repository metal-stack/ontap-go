...
type ClusterPeerResponse struct {
	...
	// links
	Links *ClusterPeerResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cluster peer response inline records
	ClusterPeerResponseInlineRecords []*ClusterPeer `json:"records,omitempty" yaml:"records,omitempty"`
