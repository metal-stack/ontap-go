...
type MetroclusterOperation struct {
	...
	// Read Only: true
	AdditionalInfo *string `json:"additional_info,omitempty" yaml:"additional_info,omitempty"`
	...
	// Read Only: true
	MetroclusterOperationInlineErrors []*string `json:"errors,omitempty" yaml:"errors,omitempty"`

	// node
	Node *MetroclusterOperationInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type MetroclusterOperationInlineNode struct {
	...
	// links
	Links *MetroclusterOperationInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
