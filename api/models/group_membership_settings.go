...
type GroupMembershipSettings struct {
	...
	// links
	Links *GroupMembershipSettingsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *GroupMembershipSettingsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type GroupMembershipSettingsInlineSvm struct {
	...
	// links
	Links *GroupMembershipSettingsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
