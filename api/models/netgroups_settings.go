...
type NetgroupsSettings struct {
	...
	// links
	Links *NetgroupsSettingsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	NegativeCacheEnabledByhost *bool `json:"negative_cache_enabled_byhost,omitempty" yaml:"negative_cache_enabled_byhost,omitempty"`

	// Specifies negative Time to Live by host, in ISO 8601 format.
	//
	// Example: PT2M5S
	NegativeTTLByhost *string `json:"negative_ttl_byhost,omitempty" yaml:"negative_ttl_byhost,omitempty"`

	// svm
	Svm *NetgroupsSettingsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// Specifies Time to Live by host, in ISO 8601 format.
	//
	// Example: PT24H
	TTLByhost *string `json:"ttl_byhost,omitempty" yaml:"ttl_byhost,omitempty"`

	// Specifies Time to Live for netgroup members, in ISO 8601 format.
	//
	// Example: PT2M
	TTLForMembers *string `json:"ttl_for_members,omitempty" yaml:"ttl_for_members,omitempty"`
}
...
type NetgroupsSettingsInlineSvm struct {
	...
	// links
	Links *NetgroupsSettingsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
