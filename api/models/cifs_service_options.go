...
type CifsServiceOptions struct {
	...
	//
	AdminToRootMapping *bool `json:"admin_to_root_mapping,omitempty" yaml:"admin_to_root_mapping,omitempty"`
	...
	// of a file.
	//
	AdvancedSparseFile *bool `json:"advanced_sparse_file,omitempty" yaml:"advanced_sparse_file,omitempty"`

	// Specifies whether or not to preserve UNIX symlinks during backup through SMB.
	BackupSymlinkEnabled *bool `json:"backup_symlink_enabled,omitempty" yaml:"backup_symlink_enabled,omitempty"`

	// Specifies whether or not client duplicate session detection is enabled for CIFS.
	ClientDupDetectionEnabled *bool `json:"client_dup_detection_enabled,omitempty" yaml:"client_dup_detection_enabled,omitempty"`

	// Specifies whether or not client version reporting is enabled for CIFS.
	ClientVersionReportingEnabled *bool `json:"client_version_reporting_enabled,omitempty" yaml:"client_version_reporting_enabled,omitempty"`
	...
	//
	FakeOpen *bool `json:"fake_open,omitempty" yaml:"fake_open,omitempty"`

	// Specifies whether or not the trim requests (FSCTL_FILE_LEVEL_TRIM) are supported on the CIFS server.
	//
	FsctlTrim *bool `json:"fsctl_trim,omitempty" yaml:"fsctl_trim,omitempty"`
	...
	//
	JunctionReparse *bool `json:"junction_reparse,omitempty" yaml:"junction_reparse,omitempty"`

	// Specifies whether or not SMB clients can send reads up to 1 MB in size.
	LargeMtu *bool `json:"large_mtu,omitempty" yaml:"large_mtu,omitempty"`

	// Specifies the maximum number of connections allowed per multichannel session.
	// Example: 32
	// Maximum: 1024
	// Minimum: 2
	MaxConnectionsPerSession *int64 `json:"max_connections_per_session,omitempty" yaml:"max_connections_per_session,omitempty"`

	// Specifies the maximum number of LIFs advertised per multichannel session.
	// Example: 256
	// Maximum: 256
	// Minimum: 1
	MaxLifsPerSession *int64 `json:"max_lifs_per_session,omitempty" yaml:"max_lifs_per_session,omitempty"`

	// Specifies the maximum number of opens on the same file per tree.
	// Example: 1000
	MaxOpensSameFilePerTree *int64 `json:"max_opens_same_file_per_tree,omitempty" yaml:"max_opens_same_file_per_tree,omitempty"`

	// Specifies the maximum number of same tree connections per session.
	// Example: 5000
	MaxSameTreeConnectPerSession *int64 `json:"max_same_tree_connect_per_session,omitempty" yaml:"max_same_tree_connect_per_session,omitempty"`

	// Specifies the maximum number of same user sessions per connection.
	// Example: 2500
	MaxSameUserSessionsPerConnection *int64 `json:"max_same_user_sessions_per_connection,omitempty" yaml:"max_same_user_sessions_per_connection,omitempty"`

	// Specifies the maximum number of watches set per tree.
	// Example: 500
	MaxWatchesSetPerTree *int64 `json:"max_watches_set_per_tree,omitempty" yaml:"max_watches_set_per_tree,omitempty"`

	// Specifies whether or not the CIFS server supports Multichannel.
	Multichannel *bool `json:"multichannel,omitempty" yaml:"multichannel,omitempty"`

	// Specifies a Windows User or Group name that should be mapped in case of a NULL user
	// value.
	//
	NullUserWindowsName *string `json:"null_user_windows_name,omitempty" yaml:"null_user_windows_name,omitempty"`

	// Specifies whether or not the path component cache is enabled on the CIFS server.
	PathComponentCache *bool `json:"path_component_cache,omitempty" yaml:"path_component_cache,omitempty"`
	...
	//
	Referral *bool `json:"referral,omitempty" yaml:"referral,omitempty"`
	...
	//
	Shadowcopy *bool `json:"shadowcopy,omitempty" yaml:"shadowcopy,omitempty"`

	// Specifies the maximum level of subdirectories on which ONTAP should create shadow copies.
	ShadowcopyDirDepth *int64 `json:"shadowcopy_dir_depth,omitempty" yaml:"shadowcopy_dir_depth,omitempty"`

	// Specifies the maximum number of outstanding requests on a CIFS connection.
	// Example: 128
	// Maximum: 8192
	// Minimum: 2
	SmbCredits *int64 `json:"smb_credits,omitempty" yaml:"smb_credits,omitempty"`
	...
	//
	TrustedDomainEnumSearchEnabled *bool `json:"trusted_domain_enum_search_enabled,omitempty" yaml:"trusted_domain_enum_search_enabled,omitempty"`

	// Specifies the CIFS protocol versions for which the widelink is reported as reparse point.
	//
	// Example: ["smb1"]
	WidelinkReparseVersions []*string `json:"widelink_reparse_versions,omitempty" yaml:"widelink_reparse_versions,omitempty"`
}
