...
type DiskPathInfo struct {
	...
	// Example: vsim4:3a.10
	DiskPathName *string `json:"disk_path_name,omitempty" yaml:"disk_path_name,omitempty"`
	...
	NodeUUID *string `json:"node.uuid,omitempty" yaml:"node.uuid,omitempty"`
	...
	VmdiskHypervisorFileName *string `json:"vmdisk_hypervisor_file_name,omitempty" yaml:"vmdisk_hypervisor_file_name,omitempty"`
