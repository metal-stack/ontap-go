...
type CifsService struct {
	...
	// links
	Links *CifsServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ad domain
	AdDomain *AdDomain `json:"ad_domain,omitempty" yaml:"ad_domain,omitempty"`
	...
	// Format: password
	ClientSecret *strfmt.Password `json:"client_secret,omitempty" yaml:"client_secret,omitempty"`
	...
	GroupPolicyObjectEnabled *bool `json:"group_policy_object_enabled,omitempty" yaml:"group_policy_object_enabled,omitempty"`

	// URI of the deployed AKV that is used by ONTAP for storing keys.
	// Example: https://kmip-akv-keyvault.vault.azure.net/
	// Format: uri
	KeyVaultURI *strfmt.URI `json:"key_vault_uri,omitempty" yaml:"key_vault_uri,omitempty"`

	// metric
	Metric *CifsServiceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// netbios
	Netbios *CifsNetbios `json:"netbios,omitempty" yaml:"netbios,omitempty"`

	// Open authorization server host name.
	// Example: login.microsoftonline.com
	OauthHost *string `json:"oauth_host,omitempty" yaml:"oauth_host,omitempty"`

	// options
	Options *CifsServiceOptions `json:"options,omitempty" yaml:"options,omitempty"`
	...
	// Proxy port.
	// Example: 1234
	ProxyPort *int64 `json:"proxy_port,omitempty" yaml:"proxy_port,omitempty"`

	// Proxy type.
	// Enum: ["http","https"]
	ProxyType *string `json:"proxy_type,omitempty" yaml:"proxy_type,omitempty"`
	...
	// security
	Security *CifsServiceSecurity `json:"security,omitempty" yaml:"security,omitempty"`

	// statistics
	Statistics *CifsServiceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`
	...
	VerifyHost *bool `json:"verify_host,omitempty" yaml:"verify_host,omitempty"`
...
type CifsServiceInlineMetric struct {
	...
	// links
	Links *CifsServiceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *CifsServiceInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *CifsServiceInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *CifsServiceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type CifsServiceInlineStatistics struct {
	...
	// iops raw
	IopsRaw *CifsServiceInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *CifsServiceInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *CifsServiceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type CifsServiceInlineSvm struct {
	...
	// links
	Links *CifsServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
