...
type SnapmirrorSourceEndpoint struct {
	...
	// svm
	Svm *SnapmirrorSourceEndpointInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type SnapmirrorSourceEndpointInlineCluster struct {
	...
	// links
	Links *SnapmirrorSourceEndpointInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnapmirrorSourceEndpointInlineSvm struct {
	...
	// links
	Links *SnapmirrorSourceEndpointInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
