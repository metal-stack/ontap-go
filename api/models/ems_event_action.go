...
type EmsEventAction struct {
	...
	ConfirmationMessage *EmsEventActionInlineConfirmationMessage `json:"confirmation_message,omitempty" yaml:"confirmation_message,omitempty"`

	// description
	Description *EmsEventActionInlineDescription `json:"description,omitempty" yaml:"description,omitempty"`

	// Parameter list for the action.
	// Read Only: true
	EmsEventActionInlineParameters []*EmsEventActionInlineParametersInlineArrayItem `json:"parameters,omitempty" yaml:"parameters,omitempty"`
	...
	//
	// Read Only: true
	EmsEventActionInlineRequestBodyTemplate interface{} `json:"request_body_template,omitempty" yaml:"request_body_template,omitempty"`
	...
	// title
	Title *EmsEventActionInlineTitle `json:"title,omitempty" yaml:"title,omitempty"`
}
...
type EmsEventActionInlineConfirmationMessage struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionConfirmationMessageArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type EmsEventActionInlineDescription struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionDescriptionArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type EmsEventActionInlineParametersInlineArrayItem struct {
	...
	// description
	Description *EmsEventActionInlineParametersInlineArrayItemInlineDescription `json:"description,omitempty" yaml:"description,omitempty"`
	...
	// Read Only: true
	EmsEventActionInlineParametersInlineArrayItemInlineItems interface{} `json:"items,omitempty" yaml:"items,omitempty"`
	...
	// Read Only: true
	EmsEventActionInlineParametersInlineArrayItemInlineProperties interface{} `json:"properties,omitempty" yaml:"properties,omitempty"`

	// Specifies the current value(s) for the parameter encoded in the appropriate JSON type.
	// Read Only: true
	EmsEventActionInlineParametersInlineArrayItemInlineValue interface{} `json:"value,omitempty" yaml:"value,omitempty"`
	...
	// help
	Help *EmsEventActionInlineParametersInlineArrayItemInlineHelp `json:"help,omitempty" yaml:"help,omitempty"`
	...
	// title
	Title *EmsEventActionInlineParametersInlineArrayItemInlineTitle `json:"title,omitempty" yaml:"title,omitempty"`
	...
	ValidationErrorMessage *EmsEventActionInlineParametersInlineArrayItemInlineValidationErrorMessage `json:"validation_error_message,omitempty" yaml:"validation_error_message,omitempty"`
}
...
type EmsEventActionInlineParametersInlineArrayItemInlineDescription struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionParametersItems0DescriptionArgumentsItems0 `json:"arguments" yaml:"arguments"`
...
type EmsEventActionInlineParametersInlineArrayItemInlineHelp struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionParametersItems0HelpArgumentsItems0 `json:"arguments" yaml:"arguments"`
...
type EmsEventActionInlineParametersInlineArrayItemInlineTitle struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionParametersItems0TitleArgumentsItems0 `json:"arguments" yaml:"arguments"`
...
type EmsEventActionInlineParametersInlineArrayItemInlineValidationErrorMessage struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionParametersItems0ValidationErrorMessageArgumentsItems0 `json:"arguments" yaml:"arguments"`
...
type EmsEventActionInlineTitle struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*EmsEventActionTitleArgumentsItems0 `json:"arguments,omitempty" yaml:"arguments,omitempty"`
