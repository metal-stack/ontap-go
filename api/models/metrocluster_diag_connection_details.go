...
type MetroclusterDiagConnectionDetails struct {
	...
	// cluster
	Cluster *MetroclusterDiagConnectionDetailsInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// metrocluster diag connection details inline connections
	// Read Only: true
	MetroclusterDiagConnectionDetailsInlineConnections []*MetroclusterDiagConnection `json:"connections,omitempty" yaml:"connections,omitempty"`

	// node
	Node *MetroclusterDiagConnectionDetailsInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type MetroclusterDiagConnectionDetailsInlineCluster struct {
	...
	// links
	Links *MetroclusterDiagConnectionDetailsInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterDiagConnectionDetailsInlineNode struct {
	...
	// links
	Links *MetroclusterDiagConnectionDetailsInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
