...
type EmsFilterRuleResponse struct {
	...
	// links
	Links *EmsFilterRuleResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ems filter rule response inline records
	EmsFilterRuleResponseInlineRecords []*EmsFilterRuleResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type EmsFilterRuleResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *EmsFilterRuleResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// message criteria
	MessageCriteria *EmsFilterRuleResponseInlineRecordsInlineArrayItemInlineMessageCriteria `json:"message_criteria,omitempty" yaml:"message_criteria,omitempty"`
	...
	ParameterCriteria []*EmsFilterRuleResponseRecordsItems0ParameterCriteriaItems0 `json:"parameter_criteria" yaml:"parameter_criteria"`
...
type EmsFilterRuleResponseInlineRecordsInlineArrayItemInlineMessageCriteria struct {
	...
	// links
	Links *EmsFilterRuleResponseInlineRecordsInlineArrayItemInlineMessageCriteriaInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
