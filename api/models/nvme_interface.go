...
type NvmeInterface struct {
	...
	// links
	Links *NvmeInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// fc interface
	FcInterface *NvmeInterfaceInlineFcInterface `json:"fc_interface,omitempty" yaml:"fc_interface,omitempty"`
	...
	// ip interface
	IPInterface *NvmeInterfaceInlineIPInterface `json:"ip_interface,omitempty" yaml:"ip_interface,omitempty"`
	...
	// node
	Node *NvmeInterfaceInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// svm
	Svm *NvmeInterfaceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// The transport address of the NVMe interface.
	//
	// Example: nn-0x200a00a0989062da:pn-0x200100a0989062da
	// Read Only: true
	TransportAddress *string `json:"transport_address,omitempty" yaml:"transport_address,omitempty"`

	// The transport protocols supported by the NVMe interface.
	//
	TransportProtocols []*string `json:"transport_protocols,omitempty" yaml:"transport_protocols,omitempty"`
...
type NvmeInterfaceInlineFcInterface struct {
	...
	// links
	Links *NvmeInterfaceInlineFcInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// port
	Port *NvmeInterfaceInlineFcInterfaceInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
...
type NvmeInterfaceInlineFcInterfaceInlinePort struct {
	...
	// links
	Links *NvmeInterfaceInlineFcInterfaceInlinePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *NvmeInterfaceInlineFcInterfaceInlinePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type NvmeInterfaceInlineIPInterface struct {
	...
	// ip
	IP *NvmeInterfaceInlineIPInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`

	// location
	Location *NvmeInterfaceInlineIPInterfaceInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`
}
...
type NvmeInterfaceInlineIPInterfaceInlineLocation struct {
	...
	// port
	// Read Only: true
	Port *PortReference `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type NvmeInterfaceInlineNode struct {
	...
	// links
	Links *NvmeInterfaceInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NvmeInterfaceInlineSvm struct {
	...
	// links
	Links *NvmeInterfaceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
