...
type VolumeProtocolRawPerformanceStatRw struct {
	...
	VolumeProtocolRawPerformanceStatRwInlineVolumeProtocolLatencyHistogramCounts []*int64 `json:"volume_protocol_latency_histogram_counts,omitempty" yaml:"volume_protocol_latency_histogram_counts,omitempty"`
	...
	VolumeProtocolRawPerformanceStatRwInlineVolumeProtocolLatencyHistogramLabels []*string `json:"volume_protocol_latency_histogram_labels,omitempty" yaml:"volume_protocol_latency_histogram_labels,omitempty"`
	...
	VolumeProtocolRawPerformanceStatRwInlineVolumeProtocolSizeHistogramCounts []*int64 `json:"volume_protocol_size_histogram_counts,omitempty" yaml:"volume_protocol_size_histogram_counts,omitempty"`
	...
	VolumeProtocolRawPerformanceStatRwInlineVolumeProtocolSizeHistogramLabels []*string `json:"volume_protocol_size_histogram_labels,omitempty" yaml:"volume_protocol_size_histogram_labels,omitempty"`
}
