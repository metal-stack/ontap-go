...
type VolumeProtocolRawPerformanceStatCreate struct {
	...
	// dir
	Dir *VolumeProtocolRawPerformanceStatCreateInlineDir `json:"dir,omitempty" yaml:"dir,omitempty"`

	// file
	File *VolumeProtocolRawPerformanceStatCreateInlineFile `json:"file,omitempty" yaml:"file,omitempty"`

	// other
	Other *VolumeProtocolRawPerformanceStatCreateInlineOther `json:"other,omitempty" yaml:"other,omitempty"`

	// symlink
	Symlink *VolumeProtocolRawPerformanceStatCreateInlineSymlink `json:"symlink,omitempty" yaml:"symlink,omitempty"`
}
