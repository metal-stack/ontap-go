...
type BroadcastDomainReference struct {
	...
	// links
	Links *BroadcastDomainReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ipspace
	Ipspace *BroadcastDomainReferenceInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
