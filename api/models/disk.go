...
type Disk struct {
	...
	// Example: 1
	// Read Only: true
	Bay *int64 `json:"bay,omitempty" yaml:"bay,omitempty"`

	// Bytes per sector.
	// Example: 520
	// Read Only: true
	BytesPerSector *int64 `json:"bytes_per_sector,omitempty" yaml:"bytes_per_sector,omitempty"`
	...
	// Read Only: true
	ControlStandard *string `json:"control_standard,omitempty" yaml:"control_standard,omitempty"`

	// List of aggregates sharing this disk
	// Read Only: true
	DiskInlineAggregates []*DiskInlineAggregatesInlineArrayItem `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`

	// List of disk errors information.
	// Read Only: true
	DiskInlineError []*DiskErrorInfo `json:"error,omitempty" yaml:"error,omitempty"`

	// List of paths to a disk
	// Read Only: true
	DiskInlinePaths []*DiskPathInfo `json:"paths,omitempty" yaml:"paths,omitempty"`

	// dr node
	DrNode *DiskInlineDrNode `json:"dr_node,omitempty" yaml:"dr_node,omitempty"`

	// drawer
	Drawer *DiskInlineDrawer `json:"drawer,omitempty" yaml:"drawer,omitempty"`

	// Effective Disk type
	// Example: vmdisk
	// Read Only: true
	// Enum: ["ata","fcal","lun","msata","sas","bsas","ssd","ssd_nvm","ssd_zns","ssd_cap","fsas","vmdisk","unknown"]
	EffectiveType *string `json:"effective_type,omitempty" yaml:"effective_type,omitempty"`
	...
	//
	EncryptionOperation *string `json:"encryption_operation,omitempty" yaml:"encryption_operation,omitempty"`

	// fips certified
	// Read Only: true
	FipsCertified *bool `json:"fips_certified,omitempty" yaml:"fips_certified,omitempty"`
	...
	// home node
	HomeNode *DiskInlineHomeNode `json:"home_node,omitempty" yaml:"home_node,omitempty"`

	// key id
	KeyID *DiskInlineKeyID `json:"key_id,omitempty" yaml:"key_id,omitempty"`
	...
	// node
	Node *DiskInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// outage
	Outage *DiskInlineOutage `json:"outage,omitempty" yaml:"outage,omitempty"`

	// Overall Security rating, for FIPS-certified devices.
	// Example: Level 2
	// Read Only: true
	OverallSecurity *string `json:"overall_security,omitempty" yaml:"overall_security,omitempty"`

	// Physical size, in units of bytes
	// Example: 228930
	// Read Only: true
	PhysicalSize *int64 `json:"physical_size,omitempty" yaml:"physical_size,omitempty"`
	...
	ProtectionMode *string `json:"protection_mode,omitempty" yaml:"protection_mode,omitempty"`

	// Percentage of rated life used
	// Example: 10
	// Read Only: true
	RatedLifeUsedPercent *int64 `json:"rated_life_used_percent,omitempty" yaml:"rated_life_used_percent,omitempty"`

	// Number of usable disk sectors that remain after subtracting the right-size adjustment for this disk.
	// Example: 1172123568
	// Read Only: true
	RightSizeSectorCount *int64 `json:"right_size_sector_count,omitempty" yaml:"right_size_sector_count,omitempty"`
	...
	// Example: 1172123568
	// Read Only: true
	SectorCount *int64 `json:"sector_count,omitempty" yaml:"sector_count,omitempty"`

	// self encrypting
	// Read Only: true
	SelfEncrypting *bool `json:"self_encrypting,omitempty" yaml:"self_encrypting,omitempty"`
	...
	// shelf
	Shelf *DiskInlineShelf `json:"shelf,omitempty" yaml:"shelf,omitempty"`
	...
	// stats
	Stats *DiskInlineStats `json:"stats,omitempty" yaml:"stats,omitempty"`

	// storage pool
	StoragePool *DiskInlineStoragePool `json:"storage_pool,omitempty" yaml:"storage_pool,omitempty"`
	...
	// virtual
	Virtual *DiskInlineVirtual `json:"virtual,omitempty" yaml:"virtual,omitempty"`
}
...
type DiskInlineAggregatesInlineArrayItem struct {
	...
	// links
	Links *DiskInlineAggregatesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type DiskInlineHomeNode struct {
	...
	// links
	Links *DiskInlineHomeNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type DiskInlineNode struct {
	...
	// links
	Links *DiskInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type DiskInlineOutage struct {
	...
	// Read Only: true
	PersistentlyFailed *bool `json:"persistently_failed,omitempty" yaml:"persistently_failed,omitempty"`
...
type DiskInlineShelf struct {
	...
	// links
	Links *DiskInlineShelfInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type DiskInlineStats struct {
	...
	// Example: 3
	// Read Only: true
	AverageLatency *int64 `json:"average_latency,omitempty" yaml:"average_latency,omitempty"`

	// Total I/O operations per second read and written to this disk across all active paths.
	// Example: 12854
	// Read Only: true
	IopsTotal *int64 `json:"iops_total,omitempty" yaml:"iops_total,omitempty"`

	// Disk path error count; failed I/O operations.
	// Example: 0
	// Read Only: true
	PathErrorCount *int64 `json:"path_error_count,omitempty" yaml:"path_error_count,omitempty"`

	// Hours powered on.
	// Example: 21016
	// Read Only: true
	PowerOnHours *int64 `json:"power_on_hours,omitempty" yaml:"power_on_hours,omitempty"`

	// Total disk throughput per second across all active paths, in bytes.
	// Example: 1957888
	// Read Only: true
	Throughput *int64 `json:"throughput,omitempty" yaml:"throughput,omitempty"`
}
...
type DiskInlineStoragePool struct {
	...
	// links
	Links *DiskInlineStoragePoolInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type DiskInlineVirtual struct {
	...
	// Read Only: true
	TargetAddress *string `json:"target_address,omitempty" yaml:"target_address,omitempty"`
}
