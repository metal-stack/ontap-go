...
type WwpnAlias struct {
	...
	// links
	Links *WwpnAliasInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// svm
	Svm *WwpnAliasInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type WwpnAliasInlineSvm struct {
	...
	// links
	Links *WwpnAliasInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
