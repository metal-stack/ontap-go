...
type OracleRacOnSan struct {
	...
	// archive log
	ArchiveLog *OracleRacOnSanArchiveLog `json:"archive_log,omitempty" yaml:"archive_log,omitempty"`

	// db
	// Required: true
	Db *OracleRacOnSanDb `json:"db" yaml:"db"`

	// db sids
	// Required: true
	// Max Items: 2
	// Min Items: 2
	DbSids []*OracleRacOnSanDbSidsItems0 `json:"db_sids" yaml:"db_sids"`

	// grid binary
	GridBinary *OracleRacOnSanGridBinary `json:"grid_binary,omitempty" yaml:"grid_binary,omitempty"`

	// The list of initiator groups to create.
	// Max Items: 2
	// Min Items: 0
	NewIgroups []*OracleRacOnSanNewIgroups `json:"new_igroups" yaml:"new_igroups"`

	// ora home
	OraHome *OracleRacOnSanOraHome `json:"ora_home,omitempty" yaml:"ora_home,omitempty"`

	// oracle crs
	OracleCrs *OracleRacOnSanOracleCrs `json:"oracle_crs,omitempty" yaml:"oracle_crs,omitempty"`
	...
	// protection type
	ProtectionType *OracleRacOnSanProtectionType `json:"protection_type,omitempty" yaml:"protection_type,omitempty"`

	// redo log
	// Required: true
	RedoLog *OracleRacOnSanRedoLog `json:"redo_log" yaml:"redo_log"`
}
...
type OracleRacOnSanArchiveLog struct {
	...
	// storage service
	StorageService *OracleRacOnSanArchiveLogStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type OracleRacOnSanDb struct {
	...
	// storage service
	StorageService *OracleRacOnSanDbStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type OracleRacOnSanGridBinary struct {
	...
	// storage service
	StorageService *OracleRacOnSanGridBinaryStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type OracleRacOnSanOraHome struct {
	...
	// storage service
	StorageService *OracleRacOnSanOraHomeStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type OracleRacOnSanOracleCrs struct {
	...
	// storage service
	StorageService *OracleRacOnSanOracleCrsStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type OracleRacOnSanRedoLog struct {
	...
	// storage service
	StorageService *OracleRacOnSanRedoLogStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
