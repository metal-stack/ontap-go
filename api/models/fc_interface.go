...
type FcInterface struct {
	...
	// links
	Links *FcInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	// Enum: ["fcp","fc_nvme"]
	DataProtocol *string `json:"data_protocol,omitempty" yaml:"data_protocol,omitempty"`
	...
	// location
	Location *FcInterfaceInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`

	// metric
	Metric *FcInterfaceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`
	...
	// Example: 5060F
	// Read Only: true
	PortAddress *string `json:"port_address,omitempty" yaml:"port_address,omitempty"`
	...
	// statistics
	Statistics *FcInterfaceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// svm
	Svm *FcInterfaceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type FcInterfaceInlineLocation struct {
	...
	// home node
	HomeNode *FcInterfaceInlineLocationInlineHomeNode `json:"home_node,omitempty" yaml:"home_node,omitempty"`

	// home port
	HomePort *FcInterfaceInlineLocationInlineHomePort `json:"home_port,omitempty" yaml:"home_port,omitempty"`
	...
	// node
	Node *FcInterfaceInlineLocationInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// port
	Port *FcInterfaceInlineLocationInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type FcInterfaceInlineLocationInlineHomeNode struct {
	...
	// links
	Links *FcInterfaceInlineLocationInlineHomeNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FcInterfaceInlineLocationInlineHomePort struct {
	...
	// links
	Links *FcInterfaceInlineLocationInlineHomePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *FcInterfaceInlineLocationInlineHomePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type FcInterfaceInlineLocationInlineNode struct {
	...
	// links
	Links *FcInterfaceInlineLocationInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FcInterfaceInlineLocationInlinePort struct {
	...
	// links
	Links *FcInterfaceInlineLocationInlinePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *FcInterfaceInlineLocationInlinePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type FcInterfaceInlineMetric struct {
	...
	// links
	Links *FcInterfaceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *FcInterfaceInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *FcInterfaceInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *FcInterfaceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type FcInterfaceInlineStatistics struct {
	...
	// iops raw
	IopsRaw *FcInterfaceInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *FcInterfaceInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *FcInterfaceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type FcInterfaceInlineSvm struct {
	...
	// links
	Links *FcInterfaceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
