...
type CifsOpenFile struct {
	...
	// connection
	Connection *CifsOpenFileInlineConnection `json:"connection,omitempty" yaml:"connection,omitempty"`
	...
	// Read Only: true
	// Enum: ["no","yes"]
	ContinuouslyAvailable *string `json:"continuously_available,omitempty" yaml:"continuously_available,omitempty"`
	...
	// node
	// Required: true
	Node *CifsOpenFileInlineNode `json:"node" yaml:"node"`
	...
	// Example: 4
	// Read Only: true
	RangeLocksCount *int64 `json:"range_locks_count,omitempty" yaml:"range_locks_count,omitempty"`

	// session
	Session *CifsOpenFileInlineSession `json:"session,omitempty" yaml:"session,omitempty"`

	// share
	Share *CifsOpenFileInlineShare `json:"share,omitempty" yaml:"share,omitempty"`

	// svm
	// Required: true
	Svm *CifsOpenFileInlineSvm `json:"svm" yaml:"svm"`
	...
	// volume
	Volume *CifsOpenFileInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type CifsOpenFileInlineNode struct {
	...
	// links
	Links *CifsOpenFileInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsOpenFileInlineSvm struct {
	...
	// links
	Links *CifsOpenFileInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsOpenFileInlineVolume struct {
	...
	// links
	Links *CifsOpenFileInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
