...
type AutosupportIssues struct {
	...
	// corrective action
	CorrectiveAction *AutosupportConnectivityCorrectiveAction `json:"corrective_action,omitempty" yaml:"corrective_action,omitempty"`
	...
	// issue
	Issue *AutosupportConnectivityIssue `json:"issue,omitempty" yaml:"issue,omitempty"`

	// node
	Node *AutosupportIssuesInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type AutosupportIssuesInlineNode struct {
	...
	// links
	Links *AutosupportIssuesInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
