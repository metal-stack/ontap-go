...
type SecurityKeyManager struct {
	...
	// links
	Links *SecurityKeyManagerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// configuration
	Configuration *SecurityKeyManagerInlineConfiguration `json:"configuration,omitempty" yaml:"configuration,omitempty"`
	...
	// external
	External *SecurityKeyManagerInlineExternal `json:"external,omitempty" yaml:"external,omitempty"`
	...
	IsDefaultDataAtRestEncryptionDisabled *bool `json:"is_default_data_at_rest_encryption_disabled,omitempty" yaml:"is_default_data_at_rest_encryption_disabled,omitempty"`

	// onboard
	Onboard *SecurityKeyManagerInlineOnboard `json:"onboard,omitempty" yaml:"onboard,omitempty"`
	...
	// status
	Status *SecurityKeyManagerInlineStatus `json:"status,omitempty" yaml:"status,omitempty"`

	// svm
	Svm *SecurityKeyManagerInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// volume encryption
	VolumeEncryption *SecurityKeyManagerInlineVolumeEncryption `json:"volume_encryption,omitempty" yaml:"volume_encryption,omitempty"`
}
...
type SecurityKeyManagerInlineConfiguration struct {
	...
	// links
	Links *SecurityKeyManagerInlineConfigurationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SecurityKeyManagerInlineExternal struct {
	...
	// client certificate
	ClientCertificate *SecurityKeyManagerInlineExternalInlineClientCertificate `json:"client_certificate,omitempty" yaml:"client_certificate,omitempty"`

	// The array of certificates that are common for all the keyservers per SVM.
	ServerCaCertificates []*SecurityKeyManagerExternalServerCaCertificatesItems0 `json:"server_ca_certificates,omitempty" yaml:"server_ca_certificates,omitempty"`

	// The set of external key servers.
	// Max Items: 4
	Servers []*KeyServerReadcreate `json:"servers,omitempty" yaml:"servers,omitempty"`
}
...
type SecurityKeyManagerInlineExternalInlineClientCertificate struct {
	...
	// links
	Links *SecurityKeyManagerInlineExternalInlineClientCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SecurityKeyManagerExternalServerCaCertificatesItems0 struct {
	...
	// links
	Links *SecurityKeyManagerExternalServerCaCertificatesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SecurityKeyManagerInlineOnboard struct {
	...
	// Format: password
	ExistingPassphrase *strfmt.Password `json:"existing_passphrase,omitempty" yaml:"existing_passphrase,omitempty"`
	...
	// Read Only: true
	KeyBackup *string `json:"key_backup,omitempty" yaml:"key_backup,omitempty"`

	// The cluster-wide passphrase. This is not audited.
	// Example: The cluster password of length 32-256 ASCII characters.
	// Format: password
	Passphrase *strfmt.Password `json:"passphrase,omitempty" yaml:"passphrase,omitempty"`
...
type SecurityKeyManagerInlineSvm struct {
	...
	// links
	Links *SecurityKeyManagerInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
