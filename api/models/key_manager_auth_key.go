...
type KeyManagerAuthKey struct {
	...
	SecurityKeyManager *KeyManagerAuthKeyInlineSecurityKeyManager `json:"security_key_manager,omitempty" yaml:"security_key_manager,omitempty"`
}
...
type KeyManagerAuthKeyInlineSecurityKeyManager struct {
	...
	// links
	Links *KeyManagerAuthKeyInlineSecurityKeyManagerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
