...
type TopMetricsFile struct {
	...
	// links
	Links *TopMetricsFileInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// iops
	Iops *TopMetricsFileInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`
	...
	// svm
	Svm *TopMetricsFileInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsFileInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`

	// volume
	Volume *TopMetricsFileInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type TopMetricsFileInlineSvm struct {
	...
	// links
	Links *TopMetricsFileInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type TopMetricsFileInlineVolume struct {
	...
	// links
	Links *TopMetricsFileInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
