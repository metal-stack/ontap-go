...
type WebauthnCredentials struct {
	...
	// credential
	Credential *WebauthnCredentialsInlineCredential `json:"credential,omitempty" yaml:"credential,omitempty"`
	...
	// Read Only: true
	// Format: date-time
	LastUsedTime *strfmt.DateTime `json:"last_used_time,omitempty" yaml:"last_used_time,omitempty"`

	// WebAuthn credential owner. Used to identify a cluster or an SVM.
	// Read Only: true
	Owner *SvmReference `json:"owner,omitempty" yaml:"owner,omitempty"`

	// public key
	PublicKey *WebauthnCredentialsInlinePublicKey `json:"public_key,omitempty" yaml:"public_key,omitempty"`

	// relying party
	RelyingParty *WebauthnCredentialsInlineRelyingParty `json:"relying_party,omitempty" yaml:"relying_party,omitempty"`
...
type WebauthnCredentialsInlineCredential struct {
	...
	// Read Only: true
	IDSha *string `json:"id_sha,omitempty" yaml:"id_sha,omitempty"`
