...
type FlexcacheRelationship struct {
	...
	// cluster
	Cluster *FlexcacheRelationshipInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`
	...
	// svm
	Svm *FlexcacheRelationshipInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FlexcacheRelationshipInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FlexcacheRelationshipInlineCluster struct {
	...
	// links
	Links *FlexcacheRelationshipInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FlexcacheRelationshipInlineSvm struct {
	...
	// links
	Links *FlexcacheRelationshipInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
