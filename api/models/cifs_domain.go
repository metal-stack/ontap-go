...
type CifsDomain struct {
	...
	// ad domain
	AdDomain *CifsDomainInlineAdDomain `json:"ad_domain,omitempty" yaml:"ad_domain,omitempty"`

	// Specifies the discovered servers records.
	//
	// Read Only: true
	CifsDomainInlineDiscoveredServers []*CifsDomainInlineDiscoveredServersInlineArrayItem `json:"discovered_servers,omitempty" yaml:"discovered_servers,omitempty"`

	// Specifies the preferred DC records.
	//
	// Read Only: true
	CifsDomainInlinePreferredDcs []*CifsDomainInlinePreferredDcsInlineArrayItem `json:"preferred_dcs,omitempty" yaml:"preferred_dcs,omitempty"`
	...
	// password schedule
	PasswordSchedule *CifsDomainInlinePasswordSchedule `json:"password_schedule,omitempty" yaml:"password_schedule,omitempty"`

	// Specifies the mode of server discovery.
	//
	// Enum: ["all","site","none"]
	ServerDiscoveryMode *string `json:"server_discovery_mode,omitempty" yaml:"server_discovery_mode,omitempty"`
...
type CifsDomainInlineDiscoveredServersInlineArrayItem struct {
	...
	// node
	Node *CifsDomainInlineDiscoveredServersInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	ServerType *string `json:"server_type,omitempty" yaml:"server_type,omitempty"`
...
type CifsDomainInlineDiscoveredServersInlineArrayItemInlineNode struct {
	...
	// links
	Links *CifsDomainInlineDiscoveredServersInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsDomainInlinePasswordSchedule struct {
	...
	// Example: Sunday
	ScheduleDayOfWeek *string `json:"schedule_day_of_week,omitempty" yaml:"schedule_day_of_week,omitempty"`

	// Schedule description.
	// Read Only: true
	ScheduleDescription *string `json:"schedule_description,omitempty" yaml:"schedule_description,omitempty"`

	// Is password schedule enabled.
	ScheduleEnabled *bool `json:"schedule_enabled,omitempty" yaml:"schedule_enabled,omitempty"`

	// Last successful password change time.
	// Read Only: true
	// Format: date-time
	ScheduleLastChangedTime *strfmt.DateTime `json:"schedule_last_changed_time,omitempty" yaml:"schedule_last_changed_time,omitempty"`

	// Minutes within which schedule start can be randomized.
	// Maximum: 180
	// Minimum: 1
	ScheduleRandomizedMinute *int64 `json:"schedule_randomized_minute,omitempty" yaml:"schedule_randomized_minute,omitempty"`

	// Start time for password change schedule.
	// Example: 36900
	ScheduleTimeOfDay *string `json:"schedule_time_of_day,omitempty" yaml:"schedule_time_of_day,omitempty"`

	// Warning message in case job is deleted.
	// Read Only: true
	ScheduleWarnMessage *string `json:"schedule_warn_message,omitempty" yaml:"schedule_warn_message,omitempty"`

	// Interval in weeks for password change schedule.
	// Maximum: 52
	// Minimum: 1
	ScheduleWeeklyInterval *int64 `json:"schedule_weekly_interval,omitempty" yaml:"schedule_weekly_interval,omitempty"`
}
...
type CifsDomainInlineSvm struct {
	...
	// links
	Links *CifsDomainInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type CifsDomainInlineTrustRelationshipsInlineArrayItem struct {
	...
	// Home Domain Name
	//
	HomeDomain *string `json:"home_domain,omitempty" yaml:"home_domain,omitempty"`

	// node
	Node *CifsDomainInlineTrustRelationshipsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type CifsDomainInlineTrustRelationshipsInlineArrayItemInlineNode struct {
	...
	// links
	Links *CifsDomainInlineTrustRelationshipsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
