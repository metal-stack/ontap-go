...
type S3User struct {
	...
	// Read Only: true
	// Format: date-time
	KeyExpiryTime *strfmt.DateTime `json:"key_expiry_time,omitempty" yaml:"key_expiry_time,omitempty"`
	...
	//
	// Example: PT6H3M
	KeyTimeToLive *string `json:"key_time_to_live,omitempty" yaml:"key_time_to_live,omitempty"`
...
type S3UserInlineSvm struct {
	...
	// links
	Links *S3UserInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
