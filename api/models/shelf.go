...
type Shelf struct {
	...
	LocationLed *string `json:"location_led,omitempty" yaml:"location_led,omitempty"`

	// manufacturer
	Manufacturer *ShelfInlineManufacturer `json:"manufacturer,omitempty" yaml:"manufacturer,omitempty"`
	...
	// Read Only: true
	ShelfInlineAcps []*ShelfInlineAcpsInlineArrayItem `json:"acps,omitempty" yaml:"acps,omitempty"`

	// shelf inline bays
	ShelfInlineBays []*ShelfInlineBaysInlineArrayItem `json:"bays,omitempty" yaml:"bays,omitempty"`

	// shelf inline current sensors
	// Read Only: true
	ShelfInlineCurrentSensors []*ShelfInlineCurrentSensorsInlineArrayItem `json:"current_sensors,omitempty" yaml:"current_sensors,omitempty"`

	// shelf inline drawers
	// Read Only: true
	ShelfInlineDrawers []*ShelfInlineDrawersInlineArrayItem `json:"drawers,omitempty" yaml:"drawers,omitempty"`

	// shelf inline errors
	ShelfInlineErrors []*ShelfInlineErrorsInlineArrayItem `json:"errors,omitempty" yaml:"errors,omitempty"`

	// shelf inline fans
	// Read Only: true
	ShelfInlineFans []*ShelfInlineFansInlineArrayItem `json:"fans,omitempty" yaml:"fans,omitempty"`

	// shelf inline frus
	// Read Only: true
	ShelfInlineFrus []*ShelfInlineFrusInlineArrayItem `json:"frus,omitempty" yaml:"frus,omitempty"`

	// shelf inline paths
	// Read Only: true
	ShelfInlinePaths []*ShelfInlinePathsInlineArrayItem `json:"paths,omitempty" yaml:"paths,omitempty"`

	// shelf inline ports
	ShelfInlinePorts []*ShelfInlinePortsInlineArrayItem `json:"ports,omitempty" yaml:"ports,omitempty"`

	// shelf inline temperature sensors
	// Read Only: true
	ShelfInlineTemperatureSensors []*ShelfInlineTemperatureSensorsInlineArrayItem `json:"temperature_sensors,omitempty" yaml:"temperature_sensors,omitempty"`

	// shelf inline voltage sensors
	// Read Only: true
	ShelfInlineVoltageSensors []*ShelfInlineVoltageSensorsInlineArrayItem `json:"voltage_sensors,omitempty" yaml:"voltage_sensors,omitempty"`
	...
	// vendor
	Vendor *ShelfInlineVendor `json:"vendor,omitempty" yaml:"vendor,omitempty"`
}
...
type ShelfInlineAcpsInlineArrayItem struct {
	...
	// error
	Error *ShelfInlineAcpsInlineArrayItemInlineError `json:"error,omitempty" yaml:"error,omitempty"`
	...
	// node
	Node *ShelfInlineAcpsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type ShelfInlineAcpsInlineArrayItemInlineError struct {
	...
	// reason
	Reason *Error `json:"reason,omitempty" yaml:"reason,omitempty"`
...
type ShelfInlineAcpsInlineArrayItemInlineNode struct {
	...
	// links
	Links *ShelfInlineAcpsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ShelfInlineBaysInlineArrayItem struct {
	...
	// drawer
	Drawer *ShelfInlineBaysInlineArrayItemInlineDrawer `json:"drawer,omitempty" yaml:"drawer,omitempty"`

	// has disk
	HasDisk *bool `json:"has_disk,omitempty" yaml:"has_disk,omitempty"`
...
type ShelfInlineBaysInlineArrayItemInlineDrawer struct {
	...
	// Example: 0
	Slot *int64 `json:"slot,omitempty" yaml:"slot,omitempty"`
}
...
type ShelfInlineFrusInlineArrayItem struct {
	...
	// psu
	Psu *ShelfInlineFrusInlineArrayItemInlinePsu `json:"psu,omitempty" yaml:"psu,omitempty"`
...
type ShelfInlineFrusInlineArrayItemInlinePsu struct {
	...
	// Example: 92
	CrestFactor *int64 `json:"crest_factor,omitempty" yaml:"crest_factor,omitempty"`
	...
	// Example: 210
	PowerDrawn *int64 `json:"power_drawn,omitempty" yaml:"power_drawn,omitempty"`

	// Power rating, in watts
	// Example: 1600
	PowerRating *int64 `json:"power_rating,omitempty" yaml:"power_rating,omitempty"`
}
...
type ShelfInlinePathsInlineArrayItem struct {
	...
	// links
	Links *ShelfInlinePathsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *ShelfInlinePathsInlineArrayItemInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type ShelfInlinePathsInlineArrayItemInlineNode struct {
	...
	// links
	Links *ShelfInlinePathsInlineArrayItemInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ShelfInlinePortsInlineArrayItem struct {
	...
	// cable
	Cable *ShelfInlinePortsInlineArrayItemInlineCable `json:"cable,omitempty" yaml:"cable,omitempty"`

	// designator
	// Example: square
	// Enum: ["circle","square","1","2","3","4"]
	Designator *string `json:"designator,omitempty" yaml:"designator,omitempty"`
	...
	// remote
	Remote *ShelfInlinePortsInlineArrayItemInlineRemote `json:"remote,omitempty" yaml:"remote,omitempty"`
...
type ShelfInlinePortsInlineArrayItemInlineRemote struct {
	...
	// phy
	// Example: 12
	Phy *string `json:"phy,omitempty" yaml:"phy,omitempty"`
...
type ShelfInlineTemperatureSensorsInlineArrayItem struct {
	...
	// Example: false
	Ambient *bool `json:"ambient,omitempty" yaml:"ambient,omitempty"`
	...
	// Example: 32
	Temperature *int64 `json:"temperature,omitempty" yaml:"temperature,omitempty"`

	// threshold
	Threshold *ShelfInlineTemperatureSensorsInlineArrayItemInlineThreshold `json:"threshold,omitempty" yaml:"threshold,omitempty"`
}
...
type ShelfInlineTemperatureSensorsInlineArrayItemInlineThreshold struct {
	...
	// high
	High *ShelfInlineTemperatureSensorsInlineArrayItemInlineThresholdInlineHigh `json:"high,omitempty" yaml:"high,omitempty"`

	// low
	Low *ShelfInlineTemperatureSensorsInlineArrayItemInlineThresholdInlineLow `json:"low,omitempty" yaml:"low,omitempty"`
}
