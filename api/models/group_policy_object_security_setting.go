...
type GroupPolicyObjectSecuritySetting struct {
	...
	EventAuditSettings *GroupPolicyObjectEventAudit `json:"event_audit_settings,omitempty" yaml:"event_audit_settings,omitempty"`

	// event log settings
	EventLogSettings *GroupPolicyObjectEventLog `json:"event_log_settings,omitempty" yaml:"event_log_settings,omitempty"`

	// Files/Directories for file security.
	// Example: ["/vol1/home","/vol1/dir1"]
	GroupPolicyObjectSecuritySettingInlineFilesOrFolders []*string `json:"files_or_folders,omitempty" yaml:"files_or_folders,omitempty"`

	// kerberos
	Kerberos *GroupPolicyObjectKerberos `json:"kerberos,omitempty" yaml:"kerberos,omitempty"`

	// privilege rights
	PrivilegeRights *GroupPolicyObjectPrivilegeRight `json:"privilege_rights,omitempty" yaml:"privilege_rights,omitempty"`

	// registry values
	RegistryValues *GroupPolicyObjectRegistryValue `json:"registry_values,omitempty" yaml:"registry_values,omitempty"`

	// restrict anonymous
	RestrictAnonymous *GroupPolicyObjectRestrictAnonymous `json:"restrict_anonymous,omitempty" yaml:"restrict_anonymous,omitempty"`

	// restricted groups
	RestrictedGroups GroupPolicyObjectRestrictedGroupsArrayInline `json:"restricted_groups,omitempty" yaml:"restricted_groups,omitempty"`
}
