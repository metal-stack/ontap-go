...
type MetroclusterPartner struct {
	...
	// node
	Node *MetroclusterPartnerInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type MetroclusterPartnerInlineNode struct {
	...
	// links
	Links *MetroclusterPartnerInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
