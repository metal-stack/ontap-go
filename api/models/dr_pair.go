...
type DrPair struct {
	...
	// node
	Node *DrPairInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// partner
	Partner *DrPairInlinePartner `json:"partner,omitempty" yaml:"partner,omitempty"`
}
...
type DrPairInlineNode struct {
	...
	// links
	Links *DrPairInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type DrPairInlinePartner struct {
	...
	// links
	Links *DrPairInlinePartnerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
