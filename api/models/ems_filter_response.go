...
type EmsFilterResponse struct {
	...
	// links
	Links *EmsFilterResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ems filter response inline records
	EmsFilterResponseInlineRecords []*EmsFilterResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type EmsFilterResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *EmsFilterResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// access control role
	AccessControlRole *EmsFilterResponseInlineRecordsInlineArrayItemInlineAccessControlRole `json:"access_control_role,omitempty" yaml:"access_control_role,omitempty"`
	...
	Rules []*EmsFilterResponseRecordsItems0RulesItems0 `json:"rules" yaml:"rules"`
...
type EmsFilterResponseInlineRecordsInlineArrayItemInlineAccessControlRole struct {
	...
	// links
	Links *EmsFilterResponseInlineRecordsInlineArrayItemInlineAccessControlRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type EmsFilterResponseRecordsItems0RulesItems0 struct {
	...
	// links
	Links *EmsFilterResponseRecordsItems0RulesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// message criteria
	MessageCriteria *EmsFilterResponseRecordsItems0RulesItems0MessageCriteria `json:"message_criteria,omitempty" yaml:"message_criteria,omitempty"`
	...
	ParameterCriteria []*EmsFilterResponseRecordsItems0RulesItems0ParameterCriteriaItems0 `json:"parameter_criteria" yaml:"parameter_criteria"`
...
type EmsFilterResponseRecordsItems0RulesItems0MessageCriteria struct {
	...
	// links
	Links *EmsFilterResponseRecordsItems0RulesItems0MessageCriteriaLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnmpTrapTypes *string `json:"snmp_trap_types,omitempty" yaml:"snmp_trap_types,omitempty"`
}
...
type EmsFilterResponseRecordsItems0RulesItems0MessageCriteriaLinks struct {
	...
	// related
	Related *Href `json:"related,omitempty" yaml:"related,omitempty"`
}
