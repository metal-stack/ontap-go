...
type SvmMigrationIPInterfacePort struct {
	...
	// interface
	Interface *SvmMigrationIPInterfacePortInlineInterface `json:"interface,omitempty" yaml:"interface,omitempty"`

	// port
	Port *SvmMigrationIPInterfacePortInlinePort `json:"port,omitempty" yaml:"port,omitempty"`
}
...
type SvmMigrationIPInterfacePortInlineInterface struct {
	...
	// links
	Links *SvmMigrationIPInterfacePortInlineInterfaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *SvmMigrationIPInterfacePortInlineInterfaceInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type SvmMigrationIPInterfacePortInlinePort struct {
	...
	// links
	Links *SvmMigrationIPInterfacePortInlinePortInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *SvmMigrationIPInterfacePortInlinePortInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
