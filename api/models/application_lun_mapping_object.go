...
type ApplicationLunMappingObject struct {
	...
	// Read Only: true
	ApplicationLunMappingObjectInlineFcp []*ApplicationSanAccessFcpEndpoint `json:"fcp,omitempty" yaml:"fcp,omitempty"`

	// All possible iSCSI access endpoints for the LUN.
	// Read Only: true
	ApplicationLunMappingObjectInlineIscsi []*ApplicationSanAccessIscsiEndpoint `json:"iscsi,omitempty" yaml:"iscsi,omitempty"`

	// igroup
	Igroup *ApplicationLunMappingObjectInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`
