...
type KeyServer struct {
	...
	// links
	Links *KeyServerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// connectivity
	Connectivity *KeyServerInlineConnectivity `json:"connectivity,omitempty" yaml:"connectivity,omitempty"`
	...
	// Maximum: 60
	// Minimum: -1
	CreateRemoveTimeout *int64 `json:"create_remove_timeout,omitempty" yaml:"create_remove_timeout,omitempty"`
	...
	//
	// Max Items: 4
	KeyServerInlineRecords []*KeyServerInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`

	// A list of the secondary key servers associated with the primary key server.
	// Example: ["secondary1.com","10.1.2.3"]
	KeyServerInlineSecondaryKeyServers []*string `json:"secondary_key_servers,omitempty" yaml:"secondary_key_servers,omitempty"`
...
type KeyServerInlineConnectivity struct {
	...
	// Read Only: true
	ClusterAvailability *bool `json:"cluster_availability,omitempty" yaml:"cluster_availability,omitempty"`

	// An array of key server connectivity states for each node.
	//
	// Read Only: true
	NodeStates []*KeyServerState `json:"node_states,omitempty" yaml:"node_states,omitempty"`
}
...
type KeyServerInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *KeyServerInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// connectivity
	Connectivity *KeyServerInlineRecordsInlineArrayItemInlineConnectivity `json:"connectivity,omitempty" yaml:"connectivity,omitempty"`
...
type KeyServerInlineRecordsInlineArrayItemInlineConnectivity struct {
	...
	//
	// Read Only: true
	NodeStates []*KeyServerState `json:"node_states" yaml:"node_states"`
}
