...
type Coredump struct {
	...
	// links
	Links *CoredumpInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	IsSaved *bool `json:"is_saved,omitempty" yaml:"is_saved,omitempty"`
	...
	// Read Only: true
	Md5DataChecksum *string `json:"md5_data_checksum,omitempty" yaml:"md5_data_checksum,omitempty"`
	...
	// node
	Node *CoredumpInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// Time of panic that generated the core.
	// Example: 2021-03-01 22:09:11
	// Read Only: true
	// Format: date-time
	PanicTime *strfmt.DateTime `json:"panic_time,omitempty" yaml:"panic_time,omitempty"`
...
type CoredumpInlineNode struct {
	...
	// links
	Links *CoredumpInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
