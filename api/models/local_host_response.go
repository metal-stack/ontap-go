...
type LocalHostResponse struct {
	...
	// links
	Links *LocalHostResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// local host response inline records
	LocalHostResponseInlineRecords []*LocalHost `json:"records,omitempty" yaml:"records,omitempty"`
