...
type LdapSchemaNameMapping struct {
	...
	// account
	Account *LdapSchemaAccount `json:"account,omitempty" yaml:"account,omitempty"`

	// windows to unix
	WindowsToUnix *WindowsToUnix `json:"windows_to_unix,omitempty" yaml:"windows_to_unix,omitempty"`
}
