...
type GroupRoleMappings struct {
	...
	// links
	Links *GroupRoleMappingsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// ontap role
	OntapRole *GroupRoleMappingsInlineOntapRole `json:"ontap_role,omitempty" yaml:"ontap_role,omitempty"`
...
type GroupRoleMappingsInlineOntapRole struct {
	...
	// links
	Links *GroupRoleMappingsInlineOntapRoleInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
