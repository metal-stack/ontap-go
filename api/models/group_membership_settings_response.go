...
type GroupMembershipSettingsResponse struct {
	...
	// links
	Links *GroupMembershipSettingsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// group membership settings response inline records
	GroupMembershipSettingsResponseInlineRecords []*GroupMembershipSettings `json:"records,omitempty" yaml:"records,omitempty"`
