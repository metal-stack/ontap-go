...
type IscsiCredentials struct {
	...
	// links
	Links *IscsiCredentialsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// chap
	Chap *IscsiCredentialsInlineChap `json:"chap,omitempty" yaml:"chap,omitempty"`
	...
	// initiator address
	InitiatorAddress *IscsiCredentialsInlineInitiatorAddress `json:"initiator_address,omitempty" yaml:"initiator_address,omitempty"`

	// svm
	Svm *IscsiCredentialsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type IscsiCredentialsInlineChap struct {
	...
	// inbound
	Inbound *IscsiCredentialsInlineChapInlineInbound `json:"inbound,omitempty" yaml:"inbound,omitempty"`

	// outbound
	Outbound *IscsiCredentialsInlineChapInlineOutbound `json:"outbound,omitempty" yaml:"outbound,omitempty"`
}
...
type IscsiCredentialsInlineInitiatorAddress struct {
	...
	// masks
	Masks []*IPInfo `json:"masks,omitempty" yaml:"masks,omitempty"`

	// ranges
	Ranges []*IPAddressRange `json:"ranges,omitempty" yaml:"ranges,omitempty"`
}
...
type IscsiCredentialsInlineSvm struct {
	...
	// links
	Links *IscsiCredentialsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
