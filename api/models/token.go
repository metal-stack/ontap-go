...
type Token struct {
	...
	// expiry time
	ExpiryTime *TokenInlineExpiryTime `json:"expiry_time,omitempty" yaml:"expiry_time,omitempty"`

	// node
	Node *TokenInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
	...
	// Required: true
	ReserveSize *int64 `json:"reserve_size" yaml:"reserve_size"`
