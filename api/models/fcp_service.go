...
type FcpService struct {
	...
	// links
	Links *FcpServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// metric
	Metric *FcpServiceInlineMetric `json:"metric,omitempty" yaml:"metric,omitempty"`

	// statistics
	Statistics *FcpServiceInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// svm
	Svm *FcpServiceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// target
	Target *FcpServiceInlineTarget `json:"target,omitempty" yaml:"target,omitempty"`
}
...
type FcpServiceInlineMetric struct {
	...
	// links
	Links *FcpServiceInlineMetricInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *FcpServiceInlineMetricInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *FcpServiceInlineMetricInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *FcpServiceInlineMetricInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
...
type FcpServiceInlineStatistics struct {
	...
	// iops raw
	IopsRaw *FcpServiceInlineStatisticsInlineIopsRaw `json:"iops_raw,omitempty" yaml:"iops_raw,omitempty"`

	// latency raw
	LatencyRaw *FcpServiceInlineStatisticsInlineLatencyRaw `json:"latency_raw,omitempty" yaml:"latency_raw,omitempty"`
	...
	// throughput raw
	ThroughputRaw *FcpServiceInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type FcpServiceInlineSvm struct {
	...
	// links
	Links *FcpServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
