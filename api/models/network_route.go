...
type NetworkRoute struct {
	...
	// links
	Links *NetworkRouteInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// destination
	Destination *IPInfo `json:"destination,omitempty" yaml:"destination,omitempty"`
	...
	// ipspace
	Ipspace *NetworkRouteInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`
	...
	// Read Only: true
	NetworkRouteInlineInterfaces []*NetworkRouteInlineInterfacesInlineArrayItem `json:"interfaces,omitempty" yaml:"interfaces,omitempty"`

	// scope
	Scope *NetworkScopeReadonly `json:"scope,omitempty" yaml:"scope,omitempty"`

	// svm
	Svm *NetworkRouteInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type NetworkRouteInlineInterfacesInlineArrayItem struct {
	...
	// links
	Links *NetworkRouteInlineInterfacesInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ip
	IP *NetworkRouteInlineInterfacesInlineArrayItemInlineIP `json:"ip,omitempty" yaml:"ip,omitempty"`
...
type NetworkRouteInlineIpspace struct {
	...
	// links
	Links *NetworkRouteInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NetworkRouteInlineSvm struct {
	...
	// links
	Links *NetworkRouteInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
