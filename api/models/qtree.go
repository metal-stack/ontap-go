...
type Qtree struct {
	...
	// links
	Links *QtreeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// nas
	Nas *QtreeInlineNas `json:"nas,omitempty" yaml:"nas,omitempty"`
	...
	// qos policy
	QosPolicy *QtreeInlineQosPolicy `json:"qos_policy,omitempty" yaml:"qos_policy,omitempty"`
	...
	// Max Items: 64
	QtreeInlineTags []*string `json:"_tags,omitempty" yaml:"_tags,omitempty"`

	// security style
	SecurityStyle *SecurityStyle `json:"security_style,omitempty" yaml:"security_style,omitempty"`

	// statistics
	Statistics *QtreeInlineStatistics `json:"statistics,omitempty" yaml:"statistics,omitempty"`

	// svm
	Svm *QtreeInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
	...
	// user
	User *QtreeInlineUser `json:"user,omitempty" yaml:"user,omitempty"`

	// volume
	Volume *QtreeInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type QtreeInlineExportPolicy struct {
	...
	// links
	Links *QtreeInlineExportPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type QtreeInlineQosPolicy struct {
	...
	// links
	Links *QtreeInlineQosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type QtreeInlineStatistics struct {
	...
	// throughput raw
	ThroughputRaw *QtreeInlineStatisticsInlineThroughputRaw `json:"throughput_raw,omitempty" yaml:"throughput_raw,omitempty"`
...
type QtreeInlineSvm struct {
	...
	// links
	Links *QtreeInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
