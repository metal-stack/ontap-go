...
type DuogroupResponse struct {
	...
	// links
	Links *DuogroupResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// duogroup response inline records
	DuogroupResponseInlineRecords []*Duogroup `json:"records,omitempty" yaml:"records,omitempty"`
