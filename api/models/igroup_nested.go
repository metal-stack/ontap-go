...
type IgroupNested struct {
	...
	// links
	Links *IgroupNestedInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// igroup
	Igroup *IgroupNestedInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`
	...
	//
	IgroupNestedInlineRecords []*IgroupNestedInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type IgroupNestedInlineIgroup struct {
	...
	// links
	Links *IgroupNestedInlineIgroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupNestedInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *IgroupNestedInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
