...
type ApplicationComponentSnapshotRestore struct {
	...
	// links
	Links *ApplicationComponentSnapshotRestoreInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// application
	Application *ApplicationComponentSnapshotRestoreInlineApplication `json:"application,omitempty" yaml:"application,omitempty"`

	// component
	Component *ApplicationComponentSnapshotRestoreInlineComponent `json:"component,omitempty" yaml:"component,omitempty"`
...
type ApplicationComponentSnapshotRestoreInlineApplication struct {
	...
	// links
	Links *ApplicationComponentSnapshotRestoreInlineApplicationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type ApplicationComponentSnapshotRestoreInlineComponent struct {
	...
	// links
	Links *ApplicationComponentSnapshotRestoreInlineComponentInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
