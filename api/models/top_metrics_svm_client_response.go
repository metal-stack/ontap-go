...
type TopMetricsSvmClientResponse struct {
	...
	// links
	Links *TopMetricsSvmClientResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// notice
	Notice *TopMetricsSvmClientResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsSvmClientResponseInlineExcludedVolumes []*TopMetricsSvmClientExcludedVolume `json:"excluded_volumes,omitempty" yaml:"excluded_volumes,omitempty"`

	// top metrics svm client response inline records
	TopMetricsSvmClientResponseInlineRecords []*TopMetricsSvmClient `json:"records,omitempty" yaml:"records,omitempty"`
}
