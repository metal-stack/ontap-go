...
type LdapServiceResponse struct {
	...
	// links
	Links *LdapServiceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ldap service response inline records
	LdapServiceResponseInlineRecords []*LdapService `json:"records,omitempty" yaml:"records,omitempty"`
