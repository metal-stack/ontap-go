...
type SecurityOauth2Response struct {
	...
	// links
	Links *SecurityOauth2ResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SecurityOauth2ResponseInlineRecords []*SecurityOauth2 `json:"records,omitempty" yaml:"records,omitempty"`
}
