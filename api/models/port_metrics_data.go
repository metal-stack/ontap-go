...
type PortMetricsData struct {
	...
	// links
	Links *PortMetricsDataInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// throughput
	Throughput *PortMetricsDataInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
