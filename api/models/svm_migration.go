...
type SvmMigration struct {
	...
	AutoCutover *bool `json:"auto_cutover,omitempty" yaml:"auto_cutover,omitempty"`
	...
	AutoSourceCleanup *bool `json:"auto_source_cleanup,omitempty" yaml:"auto_source_cleanup,omitempty"`

	// Optional property that when set to true performs only migration pre-checks not the actual migration.
	CheckOnly *bool `json:"check_only,omitempty" yaml:"check_only,omitempty"`

	// current operation
	// Read Only: true
	CurrentOperation *SvmMigrationOperation `json:"current_operation,omitempty" yaml:"current_operation,omitempty"`

	// destination
	Destination *SvmMigrationInlineDestination `json:"destination,omitempty" yaml:"destination,omitempty"`
	...
	IPInterfacePlacement *SvmMigrationIPInterfacePlacement `json:"ip_interface_placement,omitempty" yaml:"ip_interface_placement,omitempty"`

	// last failed state
	// Read Only: true
	LastFailedState *SvmMigrationState `json:"last_failed_state,omitempty" yaml:"last_failed_state,omitempty"`
	...
	// Read Only: true
	PointOfNoReturn *bool `json:"point_of_no_return,omitempty" yaml:"point_of_no_return,omitempty"`

	// Number of times migrate restarted the transfer, for example, rollback to transfer after starting the cutover.
	// Read Only: true
	RestartCount *int64 `json:"restart_count,omitempty" yaml:"restart_count,omitempty"`

	// source
	Source *SvmMigrationInlineSource `json:"source,omitempty" yaml:"source,omitempty"`

	// state
	// Read Only: true
	State *SvmMigrationState `json:"state,omitempty" yaml:"state,omitempty"`

	// Errors and warnings returned/displayed during migration.
	// Read Only: true
	SvmMigrationInlineMessages []*SvmMigrationInlineMessagesInlineArrayItem `json:"messages,omitempty" yaml:"messages,omitempty"`
	...
	Throttle *int64 `json:"throttle,omitempty" yaml:"throttle,omitempty"`

	// time metrics
	TimeMetrics *SvmMigrationInlineTimeMetrics `json:"time_metrics,omitempty" yaml:"time_metrics,omitempty"`
...
type SvmMigrationInlineDestination struct {
	...
	// ipspace
	Ipspace *SvmMigrationInlineDestinationInlineIpspace `json:"ipspace,omitempty" yaml:"ipspace,omitempty"`

	// volume placement
	VolumePlacement *SvmMigrationInlineDestinationInlineVolumePlacement `json:"volume_placement,omitempty" yaml:"volume_placement,omitempty"`
}
...
type SvmMigrationInlineDestinationInlineIpspace struct {
	...
	// links
	Links *SvmMigrationInlineDestinationInlineIpspaceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationInlineDestinationInlineVolumePlacement struct {
	...
	Aggregates []*SvmMigrationDestinationVolumePlacementAggregatesItems0 `json:"aggregates,omitempty" yaml:"aggregates,omitempty"`

	// Optional property used to specify the list of desired volume-aggregate pairs in the destination.
	VolumeAggregatePairs []*SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0 `json:"volume_aggregate_pairs,omitempty" yaml:"volume_aggregate_pairs,omitempty"`
}
...
type SvmMigrationDestinationVolumePlacementAggregatesItems0 struct {
	...
	// links
	Links *SvmMigrationDestinationVolumePlacementAggregatesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0 struct {
	...
	// aggregate
	Aggregate *SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0Aggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`

	// volume
	Volume *SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0Volume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0Aggregate struct {
	...
	// links
	Links *SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0AggregateLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0Volume struct {
	...
	// links
	Links *SvmMigrationDestinationVolumePlacementVolumeAggregatePairsItems0VolumeLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationInlineSource struct {
	...
	// cluster
	Cluster *SvmMigrationInlineSourceInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`

	// svm
	Svm *SvmMigrationInlineSourceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type SvmMigrationInlineSourceInlineCluster struct {
	...
	// links
	Links *SvmMigrationInlineSourceInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationInlineSourceInlineSvm struct {
	...
	// links
	Links *SvmMigrationInlineSourceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmMigrationInlineTimeMetrics struct {
	...
	// Read Only: true
	// Format: date-time
	CutoverCompleteTime *strfmt.DateTime `json:"cutover_complete_time,omitempty" yaml:"cutover_complete_time,omitempty"`

	// Cutover start time
	// Example: 2020-12-03 02:20:19
	// Read Only: true
	// Format: date-time
	CutoverStartTime *strfmt.DateTime `json:"cutover_start_time,omitempty" yaml:"cutover_start_time,omitempty"`

	// Cutover trigger time
	// Example: 2020-12-03 03:15:19
	// Read Only: true
	// Format: date-time
	CutoverTriggerTime *strfmt.DateTime `json:"cutover_trigger_time,omitempty" yaml:"cutover_trigger_time,omitempty"`
	...
	// Read Only: true
	// Format: date-time
	LastPauseTime *strfmt.DateTime `json:"last_pause_time,omitempty" yaml:"last_pause_time,omitempty"`

	// Last migration resume time
	// Example: 2020-12-03 02:54:19
	// Read Only: true
	// Format: date-time
	LastResumeTime *strfmt.DateTime `json:"last_resume_time,omitempty" yaml:"last_resume_time,omitempty"`
