...
type QtreeResponse struct {
	...
	// links
	Links *QtreeResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	QtreeResponseInlineRecords []*Qtree `json:"records,omitempty" yaml:"records,omitempty"`
}
