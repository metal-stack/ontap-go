...
type MediatorResponse struct {
	...
	// links
	Links *MediatorResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// mediator response inline records
	MediatorResponseInlineRecords []*MediatorResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
...
type MediatorResponseInlineRecordsInlineArrayItem struct {
	...
	// dr group
	DrGroup *MediatorResponseInlineRecordsInlineArrayItemInlineDrGroup `json:"dr_group,omitempty" yaml:"dr_group,omitempty"`
	...
	// peer cluster
	PeerCluster *MediatorResponseInlineRecordsInlineArrayItemInlinePeerCluster `json:"peer_cluster,omitempty" yaml:"peer_cluster,omitempty"`
...
type MediatorResponseInlineRecordsInlineArrayItemInlinePeerCluster struct {
	...
	// links
	Links *MediatorResponseInlineRecordsInlineArrayItemInlinePeerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
