...
type UnixGroupSettings struct {
	...
	// links
	Links *UnixGroupSettingsInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	//
	NegativeCacheEnabled *bool `json:"negative_cache_enabled,omitempty" yaml:"negative_cache_enabled,omitempty"`

	// Specifies negative Time to Live, in ISO 8601 format.
	//
	// Example: PT5M
	NegativeTTL *string `json:"negative_ttl,omitempty" yaml:"negative_ttl,omitempty"`

	// Specifies whether the propagation setting is enabled or not.
	//
	PropagationEnabled *bool `json:"propagation_enabled,omitempty" yaml:"propagation_enabled,omitempty"`

	// svm
	Svm *UnixGroupSettingsInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type UnixGroupSettingsInlineSvm struct {
	...
	// links
	Links *UnixGroupSettingsInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
