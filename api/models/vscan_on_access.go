...
type VscanOnAccess struct {
	...
	// scope
	Scope *VscanOnAccessInlineScope `json:"scope,omitempty" yaml:"scope,omitempty"`

	// svm
	Svm *VscanOnAccessInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type VscanOnAccessInlineScope struct {
	...
	OnlyExecuteAccess *bool `json:"only_execute_access,omitempty" yaml:"only_execute_access,omitempty"`

	// Specifies whether or not read-only volume can be scanned.
	ScanReadonlyVolumes *bool `json:"scan_readonly_volumes,omitempty" yaml:"scan_readonly_volumes,omitempty"`
...
type VscanOnAccessInlineSvm struct {
	...
	// links
	Links *VscanOnAccessInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
