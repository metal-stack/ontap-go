...
type SvmS3ServiceReference struct {
	...
	// links
	Links *SvmS3ServiceReferenceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// certificate
	Certificate *SvmS3ServiceReferenceInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`
...
type SvmS3ServiceReferenceInlineCertificate struct {
	...
	// links
	Links *SvmS3ServiceReferenceInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
