...
type GroupPolicyObjectBranchcache struct {
	...
	HashPublicationMode *string `json:"hash_publication_mode,omitempty" yaml:"hash_publication_mode,omitempty"`

	// Hash version.
	// Example: version1
	// Enum: ["version1","version2","all_versions"]
	SupportedHashVersion *string `json:"supported_hash_version,omitempty" yaml:"supported_hash_version,omitempty"`
}
