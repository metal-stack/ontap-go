...
type IpsecCaCertificateResponse struct {
	...
	// links
	Links *IpsecCaCertificateResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// ipsec ca certificate response inline records
	IpsecCaCertificateResponseInlineRecords []*IpsecCaCertificate `json:"records,omitempty" yaml:"records,omitempty"`
