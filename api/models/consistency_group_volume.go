...
type ConsistencyGroupVolume struct {
	...
	// nas
	Nas *ConsistencyGroupVolumeInlineNas `json:"nas,omitempty" yaml:"nas,omitempty"`

	// provisioning options
	ProvisioningOptions *ConsistencyGroupVolumeInlineProvisioningOptions `json:"provisioning_options,omitempty" yaml:"provisioning_options,omitempty"`
	...
	// space
	Space *ConsistencyGroupVolumeInlineSpace `json:"space,omitempty" yaml:"space,omitempty"`

	// tiering
	Tiering *ConsistencyGroupVolumeInlineTiering `json:"tiering,omitempty" yaml:"tiering,omitempty"`
...
type ConsistencyGroupVolumeInlineNas struct {
	...
	// cifs
	Cifs *ConsistencyGroupVolumeInlineNasInlineCifs `json:"cifs,omitempty" yaml:"cifs,omitempty"`

	// export policy
	ExportPolicy *ConsistencyGroupVolumeInlineNasInlineExportPolicy `json:"export_policy,omitempty" yaml:"export_policy,omitempty"`

	// The UNIX group ID of the volume. Valid in POST or PATCH.
	Gid *int64 `json:"gid,omitempty" yaml:"gid,omitempty"`

	// junction parent
	JunctionParent *ConsistencyGroupVolumeInlineNasInlineJunctionParent `json:"junction_parent,omitempty" yaml:"junction_parent,omitempty"`
...
type ConsistencyGroupVolumeInlineNasInlineCifs struct {
	...
	// shares
	Shares []*ConsistencyGroupCifsShare `json:"shares,omitempty" yaml:"shares,omitempty"`
}
...
type ConsistencyGroupVolumeInlineNasInlineExportPolicy struct {
	...
	Rules []*ExportRules `json:"rules,omitempty" yaml:"rules,omitempty"`
}
...
type ConsistencyGroupVolumeInlineProvisioningOptions struct {
	...
	// storage service
	StorageService *ConsistencyGroupVolumeInlineProvisioningOptionsInlineStorageService `json:"storage_service,omitempty" yaml:"storage_service,omitempty"`
}
...
type ConsistencyGroupVolumeInlineQos struct {
	...
	// policy
	Policy *ConsistencyGroupVolumeInlineQosInlinePolicy `json:"policy,omitempty" yaml:"policy,omitempty"`
}
