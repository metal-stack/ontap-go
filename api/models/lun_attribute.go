...
type LunAttribute struct {
	...
	// links
	Links *LunAttributeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// lun
	Lun *LunAttributeInlineLun `json:"lun,omitempty" yaml:"lun,omitempty"`
...
type LunAttributeInlineLun struct {
	...
	// links
	Links *LunAttributeInlineLunInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
