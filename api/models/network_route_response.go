...
type NetworkRouteResponse struct {
	...
	// links
	Links *NetworkRouteResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// error
	Error *Error `json:"error,omitempty" yaml:"error,omitempty"`

	// network route response inline records
	NetworkRouteResponseInlineRecords []*NetworkRoute `json:"records,omitempty" yaml:"records,omitempty"`
