...
type S3ServicePostResponse struct {
	...
	S3ServicePostResponseInlineRecords []*S3ServicePostResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
}
...
type S3ServicePostResponseInlineRecordsInlineArrayItem struct {
	...
	// users
	Users []*S3ServiceUserPostResponse `json:"users" yaml:"users"`

	// warning
	Warning *S3ServicePostResponseInlineRecordsInlineArrayItemInlineWarning `json:"warning,omitempty" yaml:"warning,omitempty"`
}
