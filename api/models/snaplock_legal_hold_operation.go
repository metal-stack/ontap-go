...
type SnaplockLegalHoldOperation struct {
	...
	// links
	Links *SnaplockLegalHoldOperationInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: 0
	// Read Only: true
	NumFilesFailed *string `json:"num_files_failed,omitempty" yaml:"num_files_failed,omitempty"`

	// Specifies the number of files on which legal-hold operation was successful.
	// Example: 30
	// Read Only: true
	NumFilesProcessed *string `json:"num_files_processed,omitempty" yaml:"num_files_processed,omitempty"`
	...
	// Example: 10
	// Read Only: true
	NumFilesSkipped *string `json:"num_files_skipped,omitempty" yaml:"num_files_skipped,omitempty"`

	// Specifies the number of inodes on which the legal-hold operation was not attempted because they were not regular files.
	// Example: 10
	// Read Only: true
	NumInodesIgnored *string `json:"num_inodes_ignored,omitempty" yaml:"num_inodes_ignored,omitempty"`
