...
type TopMetricsSvmUserResponse struct {
	...
	// links
	Links *TopMetricsSvmUserResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// notice
	Notice *TopMetricsSvmUserResponseInlineNotice `json:"notice,omitempty" yaml:"notice,omitempty"`
	...
	TopMetricsSvmUserResponseInlineExcludedVolumes []*TopMetricsSvmUserExcludedVolume `json:"excluded_volumes,omitempty" yaml:"excluded_volumes,omitempty"`

	// top metrics svm user response inline records
	TopMetricsSvmUserResponseInlineRecords []*TopMetricsSvmUser `json:"records,omitempty" yaml:"records,omitempty"`
}
