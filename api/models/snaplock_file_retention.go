...
type SnaplockFileRetention struct {
	...
	// links
	Links *SnaplockFileRetentionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Example: 168
	// Read Only: true
	SecondsUntilExpiry *int64 `json:"seconds_until_expiry,omitempty" yaml:"seconds_until_expiry,omitempty"`

	// svm
	Svm *SnaplockFileRetentionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *SnaplockFileRetentionInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type SnaplockFileRetentionInlineSvm struct {
	...
	// links
	Links *SnaplockFileRetentionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SnaplockFileRetentionInlineVolume struct {
	...
	// links
	Links *SnaplockFileRetentionInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
