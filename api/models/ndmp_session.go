...
type NdmpSession struct {
	...
	// links
	Links *NdmpSessionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Indicates the NDMP backup engine.
	// Enum: ["dump","smtape"]
	BackupEngine *string `json:"backup_engine,omitempty" yaml:"backup_engine,omitempty"`
	...
	ClientPort *int64 `json:"client_port,omitempty" yaml:"client_port,omitempty"`

	// Information about the NDMP data server.
	Data *NdmpData `json:"data,omitempty" yaml:"data,omitempty"`
	...
	Mover *NdmpMover `json:"mover,omitempty" yaml:"mover,omitempty"`

	// node
	Node *NdmpSessionInlineNode `json:"node,omitempty" yaml:"node,omitempty"`

	// Information about the NDMP SCSI server.
	Scsi *NdmpScsi `json:"scsi,omitempty" yaml:"scsi,omitempty"`
	...
	// svm
	Svm *NdmpSessionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// Indicates the NDMP tape device.
	// Example: nrst0a
	TapeDevice *string `json:"tape_device,omitempty" yaml:"tape_device,omitempty"`

	// Indicates the NDMP tape device mode of operation.
	// Example: write
	TapeMode *NdmpMoverMode `json:"tape_mode,omitempty" yaml:"tape_mode,omitempty"`
...
type NdmpSessionInlineNode struct {
	...
	// links
	Links *NdmpSessionInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type NdmpSessionInlineSvm struct {
	...
	// links
	Links *NdmpSessionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
