...
type Plex struct {
	...
	// aggregate
	Aggregate *PlexInlineAggregate `json:"aggregate,omitempty" yaml:"aggregate,omitempty"`
	...
	// Read Only: true
	PlexInlineRaidGroups []*RaidGroup `json:"raid_groups,omitempty" yaml:"raid_groups,omitempty"`
	...
	// resync
	Resync *PlexInlineResync `json:"resync,omitempty" yaml:"resync,omitempty"`
...
type PlexInlineAggregate struct {
	...
	// links
	Links *PlexInlineAggregateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
