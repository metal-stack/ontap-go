...
type ApplicationNfsProperties struct {
	...
	ApplicationNfsPropertiesInlineIps []*string `json:"ips,omitempty" yaml:"ips,omitempty"`

	// application nfs properties inline permissions
	// Read Only: true
	ApplicationNfsPropertiesInlinePermissions []*ApplicationNfsPropertiesInlinePermissionsInlineArrayItem `json:"permissions,omitempty" yaml:"permissions,omitempty"`

	// backing storage
	BackingStorage *ApplicationNfsPropertiesInlineBackingStorage `json:"backing_storage,omitempty" yaml:"backing_storage,omitempty"`

	// export policy
	ExportPolicy *ApplicationNfsPropertiesInlineExportPolicy `json:"export_policy,omitempty" yaml:"export_policy,omitempty"`
