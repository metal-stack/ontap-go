...
type KeyServerState struct {
	...
	// node
	Node *KeyServerStateInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type KeyServerStateInlineNode struct {
	...
	// links
	Links *KeyServerStateInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
