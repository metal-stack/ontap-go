...
type CounterRow struct {
	...
	// links
	Links *CounterRowInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// aggregation
	Aggregation *InstanceCounterAggregation `json:"aggregation,omitempty" yaml:"aggregation,omitempty"`

	// Array of counter name/value pairs.
	CounterRowInlineCounters []*Counter `json:"counters,omitempty" yaml:"counters,omitempty"`

	// Array of property name/value pairs.
	CounterRowInlineProperties []*CounterProperty `json:"properties,omitempty" yaml:"properties,omitempty"`

	// counter table
	CounterTable *CounterTableReference `json:"counter_table,omitempty" yaml:"counter_table,omitempty"`
