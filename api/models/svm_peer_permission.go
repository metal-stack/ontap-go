...
type SvmPeerPermission struct {
	...
	// links
	Links *SvmPeerPermissionInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// cluster peer
	ClusterPeer *SvmPeerPermissionInlineClusterPeer `json:"cluster_peer,omitempty" yaml:"cluster_peer,omitempty"`

	// svm
	Svm *SvmPeerPermissionInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// A list of applications for an SVM peer relationship.
	// Example: ["snapmirror","flexcache"]
	SvmPeerPermissionInlineApplications []*SvmPeerPermissionApplications `json:"applications,omitempty" yaml:"applications,omitempty"`
}
...
type SvmPeerPermissionInlineClusterPeer struct {
	...
	// links
	Links *SvmPeerPermissionInlineClusterPeerInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type SvmPeerPermissionInlineSvm struct {
	...
	// links
	Links *SvmPeerPermissionInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
