...
type FcLoginResponse struct {
	...
	// links
	Links *FcLoginResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// fc login response inline records
	FcLoginResponseInlineRecords []*FcLogin `json:"records,omitempty" yaml:"records,omitempty"`
