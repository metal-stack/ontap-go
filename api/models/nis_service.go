...
type NisService struct {
	...
	// links
	Links *NisServiceInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Read Only: true
	NisServiceInlineBindingDetails []*NisServiceInlineBindingDetailsInlineArrayItem `json:"binding_details,omitempty" yaml:"binding_details,omitempty"`

	// nis service inline bound servers
	// Read Only: true
	NisServiceInlineBoundServers []*string `json:"bound_servers,omitempty" yaml:"bound_servers,omitempty"`
	...
	// Max Items: 10
	NisServiceInlineServers []*string `json:"servers,omitempty" yaml:"servers,omitempty"`

	// svm
	Svm *NisServiceInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type NisServiceInlineSvm struct {
	...
	// links
	Links *NisServiceInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
