...
type LoginMessages struct {
	...
	// links
	Links *LoginMessagesInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// Optional in the PATCH body.
	//
	ShowClusterMessage *bool `json:"show_cluster_message,omitempty" yaml:"show_cluster_message,omitempty"`

	// svm
	Svm *LoginMessagesInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type LoginMessagesInlineSvm struct {
	...
	// links
	Links *LoginMessagesInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
