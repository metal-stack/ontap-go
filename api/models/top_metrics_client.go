...
type TopMetricsClient struct {
	...
	// iops
	Iops *TopMetricsClientInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// svm
	Svm *TopMetricsClientInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsClientInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`

	// volume
	Volume *TopMetricsClientInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type TopMetricsClientInlineSvm struct {
	...
	// links
	Links *TopMetricsClientInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type TopMetricsClientInlineVolume struct {
	...
	// links
	Links *TopMetricsClientInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
