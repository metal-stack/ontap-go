...
type AutoUpdateConfigurationResponse struct {
	...
	// links
	Links *AutoUpdateConfigurationResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// auto update configuration response inline records
	AutoUpdateConfigurationResponseInlineRecords []*AutoUpdateConfiguration `json:"records,omitempty" yaml:"records,omitempty"`
