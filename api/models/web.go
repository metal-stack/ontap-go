...
type Web struct {
	...
	// links
	Links *WebInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// certificate
	Certificate *WebInlineCertificate `json:"certificate,omitempty" yaml:"certificate,omitempty"`

	// Indicates whether client authentication is enabled.
	ClientEnabled *bool `json:"client_enabled,omitempty" yaml:"client_enabled,omitempty"`

	// csrf
	Csrf *WebInlineCsrf `json:"csrf,omitempty" yaml:"csrf,omitempty"`

	// Indicates whether remote clients can connect to the web services.
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty"`

	// Indicates whether HTTP is enabled.
	HTTPEnabled *bool `json:"http_enabled,omitempty" yaml:"http_enabled,omitempty"`

	// HTTP port for cluster-level web services.
	HTTPPort *int64 `json:"http_port,omitempty" yaml:"http_port,omitempty"`

	// HTTPS port for cluster-level web services.
	HTTPSPort *int64 `json:"https_port,omitempty" yaml:"https_port,omitempty"`

	// Indicates whether online certificate status protocol verification is enabled.
	OcspEnabled *bool `json:"ocsp_enabled,omitempty" yaml:"ocsp_enabled,omitempty"`

	// The number of connections that can be processed concurrently from the same remote address.
	// Example: 42
	// Maximum: 999
	// Minimum: 24
	PerAddressLimit *int64 `json:"per_address_limit,omitempty" yaml:"per_address_limit,omitempty"`
	...
	WaitQueueCapacity *int64 `json:"wait_queue_capacity,omitempty" yaml:"wait_queue_capacity,omitempty"`
}
...
type WebInlineCertificate struct {
	...
	// links
	Links *WebInlineCertificateInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type WebInlineCsrf struct {
	...
	ProtectionEnabled *bool `json:"protection_enabled,omitempty" yaml:"protection_enabled,omitempty"`

	// token
	Token *WebInlineCsrfInlineToken `json:"token,omitempty" yaml:"token,omitempty"`
}
...
type WebInlineCsrfInlineToken struct {
	...
	// Maximum: 9999
	// Minimum: 100
	ConcurrentLimit *int64 `json:"concurrent_limit,omitempty" yaml:"concurrent_limit,omitempty"`
	...
	// Example: 1200
	// Minimum: 600
	MaxTimeout *int64 `json:"max_timeout,omitempty" yaml:"max_timeout,omitempty"`
}
