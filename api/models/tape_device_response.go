...
type TapeDeviceResponse struct {
	...
	// links
	Links *TapeDeviceResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	TapeDeviceResponseInlineRecords []*TapeDevice `json:"records,omitempty" yaml:"records,omitempty"`
}
