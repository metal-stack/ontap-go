...
type SnaplockFileFingerprintResponse struct {
	...
	// links
	Links *SnaplockFileFingerprintResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnaplockFileFingerprintResponseInlineRecords []*SnaplockFileFingerprintGet `json:"records,omitempty" yaml:"records,omitempty"`
}
