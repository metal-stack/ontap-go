...
type TopMetricsSvmClient struct {
	...
	// iops
	Iops *TopMetricsSvmClientInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// svm
	Svm *TopMetricsSvmClientInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsSvmClientInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
}
...
type TopMetricsSvmClientInlineSvm struct {
	...
	// links
	Links *TopMetricsSvmClientInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
