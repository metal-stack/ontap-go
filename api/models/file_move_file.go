...
type FileMoveFile struct {
	...
	// svm
	Svm *FileMoveFileInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// volume
	Volume *FileMoveFileInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileMoveFileInlineSvm struct {
	...
	// links
	Links *FileMoveFileInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type FileMoveFileInlineVolume struct {
	...
	// links
	Links *FileMoveFileInlineVolumeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
