...
type VolumeMetricsResponse struct {
	...
	// links
	Links *VolumeMetricsResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	VolumeMetricsResponseInlineRecords []*VolumeMetricsResponseInlineRecordsInlineArrayItem `json:"records,omitempty" yaml:"records,omitempty"`
}
...
type VolumeMetricsResponseInlineRecordsInlineArrayItem struct {
	...
	// links
	Links *VolumeMetricsResponseInlineRecordsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// iops
	Iops *VolumeMetricsResponseInlineRecordsInlineArrayItemInlineIops `json:"iops,omitempty" yaml:"iops,omitempty"`

	// latency
	Latency *VolumeMetricsResponseInlineRecordsInlineArrayItemInlineLatency `json:"latency,omitempty" yaml:"latency,omitempty"`
	...
	// throughput
	Throughput *VolumeMetricsResponseInlineRecordsInlineArrayItemInlineThroughput `json:"throughput,omitempty" yaml:"throughput,omitempty"`
