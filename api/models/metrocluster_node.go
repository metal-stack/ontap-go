...
type MetroclusterNode struct {
	...
	// Read Only: true
	AutomaticUso *bool `json:"automatic_uso,omitempty" yaml:"automatic_uso,omitempty"`

	// cluster
	Cluster *MetroclusterNodeInlineCluster `json:"cluster,omitempty" yaml:"cluster,omitempty"`
	...
	DrAuxiliaryCluster *MetroclusterNodeInlineDrAuxiliaryCluster `json:"dr_auxiliary_cluster,omitempty" yaml:"dr_auxiliary_cluster,omitempty"`

	// dr auxiliary partner
	DrAuxiliaryPartner *MetroclusterNodeInlineDrAuxiliaryPartner `json:"dr_auxiliary_partner,omitempty" yaml:"dr_auxiliary_partner,omitempty"`

	// DR Group ID.
	// Read Only: true
	DrGroupID *int64 `json:"dr_group_id,omitempty" yaml:"dr_group_id,omitempty"`

	// State of the DR mirroring configuration.
	// Read Only: true
	// Enum: ["enabled","disabled","unreachable","configured"]
	DrMirroringState *string `json:"dr_mirroring_state,omitempty" yaml:"dr_mirroring_state,omitempty"`
	...
	DrOperationState *string `json:"dr_operation_state,omitempty" yaml:"dr_operation_state,omitempty"`

	// dr partner
	DrPartner *MetroclusterNodeInlineDrPartner `json:"dr_partner,omitempty" yaml:"dr_partner,omitempty"`

	// dr partner cluster
	DrPartnerCluster *MetroclusterNodeInlineDrPartnerCluster `json:"dr_partner_cluster,omitempty" yaml:"dr_partner_cluster,omitempty"`
	...
	// ha partner
	HaPartner *MetroclusterNodeInlineHaPartner `json:"ha_partner,omitempty" yaml:"ha_partner,omitempty"`

	// ha partner cluster
	HaPartnerCluster *MetroclusterNodeInlineHaPartnerCluster `json:"ha_partner_cluster,omitempty" yaml:"ha_partner_cluster,omitempty"`

	// Indicates whether the configuration type is MCC-IP.
	// Read Only: true
	IsMccip *bool `json:"is_mccip,omitempty" yaml:"is_mccip,omitempty"`

	// Indicates if the node object limits are enforced.
	// Read Only: true
	// Enum: ["enabled","disabled"]
	LimitEnforcement *string `json:"limit_enforcement,omitempty" yaml:"limit_enforcement,omitempty"`

	// node
	Node *MetroclusterNodeInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
}
...
type MetroclusterNodeInlineCluster struct {
	...
	// links
	Links *MetroclusterNodeInlineClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterNodeInlineDrAuxiliaryCluster struct {
	...
	// links
	Links *MetroclusterNodeInlineDrAuxiliaryClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterNodeInlineDrPartnerCluster struct {
	...
	// links
	Links *MetroclusterNodeInlineDrPartnerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type MetroclusterNodeInlineHaPartnerCluster struct {
	...
	// links
	Links *MetroclusterNodeInlineHaPartnerClusterInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
