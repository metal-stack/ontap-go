...
type Igroup struct {
	...
	// links
	Links *IgroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	ConnectivityTracking *IgroupInlineConnectivityTracking `json:"connectivity_tracking,omitempty" yaml:"connectivity_tracking,omitempty"`
	...
	//
	IgroupInlineInitiators []*IgroupInlineInitiatorsInlineArrayItem `json:"initiators,omitempty" yaml:"initiators,omitempty"`
	...
	//
	// Read Only: true
	IgroupInlineParentIgroups []*IgroupParent `json:"parent_igroups,omitempty" yaml:"parent_igroups,omitempty"`
	...
	// portset
	Portset *IgroupInlinePortset `json:"portset,omitempty" yaml:"portset,omitempty"`
	...
	// replication
	Replication *IgroupInlineReplication `json:"replication,omitempty" yaml:"replication,omitempty"`
	...
	//
	// Read Only: true
	SupportsIgroups *bool `json:"supports_igroups,omitempty" yaml:"supports_igroups,omitempty"`

	// svm
	Svm *IgroupInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`

	// target
	Target *IgroupInlineTarget `json:"target,omitempty" yaml:"target,omitempty"`
...
type IgroupInlineConnectivityTracking struct {
	...
	// alerts
	// Read Only: true
	Alerts []*IgroupConnectivityTrackingAlertsItems0 `json:"alerts,omitempty" yaml:"alerts,omitempty"`
	...
	//
	// Read Only: true
	RequiredNodes []*IgroupConnectivityTrackingRequiredNodesItems0 `json:"required_nodes,omitempty" yaml:"required_nodes,omitempty"`
}
...
type IgroupConnectivityTrackingAlertsItems0 struct {
	...
	// summary
	Summary *IgroupConnectivityTrackingAlertsItems0Summary `json:"summary,omitempty" yaml:"summary,omitempty"`
}
...
type IgroupConnectivityTrackingAlertsItems0Summary struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*ErrorArguments `json:"arguments" yaml:"arguments"`
...
type IgroupConnectivityTrackingRequiredNodesItems0 struct {
	...
	// links
	Links *IgroupConnectivityTrackingRequiredNodesItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlineInitiatorsInlineArrayItem struct {
	...
	// links
	Links *IgroupInlineInitiatorsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// connectivity tracking
	ConnectivityTracking *IgroupInlineInitiatorsInlineArrayItemInlineConnectivityTracking `json:"connectivity_tracking,omitempty" yaml:"connectivity_tracking,omitempty"`

	// igroup
	Igroup *IgroupInlineInitiatorsInlineArrayItemInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`
	...
	// proximity
	Proximity *IgroupInlineInitiatorsInlineArrayItemInlineProximity `json:"proximity,omitempty" yaml:"proximity,omitempty"`
}
...
type IgroupInlineInitiatorsInlineArrayItemInlineIgroup struct {
	...
	// links
	Links *IgroupInlineInitiatorsInlineArrayItemInlineIgroupInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlineInitiatorsInlineArrayItemInlineLinks struct {
	...
	// connectivity tracking
	ConnectivityTracking *IgroupInlineInitiatorsInlineArrayItemInlineLinksInlineConnectivityTracking `json:"connectivity_tracking,omitempty" yaml:"connectivity_tracking,omitempty"`

	// self
	Self *IgroupInlineInitiatorsInlineArrayItemInlineLinksInlineSelf `json:"self,omitempty" yaml:"self,omitempty"`
}
...
type IgroupInlineInitiatorsInlineArrayItemInlineProximity struct {
	...
	//
	PeerSvms []*IgroupInitiatorsItems0ProximityPeerSvmsItems0 `json:"peer_svms" yaml:"peer_svms"`
}
...
type IgroupInitiatorsItems0ProximityPeerSvmsItems0 struct {
	...
	// links
	Links *IgroupInitiatorsItems0ProximityPeerSvmsItems0Links `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlineLunMapsInlineArrayItem struct {
	...
	// links
	Links *IgroupInlineLunMapsInlineArrayItemInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// lun
	Lun *IgroupInlineLunMapsInlineArrayItemInlineLun `json:"lun,omitempty" yaml:"lun,omitempty"`
}
...
type IgroupInlineLunMapsInlineArrayItemInlineLun struct {
	...
	// links
	Links *IgroupInlineLunMapsInlineArrayItemInlineLunInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// node
	Node *IgroupInlineLunMapsInlineArrayItemInlineLunInlineNode `json:"node,omitempty" yaml:"node,omitempty"`
...
type IgroupInlineLunMapsInlineArrayItemInlineLunInlineNode struct {
	...
	// links
	Links *IgroupInlineLunMapsInlineArrayItemInlineLunInlineNodeInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlinePortset struct {
	...
	// links
	Links *IgroupInlinePortsetInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlineReplication struct {
	...
	// error
	Error *IgroupInlineReplicationInlineError `json:"error,omitempty" yaml:"error,omitempty"`

	// peer svm
	PeerSvm *IgroupInlineReplicationInlinePeerSvm `json:"peer_svm,omitempty" yaml:"peer_svm,omitempty"`
...
type IgroupInlineReplicationInlineError struct {
	...
	// igroup
	Igroup *IgroupInlineReplicationInlineErrorInlineIgroup `json:"igroup,omitempty" yaml:"igroup,omitempty"`

	// summary
	Summary *IgroupInlineReplicationInlineErrorInlineSummary `json:"summary,omitempty" yaml:"summary,omitempty"`
}
...
type IgroupInlineReplicationInlineErrorInlineSummary struct {
	...
	// Message arguments
	// Read Only: true
	Arguments []*ErrorArguments `json:"arguments,omitempty" yaml:"arguments,omitempty"`
...
type IgroupInlineReplicationInlinePeerSvm struct {
	...
	// links
	Links *IgroupInlineReplicationInlinePeerSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlineSvm struct {
	...
	// links
	Links *IgroupInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
...
type IgroupInlineTarget struct {
	...
	// Example: 9111
	// Read Only: true
	FirmwareRevision *string `json:"firmware_revision,omitempty" yaml:"firmware_revision,omitempty"`
