...
type SnapshotResponse struct {
	...
	// links
	Links *SnapshotResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	SnapshotResponseInlineRecords []*Snapshot `json:"records,omitempty" yaml:"records,omitempty"`
}
