...
type GroupPolicyObject struct {
	...
	CentralAccessPolicySettings GroupPolicyObjectCentralAccessPolicySettingsArrayInline `json:"central_access_policy_settings,omitempty" yaml:"central_access_policy_settings,omitempty"`

	// Types of events to be audited.
	// Example: none
	// Enum: ["none","success","failure","both"]
	CentralAccessPolicyStagingAuditType *string `json:"central_access_policy_staging_audit_type,omitempty" yaml:"central_access_policy_staging_audit_type,omitempty"`
	...
	FileSystemPath *string `json:"file_system_path,omitempty" yaml:"file_system_path,omitempty"`
	...
	LdapPath *string `json:"ldap_path,omitempty" yaml:"ldap_path,omitempty"`
	...
	// registry settings
	RegistrySettings *GroupPolicyObjectRegistrySetting `json:"registry_settings,omitempty" yaml:"registry_settings,omitempty"`

	// security settings
	SecuritySettings *GroupPolicyObjectSecuritySetting `json:"security_settings,omitempty" yaml:"security_settings,omitempty"`

	// svm
	Svm *GroupPolicyObjectInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
...
type GroupPolicyObjectInlineSvm struct {
	...
	// links
	Links *GroupPolicyObjectInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
