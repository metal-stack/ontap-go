...
type FcInterfaceSvm struct {
	...
	// links
	Links *FcInterfaceSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
	...
	// location
	Location *FcInterfaceSvmInlineLocation `json:"location,omitempty" yaml:"location,omitempty"`
...
type FcInterfaceSvmInlineLocation struct {
	...
	// port
	Port *FcPortReference `json:"port,omitempty" yaml:"port,omitempty"`
}
