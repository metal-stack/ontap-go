...
type FileInfo struct {
	...
	// links
	Links *FileInfoInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// Last access time of the file in date-time format.
	// Example: 2019-06-12 15:00:16
	// Read Only: true
	// Format: date-time
	AccessedTime *strfmt.DateTime `json:"accessed_time,omitempty" yaml:"accessed_time,omitempty"`

	// analytics
	Analytics *FileInfoInlineAnalytics `json:"analytics,omitempty" yaml:"analytics,omitempty"`
	...
	// Read Only: true
	// Format: date-time
	ChangedTime *strfmt.DateTime `json:"changed_time,omitempty" yaml:"changed_time,omitempty"`

	// constituent
	Constituent *FileInfoInlineConstituent `json:"constituent,omitempty" yaml:"constituent,omitempty"`

	// Creation time of the file in date-time format.
	// Example: 2019-06-12 15:00:16
	// Read Only: true
	// Format: date-time
	CreationTime *strfmt.DateTime `json:"creation_time,omitempty" yaml:"creation_time,omitempty"`
	...
	FillEnabled *bool `json:"fill_enabled,omitempty" yaml:"fill_enabled,omitempty"`
	...
	// Example: 1
	// Read Only: true
	HardLinksCount *int64 `json:"hard_links_count,omitempty" yaml:"hard_links_count,omitempty"`

	// Inode generation number.
	// Example: 214753547
	// Read Only: true
	InodeGeneration *int64 `json:"inode_generation,omitempty" yaml:"inode_generation,omitempty"`
	...
	// Example: false
	// Read Only: true
	IsVMAligned *bool `json:"is_vm_aligned,omitempty" yaml:"is_vm_aligned,omitempty"`
	...
	OverwriteEnabled *bool `json:"overwrite_enabled,omitempty" yaml:"overwrite_enabled,omitempty"`
	...
	// volume
	Volume *FileInfoInlineVolume `json:"volume,omitempty" yaml:"volume,omitempty"`
}
...
type FileInfoInlineAnalytics struct {
	...
	// by accessed time
	ByAccessedTime *FileInfoInlineAnalyticsInlineByAccessedTime `json:"by_accessed_time,omitempty" yaml:"by_accessed_time,omitempty"`

	// by modified time
	ByModifiedTime *FileInfoInlineAnalyticsInlineByModifiedTime `json:"by_modified_time,omitempty" yaml:"by_modified_time,omitempty"`
	...
	// Example: 21134
	FileCount *int64 `json:"file_count,omitempty" yaml:"file_count,omitempty"`

	// Returns true if data collection is incomplete for this directory tree.
	IncompleteData *bool `json:"incomplete_data,omitempty" yaml:"incomplete_data,omitempty"`

	// Number of sub directories
	// Example: 35
	SubdirCount *int64 `json:"subdir_count,omitempty" yaml:"subdir_count,omitempty"`
}
...
type FileInfoInlineAnalyticsInlineByAccessedTime struct {
	...
	// bytes used
	BytesUsed *FileInfoInlineAnalyticsInlineByAccessedTimeInlineBytesUsed `json:"bytes_used,omitempty" yaml:"bytes_used,omitempty"`
}
...
type FileInfoInlineAnalyticsInlineByAccessedTimeInlineBytesUsed struct {
	...
	NewestLabel *AnalyticsHistogramTimeLabel `json:"newest_label,omitempty" yaml:"newest_label,omitempty"`

	// The oldest time label with a non-zero histogram value.
	OldestLabel *AnalyticsHistogramTimeLabel `json:"oldest_label,omitempty" yaml:"oldest_label,omitempty"`

	// Percentages for this histogram
	// Example: [0.1,11.24,0.18,15.75,0.75,83.5,0]
	Percentages []*float64 `json:"percentages,omitempty" yaml:"percentages,omitempty"`
...
type FileInfoInlineAnalyticsInlineByModifiedTime struct {
	...
	// bytes used
	BytesUsed *FileInfoInlineAnalyticsInlineByModifiedTimeInlineBytesUsed `json:"bytes_used,omitempty" yaml:"bytes_used,omitempty"`
}
...
type FileInfoInlineQosPolicy struct {
	...
	// links
	Links *FileInfoInlineQosPolicyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
