...
type ApplicationTemplateResponse struct {
	...
	// links
	Links *ApplicationTemplateResponseInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// application template response inline records
	ApplicationTemplateResponseInlineRecords []*ApplicationTemplate `json:"records,omitempty" yaml:"records,omitempty"`
