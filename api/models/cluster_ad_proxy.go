...
type ClusterAdProxy struct {
	...
	// links
	Links *ClusterAdProxyInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`

	// svm
	Svm *ClusterAdProxyInlineSvm `json:"svm,omitempty" yaml:"svm,omitempty"`
}
...
type ClusterAdProxyInlineSvm struct {
	...
	// links
	Links *ClusterAdProxyInlineSvmInlineLinks `json:"_links,omitempty" yaml:"_links,omitempty"`
