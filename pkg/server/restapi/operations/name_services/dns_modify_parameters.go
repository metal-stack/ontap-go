...
// DNSModifyParams contains all the bound params for the dns modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters dns_modify
...
//
// To ensure default values, the struct must have been initialized with NewDNSModifyParams() beforehand.
func (o *DNSModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DNSModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
