...
// HostsSettingsModifyParams contains all the bound params for the hosts settings modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters hosts_settings_modify
...
//
// To ensure default values, the struct must have been initialized with NewHostsSettingsModifyParams() beforehand.
func (o *HostsSettingsModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *HostsSettingsModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
