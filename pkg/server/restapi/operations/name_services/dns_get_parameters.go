...
// DNSGetParams contains all the bound params for the dns get operation
// typically these are obtained from a http.Request
//
// swagger:parameters dns_get
...
//
// To ensure default values, the struct must have been initialized with NewDNSGetParams() beforehand.
func (o *DNSGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DNSGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *DNSGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
