...
// ClientLockGetParams contains all the bound params for the client lock get operation
// typically these are obtained from a http.Request
//
// swagger:parameters client_lock_get
...
//
// To ensure default values, the struct must have been initialized with NewClientLockGetParams() beforehand.
func (o *ClientLockGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ClientLockGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *ClientLockGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
