...
// ShadowcopySetGetParams contains all the bound params for the shadowcopy set get operation
// typically these are obtained from a http.Request
//
// swagger:parameters shadowcopy_set_get
...
//
// To ensure default values, the struct must have been initialized with NewShadowcopySetGetParams() beforehand.
func (o *ShadowcopySetGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ShadowcopySetGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *ShadowcopySetGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
