...
// ExportPolicyModifyOKCode is the HTTP code returned for type ExportPolicyModifyOK
const ExportPolicyModifyOKCode int = 200

/*
ExportPolicyModifyOK OK

swagger:response exportPolicyModifyOK
*/
type ExportPolicyModifyOK struct {
}

// NewExportPolicyModifyOK creates ExportPolicyModifyOK with default headers values
...
func (o *ExportPolicyModifyOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*
ExportPolicyModifyDefault ONTAP Error Response Codes
...
swagger:response exportPolicyModifyDefault
*/
...
// NewExportPolicyModifyDefault creates ExportPolicyModifyDefault with default headers values
...
// WithStatusCode adds the status to the export policy modify default response
func (o *ExportPolicyModifyDefault) WithStatusCode(code int) *ExportPolicyModifyDefault {
	o._statusCode = code
	return o
}

// SetStatusCode sets the status to the export policy modify default response
func (o *ExportPolicyModifyDefault) SetStatusCode(code int) {
	o._statusCode = code
}

// WithPayload adds the payload to the export policy modify default response
func (o *ExportPolicyModifyDefault) WithPayload(payload *models.ErrorResponse) *ExportPolicyModifyDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the export policy modify default response
func (o *ExportPolicyModifyDefault) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ExportPolicyModifyDefault) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
