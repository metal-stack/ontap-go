...
// WebGetParams contains all the bound params for the web get operation
// typically these are obtained from a http.Request
//
// swagger:parameters web_get
...
//
// To ensure default values, the struct must have been initialized with NewWebGetParams() beforehand.
func (o *WebGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WebGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
