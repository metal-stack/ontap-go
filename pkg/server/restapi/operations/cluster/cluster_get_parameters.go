...
// ClusterGetParams contains all the bound params for the cluster get operation
// typically these are obtained from a http.Request
//
// swagger:parameters cluster_get
...
//
// To ensure default values, the struct must have been initialized with NewClusterGetParams() beforehand.
func (o *ClusterGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ClusterGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
