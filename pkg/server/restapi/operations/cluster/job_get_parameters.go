...
// JobGetParams contains all the bound params for the job get operation
// typically these are obtained from a http.Request
//
// swagger:parameters job_get
...
//
// To ensure default values, the struct must have been initialized with NewJobGetParams() beforehand.
func (o *JobGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *JobGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *JobGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
