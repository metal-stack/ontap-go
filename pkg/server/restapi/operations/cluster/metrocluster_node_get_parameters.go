...
// MetroclusterNodeGetParams contains all the bound params for the metrocluster node get operation
// typically these are obtained from a http.Request
//
// swagger:parameters metrocluster_node_get
...
//
// To ensure default values, the struct must have been initialized with NewMetroclusterNodeGetParams() beforehand.
func (o *MetroclusterNodeGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *MetroclusterNodeGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *MetroclusterNodeGetParams) bindNodeUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
