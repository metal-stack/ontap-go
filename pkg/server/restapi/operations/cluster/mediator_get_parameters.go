...
// MediatorGetParams contains all the bound params for the mediator get operation
// typically these are obtained from a http.Request
//
// swagger:parameters mediator_get
...
//
// To ensure default values, the struct must have been initialized with NewMediatorGetParams() beforehand.
func (o *MediatorGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *MediatorGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *MediatorGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *MediatorGetParams) validateUUID(formats strfmt.Registry) error {
