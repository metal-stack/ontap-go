...
// NodeGetParams contains all the bound params for the node get operation
// typically these are obtained from a http.Request
//
// swagger:parameters node_get
...
//
// To ensure default values, the struct must have been initialized with NewNodeGetParams() beforehand.
func (o *NodeGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NodeGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NodeGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *NodeGetParams) validateUUID(formats strfmt.Registry) error {
