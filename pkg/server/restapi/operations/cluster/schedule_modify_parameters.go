...
// ScheduleModifyParams contains all the bound params for the schedule modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters schedule_modify
...
//
// To ensure default values, the struct must have been initialized with NewScheduleModifyParams() beforehand.
func (o *ScheduleModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ScheduleModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
