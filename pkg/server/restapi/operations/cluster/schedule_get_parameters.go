...
// ScheduleGetParams contains all the bound params for the schedule get operation
// typically these are obtained from a http.Request
//
// swagger:parameters schedule_get
...
//
// To ensure default values, the struct must have been initialized with NewScheduleGetParams() beforehand.
func (o *ScheduleGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ScheduleGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *ScheduleGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
