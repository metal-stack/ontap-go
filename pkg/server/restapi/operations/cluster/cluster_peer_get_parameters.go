...
// ClusterPeerGetParams contains all the bound params for the cluster peer get operation
// typically these are obtained from a http.Request
//
// swagger:parameters cluster_peer_get
...
//
// To ensure default values, the struct must have been initialized with NewClusterPeerGetParams() beforehand.
func (o *ClusterPeerGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ClusterPeerGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *ClusterPeerGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
