...
// SoftwarePackageGetParams contains all the bound params for the software package get operation
// typically these are obtained from a http.Request
//
// swagger:parameters software_package_get
...
//
// To ensure default values, the struct must have been initialized with NewSoftwarePackageGetParams() beforehand.
func (o *SoftwarePackageGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SoftwarePackageGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SoftwarePackageGetParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
