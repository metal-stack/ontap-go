...
// NdmpNodeGetParams contains all the bound params for the ndmp node get operation
// typically these are obtained from a http.Request
//
// swagger:parameters ndmp_node_get
...
//
// To ensure default values, the struct must have been initialized with NewNdmpNodeGetParams() beforehand.
func (o *NdmpNodeGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NdmpNodeGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NdmpNodeGetParams) bindNodeUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
