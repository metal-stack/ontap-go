...
// MultiAdminVerifyRequestModifyParams contains all the bound params for the multi admin verify request modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters multi_admin_verify_request_modify
...
//
// To ensure default values, the struct must have been initialized with NewMultiAdminVerifyRequestModifyParams() beforehand.
func (o *MultiAdminVerifyRequestModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *MultiAdminVerifyRequestModifyParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
