...
// IpsecGetParams contains all the bound params for the ipsec get operation
// typically these are obtained from a http.Request
//
// swagger:parameters ipsec_get
...
//
// To ensure default values, the struct must have been initialized with NewIpsecGetParams() beforehand.
func (o *IpsecGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IpsecGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
