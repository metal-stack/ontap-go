...
// SecurityAssociationGetParams contains all the bound params for the security association get operation
// typically these are obtained from a http.Request
//
// swagger:parameters security_association_get
...
//
// To ensure default values, the struct must have been initialized with NewSecurityAssociationGetParams() beforehand.
func (o *SecurityAssociationGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SecurityAssociationGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SecurityAssociationGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
