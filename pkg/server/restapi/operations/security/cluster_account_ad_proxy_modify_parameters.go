...
// ClusterAccountAdProxyModifyParams contains all the bound params for the cluster account ad proxy modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters cluster_account_ad_proxy_modify
...
//
// To ensure default values, the struct must have been initialized with NewClusterAccountAdProxyModifyParams() beforehand.
func (o *ClusterAccountAdProxyModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
