...
// ClusterNisGetParams contains all the bound params for the cluster nis get operation
// typically these are obtained from a http.Request
//
// swagger:parameters cluster_nis_get
...
//
// To ensure default values, the struct must have been initialized with NewClusterNisGetParams() beforehand.
func (o *ClusterNisGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ClusterNisGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
