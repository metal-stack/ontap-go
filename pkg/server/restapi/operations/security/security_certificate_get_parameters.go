...
// SecurityCertificateGetParams contains all the bound params for the security certificate get operation
// typically these are obtained from a http.Request
//
// swagger:parameters security_certificate_get
...
//
// To ensure default values, the struct must have been initialized with NewSecurityCertificateGetParams() beforehand.
func (o *SecurityCertificateGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SecurityCertificateGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SecurityCertificateGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
