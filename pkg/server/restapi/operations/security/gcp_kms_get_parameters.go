...
// GcpKmsGetParams contains all the bound params for the gcp kms get operation
// typically these are obtained from a http.Request
//
// swagger:parameters gcp_kms_get
...
//
// To ensure default values, the struct must have been initialized with NewGcpKmsGetParams() beforehand.
func (o *GcpKmsGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GcpKmsGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *GcpKmsGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
