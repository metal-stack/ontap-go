...
// SecurityKeyManagerGetParams contains all the bound params for the security key manager get operation
// typically these are obtained from a http.Request
//
// swagger:parameters security_key_manager_get
...
//
// To ensure default values, the struct must have been initialized with NewSecurityKeyManagerGetParams() beforehand.
func (o *SecurityKeyManagerGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SecurityKeyManagerGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SecurityKeyManagerGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
