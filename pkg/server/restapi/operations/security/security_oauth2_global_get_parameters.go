...
// SecurityOauth2GlobalGetParams contains all the bound params for the security oauth2 global get operation
// typically these are obtained from a http.Request
//
// swagger:parameters security_oauth2_global_get
...
//
// To ensure default values, the struct must have been initialized with NewSecurityOauth2GlobalGetParams() beforehand.
func (o *SecurityOauth2GlobalGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SecurityOauth2GlobalGetParams) bindEnabled(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SecurityOauth2GlobalGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
