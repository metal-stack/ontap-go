...
// ClusterLdapGetParams contains all the bound params for the cluster ldap get operation
// typically these are obtained from a http.Request
//
// swagger:parameters cluster_ldap_get
...
//
// To ensure default values, the struct must have been initialized with NewClusterLdapGetParams() beforehand.
func (o *ClusterLdapGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ClusterLdapGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
