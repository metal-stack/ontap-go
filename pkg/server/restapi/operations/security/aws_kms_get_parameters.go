...
// AwsKmsGetParams contains all the bound params for the aws kms get operation
// typically these are obtained from a http.Request
//
// swagger:parameters aws_kms_get
...
//
// To ensure default values, the struct must have been initialized with NewAwsKmsGetParams() beforehand.
func (o *AwsKmsGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AwsKmsGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *AwsKmsGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
