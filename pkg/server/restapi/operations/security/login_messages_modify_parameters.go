...
// LoginMessagesModifyParams contains all the bound params for the login messages modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters login_messages_modify
...
//
// To ensure default values, the struct must have been initialized with NewLoginMessagesModifyParams() beforehand.
func (o *LoginMessagesModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *LoginMessagesModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
