...
// IpsecPolicyGetParams contains all the bound params for the ipsec policy get operation
// typically these are obtained from a http.Request
//
// swagger:parameters ipsec_policy_get
...
//
// To ensure default values, the struct must have been initialized with NewIpsecPolicyGetParams() beforehand.
func (o *IpsecPolicyGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IpsecPolicyGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *IpsecPolicyGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
