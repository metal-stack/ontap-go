...
// AzureKeyVaultGetParams contains all the bound params for the azure key vault get operation
// typically these are obtained from a http.Request
//
// swagger:parameters azure_key_vault_get
...
//
// To ensure default values, the struct must have been initialized with NewAzureKeyVaultGetParams() beforehand.
func (o *AzureKeyVaultGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AzureKeyVaultGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *AzureKeyVaultGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
