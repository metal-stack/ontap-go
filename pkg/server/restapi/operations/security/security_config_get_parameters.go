...
// SecurityConfigGetParams contains all the bound params for the security config get operation
// typically these are obtained from a http.Request
//
// swagger:parameters security_config_get
...
//
// To ensure default values, the struct must have been initialized with NewSecurityConfigGetParams() beforehand.
func (o *SecurityConfigGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SecurityConfigGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
