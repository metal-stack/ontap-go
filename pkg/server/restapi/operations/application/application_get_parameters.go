...
// ApplicationGetParams contains all the bound params for the application get operation
// typically these are obtained from a http.Request
//
// swagger:parameters application_get
...
//
// To ensure default values, the struct must have been initialized with NewApplicationGetParams() beforehand.
func (o *ApplicationGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ApplicationGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *ApplicationGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
