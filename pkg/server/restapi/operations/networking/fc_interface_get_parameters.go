...
// FcInterfaceGetParams contains all the bound params for the fc interface get operation
// typically these are obtained from a http.Request
//
// swagger:parameters fc_interface_get
...
//
// To ensure default values, the struct must have been initialized with NewFcInterfaceGetParams() beforehand.
func (o *FcInterfaceGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *FcInterfaceGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *FcInterfaceGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
