...
// FcPortModifyParams contains all the bound params for the fc port modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters fc_port_modify
...
//
// To ensure default values, the struct must have been initialized with NewFcPortModifyParams() beforehand.
func (o *FcPortModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *FcPortModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
