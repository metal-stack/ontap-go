...
// NetworkIPInterfaceGetParams contains all the bound params for the network ip interface get operation
// typically these are obtained from a http.Request
//
// swagger:parameters network_ip_interface_get
...
//
// To ensure default values, the struct must have been initialized with NewNetworkIPInterfaceGetParams() beforehand.
func (o *NetworkIPInterfaceGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NetworkIPInterfaceGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NetworkIPInterfaceGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
