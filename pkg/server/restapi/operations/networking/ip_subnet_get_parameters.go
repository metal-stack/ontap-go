...
// IPSubnetGetParams contains all the bound params for the ip subnet get operation
// typically these are obtained from a http.Request
//
// swagger:parameters ip_subnet_get
...
//
// To ensure default values, the struct must have been initialized with NewIPSubnetGetParams() beforehand.
func (o *IPSubnetGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IPSubnetGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *IPSubnetGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
