...
// NetworkEthernetPortGetParams contains all the bound params for the network ethernet port get operation
// typically these are obtained from a http.Request
//
// swagger:parameters network_ethernet_port_get
...
//
// To ensure default values, the struct must have been initialized with NewNetworkEthernetPortGetParams() beforehand.
func (o *NetworkEthernetPortGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NetworkEthernetPortGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NetworkEthernetPortGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
