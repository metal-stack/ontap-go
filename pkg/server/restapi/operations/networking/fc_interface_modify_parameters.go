...
// FcInterfaceModifyParams contains all the bound params for the fc interface modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters fc_interface_modify
...
//
// To ensure default values, the struct must have been initialized with NewFcInterfaceModifyParams() beforehand.
func (o *FcInterfaceModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *FcInterfaceModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
