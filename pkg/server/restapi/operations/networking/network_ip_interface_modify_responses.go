...
// NetworkIPInterfaceModifyOKCode is the HTTP code returned for type NetworkIPInterfaceModifyOK
const NetworkIPInterfaceModifyOKCode int = 200

/*
NetworkIPInterfaceModifyOK OK

swagger:response networkIpInterfaceModifyOK
*/
type NetworkIPInterfaceModifyOK struct {
}

// NewNetworkIPInterfaceModifyOK creates NetworkIPInterfaceModifyOK with default headers values
...
func (o *NetworkIPInterfaceModifyOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*
NetworkIPInterfaceModifyDefault ONTAP Error Response Codes
...
swagger:response networkIpInterfaceModifyDefault
*/
...
// NewNetworkIPInterfaceModifyDefault creates NetworkIPInterfaceModifyDefault with default headers values
...
// WithStatusCode adds the status to the network ip interface modify default response
func (o *NetworkIPInterfaceModifyDefault) WithStatusCode(code int) *NetworkIPInterfaceModifyDefault {
	o._statusCode = code
	return o
}

// SetStatusCode sets the status to the network ip interface modify default response
func (o *NetworkIPInterfaceModifyDefault) SetStatusCode(code int) {
	o._statusCode = code
}

// WithPayload adds the payload to the network ip interface modify default response
func (o *NetworkIPInterfaceModifyDefault) WithPayload(payload *models.ErrorResponse) *NetworkIPInterfaceModifyDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the network ip interface modify default response
func (o *NetworkIPInterfaceModifyDefault) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *NetworkIPInterfaceModifyDefault) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
