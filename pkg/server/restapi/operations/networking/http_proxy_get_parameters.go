...
// HTTPProxyGetParams contains all the bound params for the http proxy get operation
// typically these are obtained from a http.Request
//
// swagger:parameters http_proxy_get
...
//
// To ensure default values, the struct must have been initialized with NewHTTPProxyGetParams() beforehand.
func (o *HTTPProxyGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *HTTPProxyGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *HTTPProxyGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
