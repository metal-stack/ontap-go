...
// NetworkIPBgpPeerGroupGetParams contains all the bound params for the network ip bgp peer group get operation
// typically these are obtained from a http.Request
//
// swagger:parameters network_ip_bgp_peer_group_get
...
//
// To ensure default values, the struct must have been initialized with NewNetworkIPBgpPeerGroupGetParams() beforehand.
func (o *NetworkIPBgpPeerGroupGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NetworkIPBgpPeerGroupGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NetworkIPBgpPeerGroupGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
