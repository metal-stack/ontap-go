...
// NetworkIPRouteGetParams contains all the bound params for the network ip route get operation
// typically these are obtained from a http.Request
//
// swagger:parameters network_ip_route_get
...
//
// To ensure default values, the struct must have been initialized with NewNetworkIPRouteGetParams() beforehand.
func (o *NetworkIPRouteGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NetworkIPRouteGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NetworkIPRouteGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
