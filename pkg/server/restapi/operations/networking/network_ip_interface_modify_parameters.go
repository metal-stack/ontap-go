...
// NetworkIPInterfaceModifyParams contains all the bound params for the network ip interface modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters network_ip_interface_modify
...
//
// To ensure default values, the struct must have been initialized with NewNetworkIPInterfaceModifyParams() beforehand.
func (o *NetworkIPInterfaceModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NetworkIPInterfaceModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
