...
// HTTPProxyModifyParams contains all the bound params for the http proxy modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters http_proxy_modify
...
//
// To ensure default values, the struct must have been initialized with NewHTTPProxyModifyParams() beforehand.
func (o *HTTPProxyModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *HTTPProxyModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
