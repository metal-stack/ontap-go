...
// FcPortGetParams contains all the bound params for the fc port get operation
// typically these are obtained from a http.Request
//
// swagger:parameters fc_port_get
...
//
// To ensure default values, the struct must have been initialized with NewFcPortGetParams() beforehand.
func (o *FcPortGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *FcPortGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *FcPortGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
