...
// IpspaceGetParams contains all the bound params for the ipspace get operation
// typically these are obtained from a http.Request
//
// swagger:parameters ipspace_get
...
//
// To ensure default values, the struct must have been initialized with NewIpspaceGetParams() beforehand.
func (o *IpspaceGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IpspaceGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *IpspaceGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
