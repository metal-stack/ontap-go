...
// SnapmirrorPolicyGetParams contains all the bound params for the snapmirror policy get operation
// typically these are obtained from a http.Request
//
// swagger:parameters snapmirror_policy_get
...
//
// To ensure default values, the struct must have been initialized with NewSnapmirrorPolicyGetParams() beforehand.
func (o *SnapmirrorPolicyGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SnapmirrorPolicyGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SnapmirrorPolicyGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
