...
// SvmMigrationGetParams contains all the bound params for the svm migration get operation
// typically these are obtained from a http.Request
//
// swagger:parameters svm_migration_get
...
//
// To ensure default values, the struct must have been initialized with NewSvmMigrationGetParams() beforehand.
func (o *SvmMigrationGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SvmMigrationGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SvmMigrationGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
