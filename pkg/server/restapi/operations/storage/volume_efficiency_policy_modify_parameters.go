...
// VolumeEfficiencyPolicyModifyParams contains all the bound params for the volume efficiency policy modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters volume_efficiency_policy_modify
...
//
// To ensure default values, the struct must have been initialized with NewVolumeEfficiencyPolicyModifyParams() beforehand.
func (o *VolumeEfficiencyPolicyModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *VolumeEfficiencyPolicyModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
