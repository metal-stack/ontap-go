...
// SnapshotPolicyGetParams contains all the bound params for the snapshot policy get operation
// typically these are obtained from a http.Request
//
// swagger:parameters snapshot_policy_get
...
//
// To ensure default values, the struct must have been initialized with NewSnapshotPolicyGetParams() beforehand.
func (o *SnapshotPolicyGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SnapshotPolicyGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SnapshotPolicyGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
