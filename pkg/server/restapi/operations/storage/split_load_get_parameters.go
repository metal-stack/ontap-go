...
// SplitLoadGetParams contains all the bound params for the split load get operation
// typically these are obtained from a http.Request
//
// swagger:parameters split_load_get
...
//
// To ensure default values, the struct must have been initialized with NewSplitLoadGetParams() beforehand.
func (o *SplitLoadGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SplitLoadGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *SplitLoadGetParams) bindNodeUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
