...
// QosPolicyGetParams contains all the bound params for the qos policy get operation
// typically these are obtained from a http.Request
//
// swagger:parameters qos_policy_get
...
//
// To ensure default values, the struct must have been initialized with NewQosPolicyGetParams() beforehand.
func (o *QosPolicyGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *QosPolicyGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *QosPolicyGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
