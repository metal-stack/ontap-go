...
// QuotaRuleGetParams contains all the bound params for the quota rule get operation
// typically these are obtained from a http.Request
//
// swagger:parameters quota_rule_get
...
//
// To ensure default values, the struct must have been initialized with NewQuotaRuleGetParams() beforehand.
func (o *QuotaRuleGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *QuotaRuleGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *QuotaRuleGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
