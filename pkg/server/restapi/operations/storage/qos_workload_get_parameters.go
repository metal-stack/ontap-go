...
// QosWorkloadGetParams contains all the bound params for the qos workload get operation
// typically these are obtained from a http.Request
//
// swagger:parameters qos_workload_get
...
//
// To ensure default values, the struct must have been initialized with NewQosWorkloadGetParams() beforehand.
func (o *QosWorkloadGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *QosWorkloadGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *QosWorkloadGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
