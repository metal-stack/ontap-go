...
// TapeDeviceGetParams contains all the bound params for the tape device get operation
// typically these are obtained from a http.Request
//
// swagger:parameters tape_device_get
...
//
// To ensure default values, the struct must have been initialized with NewTapeDeviceGetParams() beforehand.
func (o *TapeDeviceGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *TapeDeviceGetParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *TapeDeviceGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *TapeDeviceGetParams) bindNodeUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
