...
// StoragePoolGetParams contains all the bound params for the storage pool get operation
// typically these are obtained from a http.Request
//
// swagger:parameters storage_pool_get
...
//
// To ensure default values, the struct must have been initialized with NewStoragePoolGetParams() beforehand.
func (o *StoragePoolGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *StoragePoolGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *StoragePoolGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
