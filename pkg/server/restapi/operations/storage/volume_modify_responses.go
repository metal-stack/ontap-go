...
// VolumeModifyOKCode is the HTTP code returned for type VolumeModifyOK
const VolumeModifyOKCode int = 200

/*
VolumeModifyOK OK

swagger:response volumeModifyOK
*/
...
// NewVolumeModifyOK creates VolumeModifyOK with default headers values
func NewVolumeModifyOK() *VolumeModifyOK {

	return &VolumeModifyOK{}
}

// WithPayload adds the payload to the volume modify o k response
func (o *VolumeModifyOK) WithPayload(payload *models.JobLinkResponse) *VolumeModifyOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the volume modify o k response
func (o *VolumeModifyOK) SetPayload(payload *models.JobLinkResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *VolumeModifyOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
// VolumeModifyAcceptedCode is the HTTP code returned for type VolumeModifyAccepted
const VolumeModifyAcceptedCode int = 202

/*
VolumeModifyAccepted Accepted

swagger:response volumeModifyAccepted
*/
...
// NewVolumeModifyAccepted creates VolumeModifyAccepted with default headers values
func NewVolumeModifyAccepted() *VolumeModifyAccepted {

	return &VolumeModifyAccepted{}
}

// WithPayload adds the payload to the volume modify accepted response
func (o *VolumeModifyAccepted) WithPayload(payload *models.JobLinkResponse) *VolumeModifyAccepted {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the volume modify accepted response
func (o *VolumeModifyAccepted) SetPayload(payload *models.JobLinkResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *VolumeModifyAccepted) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*
VolumeModifyDefault ONTAP Error Response Codes
...
swagger:response volumeModifyDefault
*/
...
// NewVolumeModifyDefault creates VolumeModifyDefault with default headers values
...
// WithStatusCode adds the status to the volume modify default response
func (o *VolumeModifyDefault) WithStatusCode(code int) *VolumeModifyDefault {
	o._statusCode = code
	return o
}

// SetStatusCode sets the status to the volume modify default response
func (o *VolumeModifyDefault) SetStatusCode(code int) {
	o._statusCode = code
}

// WithPayload adds the payload to the volume modify default response
func (o *VolumeModifyDefault) WithPayload(payload *models.ErrorResponse) *VolumeModifyDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the volume modify default response
func (o *VolumeModifyDefault) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *VolumeModifyDefault) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
