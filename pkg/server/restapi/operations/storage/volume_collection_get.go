...
// VolumeCollectionGetHandlerFunc turns a function with the right signature into a volume collection get handler
type VolumeCollectionGetHandlerFunc func(VolumeCollectionGetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn VolumeCollectionGetHandlerFunc) Handle(params VolumeCollectionGetParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// VolumeCollectionGetHandler interface for that can handle valid volume collection get params
type VolumeCollectionGetHandler interface {
	Handle(VolumeCollectionGetParams, interface{}) middleware.Responder
}

// NewVolumeCollectionGet creates a new http.Handler for the volume collection get operation
func NewVolumeCollectionGet(ctx *middleware.Context, handler VolumeCollectionGetHandler) *VolumeCollectionGet {
	return &VolumeCollectionGet{Context: ctx, Handler: handler}
}

/*
	VolumeCollectionGet swagger:route GET /storage/volumes Storage volumeCollectionGet
...
*/
type VolumeCollectionGet struct {
	Context *middleware.Context
	Handler VolumeCollectionGetHandler
}

func (o *VolumeCollectionGet) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewVolumeCollectionGetParams()
