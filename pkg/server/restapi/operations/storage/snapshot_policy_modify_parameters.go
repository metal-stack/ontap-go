...
// SnapshotPolicyModifyParams contains all the bound params for the snapshot policy modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters snapshot_policy_modify
...
//
// To ensure default values, the struct must have been initialized with NewSnapshotPolicyModifyParams() beforehand.
func (o *SnapshotPolicyModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SnapshotPolicyModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
