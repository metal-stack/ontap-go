...
// IgroupGetParams contains all the bound params for the igroup get operation
// typically these are obtained from a http.Request
//
// swagger:parameters igroup_get
...
//
// To ensure default values, the struct must have been initialized with NewIgroupGetParams() beforehand.
func (o *IgroupGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IgroupGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *IgroupGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
