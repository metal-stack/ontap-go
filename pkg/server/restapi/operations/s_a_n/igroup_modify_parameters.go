...
// IgroupModifyParams contains all the bound params for the igroup modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters igroup_modify
...
//
// To ensure default values, the struct must have been initialized with NewIgroupModifyParams() beforehand.
func (o *IgroupModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IgroupModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
