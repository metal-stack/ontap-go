...
// PortsetGetParams contains all the bound params for the portset get operation
// typically these are obtained from a http.Request
//
// swagger:parameters portset_get
...
//
// To ensure default values, the struct must have been initialized with NewPortsetGetParams() beforehand.
func (o *PortsetGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PortsetGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *PortsetGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
