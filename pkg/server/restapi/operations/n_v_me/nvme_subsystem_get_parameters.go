...
// NvmeSubsystemGetParams contains all the bound params for the nvme subsystem get operation
// typically these are obtained from a http.Request
//
// swagger:parameters nvme_subsystem_get
...
//
// To ensure default values, the struct must have been initialized with NewNvmeSubsystemGetParams() beforehand.
func (o *NvmeSubsystemGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NvmeSubsystemGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *NvmeSubsystemGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
