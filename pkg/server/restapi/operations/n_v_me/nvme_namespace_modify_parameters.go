...
// NvmeNamespaceModifyParams contains all the bound params for the nvme namespace modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters nvme_namespace_modify
...
//
// To ensure default values, the struct must have been initialized with NewNvmeNamespaceModifyParams() beforehand.
func (o *NvmeNamespaceModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *NvmeNamespaceModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
