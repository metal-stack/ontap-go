...
// CoredumpGetParams contains all the bound params for the coredump get operation
// typically these are obtained from a http.Request
//
// swagger:parameters coredump_get
...
//
// To ensure default values, the struct must have been initialized with NewCoredumpGetParams() beforehand.
func (o *CoredumpGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CoredumpGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *CoredumpGetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CoredumpGetParams) bindNodeUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
