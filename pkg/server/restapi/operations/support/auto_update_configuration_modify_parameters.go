...
// AutoUpdateConfigurationModifyParams contains all the bound params for the auto update configuration modify operation
// typically these are obtained from a http.Request
//
// swagger:parameters auto_update_configuration_modify
...
//
// To ensure default values, the struct must have been initialized with NewAutoUpdateConfigurationModifyParams() beforehand.
func (o *AutoUpdateConfigurationModifyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.AutoUpdateConfiguration
...
func (o *AutoUpdateConfigurationModifyParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
