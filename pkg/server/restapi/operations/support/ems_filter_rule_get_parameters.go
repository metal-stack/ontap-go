...
// EmsFilterRuleGetParams contains all the bound params for the ems filter rule get operation
// typically these are obtained from a http.Request
//
// swagger:parameters ems_filter_rule_get
...
//
// To ensure default values, the struct must have been initialized with NewEmsFilterRuleGetParams() beforehand.
func (o *EmsFilterRuleGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *EmsFilterRuleGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *EmsFilterRuleGetParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *EmsFilterRuleGetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
