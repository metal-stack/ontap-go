...
// AutoUpdateConfigurationGetParams contains all the bound params for the auto update configuration get operation
// typically these are obtained from a http.Request
//
// swagger:parameters auto_update_configuration_get
...
//
// To ensure default values, the struct must have been initialized with NewAutoUpdateConfigurationGetParams() beforehand.
func (o *AutoUpdateConfigurationGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AutoUpdateConfigurationGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *AutoUpdateConfigurationGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
