...
// AutoUpdateStatusGetParams contains all the bound params for the auto update status get operation
// typically these are obtained from a http.Request
//
// swagger:parameters auto_update_status_get
...
//
// To ensure default values, the struct must have been initialized with NewAutoUpdateStatusGetParams() beforehand.
func (o *AutoUpdateStatusGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AutoUpdateStatusGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *AutoUpdateStatusGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
