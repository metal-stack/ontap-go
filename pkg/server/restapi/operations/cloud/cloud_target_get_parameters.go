...
// CloudTargetGetParams contains all the bound params for the cloud target get operation
// typically these are obtained from a http.Request
//
// swagger:parameters cloud_target_get
...
//
// To ensure default values, the struct must have been initialized with NewCloudTargetGetParams() beforehand.
func (o *CloudTargetGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CloudTargetGetParams) bindFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvFields string
	if len(rawData) > 0 {
...
func (o *CloudTargetGetParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
