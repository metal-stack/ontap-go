...
type Nas struct {
	...
	CifsAccess []*AppCifsAccess `json:"cifs_access"`
	...
	NfsAccess []*AppNfsAccess `json:"nfs_access"`
...
type NasApplicationComponentsItems0 struct {
	...
	// snaplock
	Snaplock *NasApplicationComponentsItems0Snaplock `json:"snaplock,omitempty"`
...
type NasApplicationComponentsItems0Snaplock struct {
	...
	// retention
	Retention *NasApplicationComponentsItems0SnaplockRetention `json:"retention,omitempty"`
